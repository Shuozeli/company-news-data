...
document_id: "c87809b5408f93c5ebd9fbc4a53cc26de4dae387051fc7529ccc5a02b6b5c9df"
...
canonical_url: "https://www.stocktitan.net/news/SMTI/sanara-med-tech-inc-receives-innovative-technology-contract-from-exgkef21v6y2.html"
...
content_hash: "sha256:bebb6a81af882220185f037d86484f642080e086c0e08ae306b8ece03d43544f"
---
...
On the day this news was published, **SMTI** gained **2.79%** , reflecting a moderate positive market reaction. This price movement added approximately **$6M** to the company's valuation, bringing the market cap to **$227.37M** at that time.
...
This announcement highlights an Innovative Technology contract from Vizient for BIASURGE®, effective...
...
Start date for Vizient Innovative Technology contract for BIASURGE
...
Annual purchasing volume represented by Vizient’s client portfolio
...
Dec 10[Product development update](https://www.stocktitan.net/news/SMTI/sanara-med-tech-inc-and-biomimetic-innovations-provide-update-on-os-b5p9kge8a6f0.html) Positive


+3.3% OsStic™ progress update with strong preclinical data and launch timeline.
...
Nov 12[Earnings release](https://www.stocktitan.net/news/SMTI/sanara-med-tech-inc-reports-third-quarter-2025-financial-results-qy046t8ua3q5.html) Negative


-24.7% Q3 2025 results with growth but large THP impairment and net loss.


Nov 11[Strategic realignment](https://www.stocktitan.net/news/SMTI/sanara-med-tech-inc-announces-strategic-realignment-to-focus-on-7cavx7jg7ou1.html) Negative


-0.4% Decision to discontinue THP and refocus resources on surgical business.
...
-2.9% ** Scheduling and call details for upcoming Q3 2025 financial results.
...
innovative technology contract, no-rinse irrigation solution, antimicrobial preservative, broad-spectrum antimicrobial
...
innovative technology contract


regulatory


"BIASURGE® product has received an Innovative Technology contract from Vizient"
...
no-rinse irrigation solution


technical


"BIASURGE’s no-rinse irrigation solution enables surgeons to cleanse the wound bed"


A no-rinse irrigation solution is a sterile liquid used during medical procedures to wash away blood, debris, or bacteria that is formulated to be safe to leave in the body or wound instead of requiring a separate rinsing step—think of it like a damp cloth that cleans without needing to be dried off. For investors, these products can drive steady hospital demand and recurring sales, but adoption and margins hinge on evidence of safety, ease of use and regulatory approval.
...
"its antimicrobial preservative provides broad-spectrum antimicrobial effectiveness"


An antimicrobial preservative is a substance added to medicines, vaccines, or personal-care products to stop bacteria, fungi or other microbes from growing while the product is stored or used. Investors should care because preservatives affect product safety, shelf life, regulatory approval and manufacturing costs—think of them as a product’s internal guard against spoilage; changes, shortages or safety concerns can delay launches, trigger recalls or alter marketability and revenue.
...
A broad-spectrum antimicrobial is a medicine that can kill or stop the growth of many different types of microbes — for example multiple bacteria or fungi — rather than targeting a single species. For investors, these drugs matter because they can treat a wider range of infections, potentially reaching larger markets and simplifying treatment choices, but they also face risks such as faster resistance development and stricter regulatory scrutiny; think of them as a wide net versus a precise arrow.
...
**FORT WORTH, TX, Jan. 07, 2026 (GLOBE NEWSWIRE) --** Sanara MedTech Inc. (“Sanara MedTech,” “Sanara,” the “Company,” “we,” “our” or “us”) (Nasdaq:[SMTI](https://www.stocktitan.net/overview/SMTI/) ), a medical technology company focused on developing and commercializing transformative technologies to improve clinical outcomes and reduce healthcare expenditures in the surgical market, today announced that its BIASURGE® Advanced Surgical Solution (“BIASURGE”) product has received an Innovative Technology contract from[Vizient](https://www.globenewswire.com/Tracker?data=b76z8Kg5pdKU2lHsyRzsoFocBLaKTZLAm1gpZbuyhum02e9W-X_LL8nL7esUQeZ572GHbliYhL3D7Q4PfBaPdA==)[®](https://www.globenewswire.com/Tracker?data=L3CsnWTNDZCy9XTxUAzSSs6jQA_DttpFXRZ0W1j4AeSbbmUgML0uz0j9n1rkRhMhdKrinO0sbCPyDMErclzXcw==)[Inc.](https://www.globenewswire.com/Tracker?data=0UA7r0u5XV1UEf1ReCQPt4nlBfSpPnAYHNUsuBekixa1wL8V0A6Ug3qrnyKDKBMVd2Lva_tiHxWYSgtqMxfNUg==) (“Vizient”), the nation’s largest provider-driven healthcare performance improvement company. The contract was awarded based on the recommendation of BIASURGE by hospital experts who serve on one of Vizient’s client-led councils, and it signifies to Vizient clients BIASURGE’s unique qualities that potentially bring improvement to the healthcare industry.
...
ICR Healthcare
[IR@sanaramedtech.com](https://www.globenewswire.com/Tracker?data=AjmPqTfngGysT2Xu-S349LX3r484RUnhcNsv9yO9TgMZriquYG-N3UhbywTiURjEUQ9SVD2Gs3hVYaxyGY0nneFyHRp_FCaTPP8XkBR42PuTt4mmKDMexUyYtDPNbPWEkxNeUvjtpQT9PofTk0pELfx6Pdi3ySkcT2PH_7Cqjaz9M9-2W2pkuA7-qyA4_Hc_9fH5GOGw3MoXYN_y8Qx19cX9EdnscGhsLxnfW4Ny2Lo8sNnVx68RBqfxlAW51wmFo7GPDhJ70y8rUZbx5t2e4w==)


## FAQ


### What did Sanara MedTech (SMTI) announce on January 7, 2026 regarding Vizient?


Sanara MedTech announced that BIASURGE received an **Innovative Technology contract from Vizient** , effective January 1, 2026.


### How does the Vizient contract affect access to BIASURGE for hospitals and health systems?


Vizient members gain access to BIASURGE at **pre-negotiated pricing and contracted terms** , enabling easier procurement across Vizient’s client base.


### Why did Vizient award an Innovative Technology contract to BIASURGE (SMTI)?


Vizient’s client-led council recommended BIASURGE after finding it offers a **unique benefit** versus other products, citing its no-rinse irrigation and antimicrobial preservative.


### When does the Vizient Innovative Technology contract for BIASURGE become effective for SMTI?


The contract terms are effective **January 1, 2026** .


### Does the Sanara MedTech press release disclose the financial value of the Vizient contract?


No; the announcement does **not disclose any contract value** or expected revenue impact.
