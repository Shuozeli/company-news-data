...
document_id: "8d092b2400385ff926ae9935a84d1d866fa3d25e98e706d2aea22f1f2a93a309"
...
canonical_url: "https://www.xometry.com/resources/certifications/applying-cmmc-requirements/"
published_at: "2025-11-06T21:22:16+00:00"
first_seen_at: "2026-07-20T23:17:15.190216+00:00"
fetched_at: "2026-07-28T22:25:18.858836+00:00"
content_hash: "sha256:4f402c30a3e7f9e4ded4de493db1bd9148c3ab1d11cf1c14d1428831a8917386"
---
...
A Summary of Different CMMC Levels and Their Requirements
...
CMMC Level 1 applies to any contractor that processes, stores, or transmits[Federal Contract Information (FCI)](https://www.acquisition.gov/far/4.1901) . FCI is defined as:
...
CMMC Level 1 contractors are required to comply with the 15 "basic safeguarding" cybersecurity controls set forth in[FAR 52.204-21](https://www.acquisition.gov/far/52.204-21) . This compliance is verified through an annual self-assessment, which the contractor must affirm via the Supplier Performance Risk System ([SPRS](https://www.sprs.csd.disa.mil/) ). Contractors must meet all 15 controls to be considered compliant; there are no exceptions or allowances for a Plan of Action and Milestones (POA&M) at this level.
...
CMMC Level 2 applies to any contractor that processes, stores, or transmits[Controlled Unclassified Information (CUI)](https://www.dodcui.mil/CUI-Categories-and-Abbreviations/) . The official definition of CUI is:
...
In other words, it’s sensitive information that the government requires to be protected and not released to the public. This is expected to include orders that are subject to ITAR (International Traffic in Arms Regulations) and/or EAR (Export Administration Regulations) *and part of DoD contracts signed **after 11/10/2026** .* Although ITAR and CMMC Level 2 (C3PAO) are independent of each other, there may be cases where both are required for proper data handling flow-down, especially for contracts originating from the DoD. Be mindful of all contractual requirements to ensure that facility-level controls are taken into account while configuring a quote.


CMMC Level 2 contractors are required to undergo a third-party audit against the 110 security controls set forth in[NIST SP 800-171 Rev 2](https://nvlpubs.nist.gov/nistpubs/SpecialPublications/NIST.SP.800-171r2.pdf) , and be issued a certificate. Contractors with some minor noncompliances may be granted conditional certification and will have 180 days to remediate the open issues. Contractors should also affirm their compliance via SPRS. You can view our certificates, including our CMMC level 2 certification, on our[legal page](https://www.xometry.com/legal/) .


## Applying CMMC Requirements in the Xometry Instant Quoting Engine®


Xometry simplifies the process of applying or flowing down CMMC and other certification/supplier requirements. Start by uploading your 3D CAD and technical drawings to the[Xometry Instant Quoting Engine®](https://www.xometry.com/quoting/home) . Once your parts are finished processing and your quote has been built, you can add certification requirements in one of two ways:
...
From the list of options, you’ll find the checkbox for “ **Cybersecurity Maturity Model Certification (CMMC)** ”. Once checked, CMMC Level 1 will be selected by default. If you require CMMC Level 2, please get in touch with your Xometry representative.


**Important:** Customers who require CMMC Level 2 *must* enable[Multi-Factor Authentication](https://community.xometry.com/kb/articles/848) (MFA) on their Xometry account to remain fully compliant.
