...
document_id: "0b895490ef44469d6fb59525e8d02b51d20753990063a590c1ee8e5342b8b461"
...
canonical_url: "https://www.xometry.com/resources/materials/low-density-polyethylene-ldpe/"
...
content_hash: "sha256:cda744d833d246386915691b4699b2c1e8bb91152c0d4906f8e02a6625669de2"
---
...
Polyethylene (polythene, PE, polyethene) and ethylene (ethene) molecule.


Low-density polyethylene can shapeshift a little, becoming pellets or granules. These formats make it easy to turn the material into other products. At Xometry LDPE is a common material we quote for in our injection molding and plastic extrusion processes. Other fabrication processes that can use this type of polyethylene include:
...
**Need Custom Parts Made From LDPE?**


[Start Your Quote](https://www.xometry.com/quoting/home/?processInitialisms=Injection+Molding)


### What are the Properties of Low Density Polyethylene (LDPE)?


There are a few standout properties of low-density polyethylene that make it a good choice when you’re after strong but flexible materials. It has high corrosion and chemical resistance and offers strength and toughness other plastics might not. Because of the structure of its molecules—it has more branching than its high-density cousin—it’s less dense and more flexible. This flexibility remains even in very cold temperatures.
...
Moisture Vapor Transmission (@37.8oC/100oF)


English


1.04 (cc-mil/in2-24hr-atm)


Metric


0.410 (cc-mm/m2-24hr-atm)
...
Table 1: Relevant material properties of low density polyethylene.[Overview of materials for Low Density Polyethylene (LDPE), Extrusion Grade](https://www.matweb.com/search/DataSheet.aspx?MatGUID=8e92b9e66e214e1b8fc8222dbff6d480&ckck=1)


### What Are the Applications of Low Density Polyethylene (LDPE)?
...
### What Are the Advantages of Using Low Density Polyethylene (LDPE)?


There are good reasons to use low-density polyethylene, but depending on the type of product you’re manufacturing.
...
### What Are the Disadvantages of Using Low Density Polyethylene (LDPE)?


There are also disadvantages to be wary of.
...
## What are the health effects of Low Density Polyethylene (LDPE)?


Low Density Polyethylene is one of the safest plastics in widespread use today, mainly because it is nontoxic, and is not carcinogenic. Even when ingested (in small quantities), polyethylene does not cause any hazardous health effects. This means that Low Density Polyethylene is considered safe and non hazardous for human skin contact, inhalation, and ingestion.
...
### Is Low Density Polyethylene (LDPE) Toxic?


Low Density Polyethylene is non-toxic. It is considered to be safe enough to be in contact with food as seen from its widespread use in sandwich bags, bread bags, and juice container lamination.
It should be noted, however, that recycled polyethylene does not have the same guarantee of sterility and purity as ‘virgin’ polyethylene, since environmental contaminants it is exposed to during its lifecycle can become embedded in the recycled product. In those cases, despite polyethylene being nontoxic, the potentially hazardous foreign chemicals may leach into the environment or into food. For this reason, the FDA has only given a food-grade rating to ‘virgin’ low density polyethylene plastics. Plastic leaching increases with acidity, duration of contact, and heat, so it is important to be conscious of what and where you are storing your polyethylene.


## What Are the Differences Between Low Density Polyethylene (LDPE) and High Density Polyethylene (HDPE)?
...
To learn more, see our in-depth guide on[High Density Polyethylene (HDPE)](https://www.xometry.com/resources/materials/high-density-polyethylene-hdpe/) .


## Summary


Xometry provides a wide range of manufacturing capabilities including CNC machining, 3D printing, injection molding (using LDPE), laser cutting, and sheet metal fabrication. Get your[instant quote](https://www.xometry.com/quoting/home/) today.
