...
document_id: "6dd91b42b8e4e3fd34ad207ebccbc59eb190be5009d65888a28d1d7b4ea30bf8"
...
canonical_url: "https://www.xometry.com/resources/injection-molding/plastic-injection-molding-history/"
...
content_hash: "sha256:1fb22afd0b1a94e88bd1af63205120fe6da37926eb23088070c030afcb8f0326"
---
...
Plastic injection molding dates back to the late 19th century, with the first plastic molding machine being patented. This article looks at the history of plastic injection molding and explains how the process has changed over the years.
...
Plastic injection molding requires an injection molding machine, raw plastic material, and a typically machined mold tool. The key steps in the injection molding process are clamping, injection, cooling, and ejection. For more information you can check our article on the[Basics of Plastic Injection Molding](https://www.xometry.com/resources/injection-molding/basics-of-plastic-injection-molding/) .


The diagram below shows a typical injection molding machine used by industry:


Parts of an injection molding machine


Clamping is when the two halves of the aluminum or steel mold are held together to prepare for the enormous pressure from injecting the molten material. Next, the pelletized resin is heated to a melted state and injected into the mold.


The part cools and solidifies into the final plastic part. This may take anywhere from a few seconds to a few minutes. The molded plastic part is then ejected, either automatically or manually, and the process starts again for the next part. Periodic maintenance is performed on injection molds to assure that they are not degraded and are capable of continuing to produce high-quality molded products.
...
World War II significantly changed the United States's manufacturing economy, which would later power the first stage of the post-war industrial revolution. This period also created a high demand for inexpensive, mass-produced materials with plastics.
...
A photograph of an injection molded part
...
Advanced hybrid molding machines can also improve the operations of a plastic injection molding company. Hybrid molding machines reduce energy expenses and also bring a higher level of molding precision while accommodating large parts.
...
### Is the Plastic Injection Molding Industry a Thriving Industry to Join?
...
Companies are now focusing on developing injection molded plastics using bio-based counterparts to overcome environmental concerns from traditional plastic materials. Increasing construction spending, particularly in developing markets such as Brazil, India, China, Mexico, Russia, and South Africa, is expected to drive product demand. In addition, the versatile properties of finished products, including better heat and pressure resistance, make them more relevant to various industries. Considering all this, the plastic injection molding industry is indeed a thriving industry.
...
Xometry offers a full range of injection molding services to assist with your production needs. Browse our website to explore the full range of our capabilities or to request a[free, no-obligation quote](https://www.xometry.com/quoting/home/?processInitialisms=Injection+Molding) .
