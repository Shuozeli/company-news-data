...
document_id: "31315cde198e46798f78ede10d51989eccf95633a364599fd5cb8b86160eb57d"
...
canonical_url: "https://www.xometry.com/resources/injection-molding/polycarbonate-injection-molding/"
...
content_hash: "sha256:b993bb074032a5fe7fbe48331de146e7f627963ab1a7e7020c97da0573f9e4e0"
---

# Polycarbonate Injection Molding: Definition, Applications, Process, and Techniques

Polycarbonate injection molding is a process that is used to create polycarbonate products at high production volumes and at a low cost per part by injecting melted plastic pellets into a mold.


Polycarbonate is a tough, optically clear or opaque, biocompatible plastic with good thermal resistance. These properties make it ideal for applications like car headlights, eyeglasses, and medical equipment. The polycarbonate injection molding process is no different from injection molding in other thermoplastics: molten plastic is injected into a two-part mold at high pressure. It then solidifies in the mold and is ejected when cool to allow the cycle to repeat. Polycarbonate injection molding has a high cycle rate, but it is also a demanding process that requires attention to detail to meet customer requirements.


This article will discuss the definition of polycarbonate injection molding, the processes and techniques that are involved, and molded polycarbonate product applications.
...
For more information, see our guide onPlastic Injection Molding .


## Why Is Polycarbonate Used in Injection Molding?
...
For more information, see our guide on[All About Polycarbonate](https://www.xometry.com/resources/materials/polycarbonate/) .
...
1. **Eyeglasses and Lenses:** Polycarbonate is often used for eyeglass lenses due to its clarity and resistance to UV (Ultraviolet) light when UV stabilizers are incorporated into the base material.
2. **Medical Devices:** Polycarbonate has excellent corrosion and thermal resistance and can be sterilized using irradiation, ethylene oxide, or steam autoclaving. Coupled with its optical clarity, polycarbonate is an ideal material for medical devices that require sterilization as these processes often require elevated temperatures. Applications include catheters, syringes, and incubators.
3. **Consumer Products:** Polycarbonate has excellent toughness and optical clarity, and is food safe, making it ideal for kitchenware like food processor mixing bowls, for example. Polycarbonate can withstand the temperatures required to keep equipment that contacts food clean and hygienic. It must be noted that polycarbonate can also be made to be opaque.
4. **Automotive Products:** Polycarbonate is widely used in car headlights due to its toughness, resistance to UV light, high and low temperature, and transparency. Its resistance to impact also makes it excellent at resisting impacts from road debris.


A molded polycarbonate gear


## What Is the Polycarbonate Injection Molding Process?
...
4. **Overmolding:** If multi-material components are required then techniques such as insert or over-molding can be used. This process refers to the act of injection molding plastic over a pre-existing part that has been placed in the mold.
...
## What Are the Disadvantages of Polycarbonate Injection Molding?
...
#### What Are the Common Problems in Polycarbonate Injection Molding?


Some of the challenges that must be overcome when injection molding with polycarbonate are listed below:


1. **Moisture Control** : Polycarbonate easily absorbs moisture prior to injection andcan cause splaying in the final part and undesirable streaking on the surface. The mechanical properties of polycarbonate can also be negatively affected by the inclusion of moisture. For this reason, polycarbonate pellets must be dried with a suitable desiccant or with a dehumidifier prior to being used for molding. The optimal moisture content is less than 0.02 %.
2. **Metal Adherence** : Polycarbonate has a tendency to adhere to injection mold materials and machine equipment made from high iron-content alloys. If molds or machine parts like screws have high iron content, it may be necessary to coat them with chrome to prevent adherence.
3. **High Viscosity** : Polycarbonate has a high viscosity which makes it difficult to mold thin walls or parts with complex flow requirements. This problem can be managed with high injection pressure and high injection temperature. However, higher temperatures require reduced injection speeds.


To learn more, see our full guide on[Injection Molding Defects](https://www.xometry.com/resources/injection-molding/defects-in-injection-molding/) .
...
To learn more, see our full guide on[10 Most Common Plastic Injection Molding](https://www.xometry.com/resources/injection-molding/plastic-injection-molding-materials/) .


## Summary


Xometry provides a wide range of manufacturing capabilities including CNC machining, 3D printing, injection molding (including polycarbonate injection molding), laser cutting, and sheet metal fabrication. Get your[instant quote](https://www.xometry.com/quoting/home/) today.
