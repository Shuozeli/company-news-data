...
document_id: "13adb5adb443c10536f53c2c875b620704bfb9f0de7f1913a79a728348905df3"
...
canonical_url: "https://www.xometry.com/resources/materials/shore-d-hardness-scale/"
...
content_hash: "sha256:c5d6ead0a12cfbcbee64f2d3d4cb4f2a97e4a8fff15309fd9bb847c1f7346679"
---

# Shore D Hardness Scale: Definition, Use, Types, Benefits, and Limitations

To fully understand how a product will function and hold up over time, you need to understand the specific physical characteristics of its materials—including its hardness. Finding this value comes down to using several interesting measuring techniques, depending on the material at hand, and when it comes to[rubber and hard plastics](https://www.xometry.com/resources/blog/product-update-urethane-casting-materials-finishes/) , look no further than the Shore D Hardness scale.
...
The Shore D Hardness Scale is a method and reference system for measuring the hardness of materials such as rubber and[plastic](https://www.xometry.com/capabilities/plastic-extrusion-services/) with a tool called a durometer. The exact measurement points to how much force a material can handle before an indent is created.
...
Shore A - Shore D Hardness Scale
...
1. **Thermoplastic polyurethane (TPUs)** are a type of bendable and elastic plastics that are part of everything from footwear to medical equipment that can be tested with a durometer.
2. **ABS or acrylonitrile butadiene styrene** is a popular material tested with the Shore D system, which helps manufacturers understand how it works for FDM printing, toys, car parts, or home appliances.
3. **Polycarbonate or PC** is found in everyday objects like corrective contact lenses or automotive parts and is another plastic with a hardness that can be measured through a durometer.
4. **PET plastic** —an acronym for polyethylene terephthalate—is another familiar material found in food and beverage containers and packaging that’s tested this way.
...
1. **Thermoplastic Polyurethanes (TPUs):** Numerous products, including footwear, automotive parts, and medical equipment, use TPUs. The relative hardnesses of TPUs are typically compared using the Shore D scale.
2. **Acrylonitrile Butadiene Styrene (ABS):** ABS is a thermoplastic polymer used to make car parts, home appliances, and toys. The Shore D scale is used to evaluate grades of ABS.
3. **Polycarbonate (PC):** PC is a thermoplastic polymer used in a wide range of products, including automotive parts, medical equipment, and eyeglass lenses. PC hardness is typically measured using the Shore D scale.
4. **Polyethylene Terephthalate (PET):** PET is a thermoplastic polymer used to create beverage bottles, food containers, and packaging materials. The hardness of PET is assessed using the Shore D scale.
...
1. **Thermoplastic Elastomers:** This group of materials exhibits traits common to both elastomers and thermoplastics. They have elastic qualities similar to vulcanized rubber, but they can also be melted and remolded like thermoplastics.
2. **Vulcanized Rubber:** This kind of rubber has undergone the chemical process of vulcanization, which involves heating it and adding sulfur to increase its elasticity, tensile strength, and durability. It is usually applied in goods like tires, hoses, and seals.
3. **Elastomeric Materials:** These are materials with the capacity to stretch and then snap back to their original dimensions once released. To ensure a snug and secure fit, they are frequently used in goods like gaskets, seals, and O-rings. Neoprene, silicone, and polyurethane are some examples.
...
Our team at Xometry is familiar with numerous processes that involve the exact materials the Shore D hardness scale tests. Whether you’re interested in[plastic injection molding](https://www.xometry.com/capabilities/injection-molding-service/) ,[plastic 3D printing](https://www.xometry.com/capabilities/3d-printing-service/plastic/) ,[rubber 3D printing](https://www.xometry.com/capabilities/3d-printing-service/rubber/) , or[bridge molding](https://www.xometry.com/capabilities/injection-molding-service/bridge-tooling/) , you can get a free quote today on these services and more.
