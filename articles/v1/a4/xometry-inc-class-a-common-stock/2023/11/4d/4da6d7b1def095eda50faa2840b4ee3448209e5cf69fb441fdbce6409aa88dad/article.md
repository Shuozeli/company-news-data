...
document_id: "4da6d7b1def095eda50faa2840b4ee3448209e5cf69fb441fdbce6409aa88dad"
...
canonical_url: "https://www.xometry.com/resources/machining/types-of-milling-in-machining/"
...
content_hash: "sha256:0de38027cb8dc90071784bd1a4baec07194304656f5d9fca39364baac993a1b0"
---

# 15 Types of Milling Operations

The term “[milling](https://www.xometry.com/resources/machining/what-is-milling-in-machining/) ” refers to the manufacturing process of using a circular cutting tool on the ends and sides of a material blank to make a finished part. That’s obviously just a very general summation; there are actually around 30 different types of milling operations, 15 of which (the most commonly used ones) we’ll go over in this article.
...
Face milling is beloved in the manufacturing world because it can be used to make accurate and smooth surfaces, even on larger pieces. It can make pockets and steps in metal by flattening the material and smoothing out the top. A[face mill](https://www.xometry.com/resources/machining/face-milling-vs-end-milling/) has cutting edges on its face, which is the part that looks like a disk, and these cutters work by shaving off material from a workpiece horizontally until it reaches the depth required (this will be preset by you). This image explains how it works:
...
Slot milling makes slots (like grooves or trenches) in any size with a slot cutter which looks like a circular saw blade. This will cut into the sides of the materials to do the job, but you can also use an end mill that cuts on its side and face. It basically carves out a channel in the material, making things like the slot your keys go into (keyways) and other grooves, Like the below:


To learn more, see our full article on[Slot Milling](https://www.xometry.com/resources/machining/slot-milling/) .
...
The tool used in[end milling](https://www.xometry.com/resources/machining/end-milling/) has cutting edges on both its end and sides and can make things like slots, pockets, and contours. This method is very common because it is versatile. It’s a little like a drill bit that can cut straight down (plunging) but it can cut sideways, too. The below diagram will give you an idea of how it works.
...
The spiraling threads you find on screws and bolts are made with thread milling. The tool has many cutting edges and is able to make threads in many different materials, in all different sizes, and can even tackle more complex designs. The[thread milling](https://www.xometry.com/resources/machining/thread-milling/) cutting tool (which, by the way, is known for its durability and accuracy) rotates around the material along the thread path to cut the threads. Its capabilities are pretty much limited to making threads, but it does make them exceedingly well. Here’s a picture of a thread made by thread milling:
...
To learn more see our full article on[Shoulder Milling](https://www.xometry.com/resources/machining/shoulder-milling/) .


## 6. Side Milling


A side milling cutter or end mill is used in[side milling](https://www.xometry.com/resources/machining/side-milling/) to shave thin layers of material from the side of a workpiece. This is the way to go for flat or contoured surfaces. Xometry’s very own Aaron (our marketing SVP) explains more about this milling process in the below video.


## 7. Profile Milling


If you have to make complex shapes and profiles on a surface, profile milling will be your best friend. It uses a tool with multiple cutting edges to make curves and angles and also has a ball tip that moves around, smoothing everything out.


To learn more, see our full article on[Profile Milling](https://www.xometry.com/resources/machining/profile-milling/) .
...
To learn more, see our full article in[Type of Milling](https://www.xometry.com/resources/machining/types-of-milling-in-machining/) .
...
To learn more, see our full article on[Angle Milling](https://www.xometry.com/resources/machining/angle-milling/) .


## 12. Form Milling


Form milling makes contoured and detailed shapes on a surface with either a specialized milling cutter in the exact shape or profile you want or generic cutting tools (the latter is a somewhat repetitive process, similar to profile milling). It’s used a lot in automotive, aerospace, and mold-making, and many times with a[CNC](https://www.xometry.com/resources/machining/what-is-cnc-milling/) machine.


To learn more, see our full article on[Form Milling](https://www.xometry.com/resources/machining/form-milling/) .
...
To learn more, see our full article on[Straddle Milling](https://www.xometry.com/resources/machining/types-of-milling-in-machining/) .


## 14. Plain Milling


It might not have a very interesting name, but plain milling is still a useful manufacturing method. It’s pretty basic, removing material from a surface using a flat, horizontal cutting tool, and it is used for making square or rectangular features.


To learn more, see our full article on[Plain Milling](https://www.xometry.com/resources/machining/plain-milling/) .
...
Xometry provides a wide range of manufacturing capabilities, including all the types of[milling](https://www.xometry.com/capabilities/cnc-machining-service/cnc-milling-service/) mentioned in this article, as well as[3D printing](https://www.xometry.com/capabilities/3d-printing-service/) ,[laser cutting](https://www.xometry.com/capabilities/sheet-cutting/laser-cutting/) ,[CNC machining](https://www.xometry.com/capabilities/cnc-machining-service/) , and much more. If you want to learn more about machining or request a[free no-obligation quote](https://www.xometry.com/quoting/home/) , reach out to a Xometry representative today.
