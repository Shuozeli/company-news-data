...
document_id: "09c8a40878bbda5c06ff9a6c56089905662f1610fc94eaf35a3a0c6f8401f0ce"
...
Future Fields defines the 5 main difficult-to-express protein properties.


Misfolding, PTMs, multi-subunits, insolubility, and toxicity issues lead to protein expression challenges. This article is meant to dig deeper into how these issues come about.


Contributors: Ela Dudek PhD, Paige Grant MSc, Diane Jeon BCom, Laine Lysyk MSc, Tautvydas Paskevicius PhD, Simon Wu MSc
...
Understanding that DTEPs have multiple challenging properties, selecting the optimal expression host then becomes an evaluation of whether or not it can effectively address multiple challenges. **A one-size-fits-all approach that relies on[conventional expression systems](https://futurefields.io/blogs/flylab/overview-of-recombinant-protein-expression-systems) will not suffice. These proteins require an alternative, robust, and customizable platform.**


At Future Fields, we understand that unconventional proteins require unconventional solutions. This is why we have purposefully selected and refined the **[EntoEngine expression system](https://futurefields.io/technology/)** . Using Drosophila melanogaster, we can express even the most challenging DTEPs by leveraging the built-in, robust expression capabilities of eukaryotes; a century of innovative genetic research; and a diverse set of tissue types that allows for parallel protein expression strategies to optimize yield.
...
1. Small Molecules, Big Market Opportunities. (n.d.). Retrieved from[https://manufacturingchemist.com/small-molecules-big-market-opportunities-210051](https://manufacturingchemist.com/small-molecules-big-market-opportunities-210051)
2. Khoury, G. A., Baliban, R. C., & Floudas, C. A. (2011). Proteome-wide post-translational modification statistics: Frequency analysis and curation of the Swiss-Prot database. Scientific Reports, 1, 90. DOI: 10.1038/srep00090
3. Ramazi, S., & Zahiri, J. (2021). Post-translational modifications in proteins: Resources, tools and prediction methods. Database, 2021. DOI: 10.1093/database/baab080
4. Lim, B. K., Lim, C. S., Remus, D. M., Chen, A., van Dolleweerd, C., & Gardner, P. P. (2021). Analysis of 11,430 recombinant protein production experiments reveals that protein yield is tunable by synonymous codon changes of translation initiation sites. PLoS Computational Biology, 17(10). DOI: 10.1371/journal.pcbi.1009400
5. Yang, A., Cho, K., & Park, H.-S. (2018). Chemical biology approaches for studying posttranslational modifications. RNA Biology, 15(4-5), 427–440. DOI: 10.1080/15476286.2017.1360468
6. Walsh, G. (2010). Post-translational modifications of protein biopharmaceuticals. Drug Discovery Today, 15(17-18), 773-780.
7. Qin, Y., et al. (2016). EcoExpress: Highly efficient construction and expression of multicomponent protein complexes in Escherichia coli. ACS Synthetic Biology, 5(11), 1239-1246.
8. Levy, E. D., & Teichmann, S. A. (2013). Structural, evolutionary, and assembly principles of protein oligomerization. Progress in Molecular Biology and Translational Science, 117, 25-51.
9. Hegde, R. S., & Keenan, R. J. (2022). The mechanisms of integral membrane protein biogenesis. Nature Reviews Molecular Cell Biology, 23, 107–124. DOI: 10.1038/s41580-021-00413-2
10. Cancer Monoclonal Antibodies Market Size Estimated to Reach USD 410.95 Billion by 2032. (n.d.). Retrieved from[https://www.biospace.com/article/releases/cancer-monoclonal-antibodies-market-size-estimated-to-reach-usd-410-95-billion-by-2032/](https://www.biospace.com/article/releases/cancer-monoclonal-antibodies-market-size-estimated-to-reach-usd-410-95-billion-by-2032/)
...
### [Overview of Recombinant Protein Expression Systems](https://futurefields.io/overview-of-recombinant-protein-expression-systems/)


[Read More](https://futurefields.io/overview-of-recombinant-protein-expression-systems/)
...
The post[The Art of Protein Expression: A Guide to Understanding Difficult-to-Express Proteins](https://futurefields.io/the-art-of-protein-expression-a-guide-to-understanding-difficult-to-express-proteins/) appeared first on[Future Fields](https://futurefields.io/) .
