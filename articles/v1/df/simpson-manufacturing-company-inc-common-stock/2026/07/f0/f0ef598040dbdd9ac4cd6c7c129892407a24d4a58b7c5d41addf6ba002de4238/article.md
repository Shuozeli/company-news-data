...
document_id: "f0ef598040dbdd9ac4cd6c7c129892407a24d4a58b7c5d41addf6ba002de4238"
...
canonical_url: "https://seblog.strongtie.com/2026/07/introducing-pfcb-and-pfc-column-base-brackets-and-angles-for-post-frame-construction/"
published_at: "2026-07-15T15:00:29+00:00"
first_seen_at: "2026-07-20T23:17:24.279995+00:00"
fetched_at: "2026-07-28T20:41:19.924237+00:00"
content_hash: "sha256:e51388be879aab455cf313bc377bdda6e2be3a98c66cde60e5d4c2b2e620ff00"
---
...
A very prominent feature on the PFC5, PFC6.5, and PFCB models is the detachable washer. This is a required washer for the anchor head that you can easily remove by hand. PFC3 is the only model that


doesn’t


have a detachable washer
...
anchor instead of the standard 5/8
...
cut washer on top of the normally required washer. Check the load table footnotes for the
...
anchor reduction factor. Proper washer installation looks like the picture below, where the washer sits between the stiffeners and
...
PFC3 uplift test — the setup. PFC3 uplift test – a closeup of the part after wood splitting failure. PFC5 lateral test — the setup. PFC5 lateral test – a closeup showing a wood splitting failure. PFC3 and PFC6.5 corner condition test — the setup. PFCB26-3A lateral test — view of a wood splitting failure. PFC3 uplift test with 1/2″ anchor — View of nut pull-through failure.


One of the footnotes on the anchorage load table references the prying amplification factor. This factor is baked into the table to account for the increase in anchor tension caused by prying action on the metal. We


determined


this through finite element analysis (FEA) and physical testing. We performed a physical test on steel substrate
...
to control pretension on the anchor. We did FEA both with the part anchored to steel and with embedded anchors bonded to concrete. Our theory was that steel substrate would yield higher prying forces because


it’s


a harder material than concrete, so it will have less give when the part is


leveraging


against it. On the other hand, anchor stretch length should reduce the


forces somewhat


. A lot of data was collected, and then we had to decide what to do with it.
...
chose to look at average prying amplification force from 50%-100% of allowable load and the worst case of FEA and lab testing to


come up with


the final prying ratio.


FEA research to evaluate stress in the load path. Prying test in the lab.
...
If you’re interested in learning more about PFCB and PFC, feel free to ask a question in the comments and visit the product pages for the PFCB and PFC at


[strongtie.com](http://www.strongtie.com/) .


[Share](https://www.linkedin.com/cws/share?url=https%3A%2F%2Fseblog.strongtie.com%2F2026%2F07%2Fintroducing-pfcb-and-pfc-column-base-brackets-and-angles-for-post-frame-construction%2F)


[Share](https://www.facebook.com/share.php?u=https%3A%2F%2Fseblog.strongtie.com%2F2026%2F07%2Fintroducing-pfcb-and-pfc-column-base-brackets-and-angles-for-post-frame-construction%2F)


[Tweet](https://twitter.com/intent/tweet?text=Introducing+PFCB+and+PFC%3A+Column+Base+Brackets+and+Angles+for+Post+Frame+Construction&url=https%3A%2F%2Fseblog.strongtie.com%2F2026%2F07%2Fintroducing-pfcb-and-pfc-column-base-brackets-and-angles-for-post-frame-construction%2F&via=strongtie)


[Pin](https://pinterest.com/pin/create/button/?url=https%3A%2F%2Fseblog.strongtie.com%2F2026%2F07%2Fintroducing-pfcb-and-pfc-column-base-brackets-and-angles-for-post-frame-construction%2F)
