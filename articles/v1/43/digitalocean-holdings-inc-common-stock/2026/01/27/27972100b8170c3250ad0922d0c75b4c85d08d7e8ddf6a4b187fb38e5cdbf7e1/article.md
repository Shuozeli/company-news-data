...
document_id: "27972100b8170c3250ad0922d0c75b4c85d08d7e8ddf6a4b187fb38e5cdbf7e1"
...
canonical_url: "https://www.digitalocean.com/blog/building-inference-cloud-what-comes-next"
published_at: "2026-01-07T17:29:20.238+00:00"
first_seen_at: "2026-07-20T03:30:06.260557+00:00"
fetched_at: "2026-07-28T21:58:18.576112+00:00"
content_hash: "sha256:e7cfcb62b0e7c9acacac804090c59a6ae2bfa03101e9c26050838a27ee247c46"
---

# Building the Inference Cloud, and What Comes Next

2025 was a defining year for DigitalOcean, not only because we shipped more products and features than ever before, but because we solidified our vision about what the next era of cloud and AI will look like. We[supported customers](https://www.digitalocean.com/customers) as they ran inference at scale, launched new products, engaged with our community in-person and online, and built out our inference cloud, which gives digital native enterprises and AI-native businesses the power to integrate AI and cloud workflows through one unified platform.
...
Finally, we launched our[AI-optimized data center](https://www.digitalocean.com/blog/introducing-new-atlanta-data-center) in Atlanta, which is built to support DigitalOcean’s growing GPU capacity through a state-of-the-art facility.


## The next evolution of Droplets, networking, and accounts


DigitalOcean was built on the idea that cloud infrastructure should be **predictable, transparent, and fast to set up** , and that starts with our signature Droplet virtual machines. In 2025, we[expanded the capabilities of Droplets](https://www.digitalocean.com/blog/dropletplans-persecbilling-byoip-natgateway) and announced these changes:
...
[Cold storage](https://www.digitalocean.com/blog/nfs-cold-storage-backups#spaces-cold-storage-for-infrequently-accessed-data) for low-cost, long-term retention of infrequently accessed data


-


[Network File Storage](https://www.digitalocean.com/blog/nfs-cold-storage-backups#network-file-storage-nfs-for-high-performance-ai-workloads) (NFS) for high performance AI workloads


-


[Usage-based backups](https://www.digitalocean.com/blog/nfs-cold-storage-backups#usage-based-backups-to-meet-aggressive-rpos) that stay simple and cost-efficient


-


[Storage autoscaling](https://www.digitalocean.com/blog/managed-databases-autoscale-storage) for managed databases
...
No platform exists in isolation, and we’re pleased to partner with other leaders in the AI and cloud space to bring the newest and best innovations to our customers. This year we announced our[AI Ecosystem](https://investors.digitalocean.com/news/news-details/2025/DigitalOcean-Expands-AI-Ecosystem-Launches-Partner-Program-to-Accelerate-Innovation-and-Empower-Startups-and-Builders/default.aspx) , which encompasses a full suite of tools for AI development, including AMD and NVIDIA GPUs, and access to advanced models from leading companies like OpenAI, DeepSeek, Meta, Mistral,[and fal.ai](https://investors.digitalocean.com/news/news-details/2025/DigitalOcean-and-fal-Expand-Collaboration-to-Advance-Multimodal-AI-Innovation/default.aspx) . Our revamped[AI startup ecosystem](https://www.digitalocean.com/blog/ai-startup-ecosystem-announcement) enables us to support growing AI startups throughout their journey.


We also saw many of our customers, including at DigitalOcean Deploy in Austin and London, and heard how companies like Traversal are[scaling using DigitalOcean](https://www.digitalocean.com/customers/traversal) products including Gradient AI GPU Droplets and Serverless Inference.


## 2026 is the year of the inference cloud


2025 was about building a foundation by releasing significant product updates in AI and cloud and expanding our partnerships to better serve the fast-growing businesses who build on DigitalOcean today. But 2026 is where it will all come together. Our strong foundation is now built, and we have plans for even more expansion in AI, including the upcoming release of[NVIDIA HGX™ B300 GPUs](https://www.digitalocean.com/blog/coming-soon-gpu-droplets-nvidia-b300s) . In 2026 we’re excited to support larger customers with additional AI-native workflows and tighter integration across our products, build deeper partnerships across the AI and cloud ecosystems, and engage with customers and developers at events across the country.
