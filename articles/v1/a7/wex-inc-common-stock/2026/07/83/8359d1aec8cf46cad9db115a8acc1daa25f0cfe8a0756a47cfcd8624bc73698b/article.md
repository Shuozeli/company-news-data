...
document_id: "8359d1aec8cf46cad9db115a8acc1daa25f0cfe8a0756a47cfcd8624bc73698b"
company_key: "wex-inc-common-stock"
company: "WEX Inc. common stock"
source_id: "wex-inc-common-stock-rss-a3ee0e8e35cd"
canonical_url: "https://www.wexinc.com/resources/blog/how-building-an-advisory-board-adds-value-to-your-business/"
published_at: "2026-07-28T16:57:54+00:00"
first_seen_at: "2026-07-28T17:50:36.724414+00:00"
fetched_at: "2026-07-28T21:56:44.009033+00:00"
content_hash: "sha256:7719844cef33010cc25f89f3546754d9393a2cb7c65bbd6c68fb8f83496bec87"
---

# Build an advisory board: Add value to your business

### Share


Advisory boards serve as a point of connection and innovation between your internal stakeholders, customers, and partners. Boards enable a level of cooperation and insight across a number of segments that help you discover, develop, and deploy new products strategically.
...
## When advisory boards started for WEX
...
As an example, one of WEX’s longest standing customers, Werner Enterprises, serves on the WEX OTR advisory board. Werner Enterprises, Inc. is an American transportation and logistics leader, serving the United States, Mexico and Canada, with more than 8,600 trucks, 30,000 trailers and more than 14,000 associates. Werner has been a WEX customer for more than 25 years.[Hear Steve Tisinger from Werner Enterprises](https://youtu.be/PRyDt8NMkck) share how that kind of collaboration and trust between businesses helps the industry as a whole.


Hear Steve Tisinger from Werner Enterprises share how advisory boards help the industry as a whole.
...
- **An objective perspective:** External advisory board members help provide an impartial viewpoint on business topics. They can offer unbiased advice and insights that are detached from company politics or personal interests. This helps leadership make well-informed decisions and plan for the future strategically.
- **Increased credibility:** Having industry experts on your advisory board doesn’t only communicate your dedication to success to prospective investors and clients, but to customers, too.
- **Better risk management:** The collective experience and wisdom that advisory board members bring to the table can help identify and mitigate business risks. By providing insight into challenges, an advisory board allows a business to proactively address them, which can save time, resources, and mitigate expensive mistakes.


## What a board member should strive to achieve
...
- Being an active voice in discussions.
- Bringing a spirit for collaboration and partnership.
- Sharing constructive ideas and bringing new concepts to the table.
- Facilitating and contributing to the open flow of dialogue between organizations.
...
## How to run an effective, active advisory board meeting
...
- Focus on receiving meaningful feedback on how things are running across the business, taking the time to digest that information, and having an open dialogue about it.
- Receive feedback on product development roadmaps and have conversations around the most appropriate and strategic directions to take regarding the chosen product topics of the meeting.


For WEX, its OTR partners play a significant role in the company’s OTR advisory board. Over the last few years, WEX has worked with its long-time customer,[Werner Enterprises,](https://www.werner.com/) to transform their terminals nationwide as part of WEX’s VIP initiative. Terminals, technology, trucks, trailers, and talent (and sustainability) have been the main focuses, and much of the collaboration around this initiative comes from the fleet advisory board meetings.
...
### Make advisory board meetings accessible
...
#### Here’s how WEX does it:


WEX schedules two advisory board meetings per year, rotating locations, twice over the course of the year — choosing somewhere memorable and accessible for each meeting. Beyond these two meetings, WEX coordinates additional virtual advisory board gatherings to accommodate those who can’t make the in-person sessions and to discuss important matters as they arise.


### Be committed to growth for your advisory board
...
## Ideal outcomes of advisory board meetings
...
Lastly, advisory boards are a platform for collaboration and ideation that helps drive innovation across multiple customer segments. With that point of contact a business makes more informed and strategic decisions, particularly regarding the most practical areas to invest the next dollar. To make those kinds of decisions, it’s essential to consider all aspects of a business and hear from subject matter experts with robust experience in each of the sectors.


WEX is a leading, global fintech solutions provider, simplifying payments and back-end business processes in the fleet management, benefits management, and corporate and travel payments areas. To learn more, please[visit the company’s About WEX page](https://www.wexinc.com/about/) .
