...
document_id: "3a5512ce684e2d8078b85f8675f4a44c169f9b980e7ef4700894f1882923e4f5"
company_key: "wex-inc-common-stock"
company: "WEX Inc. common stock"
source_id: "wex-inc-common-stock-rss-a3ee0e8e35cd"
canonical_url: "https://www.wexinc.com/resources/blog/midyear-check-in-are-your-payments-working-for-you/"
published_at: "2026-07-23T07:27:00+00:00"
first_seen_at: "2026-07-27T20:03:55.765306+00:00"
fetched_at: "2026-07-28T21:08:32.413121+00:00"
content_hash: "sha256:8afd03378621997bcf92d2af9d8883dd897662141877ffab4ceeb2ab41c9421f"
---

# Midyear check-in: Are your payments working for you?
...
## **The state of payments fraud in 2026**


According to the 2026 AFP Payments Fraud and Control Survey Report, more than[three-quarters of U.S. organizations](https://www.financialprofessionals.org/training-resources/resources/survey-research-economic-data/Details/payments-fraud) (76%) experienced attempted or actual payments fraud in 2025.
...
## **Checks are still the weak link**
...
And yet, checks aren’t going away on their own. Even though checks are the payment method most frequently affected by fraud, 72% of organizations using checks plan to continue using them for the foreseeable future, with 68% of those organizations citing[vendor requirements](https://www.wexinc.com/resources/blog/supplier-enablement-debunking-the-myths/) as the reason.
...
## **Business email compromise is climbing too**
...
[Fraud isn’t just a security headline](https://www.wexinc.com/resources/blog/payment-fraud-is-getting-smarter/) — it hits the bottom line directly. Financial losses from fraud were reported by 48% of organizations with revenue under $1 billion, and by 66% of organizations with revenue exceeding $1 billion.
...
You might expect AI to already be the standard fraud-fighting tool. It isn’t. Just 17% of organizations currently leverage[AI to combat payments fraud](https://www.wexinc.com/resources/blog/how-ai-is-quickly-changing-the-game-for-corporate-finance/) , even though the ones that do report real benefits: enhanced efficiency in fraud reporting (49%), improved detection of deepfake technology (45%), and real-time identification capabilities (43%).
...
## **A midyear checklist for your payment process**


If you’re doing your own midyear review, here are the questions worth asking:


- **What percentage of our supplier payments still go out by check?** If it’s high, that’s your single biggest fraud exposure point.
- **Do we know why we’re still using checks?** If the honest answer is “vendor preference” or “that’s just how we’ve always done it,” it’s worth revisiting — those are solvable problems, not fixed constraints.
- **How would we know if we’d been hit by BEC?** If the answer isn’t immediate, it’s worth tightening verification steps for any banking-detail change request.
- **Who owns fraud detection and recovery on our team?** Treasury is most likely to discover attempted fraud (83%) and actual fraud (55%), but that only works if fraud detection is actually someone’s clear responsibility.


## **A more secure way to pay, starting in the second half**


The clearest takeaway from this year’s data: sticking with checks because switching feels inconvenient is a bigger risk than the inconvenience itself.[Virtual cards](https://www.wexinc.com/products/business-payments/virtual-cards/) address the exact vulnerability checks create. Instead of a static account and routing number that’s exposed on every transaction — and printed right on the document — a virtual card generates a unique, single-use number for each payment. There’s no reusable account data for a fraudster to intercept, alter, or exploit later.
...
If a midyear look at your payment process turned up more risk than you’d like, the good news is that closing the gap doesn’t require ripping out your entire AP system. Moving supplier payments to[virtual cards](https://www.wexinc.com/resources/blog/business-case-accounts-payable-automation/) is one of the more straightforward ways to cut fraud exposure — and it comes with the added upside of earning rebates on the spend you’re already generating.
...
**How common is payments fraud for U.S. businesses in 2026?** **** According to the 2026 AFP Payments Fraud and Control Survey, 76% of U.S. organizations experienced attempted or actual payments fraud in 2025.


**Which payment method is most vulnerable to fraud?** **** Checks remain the payment method most frequently impacted by fraud, with 58% of organizations reporting check fraud in 2025 — more than ACH or wire fraud.


**Why do businesses keep using checks if they’re the riskiest payment method?** **** Most organizations that continue using checks (72%) plan to keep doing so, primarily because of vendor requirements (cited by 68%), not because checks are actually safer.


**What is business email compromise (BEC), and how common is it?** **** BEC is a scam where a fraudster impersonates a vendor or executive to redirect a payment or change banking details. It affected 74% of organizations in 2025, a significant increase from prior years.


**How do virtual cards reduce payment fraud risk?**[Virtual cards](https://www.wexinc.com/resources/blog/virtual-card-101/) use a unique, single-use number for each transaction instead of a static, reusable account number. This limits what a fraudster can exploit even if a number is compromised, and pairs with spend limits, vendor restrictions, and real-time visibility that checks simply don’t offer.
...
- [How to create an anti-fraud culture](https://www.wexinc.com/resources/blog/create-an-anti-fraud-culture/)
