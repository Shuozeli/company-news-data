...
document_id: "f7645a3e39a3d70b2d6d79577b0d883ebdecf050a8578296156cba3a5f800407"
...
canonical_url: "https://www.gevernova.com/news/articles/power-transmission-research-center-france-playing-key-role-building-tomorrows-grid"
published_at: null
first_seen_at: "2026-07-21T21:35:20.074036+00:00"
fetched_at: "2026-07-28T21:38:27.854613+00:00"
content_hash: "sha256:94ca354503d0f894ec13243b0f19d157e8eed35619d4d56f2fe5bb29d51a1581"
---

# Power Transmission: This Research Center in France Is Playing a Key Role in Building Tomorrow’s Grid

A bolt of lightning crackles through the air. An instant later there’s a flash, followed by an ominous sizzle: the lightning struck a powerline. Normally, you’d run inside and call the electric company. But overhead, where you might expect to see a wall of clouds darkening a summer sky, instead a white ceiling arches above a[thicket of space-age structures](https://www.gevernova.com/grid-solutions/sites/default/files/inline-images/High-Voltage-Testing.jpg) : 60-foot poles encircled by gleaming metal rings; a cylinder rising almost to the rafters, capped by a spherical mesh of metal discs, like a disco ball reimagined by Stanley Kubrick.


This is one of the testing labs inside GE Vernova’s[Research Center for High Voltage Technology](https://resources.grid.gevernova.com/product-overviews/research-center-hv-technology) in Villeurbanne, France, a world-class research facility specializing in high-voltage (HV) grid equipment. Down the hall, a team of engineers and scientists designs the future of HV substation components; the products then get put through their paces in the lab. You might find a circuit breaker in a deep freeze, bristling with spikes of ice, or operating in a chamber heated to 60 degrees Celsius (140 F), to make sure they can stand up to Mother Nature’s rough conditions.


The work done at the Villeurbanne Research Center simulates adverse conditions so that power infrastructure is prepared when extreme weather occurs. Images credit: GE Vernova


As climate change breeds stronger storms and intense heat waves, we can expect our power infrastructure to take these sorts of beatings more often. To try to put the brakes on global warming, the International Energy Agency has recommended the rapid deployment of sustainable energy technologies. Meanwhile, power demand continues to surge; it[jumped by 15%](https://iea.blob.core.windows.net/assets/02b65de2-1939-47ee-8e8a-4f62c38c44b0/WorldEnergyOutlook2024.pdf#page=24) worldwide between 2013 and 2023 and is projected to[nearly double by 2050](https://iea.blob.core.windows.net/assets/02b65de2-1939-47ee-8e8a-4f62c38c44b0/WorldEnergyOutlook2024.pdf#page=39) .
...
“We’re trying to prioritize the planet as we develop the technology of the future,” says Yannick Kieffel, chief technology officer for the Power Transmission business line at GE Vernova.
...
An overhead view of the Villeurbanne facility, where, Kieffel says, “decarbonization isn’t just a buzzword for us. It’s what we do.”


Last August, at the[2024 conference](https://www.cigre.org/event/session/2024/FR/paris/cigre-paris-session) of the International Council on Large Electric Systems (CIGRE), the Research Center team’s[paper](https://cse.cigre.org/cse-n036/c3-circularity-for-high-voltage-equipment.html) on eco-design considerations for power transformers and switchgear was selected as one of the[best](https://cse.cigre.org/cse-n036/editorial-by-rob-stephen.html) of the 1,100 submissions. For Kieffel and his team, it was a moment of pride — and even more motivation to keep pushing.
...
*This article contains*[forward-looking statements](https://www.gevernova.com/investors/fls) *, which provide current expectations based on certain assumptions. Except as required by law, we disclaim any obligation to update these statements.*
