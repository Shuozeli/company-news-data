...
document_id: "676ec4bf22c0c371ff9ff50dde39e71784864adb089bb2390e55695e0fb0eb8a"
...
canonical_url: "https://it.semrush.com/blog/seo-checklist-2022/"
published_at: "2022-08-01T06:00:00+00:00"
first_seen_at: "2026-07-22T16:50:18.182588+00:00"
fetched_at: "2026-07-28T21:33:46.196319+00:00"
content_hash: "sha256:c868f147c08930559b387f3fac7231c42f012080ec8691e595c9c61a4b61cea5"
---
...
[Google Search Console](https://search.google.com/search-console/) è uno strumento essenziale che ti fornisce informazioni preziose sulle prestazioni del tuo sito web, nonché una vasta gamma di dati che puoi utilizzare per aumentare la visibilità e il traffico organici delle tue pagine.


Puoi saperne di più sul motivo per cui è così importante utilizzarlo, come configurarlo e altro ancora nella[nostra guida definitiva](https://www.semrush.com/blog/definitive-guide-google-search-console/) .


[Bing Webmaster Tools](https://www.bing.com/toolbox/webmaster) è la piattaforma equivalente, che fornisce solo dati e approfondimenti per il proprio motore di ricerca.
...
[Google Analytics](https://analytics.google.com/analytics/) è uno strumento di analisi gratuito che ti consente di visualizzare dati e approfondimenti su quante persone stanno visitando il tuo sito, chi sono e come interagiscono con esso.


Se sei un principiante, nella nostra[guida definitiva](https://www.semrush.com/blog/beginners-definitive-guide-to-google-analytics/) troverai tutto quello che devi sapere sullo strumento, incluso come configurarlo e quali sono i report più utili. Una cosa è certa: non puoi portare avanti una strategia SEO di successo senza questo strumento.


Dovrai anche[collegare Google Analytics e Google Search Console](https://support.google.com/analytics/answer/1308621?hl=en) per importare i dati da quest'ultimo.


### 3. Installa e configura un plugin SEO (se utilizzi WordPress)


Se usi WordPress come CMS (cosa molto probabile, dato che[ora alimenta il 39,5% del Web](https://www.searchenginejournal.com/wordpress-powers-39-5-of-all-websites/391647/) ), dovresti installare e configurare un plugin SEO che ti fornisca le funzionalità necessarie per ottimizzare correttamente il tuo sito.


Nella[checklist SEO per WordPress,](https://www.semrush.com/blog/wordpress-seo-checklist-20-tips/) pubblicata di recente su SEMrush, ti suggerivamo alcuni plugin SEO da installare. Il plugin che scegli di usare dipende dalle tue preferenze personali, noi ti abbiamo indicato tre ottime opzioni.
...
[Plug in SEO](https://apps.shopify.com/plug-in-seo) , ad esempio, è una delle app SEO più popolari di Shopify.
...
Dalle[parole di Google](https://developers.google.com/search/docs/advanced/sitemaps/overview?hl=it&visit_id=637928931711123703-1523602028&rd=1) :
...
Altrimenti, puoi creare una sitemap XML con uno dei tanti sitemap generator tool disponibili. Abbiamo recentemente aggiornato[la nostra guida definitiva alle Sitemap](https://it.semrush.com/blog/come-creare-sitemap-xml/) , che include i nostri migliori consigli.
...
Molto semplicemente, il[file robots.txt](https://it.semrush.com/blog/file-robots-txt-guida-scrittura/) del tuo sito comunica ai crawler dei motori di ricerca le pagine e i file che i crawler web possono o non possono richiedere al tuo sito.
...
[Le azioni manuali](https://support.google.com/webmasters/answer/9044175?hl=en) sono in genere causate da un chiaro tentativo di **violare o manipolare le linee guida per i Webmaster di Google** . Questo include: spam generato dagli utenti, problemi di dati strutturati, link innaturali (sia da che verso il tuo sito), contenuto scarno, testo nascosto e persino quello che viene definito spam puro.
...
Puoi usare[Site Audit tool di SEMrush](https://www.semrush.com/siteaudit/) per assicurarti che il tuo sito web possa essere scansionato e indicizzato senza problemi.
...
Ricontrollare che le pagine principali del tuo sito che dovrebbero essere indicizzate possano effettivamente esserlo può evitare molti problemi nel futuro.
...
Secondo noi, il tempo speso per fare[analisi della concorrenza](https://it.semrush.com/blog/analisi-concorrenza/) non è mai tempo perso.


Inserisci il tuo dominio (e i tuoi concorrenti chiave) nello[strumento Panoramica dominio](https://www.semrush.com/analytics/overview/) di SEMrush e sarai in grado di identificare rapidamente quei concorrenti che competono nel tuo stesso spazio e comparare le vostre visibilità.


### 9. Trova le tue "Money" Keyword principali
...
Sono anche definite termini principali e parole chiave della[pagina pilastro](https://it.semrush.com/blog/pillar-page/) .
...
Puoi utilizzare lo strumento[Panoramica delle keyword](https://www.semrush.com/analytics/keywordoverview/) per condurre ricerche sulle parole chiave che descrivono i tuoi prodotti e servizi e identificare i termini principali.


Se stai cercando una guida completa per imparare a creare una strategia di contenuti basata su termini prioritari, dai un'occhiata alla nostra[guida definitiva alla ricerca di parole chiave](https://it.semrush.com/blog/semrush-per-la-ricerca-delle-parole-chiave/) .
...
Infatti, le[long tail keyword](https://it.semrush.com/blog/come-scegliere-le-keyword-long-tail-giuste/) , nonostante abbiano in genere un volume inferiore rispetto ai termini principali, offrono un tasso di conversione più elevato.


Devi assicurarti che la tua strategia SEO si rivolga a varianti di long tail keyword, così come alle parole chiave principali.
...
Puoi usare[Keyword Magic tool](https://www.semrush.com/features/keyword-magic-tool/) per trovare le parole chiave long tail.
...
Per ulteriori idee di long tail keyword, anche il[Topic Research tool](https://www.semrush.com/topic-research/) può aiutarti a trovare varianti di parole chiave a cui puntare o da usare in tutti i tuoi contenuti.
...
Questa[guida alla mappatura delle parole chiave](https://www.semrush.com/blog/guide-keyword-mapping-improve-seo-content/) delinea l'attività come segue:
...
Puoi anche utilizzare i vari strumenti di ricerca delle parole chiave di Semrush per[identificare l'intento di parole chiave specifiche](https://it.semrush.com/blog/analizza-search-intent-istantaneamente/) .
...
Conoscere le domande che il tuo pubblico sta ponendo può aiutarti a rispondere ad esse attraverso i contenuti del tuo sito. E non dimentichiamo che molte persone ora si riferiscono ai motori di ricerca come[motori di risposta](https://www.semrush.com/webinars/getting-to-grips-with-aeo-answer-engines-are-here-to-stay/) .


Troverai un elenco di domande relative a qualsiasi parola chiave inserita, nello strumento[Panoramica delle keyword](https://www.semrush.com/analytics/keywordoverview/) , che ti consentirà di visualizzarne anche il volume di ricerca mensile.


Questo è un ottimo punto di partenza e può fornirti una grande ispirazione, soprattutto se cominci con keyword specifiche.


Inoltre, potresti utilizzare uno strumento come[AlsoAsked.com](https://alsoasked.com/) , che perlustra in profondità le SERP e restituisce i risultati del box "People Also Asked" di Google per darti ulteriori idee e domande a cui rispondere con i tuoi contenuti.


### 14. Comprendi quanto sia difficile posizionare le tue keyword target
...
Ancora una volta, vai allo strumento[Panoramica delle keyword](https://www.semrush.com/analytics/keywordoverview/) e inserisci le tue parole chiave di destinazione per vedere la keyword difficulty, ovvero quanto sarà difficile per un nuovo sito Web classificarsi nelle prime posizioni della pagina dei risultati di Google.


## Checklist di SEO tecnica
...
[HTTPS è noto come fattore di ranking dal 2014](https://webmasters.googleblog.com/2014/08/https-as-ranking-signal.html) .
...
Tutte le altre versioni devono avere un[redirect 301](https://it.semrush.com/blog/redirect-301/) che rimanda alla versione principale. Puoi verificarlo inserendo ciascuna variante nella barra del tuo browser.
...
Infatti, nel 2021[Google ha confermato](https://searchengineland.com/the-google-page-experience-update-user-experience-to-become-a-google-ranking-factor-335252) che l'esperienza di pagina diventerà un fattore di ranking ancora più importante.
...
Scorri verso il basso per visualizzare il punteggio complessivo delle prestazioni del sito e un elenco di azioni suggerite per il miglioramento.


Puoi anche utilizzare Site Audit per ottenere un'istantanea dei tuoi Core Web Vitals e dei consigli per migliorarli.


Per ulteriori informazioni, leggi la nostra[guida a PageSpeed Insights](https://it.semrush.com/blog/come-migliorare-punteggio-google-pagespeed-insights/) .
...
### 20. Trova e correggi i link HTTP sulle pagine HTTPS
...
Anche quando c'è un[redirect](https://it.semrush.com/blog/redirect/) per indirizzare gli utenti alla nuova pagina, questi sono inutili, e si dovrebbe puntare ad aggiornarli il prima possibile.
...
La compatibilità con i dispositivi mobili è un fattore chiave per il posizionamento su Google. Dalla metà del 2019, Google è passato ufficialmente all'[indicizzazione mobile-first](https://www.searchenginejournal.com/google-mobile-first-indexing/346170/) per tutti i siti.


Se non offri un'esperienza mobile-friendly, vedrai che la tua visibilità organica ne risentirà.


Puoi verificare la compatibilità del tuo sito con i dispositivi mobili con il[Test di ottimizzazione mobile di Google](https://search.google.com/test/mobile-friendly) .
...
- **Sì** ai trattini nei tuoi URL per separare le parole, **no** agli underscore.
- **Sì** agli URL più corti possibile ([uno studio di Backlinko](https://backlinko.com/search-engine-ranking) ha mostrato che gli URL più brevi tendono ad avere posizionamenti più alti).
...
Di fatto, il vocabolario di Schema.org include formati per creare dati strutturati per persone, luoghi, organizzazioni, attività commerciali locali, recensioni e[molto altro ancora](https://schema.org/docs/full.html) .
...
Consulta la guida di SEMrush ai[dati strutturati per principianti](https://it.semrush.com/blog/che-cos-e-schema-guida-ai-dati-strutturati-per-la-seo/) per saperne di più e scoprire come sfruttarli per avere successo, oppure vai allo[Strumento di test per i dati strutturati di Google](https://search.google.com/structured-data/testing-tool/u/0/) per analizzare se il tuo sito li sta già usando oppure no.
...
I redirect 302 indicano che un reindirizzamento è temporaneo, mentre i[redirect 301](https://it.semrush.com/blog/redirect-301/) segnalano che lo spostamento è permanente.


È abbastanza comune trovare i 302 utilizzati al posto dei 301 e, sebbene Google abbia confermato che i[302 passano il PageRank](https://www.seroundtable.com/google-302-redirects-pass-pagerank-21575.html) , resta il fatto che se non si prevede che un redirect 302 venga rimosso in futuro, deve essere aggiornato a un 301.
...
I[Title tag](https://it.semrush.com/blog/title-tag-troppo-lungo-come-risolvere-problema/) ottimizzati sono la base della SEO. In effetti, sono spesso la prima cosa a cui un SEO dovrebbe dare un'occhiata per aiutare una pagina a posizionarsi.
...
Anche se le[meta description](https://it.semrush.com/blog/meta-description-come-scriverla-per-convincere-al-clic/) non sono un fattore di ranking, appaiono sotto il tag title nelle SERP e aiutano gli utenti a scoprire di cosa parla la tua pagina.
...
Tieni presente che[Google riscrive le meta description](https://www.searchenginejournal.com/google-rewrites-meta-descriptions-over-70-of-the-time/382140/#:~:text=A%20study%20finds%20Google%20ignores,first%20page%20of%20search%20results.&text=Google%20rewrites%20meta%20descriptions%20for,search%20results%20for%2030%2C000%20keywords.) oltre il 70% del volte per adattarle al meglio all'intento di ricerca. Tuttavia, dovresti sempre scriverne una che incoraggi gli utenti a saperne di più sul tuo contenuto.
...
Se non ottimizzi correttamente i[titoli di pagina](https://www.semrush.com/blog/on-page-seo-basics-page-titles/) e i meta tag, perdi l'opportunità di classificarti non solo per le tue parole chiave principali, ma anche per le varianti.
...
Fare una[content audit](https://it.semrush.com/blog/come-fare-una-content-audit/) è un modo utile per scoprire quali sono i contenuti sul tuo sito che funzionano bene e quelli che non apportano valore aggiunto.
...
Se un contenuto non aggiunge valore al tuo sito, deve sparire. Non c'è altra possibilità.[La guida di Kevin Indig all'uso di SEMrush per la potatura SEO](https://www.semrush.com/blog/guide-seo-pruning-semrush/) è un ottimo punto di partenza e ti fornirà le informazioni necessarie per intraprendere questo processo in modo efficace.
...
Presta sempre attenzione all'[ottimizzazione delle immagini](https://it.semrush.com/blog/seo-per-immagini-e-tag-alt-7-suggerimenti-avanzati-per-aumentare-il-traffico-con-le-immagini/) . È un'area della SEO che viene spesso trascurata - dalla corretta denominazione del file secondo un principio descrittivo, fino all'ottimizzazione delle dimensioni e della qualità delle immagini.
...
Puoi leggere questa guida per[impostare una strategia di link interni che funzioni](https://it.semrush.com/blog/internal-linking-guida/) e iniziare a identificare le pagine che devono essere linkate da altre pagine o che detengono **un'autorità che può essere distribuita altrove** nel tuo sito.
...
Questa[guida alla cannibalizzazione delle keyword](https://it.semrush.com/blog/cannibalizzazione-keyword-guida/) ti insegna come trovare e risolvere questi problemi.
...
Se stai inviando pagine nella tua Sitemap che non sono accessibili tramite almeno un link da un'altra pagina, le troverai contrassegnate come[Pagine orfane nelle Sitemap](https://www.semrush.com/news/site-audit-orphan-pages-checks/) nel rapporto di Site Audit.


Fai linkare queste pagine da almeno un'altra pagina pertinente.


### 36. Assicurati che il contenuto del tuo sito sia sempre aggiornato
...
[Andy Crestodina](https://www.orbitmedia.com/blog/update-old-blog-posts/) di Orbit Media commenta al rispetto:
...
Puoi esaminare qualsiasi URL tramite lo strumento[Analisi backlink](https://www.semrush.com/analytics/backlinks) e puoi analizzare il profilo dei link di un tuo concorrente e comprendere la qualità e l'autorità complessive dei link che puntano al suo sito.


### 38. Realizza un'analisi dell'intersezione dei link
...
Usando lo strumento[Analisi backlink](https://it.semrush.com/analytics/backlinks/) puoi inserire fino a cinque domini diversi per ottenere informazioni su quali siti stanno linkando ognuno dei tuoi concorrenti.
...
### 39. Trasforma le menzioni senza link in collegamenti
...
Sono definite menzioni del brand senza link. Lo strumento[Brand Monitoring](https://www.semrush.com/mentions/) può aiutarti a identificare rapidamente le menzioni del tuo brand senza link.


Qui trovi[un'ottima guida](https://www.slideshare.net/JamesBrockbank/how-to-turn-brand-mentions-into-links-learn-inbound-2019) che esamina esattamente come affrontare la richiesta di aggiunta di un link a un articolo che non offre copertura al brand menzionato.
...
Il[Link building tool](https://www.semrush.com/link_building/) , ad esempio, è un modo semplice e diretto per vedere un flusso continuo di nuove opportunità che puoi esaminare e di siti web che puoi contattare.
...
Leggi la nostra guida[Come trovare backlink con Link building tool](https://it.semrush.com/blog/come-fare-a-iniziare-una-campagna-di-link-building/) .
...
Per[comprendere l'importanza della SEO locale dai un'occhiata a questa guida](https://it.semrush.com/blog/cos-e-la-local-seo/) .
...
[Chiara Clemente](https://it.semrush.com/blog/user/148855233/)
