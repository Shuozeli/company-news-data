...
document_id: "07280f7429f991205b9d70307fc53000ee73923fdcacb66e599891e4dfe28f4b"
...
***La presente investigación ha sido realizada como parte del[informe Estado global del marketing de contenidos en 2020](https://www.semrush.com/state-of-content-marketing/?utm_source=anatomy-of-top-performing-articles&utm_medium=blog-post&utm_campaign=impacthero2) . El informe está diseñado para permitir a los profesionales del marketing explorar las mejores prácticas de la industria y mejorar sus estrategias de marketing.***
...
Un[estudio de 2019](https://www.eurekalert.org/pub_releases/2019-04/tuod-aoi041119.php) llevado a cabo por investigadores de la Universidad Técnica de Dinamarca sugiere que nuestra capacidad de atención se está reduciendo. Esto se da debido a la gran cantidad de información a la que estamos expuestos. Sin embargo, al mismo tiempo, la longitud media de los artículos ha aumentado[alrededor de un 42%](https://www.isitwp.com/amazing-blogging-stats-facts/) entre 2014 y 2018, pasando de 800 a 1.151 palabras.
...
Con la herramienta SEO Writing Assistant[de Semrush,](https://www.semrush.com/swa/?utm_source=anatomy-of-top-performing-articles&utm_medium=blog-post&utm_campaign=impacthero2) podrás identificar la longitud ideal de tu contenido, en función de los artículos que está posicionado tu competencia para tus palabras clave objetivo.
...
El interés en las listas está basado en tres características clave que, según[The New Yorker](https://www.newyorker.com/tech/annals-of-technology/a-list-of-reasons-why-our-brains-love-lists) , los hacen atractivos para nuestros cerebros:
...
Si quieres averiguar qué tipo de formato de contenido es el más eficaz para tus objetivos, puedes utilizar la[herramienta ImpactHero](https://www.semrush.com/impacthero/?utm_source=anatomy-of-top-performing-articles&utm_medium=blog-post&utm_campaign=impacthero2) . Te permite comparar el rendimiento de tu contenido por tipo y longitud, utilizando siete métricas de rendimiento.
...
Los titulares largos ofrecen más información sobre el contenido del texto. Se trata de algo importante, ya que si no hay una relación entre el título y el contenido, Google podría[categorizar el contenido](https://static.googleusercontent.com/media/guidelines.raterhub.com/en//searchqualityevaluatorguidelines.pdf) como de baja calidad. Esto explica probablemente por qué los títulos H1 de más de 10 palabras rinden mejor (aunque no es necesariamente igual para todas las audiencias y tipos de contenido).
...
En relación con las veces que se comparte, un[estudio de 2019](https://backlinko.com/content-study) de Backlinko mostró una tendencia similar. Los títulos más largos se comparten más veces y los encabezados muy largos (de 14 a 17 palabras), se comparten un 76,7% más que los títulos cortos.
...
De hecho, este enfoque es[recomendado por el propio Google](https://support.google.com/webmasters/answer/7451184?hl=en) , que advierte no condensar grandes bloques de texto en una página "sin párrafos, subencabezados o separaciones". John Mueller[amplió la información en](https://www.youtube.com/watch?v=QG2BoWRhb0k) diciembre de 2019, afirmando que las etiquetas de los encabezados ayudan a Google a comprender de qué van los textos y a clasificarlos como soluciones potenciales a las consultas de búsqueda de los usuarios.
...
Como ya hemos mencionado, al cerebro humano le gustan las listas. En un estudio bien conocido, el neurocientífico de renombre Walter Kintsch, descubrió que procesamos la información en forma de lista[más fácilmente](https://philpapers.org/rec/KINRAF) que en grandes fragmentos de texto y datos.
...
También tiene importantes beneficios SEO y el potencial de posicionarse en las búsquedas de imágenes, así como la posibilidad de aprovechar las nuevas tecnologías,[como la búsqueda visual](https://www.semrush.com/blog/visual-search-guide-benefits-optimizatiion/) .
...
En los últimos años, el uso de vídeos en el contenido ha crecido exponencialmente. De acuerdo con el estudio de animación Wyzowl,[el 86% de los negocios](https://www.wyzowl.com/video-marketing-statistics/) están usando vídeos como una herramienta de marketing en 2021, en comparación con el 61% de 2016. Además, el pronóstico de Cisco considera que el tráfico en internet de los vídeos[representará el 82%](https://www.cisco.com/c/en/us/solutions/collateral/executive-perspectives/annual-internet-report/white-paper-c11-741490.html#_Toc484813971) del tráfico total de los consumidores en 2021. Por lo que podemos afirmar que los vídeos son el futuro del marketing de contenidos.


No es sorprendente, ya que los vídeos son una herramienta muy útil y flexible. Principalmente, son ideales para la distribución entre canales, permitiéndote compartir los vídeos en una amplia gama de plataformas. También puedes utilizarlos para abordar las necesidades de los usuarios, como vídeos del tipo "cómo", entrevistas con expertos e influencers o demostraciones de productos. De hecho, los vídeos pueden ser muy importantes para obtener clientes potenciales, ya que[más de la mitad de los consumidores](https://www.searchenginejournal.com/youtube-shopping-influence/323503/) utilizan los vídeos como forma de toma de decisiones.


En términos de SEO, utilizar vídeos en tus artículos puede aumentar las interacciones, aumentando el[tiempo medio en página](https://backlinko.com/hub/seo/dwell-time) considerablemente. Si alojas los vídeos en tu propia web (en sustitución de YouTube o Vimeo), también puedes potencialmente atraer una gran cantidad de backlinks de calidad.
