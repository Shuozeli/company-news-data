...
document_id: "db5556904dd6ceb67653cf2f4e1ec687a522c08e59b2552ceddda26122b8ddbf"
...
canonical_url: "https://pt.semrush.com/blog/checklist-de-seo-melhores-praticas/"
published_at: "2020-08-03T11:11:00+00:00"
first_seen_at: "2026-07-22T16:50:14.188504+00:00"
fetched_at: "2026-07-28T21:33:49.818370+00:00"
content_hash: "sha256:1794c649dc6ad7e0c1c586333124e8ded0b410fce1d0dd8b6075d6a082e41e5d"
---
...
***Dica:**[Crie uma conta gratuita na Semrush](https://pt.semrush.com/signup/get-free-trial/) (não é necessário inserir dados do cartão de crédito) para que você possa seguir os passos deste guia.*
...
Você precisa cobrir todos os itens acima para cumprir com as[boas práticas de SEO](https://pt.semrush.com/blog/melhores-praticas-seo/) .


E se quiser praticar ainda mais e receber um plano testado e aprovado para gerar mais tráfego para seu site a partir do Google, recomendamos que você faça nosso[curso com Brian Dean](https://pt.semrush.com/academy/courses/curso-intensivo-de-seo-da-semrush-com-brian-dean/lessons/lesson-1/) .
...
O[Google Search Console](https://search.google.com/search-console/welcome) (GSC) é uma ferramenta essencial que fornece informações importantes sobre o desempenho do seu site, assim como sobre a integridade dos dados que você pode usar para melhorar o tráfego e a visibilidade orgânica do seu site.


É uma das melhores ferramentas para compreender melhor como o Google vê seu domínio.


Saiba mais sobre a importância de usar essa ferramenta, como configurá-la e mais[em nosso guia](https://pt.semrush.com/blog/o-guia-definitivo-para-o-google-search-console/) .


O[Bing Webmaster Tools](https://www.bing.com/webmasters/home) é semelhante e fornece dados e informações relacionadas ao Bing.
...
O[Google Analytics](https://analytics.google.com/analytics/web/#/) (GA) é uma ferramenta gratuita que permite que você visualize dados e informações sobre quantas pessoas visitam seu site, quem elas são e seu engajamento.
...
- Acompanhar sua[taxa média de rejeição](https://pt.semrush.com/blog/bounce-rate-taxa-de-rejeicao/) , visualizações de página e tempo no site


Nosso[conteúdo sobre Google Analytics](https://pt.semrush.com/kb/857-google-analytics-and-search-console) ajuda você a utilizar a ferramenta, ensinando como configurá-la e quais são os principais relatórios.
...
- [Semrush SEO Writing Assistant](https://pt.semrush.com/swa/)
...
A finalidade de um mapa do site – ou sitemap, como geralmente dizemos – é ajudar os mecanismos de pesquisa a identificarem quais páginas devem ser[rastreadas e indexadas](https://pt.semrush.com/blog/taticas-para-gestao-de-rastreabilidade-e-indexacao/) e qual é a sua versão canônica.
...
Caso contrário, você pode gerar um sitemap XML com auxílio de ferramentas específicas.[Neste guia sobre sitemaps](https://pt.semrush.com/blog/geradores-sitemap-xml/) , você encontra nossas principais recomendações.
...
De modo geral, o arquivo robots.txt informa aos[rastreadores dos mecanismos de busca](https://pt.semrush.com/blog/web-crawler/) quais são as páginas e arquivos que eles podem ou não acessar do seu site.
...
Saiba mais sobre[como usar arquivos robots.txt](https://pt.semrush.com/blog/guia-robots-txt/) , o que é syntax e as boas práticas em nosso guia para iniciantes.


### 6. Verifique Ações Manuais no Search Console


É raro, mas você pode descobrir que seu site sofreu alguma penalização (ação manual) do Google.[Ações manuais](https://support.google.com/webmasters/answer/9044175?hl=pt) normalmente são causadas por tentativas de violar ou manipular as[diretrizes do Google para webmasters](https://developers.google.com/search/docs/advanced/guidelines/webmaster-guidelines) .
...
Você pode conferir tudo isso na guia de 'Ações Manuais' no[Google Search Console](https://search.google.com/search-console/about) .
...
Ao configurá-lo, você será avisado por um[relatório do GSC](https://support.google.com/webmasters/answer/9044175?hl=pt) caso seu site receba uma ação manual.
...
Parte fundamental do trabalho de[SEO básico](https://pt.semrush.com/blog/seo-basico/) é garantir que seu site seja indexado pelo Google. De fato, é surpreendente a frequência com que sites são desindexados, simplesmente porque os desenvolvedores não removeram tags "noindex" ao colocarem o site definitivo no ar.


Você pode usar a ferramenta[Auditoria do site](https://pt.semrush.com/siteaudit/) para certificar-se de que seu site será rastreado e indexado.
...
Esse processo inclui encontrar, classificar e priorizar palavras-chave. Com isso, você aprimora sua[estratégia de SEO](https://pt.semrush.com/blog/como-criar-uma-estrategia-de-seo/) .
...
Uma das formas mais práticas para iniciar sua pesquisa de palavras-chave é encontrar os[termos que trazem bons resultados para seus concorrentes](https://pt.semrush.com/blog/como-encontrar-palavras-chave-de-baixa-concorrencia-com-a-semrush/) .
...
Comece abrindo a ferramenta[Lacunas nas palavras-chave](https://pt.semrush.com/analytics/keywordgap/) , da Semrush. Depois, insira seu domínio e o site de até quatro concorrentes.
...
Esses termos também são chamados de *palavras-chave de cauda curta* ou *[palavras-chave de pillar page](https://pt.semrush.com/blog/pillar-page-exemplos/)* .


Parar encontrar suas principais palavras-chave orgânicas, abra a ferramenta[Visão geral do domínio](https://pt.semrush.com/analytics/overview/?searchType=domain) e insira seu site.
...
[Palavras-chave de cauda longa](https://pt.semrush.com/blog/palavras-chave-cauda-longa/) são consultas nos mecanismos de busca com um volume de pesquisa relativamente baixo.
...
Acesse a[Keyword Magic Tool](https://pt.semrush.com/features/keyword-magic-tool/) da Semrush e insira sua palavra-chave.
...
Abra a seção[Visão geral de palavras-chave](https://pt.semrush.com/analytics/keywordoverview/) , insira sua palavra-chave e clique em " **Pesquisar** ".
...
Para aprender a mapear suas palavras-chave em apenas quatro etapas, consulte nosso[guia de mapeamento de palavras-chave](https://www.semrush.com/blog/guide-keyword-mapping-improve-seo-content/) .


### 12. Analise a Intenção das Páginas que já Ranqueiam


A[intenção de pesquisa](https://pt.semrush.com/blog/tipos-de-palavras-chave/) é o motivo da pesquisa de um usuário.
...
Para encontrar rapidamente a intenção de uma palavra-chave, use nossa ferramenta[Visão geral de palavras-chave](https://pt.semrush.com/analytics/keywordoverview/) .
...
Além disso, você pode usar a ferramenta[AlsoAsked.com](https://alsoasked.com/) . Ela traz resultados com base no recurso "As pessoas também perguntam", do Google, e ajuda a encontrar ideias para a criação de conteúdo.
...
Para uma estimativa rápida, use a pontuação de "Dificuldade de palavras-chave" (KD) na seção[Visão geral de palavras-chave](https://pt.semrush.com/analytics/keywordoverview/?db=br&currency=brl) .


A[dificuldade de palavras-chave](https://pt.semrush.com/blog/dificuldade-de-palavra-chave/) mostra o quão difícil seria para um site se classificar organicamente entre os 10 primeiros no Google para aquela palavra-chave.
...
O[SEO técnico](https://pt.semrush.com/blog/aprendendo-seo-tecnico/) ajuda a garantir que seu site seja rastreado e indexado.
...
O[HTTPS é um fator de classificação desde 2014](https://webmasters.googleblog.com/2014/08/https-as-ranking-signal.html) . Não há desculpas para não usar a criptografia de HTTPS no seu site. Se você ainda usa HTTP, já é hora de[migrar](https://www.searchenginejournal.com/https-migration-guide/195103/) .
...
Para obter um relatório mais detalhado sobre possíveis problemas, visite a ferramenta de[Auditoria do site](https://pt.semrush.com/siteaudit/) e acesse o relatório dedicado a HTTPS.
...
Em todas as outras versões deve ser usado o[redirecionamento 301](https://pt.semrush.com/blog/redirecionamento-301-htaccess/) para que elas apontem para a principal.
...
Você pode identificar rapidamente quaisquer erros de rastreamento por meio do[Google Search Console](https://search.google.com/search-console/about) .
...
Sites lentos oferecem uma experiência ruim para o usuário. E a experiência do usuário (UX) é um[fator de ranqueamento](https://searchengineland.com/the-google-page-experience-update-user-experience-to-become-a-google-ranking-factor-335252) importante para o Google.
...
Use a[ferramenta PageSpeed ​​Insights do Google](https://developers.google.com/speed/pagespeed/insights/) para avaliar o desempenho da página e as estatísticas do Core Web Vitals.
...
Para um relatório mais detalhado, acesse a seção[Auditoria do site](https://pt.semrush.com/siteaudit/) na plataforma da Semrush e clique em " **Core Web Vitals** ".


Você verá um panorama do Core Web Vitals e recomendações para melhorias.


Leia nosso[guia sobre o PageSpeed Insights](https://pt.semrush.com/blog/google-pagespeed-insight/) para mais informações.
...
Para encontrar (e corrigir) links quebrados rapidamente, vá para a seção[Auditoria do site](https://pt.semrush.com/siteaudit/) , na Semrush.
...
Dê uma olhada no **relatório de implementação do HTTPS** na seção[Auditoria do site](https://pt.semrush.com/siteaudit/) para identificar quaisquer problemas.
...
A compatibilidade com dispositivos móveis é um fator chave de ranqueamento. Desde meados de 2019, o Google adotou oficialmente a[indexação mobile-first](https://developers.google.com/search/docs/crawling-indexing/mobile/mobile-sites-mobile-first-indexing) para todos os sites.


Você pode testar a compatibilidade do seu site com dispositivos móveis usando a[ferramenta a do Google](https://search.google.com/test/mobile-friendly) para esse fim.
...
Se quiser se aprofundar no assunto, confira nosso[guia de SEO para dispositivos móveis](https://pt.semrush.com/blog/seo-para-mobile/) .
...
**Crie URLs curtas** –[um estudo feito pelo Backlinko](https://backlinko.com/search-engine-ranking) mostrou que URLs mais curtas tendem a ranquear melhor.
...
Eles requerem um vocabulário HTML especial chamado Schema (veja mais em[Schema.org](https://schema.org/) ). O Schema apresenta o conteúdo de uma forma que os mecanismos de pesquisa possam entender.
...
Confira nosso guia sobre[dados estruturados para iniciantes](https://pt.semrush.com/blog/o-que-e-schema-dados-estruturados-para-iniciantes/) para saber como você pode se beneficiar deles.
...
Você encontra as páginas profundas em destaque na seção de ' **Links internos** ' no relatório[Auditoria do site](https://pt.semrush.com/siteaudit/) .
...
É muito comum encontrar um 302 sendo usado no lugar do redirecionamento 301. Embora o Google tenha confirmado que o redirecionamento[302 passa PageRank](https://www.seroundtable.com/google-302-redirects-pass-pagerank-21575.html) , se não você não pensa em removê-lo em algum momento, ele precisa ser atualizado para 301.


Você encontra os redirecionamentos 302 em destaque no relatório de[Auditoria do site](https://pt.semrush.com/siteaudit/) .
...
A aba " **Problemas** " na seção[Auditoria do site](https://pt.semrush.com/siteaudit/#sorting/update_asc/page/1/) destaca qualquer cadeia de redirecionamento ou problemas de loop. Basta pesquisar "cadeia de redirecionamento".
...
Veja a[checklist de SEO on-page](https://pt.semrush.com/blog/checklist-de-on-page-seo/) :


### 27. Encontre e conserte title tags duplicadas, perdidas ou quebradas


[Title tags](https://pt.semrush.com/blog/como-escrever-title-tags/) ou tags de título otimizadas são parte fundamental dos esforços de SEO. Na verdade, elas muitas vezes são a primeira coisa que qualquer profissional de SEO deve analisar para otimizar a página.
...
Você pode auditar rapidamente suas tags de título em[Auditoria do site](https://pt.semrush.com/siteaudit/) , na aba " **Problemas** ". Lá, pesquise "tags de título".
...
As[metadescrições](https://pt.semrush.com/blog/meta-description/) ou descrições meta não são um fator direto de classificação, mas elas ajudam os usuários a entenderem do que se trata sua página.
...
Você pode auditar suas metadescrições na seção[Auditoria do site](https://pt.semrush.com/siteaudit/) na aba " **Problemas** ". Lá, pesquise "descrição meta".


**Observação** : o Google reescreve as metadescrições[em mais de 70% das vezes](https://www.searchenginejournal.com/google-rewrites-meta-descriptions-over-70-of-the-time/382140/#:~:text=A%20study%20finds%20Google%20ignores,first%20page%20of%20search%20results.&text=Google%20rewrites%20meta%20descriptions%20for,search%20results%20for%2030%2C000%20keywords) para melhor corresponder à intenção de pesquisa. No entanto, você deve sempre elaborar uma que incentive os usuários a aprenderem mais.


### 29. Encontre e Conserte as Tags H1


A tag H1 de uma página é o[título principal do seu conteúdo](https://pt.semrush.com/blog/tag-h1-para-seo/) ; cada página deve ter apenas uma dessas tags.
...
A aba " **Problemas** " da[Auditoria do site](https://pt.semrush.com/siteaudit/#sorting/update_asc/page/1/) sinaliza páginas com erros de tag H1. Basta pesquisar "h1".
...
Se você não otimizar de forma adequada suas[title tags](https://pt.semrush.com/blog/como-escrever-title-tags/) e meta tags, perderá uma ótima oportunidade de ranquear não apenas para suas palavras-chave alvo, mas também para variações delas.


Comece acessando o[Google Search Console](https://search.google.com/search-console) e clicando em " **Search results** " em " **Performance** ".
...
Uma[auditoria de conteúdo](https://pt.semrush.com/blog/guia-passo-a-passo-de-auditoria-de-conteudo/) é a análise do seu conteúdo para encontrar oportunidades de melhoria.


Realizar uma auditoria é importante para ajudar a entender como você pode melhorar o SEO do seu site.


Você pode auditar seu conteúdo usando ferramentas como o[Google Analytics](https://analytics.google.com/analytics/web/) .
...
[Alt text](https://pt.semrush.com/blog/alt-text-para-imagens/) (abreviação de texto alternativo em inglês) é o texto incluído no código HTML de uma página para descrever uma imagem.
...
Você pode encontrar rapidamente imagens sem texto alternativo usando a ferramenta[Auditoria do site](https://pt.semrush.com/siteaudit/#sorting/update_asc/page/1/) .
...
Os links internos são uma das táticas de link building que menos recebem atenção no[marketing digital](https://pt.semrush.com/blog/marketing-digital/%20) .
...
O relatório " **Links internos** " da[Auditoria do site](https://pt.semrush.com/siteaudit/#sorting/update_asc/page/1/) mostra quais páginas possuem apenas um link interno.
...
Saiba mais sobre como identificar quais páginas precisam de links internos com nosso[guia sobre o assunto](https://pt.semrush.com/blog/links-internos/) .
...
Para descobrir se o seu site apresenta problemas de canibalização de palavras-chave, use a ferramenta[Monitoramento de posição](https://pt.semrush.com/position-tracking/) .
...
Para saber mais sobre como detectar e corrigir a canibalização de palavras-chave,[confira nosso guia](https://pt.semrush.com/blog/canibalizacao-de-palavras-chave/) .
...
Para encontrar páginas órfãs, abra a ferramenta[Auditoria do site](https://pt.semrush.com/siteaudit/) , vá para a aba " **Problemas** " e pesquise "páginas órfãs".
...
É possível conferir qualquer URL nas ferramentas[Análise de backlinks](https://pt.semrush.com/analytics/backlinks/) e[Backlink Audit](https://pt.semrush.com/backlink_audit/) e você pode analisar o perfil dos concorrentes para entender a qualidade e autoridade geral dos links que apontam para o site deles.
...
Para encontrar rapidamente menções não linkadas, use os alertas da ferramenta[Brand Monitoring](https://pt.semrush.com/apps/brand-monitoring/) .
...
### 40. Encontre Novas Oportunidades de Link Building


Há sempre novas oportunidades de[link building](https://pt.semrush.com/blog/link-building-seo/) que você pode explorar e implementar, mas encontrá-las muitas vezes leva tempo.


É importante criar um perfil de backlinks de alta qualidade, e usar as[ferramentas de SEO](https://pt.semrush.com/blog/ferramentas-seo/) certas pode facilitar essa tarefa.


A[Link Building Tool](https://pt.semrush.com/link_building/) é uma forma simples e direta de encontrar novas oportunidades e também sites com os quais você pode entrar em contato.
...
Para começar a melhorar a visibilidade local da sua marca, leia nosso guia[Perfil da Empresa no Google](https://pt.semrush.com/blog/google-meu-negocio/) .
