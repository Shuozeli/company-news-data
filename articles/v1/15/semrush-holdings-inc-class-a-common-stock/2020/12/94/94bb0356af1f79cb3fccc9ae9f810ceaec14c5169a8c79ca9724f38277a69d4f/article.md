...
document_id: "94bb0356af1f79cb3fccc9ae9f810ceaec14c5169a8c79ca9724f38277a69d4f"
...
canonical_url: "https://pt.semrush.com/blog/6-etapas-para-uma-analise-de-mercado-completa/"
published_at: "2020-12-21T20:32:00+00:00"
first_seen_at: "2026-07-22T16:50:14.188504+00:00"
fetched_at: "2026-07-28T21:33:49.818370+00:00"
content_hash: "sha256:3f9b2932d140943b32a7d2b8f76c893ab391333e774f8429939ad5a044819ddf"
---

# 6 etapas para uma Análise de Mercado completa e uma estratégia de marketing competitiva
...
- **CSFs do setor:** fatores que derivam das características do setor. Coisas como avanços tecnológicos ou modelos de negócios avançados fazem parte desse tipo de CSF. Por exemplo, para criar[a primeira aeronave supersônica,](https://www.businessinsider.com/concorde-supersonic-jet-history-2018-10#the-concorde-had-features-found-on-no-other-western-commercial-airliner-such-as-the-double-delta-wing-and--9) o Concorde, os engenheiros de aviação tiveram que contar com engenheiros de projeto que criaram projetos totalmente novos para a asa. Sem a asa de duplo delta, o avião nunca teria decolado.
...
- **CSFs ambientais** : os fatores ambientais estão relacionados ao ambiente externo ao qual sua empresa pertence. Uma rápida[análise de fatores PEST (políticos, econômicos, sociais e tecnológicos)](https://www.semrush.com/blog/go-to-market-strategy-checklist/?utm_source=blog&utm_medium=article&utm_campaign=en_6_market_analysis_steps) será suficiente para determinar seus CSFs aqui.
-


MindTools fornece uma[planilha](https://www.mindtools.com/pages/article/newTMC_09.htm) conveniente para documentar os resultados da análise de PEST.


- **CSFs temporários:** esses fatores ocasionais geralmente são um resultado de um evento repentino ou temporário - uma pandemia global ou uma[nova expansão de mercado](https://pt.semrush.com/blog/analise-de-mercado-para-expansao-internacional/) que exige que as empresas recrutem nova equipe, mudem para o digital, etc.
...
- O[Business Model Canvas](https://miro.com/templates/business-model-canvas/) pode fornecer uma visão geral do seu negócio - desde os principais parceiros até a estrutura de custos - para consolidar ideias de melhoria para seu modelo de negócios.
- A boa e velha[tática de SMART](https://www.smartsheet.com/blog/essential-guide-writing-smart-goals) ajuda a definir os critérios corretos para melhorar a probabilidade de alcançar suas metas de negócios.
...
Empresas de informação, dados e medição como[Gartner](https://www.gartner.com/en) ,[Nielsen](https://www.nielsen.com/) e[Statista](https://www.statista.com/) são fontes valiosas de informações detalhadas sobre o mercado.
...
A[ferramenta Market Explorer](https://www.semrush.com/market-explorer/?utm_source=blog&utm_medium=article&utm_campaign=en_6_market_analysis_steps) estima o tamanho geral do mercado para um nicho específico com base nas tendências de tráfego online:


A base geral de público interessado no setor parece estar em constante expansão, com picos de interesse específicos ocorrendo em maio de 2020, quando[CrewDragon fez seu lançamento histórico](https://www.forbes.com/sites/jonathanocallaghan/2020/05/30/spacex-makes-history-with-first-ever-human-rocket-launch-for-nasa/#53238e653218) .


A[ferramenta de Análise de tráfego](https://www.semrush.com/analytics/traffic/?utm_source=blog&utm_medium=article&utm_campaign=en_6_market_analysis_steps) revela que o lançamento vitorioso da SpaceX também afetou o tamanho do mercado de seus concorrentes, dobrando o interesse do público médio nos principais jogadores do setor:


[A ferramenta Market Explorer](https://www.semrush.com/kb/1063-market-explorer-overview?utm_source=blog&utm_medium=article&utm_campaign=en_6_market_analysis_steps) também fornece um detalhamento de onde seu público-alvo vem, identificando a participação de cada fonte de tráfego - direto, de referência, social, pago ou de pesquisa. Esses insights podem ajudar a informar sua estratégia de marketing, ajudando você a priorizar seus esforços de marketing e focar em canais que podem potencialmente expandir sua participação no mercado.
...
O[crescimento do mercado](https://pt.semrush.com/blog/identificar-tendencias-de-mercado/) é um aumento do tamanho do mercado ou das vendas gerais dentro de um determinado nicho durante um determinado período de tempo.
...
Também vamos usar a[ferramenta Market Explorer da SEMrush](https://www.semrush.com/market-explorer/?utm_source=blog&utm_medium=article&utm_campaign=en_6_market_analysis_steps) para reunir todos os dados de mercado necessários para construir uma matriz BCG para Elon Musk. Nesse caso, vamos imaginar, que ele precisa decidir entre priorizar Tesla sobre SpaceX, SolarCity ou OpenAI.
...
- O[modelo Três Horizontes de Crescimento](https://miro.com/templates/3-horizons-of-growth/) da McKinsey ajuda as empresas a gerenciar seu desempenho atual, mantendo um olho aberto para oportunidades de inovação e crescimento.
- O modelo[Growth Experiments](https://airtable.com/templates/marketing/expqcJBnIeWOvxJX0/growth-experiments) da Airtable oferece uma estrutura para a execução de experimentos de crescimento que podem potencialmente escalar seus negócios.
...
Tendo descoberto que a NASA e a Boeing são os principais concorrentes da SpaceX, vamos gerar o relatório de[Insights de público-alvo da ferramenta Análise de tráfego](https://www.semrush.com/kb/896-audience-overlap-report?utm_source=blog&utm_medium=article&utm_campaign=en_6_market_analysis_steps) para as três empresas para ver se seus públicos correspondem.
...
Se vocês estão atraindo diferentes tipos de clientes, são uma ameaça menor uns aos outros, mas uma dessas empresas pode começar a ter ideias sobre como alcançar os consumidores de concorrentes.[Este post](https://pt.semrush.com/blog/como-gerar-trafego/) vai mostrar as maneiras de moldar uma estratégia de marketing mais forte para atrair públicos concorrentes.
...
[Este post](https://pt.semrush.com/blog/analise-de-trafego-concorrentes/) vai ajudar a encontrar as táticas certas que permitem:


- Analisar o desempenho online geral de seus concorrentes;
- Avaliar suas estratégias de publicidade online;
- [Identificar as estratégias de SEO](https://pt.semrush.com/blog/o-que-e-seo/) , conteúdo e RP de seus concorrentes;
- Revelar as ações deles em canais de[mídia social](https://pt.semrush.com/blog/redes-sociais/) .
...
Embora a posição da SpaceX seja relativamente estável,[concorrentes asiáticos como a Interstellar Technologies](https://asia.nikkei.com/Business/Business-Spotlight/SpaceX-success-has-Asia-startups-dreaming-of-the-stars) podem representar uma ameaça nos próximos anos.
...
Confira esse[exemplo](https://www.visual-paradigm.com/tutorials/five-forces-analysis-tutorial/) da análise das Cinco Forças de Porter:


Ferramentas como[Tuzzit](https://www.tuzzit.com/en/canvas/porter_five_forces#:~:text=The%20Porter's%20Five%20Forces%20is,strength%20of%20your%20future%20strategy.) ou[Upboard.io](https://upboard.io/porters-five-forces-model-framework-online-template/) têm modelos predefinidos que podem ser preenchidos com seus insights sobre os fatores que afetam seus negócios e estratégias de marketing.


**Técnica adicional para analisar o cenário competitivo:**


- O[Mapeamento de percepção competitiva](https://www.groupmap.com/map-templates/perceptual-map/) pode ajudá-lo a avaliar como os clientes percebem um determinado produto / serviço e avaliar os pontos fortes / fracos de comparar marcas dentro de um determinado nicho.
...
[Este post abrangente](https://pt.semrush.com/blog/o-que-e-persona/) vai guiar você por todo o processo de criação da persona do comprador, revelando onde você pode coletar os dados e fornecendo um modelo que você pode usar para preencher todos os detalhes.
...
Embora a análise SWOT seja bastante direta, ferramentas como o[Miro](https://miro.com/templates/swot-analysis/) permitem que você crie uma ilustração abrangente de seus insights que você pode compartilhar com toda a equipe e editar juntos com os principais interessados.


**Técnica adicional para avaliar riscos e oportunidades:**


- [O planejamento do cenário](https://www.netsuite.com/portal/business-benchmark-brainyard/industries/articles/cfo-central/scenario-planning.shtml) pode ajudá-lo a construir diferentes opções plausíveis do que pode dar errado ou certo para o seu negócio, bem como identificar os gatilhos que podem apontar para qual cenário é mais provável de acontecer.
...
Com a explosão dos preços dos combustíveis e uma mudança na demanda dos clientes por veículos menores, a falha do Detroit Three pavimentou o caminho para a queda da Motor City. E,[de acordo com a Forbes](https://www.forbes.com/sites/stratfor/2015/01/08/scenario-planning-and-strategic-forecasting/#283bb918411a) , é tudo porque eles não analisaram todos os cenários possíveis durante a pesquisa de mercado.


Compartilhar


[Natalia Zhukova](https://pt.semrush.com/blog/user/145676321/)
