...
document_id: "afa43bbcadbf9dc38890ba7a69ca8d942e9604fab009477907e3923b837051e1"
...
canonical_url: "https://blog.englishtest.duolingo.com/remote-english-test-security-ai-fairness/"
published_at: "2026-05-15T17:25:35+00:00"
first_seen_at: "2026-07-27T11:30:01.632624+00:00"
fetched_at: "2026-07-28T21:15:16.761066+00:00"
content_hash: "sha256:a0902037cc7cb46bab39a6adcb409cb04e815e8b34dd2b4fdf546dfbdb110335"
---

# Are remote tests secure? How the Duolingo English Test approaches AI and fairness
...
Below are some of the most common questions people ask about remote testing, along with how the[Duolingo English Test](https://bit.ly/3D7EOoA?ref=blog.englishtest.duolingo.com) approaches security, identity verification, accessibility, and test integrity.
...
[Learn how to set up your space for the DET](https://blog.englishtest.duolingo.com/duolingo-english-test-setup-secondary-camera-room-scan/)
...
[Why did we deliberately hack the DET?](https://blog.englishtest.duolingo.com/ex-spies-failed-to-hack-the-duolingo-english-test/)
...
[Learn more about adaptive testing](https://blog.englishtest.duolingo.com/is-the-duolingo-english-test-hard/)


## How does the Duolingo English Test detect proxy test takers?


Rather than relying on a single signal, the DET evaluates patterns across the entire testing session. We leverage multiple systems to identify behavioral patterns associated with proxy testing and impersonation, including facial matching technology, behavioral and typing pattern analysis, and tools that let us detect hidden devices that people may use to communicate remotely, like our patent-pending[ear scan](https://youtu.be/DnDQVrzWhxg?si=MDxKR8NXeFoCxlGv&ref=blog.englishtest.duolingo.com) technology.
...
[What is online proctoring?](https://blog.englishtest.duolingo.com/online-proctoring/)
...
Yes. The DET provides[accommodations](https://englishtest.duolingo.com/test_takers/accommodations?ref=blog.englishtest.duolingo.com) for eligible test takers. DET accommodations may include extended time, screen reader compatibility, or other supports based on documented needs. The goal is to maintain both accessibility and test integrity.


[Learn more about DET accommodations](https://englishtest.duolingo.com/test_takers/accommodations?ref=blog.englishtest.duolingo.com)
...
[Click here for a deep dive on DET security!](https://duolingo-papers.s3.us-east-1.amazonaws.com/reports/DET_Security_Report.pdf?ref=blog.englishtest.duolingo.com)
