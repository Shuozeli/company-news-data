...
document_id: "b01548278d0e75445a733a726be407dec236d46f4bed7204952bb9e19da71c64"
...
canonical_url: "https://blog.englishtest.duolingo.com/english-test-security-digital-assessment-compliance/"
published_at: "2026-06-10T05:00:02+00:00"
first_seen_at: "2026-07-27T11:30:01.632624+00:00"
fetched_at: "2026-07-28T21:13:18.116875+00:00"
content_hash: "sha256:8181919e95a7c7a73e426a489ebcf1eaf92edd2dc571c9d032b0171b12b043cd"
---

# Embedding security in digital assessment: An evidence base for institutional confidence
...
As technology continues to evolve, so do our students. And so too must the tools we use to assess them.[Advances in technology](https://www.timeshighereducation.com/news/admissions-fraudsters-targeting-crunch-points-cycle?ref=blog.englishtest.duolingo.com) provide new opportunities for those looking to secure admission through fraudulent means, and it's not just the Home Office looking to penalise those who[fail to stay one step ahead](https://www.timeshighereducation.com/news/universities-using-agents-risk-falling-foul-new-fraud-laws?ref=blog.englishtest.duolingo.com) . At the same time, these advances have unlocked new capabilities for detecting fraudulent behaviors.
...
The Duolingo English Test (DET)[Security White Paper](https://go.duolingo.com/Security+ScoreIntegrityReport?ref=blog.englishtest.duolingo.com) , being released at[DETCon London](https://www.linkedin.com/posts/duolingo-english-test-_one-glance-at-this-agenda-tells-you-where-activity-7466058290058203136--3Vg?utm_source=share&utm_medium=member_desktop&rcm=ACoAABYEYJgBFEsMUZaLadYDswWJV7HPrD4cKr4) this month, offers a detailed account of how security and score integrity can be embedded within digital-first assessments. It provides assurance to compliance, academic, and recruitment professionals alike that digital accessibility can coexist with robust security standards.


Central to the DET framework is an understanding that effective digital security is not about replacing human judgment with technology, but about[combining them](https://blog.englishtest.duolingo.com/a-test-center-could-never-make-cheating-this-difficult/) . The DET employs what it terms a "human-in-the-loop AI" approach: a[multi-layered system](https://blog.englishtest.duolingo.com/remote-english-test-security-ai-fairness/) in which artificial intelligence[flags potential issues](https://blog.englishtest.duolingo.com/remote-english-test-security-ai-fairness/) , but[trained human proctors](https://blog.englishtest.duolingo.com/what-is-online-proctoring/) retain final authority over all decisions affecting test integrity. This model demonstrates how technology can enhance rather than diminish the rigor of security oversight.


The[report](https://go.duolingo.com/Security+ScoreIntegrityReport?ref=blog.englishtest.duolingo.com) details the full architecture of this approach: environment lockdown, biometric identity verification,[adaptive testing](https://blog.englishtest.duolingo.com/is-the-duolingo-english-test-hard/) that mitigates content theft, encrypted communications, comprehensive audit trails, and continuous[quality assurance](https://blog.englishtest.duolingo.com/aquaa/) through statistical analysis of[proctor decisions](https://blog.englishtest.duolingo.com/new-research-variability-in-proctors-decision-making/) . Most importantly, it demonstrates transparency in methodology, which is precisely what we need when evidencing due diligence in our sponsor duties.


## Balancing accessibility, compliance, and assessment integrity


For institutions seeking to balance accessibility with accountability, the[DET Security and Score Integrity Report](https://drive.google.com/file/d/19edWKKERT_1CeuKlWoE_toBATy0acBSS/view?ref=blog.englishtest.duolingo.com) offers a roadmap, providing the evidence base that compliance teams need to assess whether digital assessment meets the standard of assurance required for sponsor licence obligations. In an environment where regulatory scrutiny is intensifying, and institutions are held accountable for the robustness of their admissions processes, this level of transparency is essential.
