...
document_id: "89f57c49bbf9a28aa07b2efc42cc9f091181c0d3a05c8c90c43f8048321b8338"
...
canonical_url: "https://acv.engineering/posts/delegation/"
published_at: "2024-09-27T05:00:00+00:00"
first_seen_at: "2026-07-20T23:17:32.344046+00:00"
fetched_at: "2026-07-28T22:01:06.812214+00:00"
content_hash: "sha256:89a1064127da0641d1adafb91ed0a49ac2d58456971af13969bc44dafca4881d"
---
...
- The first article is on[one on ones](https://acv.engineering/posts/one-on-ones/) .
- The second article is on[feedback](https://acv.engineering/posts/feedback/) .
- The third article is on[coaching](https://acv.engineering/posts/coaching/) .


---


In the fast-paced business world, the role of a manager is crucial to the success of the team. A recent study compilation performed by[WifiTalent](https://wifitalents.com/statistic/management/) found that companies with effective managers have 27% higher profitability. But what exactly makes a manager effective? For new managers, how do they reach the level of greatness they aspire to? For veteran managers, how can they improve their game to continue to foster high performing teams?


By looking at great leaders like[Bill Gates](https://www.amazon.com/Business-Speed-Thought-Succeeding-Digital/dp/0446525685) ,[Jack Welsh](https://www.amazon.com/Winning-Ultimate-Business-How-Book-ebook/dp/B000FCK3GO?ref_=ast_author_mpb) ,[Charles F. Kettering](https://www.amazon.com/Charles-Kettering-Thomas-Alvin-Boyd/dp/1587981335) ,[Lane Sloan](https://www.amazon.com/Develop-Leadership-Plan-Become-Leader-ebook/dp/B00B5HRCR6) ,[Tom Watson](https://www.ibm.com/history/thomas-watson-sr) , and[Henry Ford](https://www.amazon.com/My-Life-Work-Autobiography-Henry/dp/149428300X) certain themes of great management begin to appear.
...
Just knowing that these themes are important is not enough. Consider that the same WifiTalent compilation indicates that[69% of managers feel uncomfortable communicating with individual contributors](https://wifitalents.com/statistic/management/) and[33% of teammates dread meeting with their manager](https://www.octanner.com/global-culture-report/2020-one-to-ones) . This indicates that managers also need ways to put these themes into action to create positive results. For each theme, there is a corresponding actionable equivalent:
...
When a manager delegates to a teammate, they must remember that this is about influencing the teammate using the relationship rather than role power. This means that the manager needs to ask the teammate if they are willing to take on this new responsibility. This is the proposed model for how to delegate to a teammate.
...
The manager should be clear that they are asking for assistance from the teammate. By asking for help the manager can set the tone to be one of collaboration rather than dictation. The phrasing is also important as it can be used to indicate that this is a voluntary opportunity, and the teammate can say no. For example, here are four ways that a manager can ask for help that leave the teammate with different impressions of urgency and agency:
...
1. By October 30th, you will take over and run the staff meeting with an agenda that is followed.
2. By January 3rd, you will take over the creation and submission of the capital plan without errors.
...
For folks looking for more information regarding delegation I highly recommend the[Manager Tool’s podcast](https://manager-tools.com/2024/07/manager-tools-coaching-model-updated-part-1) on the topic.
