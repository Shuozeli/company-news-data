...
document_id: "09334c4254f84c09ee2fbc1e498c00ca40844519b49508aaf1c6f299a2b6551c"
...
canonical_url: "https://www.advancedenergy.com/en-us/about/news/blog/comparison-of-ac-sine-wave-vs-bipolar-pulse-dual-magnetron-sputtering-of-transparent-a-igzo-coatings/"
...
content_hash: "sha256:bb28c2e68e359622cb3ce9083033758ee2220b34338d868f851476cdfb25676a"
---
...
This was the aim of this R&D project for the new Customer Solutions Lab – to study if the deposition of IGZO by either AC/sine wave or by bipolar dual magnetron sputtering affected the film properties (see Figure 1).
...
The film properties were measured in the Lab’s materials characterization laboratory and at[Fraunhofer IST](https://www.ist.fraunhofer.de/en.html) in Braunschweig, Germany. With the help of state-of-the-art analytical tools, detailed characterization of the IGZO films was possible using methods such:


- Ellipsometry for optical refractive index and extinction coefficient *,* and thickness and thickness uniformity (also verified via physical surface profiler and SIMS);
- Electron probe micro-analysis (EPMA) for determining elemental stoichiometry and potential contaminants;
- Secondary ion mass spectroscopy (SIMS) for analyzing the elemental profile with film thickness;
- 4-point probe for film electrical resistivity;
- Optical transmission spectroscopy (OTS) for studying the optical transmittance *T* , absorption *a* and reflection *R* ;
- Atomic force microscopy (AFM) for film surface roughness;
- X-Ray Diffraction (XRD) for phase information and information on crystallinity (see Figure 3);
- Electron carrier mobility measured via Hall effect


We observed that among all the films, only the ones deposited by the bipolar DC configuration at both 20 and 40 kHz were visually ‘clear’. This was validated by OTS measurement showing the ideal peak transmittance position *l* *peak* at 550 nm, which is the center of the visual spectrum 300 to 750 nm (see Figure 2). The peak position was also dependent on the oxygen composition in the gas mixture. As the %O2 increased, the material’s *l* *peak* is “red shifted” to larger wavelengths.


*Figure 2. Optical percent transmittance %T of IGZO films deposited by AC/sine wave and bipolar pulse at a %O2 = 7% with all other parameters the same. All three samples are well centered in the visual spectrum at ƛ = 550 nm. Visually clear films were only deposited using the bipolar configuration. Note: peak wavelength ƛ peak was found to increase with increasing %O2 relative to the total gas mixture flow rate.*


While all the deposited IGZO films were predominantly amorphous ‘a-IGZO’, as confirmed by the XRD measurement (see Figure 3’s inset), the presence of a broad peak for (220) crystal plane suggests the presence of partial crystallinity. The taller (intensity) and narrower (full width at half maximum, ‘FWHM’) the peak, the more crystalline the material and correspondingly the higher the crystallinity factor ( *Q* ). Thus, the film with the highest *Q-* factor was the a-IGZO deposited at %O2 = 7% with a bipolar pulse power supply frequency of 20 kHz (see Figure 3).


*Figure 3. Crystalline quality factor Q of the three a-IGZO films deposited at 7% O2 (optically %T centered at ƛpeak= 550 nm) by each technique are shown. The highest Q-factor crystalline film was deposited by bipolar pulse at 20 kHz.*
