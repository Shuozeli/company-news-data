...
document_id: "ddf782d2cd58f2d429137eea165262ffcdd0003b326897008f45accd58eba4a1"
...
canonical_url: "https://www.advancedenergy.com/en-us/about/news/blog/sustainability-through-power-conversion-innovation/"
...
content_hash: "sha256:c16b5ae0decfaea3f353975fc5c143ee6829d7a7ff087a81777fbb88df61d268"
---

# Sustainability Through Power Conversion Innovation

Electricity generation is responsible for around[27% of the estimated 51 billion tons of greenhouse gases](https://www.breakthroughenergy.org/our-challenge/the-grand-challenges) added to the earth’s atmosphere every year. Moves to achieve ‘Net Zero’ emission targets often rely on increasing rather than decreasing electrification. Therefore, we need to make better use of the electricity that is generated and to enable renewable energy.
...
As an example, consider the data centers, which already account for at least[3% of worldwide energy use](https://www.datacenterdynamics.com/en/whitepapers/data-centers-environment-2021-report-state-green-data-center/) . As digital transformation increases and data center power consumption continues to grow, it is imperative that this growth is met without a corresponding increase in energy consumption.


While data centers have traditionally used 12 V power shelves for distribution to servers, 48 V architecture is increasingly being adopted. With 4x less current and 16x lower distribution losses compared to 12 V, 48 V delivers better thermal performance, with smaller busbars and increased efficiency. Recognizing the benefits that can be achieved by 48 V architecture, Advanced Energy’s Artesyn™[Open Compute ORv3 (Open Rack v3) platform](https://www.advancedenergy.com/en-us/products/ac-dc-power-supply-units/ac-dc-front-end-psus/ocp-compliant-ac-psus/) is a key enabler for the adoption of 48 V rack power for hyperscale data centers.
...
Advanced Energy’s Artesyn[LCM4000HV](https://www.advancedenergy.com/en-us/products/ac-dc-power-supply-units/enclosed-psus/lcm/lcm4000hv/) delivers DC power with up to 95% efficiency for a novel, centralized lighting scheme, while the Advanced Energy[GROWINSIGHT™](https://www.advancedenergy.com/en-us/applications/industrial/horticulture/growinsight%E2%84%A2/) horticultural monitoring and control system enables growers to optimize growing conditions that further reduces electricity use. For example, for crops that require specific intermittent hours of light and darkness, GROWINSIGHT enables the creation of smart lighting schedules.
...
You can find out more about how Advanced Energy’s innovations are helping to cut global electricity use in this[white paper](https://www.advancedenergy.com/getmedia/255a3b48-5c08-4ba3-b86c-527de1d79fbb/energy-efficiency-white-paper.pdf) .
