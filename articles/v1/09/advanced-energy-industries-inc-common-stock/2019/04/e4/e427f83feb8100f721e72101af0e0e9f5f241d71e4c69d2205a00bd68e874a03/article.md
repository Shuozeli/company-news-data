...
document_id: "e427f83feb8100f721e72101af0e0e9f5f241d71e4c69d2205a00bd68e874a03"
...
canonical_url: "https://www.advancedenergy.com/en-us/about/news/blog/how-to-calibrate-a-temperature-probe/"
...
content_hash: "sha256:c74cbaefbc9d2b921aeb4977a72545a623a8a0a6b99e80c5d7fc45034ef4d246"
---
...
1. Use pure water to make ice and then crush the ice to pieces smaller than 1 cm.
2. Fill the container to the top with the crushed ice (an insulated container is best).
3. Fill the container to within 1.5 cm of the top with pure water.
4. Insert the temperature probe in the middle of the container (horizontally and vertically) and stir in a small circle. This is your 0°C reference point (if doing multiple probes at the same time, keep them in a small group together).


To make a boiling point reference


1. Fill a container to within 3 cm of the top.
2. Bring to a constant boil using a hot plate or other heat source.
3. Suspend the probe half-way down and in the middle of the bath.
...
If you are in-need of temperature probes and sensors for your operations, TEGAM designs, engineers and manufactures an array of these temperature measuring tools for various applications and solutions. We feature[RTD temperature probes](https://www.advancedenergy.com/en-us/products/sense-and-measurement/thermal-sensing/temperature-probes/rtd-temperature-probes/) ,[thermistor probes](https://www.advancedenergy.com/en-us/products/sense-and-measurement/thermal-sensing/temperature-probes/thermistor-temperature-probes/) , and[thermocouple probes](https://www.advancedenergy.com/en-us/products/sense-and-measurement/thermal-sensing/temperature-probes/thermocouple-temperature-probes/) for research and production requirements as well as a full line of[digital thermometers](https://www.advancedenergy.com/en-us/products/sense-and-measurement/thermal-sensing/thermocouple-thermometers/digital-thermometers/) for multiple industries.


**[Please contact us](https://www.advancedenergy.com/en-us/contact-us-form/) with questions and queries on our durable and accurate thermometry products.**
