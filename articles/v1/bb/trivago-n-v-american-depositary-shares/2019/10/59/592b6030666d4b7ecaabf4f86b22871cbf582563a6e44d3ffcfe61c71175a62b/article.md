...
document_id: "592b6030666d4b7ecaabf4f86b22871cbf582563a6e44d3ffcfe61c71175a62b"
company_key: "trivago-n-v-american-depositary-shares"
company: "trivago N.V. American Depositary Shares"
source_id: "trivago-n-v-american-depositary-shares-rss-0be0766927d8"
canonical_url: "https://tech.trivago.com/post/2019-10-23-triversityinterview/"
published_at: "2019-10-23T00:00:00+00:00"
first_seen_at: "2026-07-20T23:19:44.896445+00:00"
fetched_at: "2026-07-28T21:06:00.870812+00:00"
content_hash: "sha256:f7b8b03777bd81fdd2c53e6c1b6fe52282fd6c41f752b79f94922e6cebfc8535"
---
...
Hi! My name is Eunae Jang and I'm completing a Bachelor's in Computer Science at RWTH Aachen University. I will start my Master's in CS from next semester. I'm interested in web front-end development and love to learn new things!


Hi! I'm Gyumin Lee. I'm completing my Master's in Computer Science at RWTH Aachen. I'm interested in Android development and Data Science. Moreover, I love to learn more about cutting-edge technologies.
...
We chose to develop a prototype web application of a project management tool for university collaboration at trivago, which we called triversity (a portmanteau of trivago and university). After a short introduction, we knew that we could learn everything that we expected from this project. The most attractive thing was that we already had a future user,[Ankia](https://www.linkedin.com/in/ankia-wolf-19920923) . That meant we could experience how to communicate with a customer, how to analyse their requirements and how to implement a product that is exactly as the user wants.


**What was the mentoring like? Can you describe the development workflow a bit?**


I was really satisfied with the mentoring. It was exactly what I expected before I applied. I appreciated that our mentor,[Matthias Endler](https://endler.dev/) , led us from the design to the deployment. The development workflow was totally based on agile methodology.
...
Next to technical things, we also put effort into branding our product. To show our project as a real product, we picked theme-colors and fonts and also made a logo. We could get insights for designing a concept from the session of UI/UX by[Janine Derix](https://www.linkedin.com/in/janinederix/) .
...
Eunae began to work on making the keynote. She really enjoyed working on it, because she was interested in designing something. The session about “How to present” by[Andy Grunwald](https://andygrunwald.com/) (a team lead and Site Reliability Engineer at trivago), which we attended during the final days of tech camp, was really helpful to organize our notes for the presentation efficiently.
...
During the development process, we also did a case-study with our future users Ankia and[Lara](https://www.linkedin.com/in/lara-kotobi-774524123) . We recorded user behavior and asked them what the most important function is for their real work. We got detailed feedback, which was very helpful to set the development workflow. After the final presentation, Ankia was happy with our prototype, and we talked a little bit about future work. There are still a few tasks on our Kanban board which correspond with the user requirements, and we are willing to extend it to a real product.


**Where can we find more information about your project?**


You can find more information about[triversity on Github](https://github.com/trivago/triversity) .
...
If you’re interested in the trivago Tech Camp, check out the[project homepage](https://techcamp.trivago.com/) . Who knows, maybe you want to apply next year?
