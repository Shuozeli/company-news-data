...
document_id: "4dc400af15ad76229580b31d2a1fb685f239b283bd4fd3f61a2455236bf146d8"
company_key: "trivago-n-v-american-depositary-shares"
company: "trivago N.V. American Depositary Shares"
source_id: "trivago-n-v-american-depositary-shares-rss-0be0766927d8"
canonical_url: "https://tech.trivago.com/post/2021-10-27-trivagotechweek2021hybridedition/"
published_at: "2021-10-27T00:00:00+00:00"
first_seen_at: "2026-07-20T23:19:44.896445+00:00"
fetched_at: "2026-07-28T21:04:47.382363+00:00"
content_hash: "sha256:d787af866c436504c9b441c1ffe481ac4e72f4bf76c7b0f707c56ce43626fb61"
---
...
Over the summer we’ve gradually[been working towards a hybrid work setup](https://www.linkedin.com/posts/trivagonv_trivagohybrid-lifeattrivago-hybridwork-activity-6840562884171325441-DMSZ/) , so naturally it made sense to host tech week in a hybrid format. Regardless of where you were working from, everyone could tune into the sessions and we made sure to create opportunities for online engagement as well. So what did this hybrid setup look like?
...
- **Malte Wessel** talked about how we built the[trivago Weekend](https://weekend.trivago.com/) frontend with[Next.js](https://nextjs.org/) . To implement Weekend, trivago started with a whole new tech stack and shipped the first version after three months of work. In the talk, Malte showed how and why we leveraged Next.js, what challenges we faced and how we are going to further improve the implementation.
...
- [Peter Thomas](https://tech.trivago.com/post/@ptrthomas) about Testing (almost) anything with the framework he created,[Karate](https://github.com/karatelabs/karate) - Just over 4 years old, Karate’s success is evident in how often it turns up in blog-posts, social media mentions, job listings and tech conferences worldwide.
- [Martin Woodward](https://twitter.com/martinwoodward) from GitHub, debunking Top Inner Source Myths. In the session, Martin talked about how InnerSource works within high performing DevOps teams and he explained in detail how to make it work in companies while also touching on the problems it can’t fix.


- [Tobias Koppers](https://twitter.com/wsokra) from[Webpack](https://webpack.js.org/) , telling the story behind[Persistent Caching in Webpack 5](https://github.com/webpack/changelog-v5/blob/master/guides/persistent-caching.md) , challenges on the way, internals and funny parts of his work.
- [Dan Boerner](https://twitter.com/dan_boerner) from Apollo talking about how teams can build products better and faster with less frustration. As an Apollo Graph Champion, Dan discussed with our peers about what is driving the rapid adoption of GraphQL and why a unified graph transforms the way companies build, deliver and organize themselves to create digital products.
- [John Cutler](https://twitter.com/johncutlefish) from Amplitude joined our colleague Alex Bleau in the Facilitated Q&A session with questions in Miro, where they covered a series of questions about Shipping faster than you learn/ Learning faster than you ship, Learning Backlogs, Balancing Divergence and Convergence when building products.
- [Jason Miller](https://twitter.com/_developit) and[Marvin Hagemeister](https://twitter.com/marvinhagemeist) from[Preact](https://preactjs.com/) tried to answer the question “What if” in their session about Continuously reimagining Preact itself. They touched on topics like What does it take to build the next generation of frameworks, How do we ensure we follow the right ideas and how do we even get those. Their talk was an exclusive behind the scenes look on the process the Preact team adopted and the future of their framework.
