...
document_id: "f6f5e071c6e4fb5e330001625f130f95887ec3051f2a78da4c212a85c7ad7991"
...
canonical_url: "https://news.broadcom.com/releases/broadcom-expands-investment-in-spring-and-java-ecosystem-security"
published_at: "2026-06-08T13:00:00+00:00"
first_seen_at: "2026-07-20T23:21:13.318217+00:00"
fetched_at: "2026-07-28T21:11:40.706155+00:00"
content_hash: "sha256:dd6e15f9b98d8de62939bb763090df210623d00f6e932e7ee300c8ddc113ce81"
---
...
**PALO ALTO, Calif.** – Today, Broadcom Inc. (NASDAQ: AVGO), a global technology leader that designs, develops, and supplies semiconductor and infrastructure software solutions, announced significant security investments for the[Spring and Java ecosystem,](https://spring.io/) relied on by over half of Fortune 500 companies.


To help the Spring community navigate an unprecedented surge in AI-detected security threats, Broadcom’s Tanzu business is releasing the largest set of Spring security updates to open source in Spring’s 23-year history. Additionally, for customers, Broadcom is extending its proven clean-room build architecture, foundational to[Bitnami](https://bitnami.com/) , to build the Java dependencies for the entire Spring ecosystem. These investments aim to protect the integrity of Spring and prepare Broadcom’s customers for the continued rise in AI-enabled security threats.
...
Recent advancements in foundation models have driven an explosion of[newly-detected security vulnerabilities](https://blogs.vmware.com/tanzu/how-to-prepare-for-the-world-of-ai-driven-exploits/) while shrinking the time-to-exploit window following vulnerability disclosure. The number of monthly security advisories reported to Broadcom by the Spring community alone increased over 1700% from March to April 2026. As a response, Broadcom’s Spring engineering team has significantly scaled its investment in advanced AI-assisted security analysis, including frontier model–based scanning and validation workflows to proactively identify vulnerabilities, assess remediation paths, and validate fixes across the dependency ecosystem.


## **Day Zero access to validated, CVE-only patches for Tanzu Spring customers**


In addition to these security initiatives, Tanzu Spring now provides customers with day zero access to validated common vulnerabilities and exposures (CVE) patch-only releases via the[Spring Enterprise Repository](https://techdocs.broadcom.com/us/en/vmware-tanzu/spring/tanzu-spring/commercial/spring-tanzu/spring-enterprise-subscription.html) before patches are released to open source. CVE-only patches isolate the security fix from any other change, allowing customers to remediate faster, shrinking the window of exposure. By utilizing Tanzu Spring’s private artifact repositories, customers can be confident that the artifacts are the official, validated patches from Broadcom, the steward of Spring. As always, Broadcom will continue to issue CVEs for all versions of every Spring project under open source support and older versions under Tanzu Spring enterprise support. Broadcom’s[VMware Tanzu Spring](http://enterprise.spring.io/) enterprise support includes:
...
Read[Spring and Security in the Times of AI](https://spring.io/blog/2026/06/01/spring_and_security_in_the_times_of_ai)


Read[How to Prepare for the World of AI-Driven Exploits](https://blogs.vmware.com/tanzu/how-to-prepare-for-the-world-of-ai-driven-exploits/)


Watch[Spring Vulnerability Update video](https://www.youtube.com/watch?v=6Q6-0Qeuqjc)


Learn about[Tanzu Spring for enterprise support](http://enterprise.spring.io/)


**About Broadcom** Broadcom Inc. (NASDAQ: AVGO) is a technology leader that designs, develops, and supplies semiconductors and infrastructure software for global organizations’ complex, mission-critical needs. Broadcom combines long-term R&D investment with superb execution to deliver the best technology, at scale. Broadcom is a Delaware corporation headquartered in Palo Alto, CA. For more information, visit[www.broadcom.com](https://www.globenewswire.com/Tracker?data=EpZ3b9Ww7G4u30fQ_4SSsKK5xm5dAKaG9XPDLRtc4dhRGoJgQA-GzDvbYL6Qow4YCxa6hTaFwapaA0pq-dg3AhMlTzZY6SqkOW2_jYCXS9Y=) .
...
john.davolio@broadcom.com +1 503 308 3096
