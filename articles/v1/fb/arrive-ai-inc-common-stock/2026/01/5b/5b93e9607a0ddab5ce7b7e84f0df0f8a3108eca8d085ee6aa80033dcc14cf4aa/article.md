...
document_id: "5b93e9607a0ddab5ce7b7e84f0df0f8a3108eca8d085ee6aa80033dcc14cf4aa"
...
canonical_url: "https://www.arriveai.com/blog/arrive-ai-indiana-becomes-home-to-new-uas-test-site"
...
content_hash: "sha256:d07630089d724c0d66c094881014e4ed36dbfc44917c6dd9164519320233fc2b"
---

# A Bright Future for Arrive AI: Indiana Becomes Home to New UAS Test Site

In[August 2025](https://www.arriveai.com/blog/america-just-opened-the-skies-were-ready) , the Arrive AI team ([NASDAQ: $ARAI](https://finance.yahoo.com/quote/ARAI/) ) applauded the news that the FAA will allow drone use for beyond visual line of sight (BVLOS) operations.


Fast forward to January 7, 2026, and the DOT and FAA announced that[Indiana will be the home of one of two new Unmanned Aircraft System (UAS) test sites](https://www.wfyi.org/news/articles/indiana-wins-national-drone-test-site-designation) . These are the first new test sites in nearly a decade, bringing the total to nine in the US.


This is a major development that signals Indiana could become a significant player in the era of “[American drone dominance.](https://www.whitehouse.gov/presidential-actions/2025/06/unleashing-american-drone-dominance/) ” This is promising news for Arrive AI, given that the expansion of our autonomous delivery network relies in part on advances in drone technology, specifically drone delivery capabilities, and on an increase in drone usage nationwide due to fewer regulatory restraints.
...
[Indiana is uniquely positioned](https://www.ipm.org/news/2025-12-02/indianas-congressional-delegation-unites-behind-faa-drone-test-site-bid) to help integrate the UAS into the NAS because of its numerous airspace testing assets and facilities that extend from Purdue University down to Southern Indiana.


# Purdue’s Potential Role


Purdue has the potential to become an anchor in the development of Indiana’s drone testing capabilities, thanks to its university-owned airport (the country’s first) and the largest indoor motion-capture system in the world at the[Purdue UAS Research and Test Facility (PURT)](https://engineering.purdue.edu/PURT) .
...
- [NSWC Crane](https://www.navsea.navy.mil/Home/Warfare-Centers/NSWC-Crane/Who-We-Are/) : A defense-grade hub for sensors, secure communications, and counter-UAS work.


- [Muscatatuck Training Center](https://www.in.gov/indiana-national-guard/muscatatuck-training-center/) : A realistic “city-plus-rural” environment where drone autonomy can be stress-tested in a variety of complex conditions.


- [Indiana Air Range Complex:](https://www.in.gov/indiana-national-guard/indiana-air-range-complex/) Managed and special-use airspace enabling advanced operations that can be run repeatedly and safely.
...
Arrive AI’s[Arrive Point™](https://www.arriveai.com/solution) is explicitly designed to work with people, ground robots, and *drones* , adding features that make scaled autonomy viable, including:
...
We’ve already proven the asynchronous model in high-stakes settings (like[hospital logistics with autonomous robotics](https://www.arriveai.com/healthcare) ), which becomes even more effective when drones start plugging into the same autonomous delivery network.
...
[Discover our delivery solution](https://www.arriveai.com/solution) that’s smart, secure, and built for the future.
