...
document_id: "1b4b2dabcf58b775ff9e115b3e9acf35466c276593fcb89fcdeb64660b756b55"
...
canonical_url: "https://www.recursion.com/news/from-novel-discovery-to-precision-biomarkers-how-recursion-is-using-data-and-ai-to-deliver-new-cancer-drugs"
published_at: "2025-08-12T00:00:00+00:00"
first_seen_at: "2026-07-22T11:05:14.614366+00:00"
fetched_at: "2026-07-28T22:01:03.825556+00:00"
content_hash: "sha256:85f77fd933efb735dd263d2f3c84768c04057a4dc731ac14917b9222781fac8e"
---
...
It’s no secret that 90% of drugs fail in clinical trials – most often due to[lack of efficacy](https://pmc.ncbi.nlm.nih.gov/articles/PMC9293739/) . When it comes to cancer, a “one size fits all” treatment approach won’t work, because not all cancers of the same type are identical. Predictive biomarkers such as genetic mutations help to predict which patients with a cancer type are most likely to respond to a specific drug.
...
1. **How does Recursion's AI platform accelerate drug discovery?** The Recursion Operating System allows scientists to find novel biological relationships, design new molecules, and virtually model and score them, so only the most promising compounds need to be physically synthesized and tested in the lab. For their RBM39 program, this efficiency allowed them to go from initial biological discovery to a lead drug candidate (REC-1245) in under 18 months, more than twice as fast as industry average.


‍


1. **What is a predictive biomarker and why is it so important for cancer treatment?** A predictive biomarker is a specific genetic or molecular characteristic (like a gene mutation) that helps predict which patients are most likely to respond to a specific drug. Biomarkers are important because not all cancers of the same type are identical. By identifying patients with the right biomarker, doctors can move beyond a "one-size-fits-all" approach and give a targeted drug to the people it will most likely help, improving efficacy and avoiding unnecessary side effects for those who wouldn't benefit.


‍


1. **How did Recursion identify RBM39 as a promising new cancer target?** Scientists used the Recursion OS to perform a search for novel relationships which uncovered a novel link between the protein RBM39 and the DNA damage response (DDR) pathway, a key process in cancer. They discovered that degrading RBM39 could achieve the same therapeutic effect as inhibiting a well-known cancer target, CDK12, but without the toxic side effects associated with inhibiting a related protein, CDK13.


‍


1. **How is Recursion finding the right patients for its REC-1245 (DAHLIA) clinical trial?** To understand which patients are most likely to benefit, Recursion scientists screened a large collection of cancer models from the Cancer Cell Line Encyclopedia, looking for shared genetic characteristics (biomarkers) in the models that responded best to the drug. They found that patient models that had genomic instability characterized by replication stress and DNA repair vulnerabilities (DDR defects) - indicating a faulty DNA repair system - including MSI-high and HRR altered cancers showed a strong response. This biomarker is now being used to select patients with specific cancers for the clinical trial.


‍


‍ *Written by:*[Brita Belli](https://www.linkedin.com/in/brita-belli/) *, Senior Communications Manager, Recursion*
