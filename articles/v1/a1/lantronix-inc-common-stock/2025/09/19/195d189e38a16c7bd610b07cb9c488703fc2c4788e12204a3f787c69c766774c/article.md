...
document_id: "195d189e38a16c7bd610b07cb9c488703fc2c4788e12204a3f787c69c766774c"
...
canonical_url: "https://www.lantronix.com/blog/more-power-fewer-ports/"
published_at: "2025-09-17T19:00:01+00:00"
first_seen_at: "2026-07-20T23:18:54.707261+00:00"
fetched_at: "2026-07-28T22:01:02.064378+00:00"
content_hash: "sha256:499b8b157b7a0dd986d3baaca45a635112cef23acce1627aee285aeb9555c2ec"
---

# More Power, Fewer Ports
...
- The original PoE (IEEE 802.3af) allowed sending 15.4W of DC power (Class 1, 2 or 3) over two pairs of twisted pair wires in an Ethernet cable.
- Then came PoE+ (IEEE 802.3at) utilizing four pairs of twisted pair wires to send 15 or 30W of power (Class 3 or 4).
- More recently, capabilities have evolved even further, and PoE++ or “Hi-PoE” (IEEE 802.3bt) can now send 45 or 60W (Class 5 and 6), 75W (Class 7) or 90W (Class 8) of DC power using all four twisted pairs of wire in an Ethernet cable.\[1\]
...
Another PSE option, a **PoE Media converter** , allows extension of the network over fiber cabling and can then add PoE over copper cabling to connect and power an end device. PoE media converters allow IP devices to be placed at the network edge, since they can be connected to a fiber switch via multi-mode or single mode fiber to achieve longer distances. (A power source is still required for the media converter, but this allows for network extension beyond the IEEE 100m distance limitation over UTP copper cabling.) Common uses for PoE media converters include VoIP phones, point-of-sale (POS) systems, gate access/guard shack connectivity, perimeter security cameras and WAPs on light poles or outdoor cabinets.


Lantronix offers PoE injectors that provide PoE+ (30W) or PoE++ (≤90W). Our specialty PoE injectors for hardened temperature applications (-40 to +70°C) are designed to protect against EMI and heavy electrical surges typical of manufacturing floor environments or curb-side traffic control cabinets. The newest injector to our portfolio (SI-IES-5200-LRT) is a multi-gig injector that supports 10Mbps, 100Mbps, 1Gbps, 2.5Gbps, 5Gbps and 10Gbps data transmission to meet the demands of high bandwidth and high power devices, such as WAPs, multi-lens surveillance cameras, license plate readers and other IP networked devices.
...
- Lantronix is very well known for its SPOEB and SGPAT media converters which provide PoE for VoIP phones in Fiber to the Desk applications.
- For security and surveillance applications, our mini PoE converters (M/GE-PSW-PSE-01) and hardened mini PoE converters (M/GE-ISW Series) are small enough to fit inside some camera mounts or other space-constrained environments.
- Our Class 1 Div 2 PoE converters are very popular for powering security cameras located in hazardous locations, with the newest addition (SI-IES-5x1D-LRT) capable of 10Mbps/100Mbps/1Gbps/2.5Gbps data transmission to accommodate evolving 2.5G WiFi 6 and higher WAPs.
- Most Lantronix converters also offer helpful features like *Remote PD Reset (PDR)* , which enables power cycling of the remote powered device from the switch by disengaging the fiber cable, and *Link Pass Through (LPT),* which ensures a loss of link on one of the converter is passed through to the other side so upstream equipment can see a fault condition on either the copper or fiber link that would otherwise be hidden by the media converter. Both features help get PDs up quickly and keep the network running effectively.
...
NEW:[https://www.lantronix.com/products/si-ies-5200-lrt/](https://www.lantronix.com/products/si-ies-5200-lrt/)


[https://www.lantronix.com/products/si-ies-1200-lrt-2/](https://www.lantronix.com/products/si-ies-1200-lrt-2/)


1 and 2-Port Media Converters


NEW:[https://www.lantronix.com/products/si-ies-5x1d-lrt-series/](https://www.lantronix.com/products/si-ies-5x1d-lrt-series/)


[https://www.lantronix.com/products/m-ge-psw-pse-01-2/](https://www.lantronix.com/products/m-ge-psw-pse-01-2/)


[https://www.lantronix.com/products/sgpat-series-2/](https://www.lantronix.com/products/sgpat-series-2/)


[https://www.lantronix.com/products/spoeb-series/](https://www.lantronix.com/products/spoeb-series/)


PoE-Powered Media Converters


[https://www.lantronix.com/products/m-ge-isw-sfp-01-pd-2/](https://www.lantronix.com/products/m-ge-isw-sfp-01-pd-2/)


4-Port Switches


[https://www.lantronix.com/products/sistp1040-551-lrt-2/](https://www.lantronix.com/products/sistp1040-551-lrt-2/)


[https://www.lantronix.com/products/sespm1040-541-lt-xx-series-4/](https://www.lantronix.com/products/sespm1040-541-lt-xx-series-4/)
