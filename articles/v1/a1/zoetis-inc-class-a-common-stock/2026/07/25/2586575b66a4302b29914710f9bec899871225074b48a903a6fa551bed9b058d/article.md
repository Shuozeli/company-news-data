...
document_id: "2586575b66a4302b29914710f9bec899871225074b48a903a6fa551bed9b058d"
...
canonical_url: "https://www.zoetis.com/news-and-insights/blog/mabs-the-rising-wave-of-innovations-in-veterinary-medicine"
published_at: null
first_seen_at: "2026-07-24T08:14:54.083561+00:00"
fetched_at: "2026-07-28T21:39:52.838477+00:00"
content_hash: "sha256:3f7b0b40552e2d08b55358ad8a60cc9e396cca31b7ab5f1bb07e05d124730b60"
---
...
[Consider renal disease](https://www.zoetis.com/news-and-insights/blog/on-a-quest-to-crack-the-kidney-disease-conundrum) : Cats of any age are at risk of developing chronic kidney disease (CKD), and the likelihood increases with age – particularly after 10.6 By age 15, 80% of cats are expected to have kidney disease.7 Meanwhile, chronic kidney disease affects up to 10% of all elderly dogs.8 Because there is no therapy to specifically target CKD, veterinarians can only offer palliative care, such as implementing diet restrictions and treating vomiting and dehydration.


Cancer is one of the most common causes of death in dogs and cats. For example, 1 in 4 dogs are expected to get cancer9 in their lifetimes with the rate rising to approximately 50% for dogs over the age of 10.10 Surgery and chemotherapy are options, but both have drawbacks.
...
“We continue to lead in the development of mAbs to give veterinary practices treatment options for pets with chronic diseases,” said Scott. “The need for new therapies around the world is huge. We intend to help close that gap with the next wave of innovations.”
...
“Traditional therapies are not always well tolerated. For example, NSAIDs have been used for years to control chronic OA pain in pets. Yet, they are poorly tolerated by cats and can only be used for a limited time because they can cause intestinal, kidney and liver issues,” said Monica Escalada, Director, Regulatory Affairs. “Monoclonal antibodies are targeted therapies that function like a naturally occurring antibody. They are metabolized and eliminated like naturally occurring antibodies, with minimal involvement of the liver or kidneys,12,13,14 which means lower risk of NSAID-like toxicity. Thanks to this, we can extend the treatment duration and, potentially, extend the pet’s life.” While monoclonal antibodies may help address some limitations of traditional therapies such as NSAIDs, it’s always important to consider the product’s safety profile when choosing medication for individual patient use since all treatments can potentially have adverse effects.
...
1. **Define the problem** This is the first step before any program begins. “We always start by asking, ‘What’s missing in veterinary medicine? What are the gaps in treatment, and what tools could help fill those gaps?’ From there, we focus our resources in areas where we can have the most impact and then marry the need with scientific curiosity,” said Scott.
2. **Understand the animal’s biology and what’s causing the disease** Scientists set out to solve the mystery by gaining a deep understanding of the animal’s unique biology and what’s triggering a problem. Is it an overactive protein? A sluggish chemical? An out-of-whack receptor? A cytokine behaving badly?
3. **Design mAbs to interact with the target** “The goal is to design a monoclonal antibody that is unique to a species and unique in its target,” said Scott. “A well-designed mAb will bind to the intended target and produce a desired effect, such as slowing down the progression of the disease, disrupting a signal or controlling pain,” said Scott.


But not just any design will work. “It must be functionally potent and safe for the animal and safe for the veterinary professional administering the therapy. A safety-mindset is a must for our teams,” said Amanda. “Also, the mAbs we design must be scalable – a therapy we can efficiently manufacture to meet demands and deliver cost-effectively for pet owners.”
4. **Meet and exceed regulatory requirements** “Regulatory processes globally are robust. Safety and efficacy requirements for animal health therapies are very similar to those in human health,” said Monica. “From the beginning, a formal, regulated process is in place including protocols for how to conduct clinical trials. It’s a process our scientists are passionate about and even go beyond regulatory expectations to deliver safe and meaningful products to veterinary medicine. It’s the right thing to do.”
5. **Bringing together the right experts and partners** To continue driving innovation in animal health, Zoetis scientists collaborate with multiple internal and external experts, from key opinion leaders to veterinary practices across the globe. The R&D organization also continues to add more scientists to development teams – biologists, protein engineers and other experts who work together to solve the complexities of chronic disease.
...
All trademarks are the property of Zoetis Services LLC or a related company or a licensor unless otherwise noted. © 2025 Zoetis Services LLC. All rights reserved. ZPC-04574
...
*2[Current Review of Monoclonal Antibody Therapeutics in Small Animal Medicine | MDPI](https://www.mdpi.com/2076-2615/15/4/472)*
*3 “Monoclonal Antibodies: Defining a New Category for Animal Care,” Zoetis[2023 Annual Report](https://www.zoetis.com/_assets/pdf/corporate/zoetis-2023-annual-report.pdf)*
*4[The history of monoclonal antibody development – Progress, remaining challenges and future innovations | PMC](https://pmc.ncbi.nlm.nih.gov/articles/PMC4284445/)*
*5 Kynetec PetTrak GAH-284 Unique Patient Count Since Launch Apoquel Cytopoint Jan 2014–June 2025*
*6[Chronic Kidney Disease (CKD) in Dogs and Cats | The Animal Medical Center](https://www.amcny.org/pet_health_library/chronic-kidney-disease-ckd/#:~:text=CKD%20develops%20slowly%20over%20time%20and%20can%20damage,cats%20are%20at%20risk%20of%20developing%20the%20disease.)*
*7[Prevalence and classification of chronic kidney disease in cats randomly selected from four age groups and in cats recruited for degenerative joint disease studies | PubMed](https://pubmed.ncbi.nlm.nih.gov/24217707/#&gid=article-figures&pid=figure-2-uid-1)*
*8[Chronic Kidney Disease (CKD) in Dogs and Cats | The Animal Medical Center](https://www.amcny.org/pet_health_library/chronic-kidney-disease-ckd/#:~:text=CKD%20develops%20slowly%20over%20time%20and%20can%20damage,cats%20are%20at%20risk%20of%20developing%20the%20disease.)*
*9[Pet Owner Resources | Veterinary Cancer Society](https://vetcancersociety.org/resources/pet-owners/pet-owner-resources/)*
*10[Cancer in Pets | American Veterinary Medical Association](https://www.avma.org/resources/pet-owners/petcare/cancer-pets)* *11[Veterinary specialists in the U.S. | American Veterinary Medical Association](https://www.avma.org/resources-tools/reports-statistics/veterinary-specialists)[. December 31, 2024.](https://www.avma.org/resources-tools/reports-statistics/veterinary-specialists)* *12 Librela (bedinvetmab injection). Freedom of Information Summary. NADA 141-562. Zoetis Inc; May 2023.*
