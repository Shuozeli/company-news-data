...
document_id: "0c95e5375403272398122ea4f1cd5f4a6afdb8b3a2f4eeb5ea4752f8006a627d"
...
This milestone represents an important step in Snowflake's continued investment in highly regulated industries and helps healthcare and life sciences organizations in France use the[Snowflake AI Data Cloud](https://www.snowflake.com/en/solutions/industries/healthcare-and-life-sciences/) for eligible workloads that require health data hosting capabilities.
...
In France,[Sanofi](https://www.snowflake.com/en/news/press-releases/sanofi-chooses-snowflake-to-accelerate-its-ai-powered-drug-development/) is using Snowflake to reinvent how it operates, from R&D to manufacturing to commercial. Its research teams use Snowflake to process real-world clinical data at scale, accelerating the analysis behind drug development decisions. HDS certification strengthens Snowflake's ability to support workloads like these across France's healthcare ecosystem.


Globally, organizations such as[Roche](https://www.snowflake.com/en/customers/all-customers/video/roche/) ,[Pfizer](https://www.snowflake.com/en/customers/all-customers/case-study/pfizer/) ,[NHS](https://www.snowflake.com/en/customers/all-customers/video/nhs-gmhscp/) in the UK,[Siemens Healthineers](https://www.snowflake.com/en/customers/all-customers/case-study/siemens/) and[Bupa](https://www.snowflake.com/en/customers/all-customers/case-study/bupa/) are using Snowflake to support scientific research, healthcare innovation, secure data collaboration and data-driven decision-making across increasingly complex healthcare ecosystems, supporting initiatives aimed at improving care delivery, access to insights and healthcare innovation.
...
At Snowflake World Tour[Berlin](https://www.snowflake.com/en/world-tour/berlin/) ,[London](https://www.snowflake.com/en/world-tour/london/) and[Paris](https://www.snowflake.com/fr/world-tour/paris/) this September and October, attendees will have the opportunity to explore dedicated healthcare and life sciences content, hear from industry experts and learn how organizations across the healthcare ecosystem are using data and AI to drive meaningful innovation.
...
To view or obtain a copy of our HDS Certification, please visit our[Compliance Center](https://trust.snowflake.com/) .
