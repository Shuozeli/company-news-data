...
document_id: "00c1fbfe560017f01676b22fe2bf965a60617d0fd279a188dc20036dc0a780dc"
...
canonical_url: "https://www.griddynamics.com/press-releases/grid-dynamics-aws-strategic-collaboration-agreement"
published_at: "2025-12-09T00:00:00+00:00"
first_seen_at: "2026-07-24T06:16:38.891283+00:00"
fetched_at: "2026-07-28T21:58:33.663804+00:00"
content_hash: "sha256:a8a5cfba76ee1232ab19ce07442559a0fa8382b46c9f35df43438d5af44d8bcd"
---
...
[DOWNLOAD PDF](https://cdnwp.griddynamics.com/wp-content/uploads/2025/12/Grid-Dynamics-AWS-SCA-PR.pdf)


**Key Takeaways:**


- Grid Dynamics has signed a multi-year agreement with Amazon Web Services (AWS) to accelerate AI-related services for enterprise customers.
- The agreement extends a 15-year collaboration and provides Grid Dynamics access to the AWS Data Foundations for Generative AI Program designed to help enterprises adopt and scale AI-enabled solutions.
- Through this expanded collaboration, Grid Dynamics is set to empower clients across every stage of their AI journey with modern, scalable, and secure data foundations from AWS.


**San Ramon, CA,** **December 09, 2025** – Grid Dynamics Holdings, Inc. (NASDAQ: GDYN) (Grid Dynamics), a premier IT consulting and digital services provider, today announced it has entered into a multi-year strategic collaboration agreement (SCA) with Amazon Web Services (AWS). The agreement focuses on enabling and scaling generative AI journeys for enterprise companies, extending a 15-year relationship between the companies.
...
- **Accelerators and Frameworks** to enable rapid deployment of robust data infrastructures on AWS.
- **End-to-End AI Solutions** that streamline iterative model refinement and customization, ensuring real-world applicability and scalability.
- **Ongoing Optimization Services** to continuously monitor and enhance data and AI operations.


With a proven track record of success across industries including retail, manufacturing, and financial services, Grid Dynamics has helped clients deploy generative AI for hyper-personalized experiences, automated processes, and data-driven decision-making. Grid Dynamics is an AWS Advanced Tier Consulting Partner with over 550 AWS-certified engineers and 5 validated AWS Competencies, including Data & Analytics and Machine Learning.[Learn more](https://www.griddynamics.com/partnerships/aws) about how Grid Dynamics is advancing enterprise AI.
