...
document_id: "37826c32723e40ad6ddd728ed3de8bac373a12694071f8b46b8a49685462081d"
...
canonical_url: "https://www.cmcsa.com/news-releases/news-release-details/sky-agrees-acquire-itv-media-entertainment-creating-commercial"
published_at: "2026-07-06T13:47:40+00:00"
first_seen_at: "2026-07-26T12:05:45.048551+00:00"
fetched_at: "2026-07-28T20:47:27.048275+00:00"
content_hash: "sha256:75f0ebfaf504e0ce727a3ec9be5a6e4f8c10345ddc3372898f35c041b0b596ae"
---

# Sky Agrees to Acquire ITV Media and Entertainment, Creating a Commercial Streaming Champion for the UK
...
[PDF Version](https://www.cmcsa.com/node/45836/pdf)
...
1. The transaction brings together two complementary UK broadcasting and streaming businesses to create a commercial streaming champion for the UK in a market that has profoundly and rapidly changed.
2. **About the transaction:** Sky has agreed terms to acquire ITV’s UK linear broadcasting and streaming business, including ITV1, ITV2, ITV3, ITV4, ITV Quiz and ITVX. The deal includes UTV, which is owned by ITV, but excludes STV which is a separate company. ITV Studios is not part of this transaction and will continue to operate independently. Sky will become an indirect 20% shareholder in ITN on completion of the deal. ITN makes national news programmes such as Good Morning Britain and News at Ten as well as regional news for London.
3. **Operations and brands:** Following completion, both companies’ broadcast channels will continue to operate under their existing brands and regulatory licences. ITV News and Sky
News will remain distinct editorial voices, subject to all existing Ofcom requirements. No changes are being proposed to ITV's networking arrangements with STV.
4. **Public-service broadcasting:** Sky will maintain in full all current public-service broadcasting commitments attached to ITV’s linear services, including regional news, accessibility, and UK production quotas. ITV’s public service media content and ITVX will also benefit from the prominence regime introduced by the Media Act 2024, helping ensure viewers can continue to find ITV’s content and services easily.
5. **Corporate structure:** Following completion, ITV M&E will form part of the Sky group. Broadcast channels will continue to operate under their existing brands and regulatory licences, and ITV’s linear services and ITVX will remain available free-to-air on platforms like Freeview, Freely, Sky’s platforms, Virgin Media and Freesat.
6. **Employment:** There is no immediate impact on existing staff in either organisation. A joint integrated team will lead formal consultation on any future structures.
7. **Regulatory process:** Completion remains subject to customary conditions, including regulatory clearance.
8. **Financial terms:** The total consideration of up to £1.6 billion (subject to adjustment for cash, debt and net working capital), comprising of £1.2 billion in cash, Love Productions at an agreed value of £0.2 billion, and up to £0.2 billion in performance-related earn-out payments. Approximately £200 million in annual cost synergies are expected to be generated on a run-rate basis by the end of the third year after closing. The transaction excludes ITV Studios and its subsidiaries. PJT Partners served as advisor to Comcast on the transaction.


**Contact:**
**Sky**
• Matt Ridsdale: matt.ridsdale@sky.uk, (+44 (0) 7545577754
• Stephen Lotinga: stephen.lotinga@sky.uk, +44 (0) 7855480361
**Comcast**
