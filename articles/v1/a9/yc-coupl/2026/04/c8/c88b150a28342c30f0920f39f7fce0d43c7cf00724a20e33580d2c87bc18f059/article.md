...
document_id: "c88b150a28342c30f0920f39f7fce0d43c7cf00724a20e33580d2c87bc18f059"
company_key: "yc-coupl"
company: "Coupl"
source_id: "yc-coupl-news-import-096e0dbd56ca"
...
# Live-In Relationships in India: The Complete Guide to Money, Law, and Rights (2026)
...
## How the Law Defines a Live-In Relationship
...
## Financial Rights: What You Have and What You Don't
...
## How Different Institutions Treat Live-In Couples


Institution How they treat live-in couples What you can do


Banks (joint account) Usually require marriage; will turn unmarried couples away Use Coupl (shared PPI wallet) for joint spending; Splitwise for tracking


Banks (nominee) Any person can be nominated, no marriage required Update nominations immediately


Mutual funds Joint holding allowed for any two adults Open joint folio; either/survivor mode


Demat accounts Joint holding allowed for any two adults Open joint demat with preferred broker


Health insurance Most plans: spouse = legally married. Some progressive insurers allow live-in partners Buy individual policies; check employer group policy


Life insurance Any person can be named as nominee Name partner as nominee; combine with a will


EPF Nominee must be family member if eligible family exists; live-in partners excluded Limited options; a will can direct EPF proceeds


Property purchase No restriction, any two adults can co-own Joint purchase with co-ownership agreement


Income tax Gift tax applies to large transfers; no spousal exemptions Label transfers clearly; use shared wallet instead of reimbursements


## The Landlord Problem: Renting as a Live-In Couple
...
- Large apartment complexes and builder projects tend to be more anonymous and less intrusive than individual landlords
- Urban metros (Mumbai, Bangalore, Hyderabad, Pune) are significantly more accepting than smaller cities
- Apps like NoBroker and Housing.com have made it easier to find landlord-friendly listings without the gatekeeping of traditional brokers
- Some couples register as "friends" or roommates, not ideal from a documentation standpoint, but common
...
## Children in Live-In Relationships: Legal Status
...
## The 5 Financial Steps Every Live-In Couple Should Take
...
- Their own bank account in their name
...
- Understand which protections exist and use them (nominations, joint investment accounts)
- Fill the gaps through private legal documents (wills, cohabitation agreements)
- Build independent financial security for each partner
- Use purpose-built tools (like Coupl) for the products that traditional institutions don't provide


This is more work than married couples have to do. It is worth doing.


### Built for all couples, married, unmarried, live-in, or same-sex


Coupl is India's shared wallet for couples. No marriage certificate. Open in 60 seconds.


[Download on iOS](https://apps.apple.com/in/app/coupl-shared-banking/id6449580815)[Download on Android](https://play.google.com/store/apps/details?id=com.couplapp)
