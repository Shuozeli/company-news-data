...
document_id: "b92b0f61af0d8a69b65f2575420e7008f3d1e0894217766e3a9d1820f1534faa"
...
Alameda Research also relied heavily on FTX’s native token,[FTT](https://www.cointracker.io/price/ftx-token-c1do6u?ref=blog.ghost.cointracker.io) , as collateral for loans and high-risk trades. This set off a risky cycle. When FTT’s price climbed, Alameda’s borrowing power grew, allowing it to take on even greater exposure. But when FTT’s value fell, the firm faced mounting margin calls and liquidations, exposing its fragile position. Even after receiving billions from FTX, Alameda Research couldn’t cover its debts, and its collapse played a key role in FTX’s downfall.


### Social media and the liquidity crisis


The crisis accelerated after a[CoinDesk](https://www.coindesk.com/markets/2022/11/12/the-epic-collapse-of-sam-bankman-frieds-ftx-exchange-a-crypto-markets-timeline?ref=blog.ghost.cointracker.io) report raised questions about Alameda’s financial health and its ties to FTX. The report spread rapidly across crypto news sites and social media, particularly X (formerly Twitter). The situation worsened when Binance, a rival crypto exchange, announced plans to sell off its FTT holdings – worth around[$500 million](https://www.theguardian.com/technology/2022/nov/11/binance-ftx-collapse-cryptocurrency-exchange-changpeng-zhao?ref=blog.ghost.cointracker.io) at the time. Investors rushed to withdraw funds from FTX, draining liquidity and pushing the exchange into a full-blown crisis.
...
- **Nov. 2, 2022:**[CoinDesk](https://www.coindesk.com/policy/2023/09/20/breaking-down-the-infamous-alameda-balance-sheet?ref=blog.ghost.cointracker.io) published a report revealing financial ties between FTX and Alameda Research, raising concerns about FTX's financial stability.
...
- **Nov. 11, 2022:** FTX and its affiliated entities, including Alameda Research, filed for[Chapter 11](https://restructuring.ra.kroll.com/ftx/?ref=blog.ghost.cointracker.io) bankruptcy protection in the United States.
- **Nov. 12, 2022:** Reports emerged of unauthorized transfers totaling approximately $400 million from FTX accounts, suggesting a[potential hack](https://fortune.com/crypto/2024/02/05/ftx-hack-carried-out-by-sim-swap-gang-who-impersonated-female-exec/?ref=blog.ghost.cointracker.io) .
- **February 2024:** The[U.S. District Court in Washington, DC](https://www.cnbc.com/2024/02/02/three-people-indicted-in-400-million-ftx-hack-conspiracy.html?ref=blog.ghost.cointracker.io) , indicted three individuals with the $400 million hack after FTX's fall.
- **March 2024:**[The U.S. District Court for the Southern District of New York](https://www.justice.gov/opa/pr/samuel-bankman-fried-sentenced-25-years-his-orchestration-multiple-fraudulent-schemes?ref=blog.ghost.cointracker.io) found Sam Bankman-Fried guilty of multiple counts related to fraud and sentenced him to 25 years in prison.
- **August 2024:** The U.S. District Court for the Southern District of New York ordered bankrupt cryptocurrency exchange FTX to pay[$12.7 billion](https://www.reuters.com/technology/crypto-exchange-ftx-ordered-pay-127-bln-customers-us-cftc-says-2024-08-08/?ref=blog.ghost.cointracker.io) in relief to its customers. This ruling, announced by the Commodity Futures Trading Commission (CFTC), included $8.7 billion in restitution and $4 billion in disgorgement to compensate victims.
- **October 2024:** FTX's bankruptcy plan[received court approval](https://www.bbc.com/news/articles/c0qz3dg21vqo?ref=blog.ghost.cointracker.io) , allowing the company to begin[repaying customers](https://www.morningstar.com/news/dow-jones/202411218606/ftx-sets-spring-2025-target-for-paying-back-customers-creditors?ref=blog.ghost.cointracker.io) using recovered assets.


## How do FTX's liquidity issues affect you?


In late 2024, FTX's restructuring board announced plans to begin refunding users in 2025. According to[disclosure statements](https://media.ra.kroll.com/ftx/plananddisclosurestatement/docs/FTX%20Disclosure%20Statement.pdf?ref=blog.ghost.cointracker.io) , FTX aims to repay investors in full, plus[interest](https://support.ftx.com/hc/en-us/articles/34522100742804-Post-petition-Interest-Calculation-FAQ?ref=blog.ghost.cointracker.io) , starting with "convenience classes" – those with claims of $50,000 or less. To facilitate the process, FTX has partnered with[Kraken](https://support.ftx.com/hc/en-us/articles/33191010627988-Using-Kraken-as-a-Distribution-Service-Provider?ref=blog.ghost.cointracker.io) and crypto custodian[BitGo](https://support.ftx.com/hc/en-us/articles/33190915164692-Using-BitGo-as-a-Distribution-Service-Provider?ref=blog.ghost.cointracker.io) to distribute funds. Those affected by the FTX collapse should monitor the restructuring process through[FTX’s official portal](https://restructuring.ra.kroll.com/FTX/?ref=blog.ghost.cointracker.io) and stay vigilant against phishing scams.
...
In contrast, FTX.US was a separate entity that served U.S. users exclusively. Although it was affected by FTX’s collapse, its smaller user base and relative independence from FTX Global helped limit the damage. While[withdrawals were initially paused](https://www.coindesk.com/business/2022/11/11/ftx-us-freezes-crypto-withdrawals-sending-millions-in-assets-to-bankruptcy-limbo?ref=blog.ghost.cointracker.io) , FTX.US later resumed them with restrictions. FTX.US customers will likely recover funds sooner than FTX Global users, but all affected users should stay updated through the official restructuring portal.
...
Following the FTX collapse, on-chain analytics firms like[Glassnode](https://x.com/glassnode/status/1591943265296998400/photo/1?ref=blog.ghost.cointracker.io) reported a spike in users moving their cryptocurrencies from CEXs to self-custodial wallets. Unlike keeping assets on exchanges, self-custodial wallets give users complete control over their funds through a private key. This shift reflected growing distrust in centralized institutions.
...
In response to FTX’s failure, regulators worldwide accelerated efforts to introduce clearer legal frameworks for crypto. In the U.S., proposals like the FIT21 Bill aim to define regulatory oversight, while in the European Union, the[Markets in Crypto-Assets Regulation (MiCA)](https://www.esma.europa.eu/esmas-activities/digital-finance-and-innovation/markets-crypto-assets-regulation-mica?ref=blog.ghost.cointracker.io) framework has gained momentum. Policymakers continue to develop new rules that aim to balance innovation, investor protection, and risk mitigation.


## Analyze crypto tax deductions with CoinTracker


If you were affected by a bankrupt exchange like FTX, Celsius, or Voyager, you may have options to claim deductions on your tax forms.[CoinTracker’s Portfolio Tracker](https://www.cointracker.io/portfolio-tracker?ref=blog.ghost.cointracker.io) organizes all your transactions from these platforms, making it easier to document your trading activity. Working with a crypto CPA can help determine the best way to report these details and potentially claim losses on your tax return.


With CoinTracker, tracking and managing your crypto taxes doesn’t have to be complicated. Get started with a[free account](https://www.cointracker.io/plans?ref=blog.ghost.cointracker.io) today and discover how easy it is to stay on top of your crypto taxes.
