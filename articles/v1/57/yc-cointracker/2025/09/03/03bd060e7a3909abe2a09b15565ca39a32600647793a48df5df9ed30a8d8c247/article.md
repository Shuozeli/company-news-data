...
document_id: "03bd060e7a3909abe2a09b15565ca39a32600647793a48df5df9ed30a8d8c247"
company_key: "yc-cointracker"
company: "CoinTracker"
source_id: "yc-cointracker-news-import-8eddc0d2ffc8"
canonical_url: "https://www.cointracker.io/blog/whats-a-1099-da"
published_at: "2025-09-03T00:00:00+00:00"
first_seen_at: "2026-07-24T23:51:12.353224+00:00"
fetched_at: "2026-07-28T22:01:02.064378+00:00"
content_hash: "sha256:451fe42e4e6054bc3ffc8f53e7f7db329d1d63ef407b75d9674a139528da2133"
---
...
The IRS says[Form 1099-DA](https://www.irs.gov/pub/irs-pdf/f1099da.pdf?ref=blog.ghost.cointracker.io) will bring more transparency and consistency to crypto tax reporting, similar to the[1099-B](https://www.irs.gov/forms-pubs/about-form-1099-b?ref=blog.ghost.cointracker.io) for stocks. But the move has also left many crypto investors – especially[new traders](https://www.cointracker.io/blog/how-to-trade-crypto-a-practical-guide-for-beginners?ref=blog.ghost.cointracker.io) – wondering whether the form applies to them and, if so, what exactly they need to report.
...
Form 1099-DA is an IRS information return for reporting sales and exchanges of digital assets on custodial brokerages like[centralized exchanges](https://www.cointracker.io/blog/where-to-buy-crypto?ref=blog.ghost.cointracker.io) (CEXs). It covers a range of transactions, including crypto-to-fiat and crypto-to-crypto trades, conversions to stablecoins, redemptions, and[non-fungible token](https://www.cointracker.io/blog/what-is-an-nft?ref=blog.ghost.cointracker.io) (NFT) sales on centralized marketplaces.


## When does 1099-DA reporting take effect?


Starting with the[2025 tax year](https://www.cointracker.io/blog/crypto-tax-guide?ref=blog.ghost.cointracker.io) , brokerages must send the form to both the IRS and their customers, which means clients will receive these forms starting in January 2026. The initial round of 1099-DAs won’t include every detail required in future tax years. For 2025 crypto tax reporting, brokerages only need to report proceeds from digital asset sales and exchanges.
...
Form 1099-DA is issued by custodial U.S. platforms that facilitate the sale or exchange of digital assets for their customers. This includes mainstream American CEXs such as[Coinbase](https://www.cointracker.io/blog/coinbase-partnership?ref=blog.ghost.cointracker.io) , fintech apps like PayPal, and brokerages like[Robinhood](https://www.cointracker.io/blog/how-to-take-money-out-of-robinhood?ref=blog.ghost.cointracker.io) . Beginning in 2026, these platforms will issue 1099-DA forms to users who sell or exchange digital assets through them.


In contrast, web3 protocols and decentralized exchanges ([DEXs](https://www.cointracker.io/blog/what-is-a-crypto-dex?ref=blog.ghost.cointracker.io) ) like[Uniswap](https://www.cointracker.io/blog/what-is-uniswap?ref=blog.ghost.cointracker.io) don’t have to issue 1099-DA forms because they’re non-custodial. Users trade directly from their own wallets without the exchange taking possession of their assets.
...
If you only use a CEX to buy, store, and trade digital assets, your 1099-DA will contain much of the information you need to complete[Form 8949](https://www.irs.gov/pub/irs-pdf/f8949.pdf?ref=blog.ghost.cointracker.io) during tax season. But if you transfer cryptocurrency to other exchanges or to self-hosted wallets, your 1099-DA will be incomplete and possibly inaccurate.


When you receive your 1099-DA, review the instructions on the form and compare the data on the form with your own records. To make this process easier, use a tax software solution like[CoinTracker](https://www.cointracker.io/?ref=blog.ghost.cointracker.io) that connects with all crypto exchange APIs, decentralized applications ([dApps](https://www.cointracker.io/blog/what-is-a-dapp?ref=blog.ghost.cointracker.io) ), and wallet addresses to give a complete picture of your digital asset activity. Tools like[CoinTracker’s Portfolio Tracker](https://www.cointracker.io/portfolio-tracker?ref=blog.ghost.cointracker.io) help reconcile the information in your 1099-DA and make any necessary adjustments before you file Form 8949. While you can’t amend a 1099-DA directly, you can supplement and modify the information on your tax return if the amounts reported do not agree to your records.
...
- **1099-MISC:** This form reports various types of income, including rewards earned on an exchange, and is typically issued by exchanges when rewards are at least[$600](https://www.irs.gov/forms-pubs/about-form-1099-misc?ref=blog.ghost.cointracker.io) .
- **1099-NEC:** The “[NEC](https://www.irs.gov/forms-pubs/about-form-1099-nec?ref=blog.ghost.cointracker.io) ” in 1099-NEC is for “nonemployee compensation,” which refers to any payments (including cryptocurrency) made to independent contractors or freelancers.
