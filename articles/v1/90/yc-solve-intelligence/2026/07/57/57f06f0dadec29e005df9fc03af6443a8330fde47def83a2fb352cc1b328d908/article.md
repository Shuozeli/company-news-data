...
document_id: "57f06f0dadec29e005df9fc03af6443a8330fde47def83a2fb352cc1b328d908"
company_key: "yc-solve-intelligence"
company: "Solve Intelligence"
source_id: "yc-solve-intelligence-news-import-a6d4afe4e85a"
canonical_url: "https://www.solveintelligence.com/blog/post/how-ai-brings-patent-intelligence-into-every-decision"
published_at: "2026-07-27T17:10:09.342+00:00"
first_seen_at: "2026-07-27T14:34:10.465172+00:00"
fetched_at: "2026-07-28T21:33:52.463534+00:00"
content_hash: "sha256:410bd4dcce931df2cb4f80f62beb11f6d76d45d9f4e6cee70457566d65f1e904"
---

# How AI turns patent intelligence into a continuous process
...
In Solve Intelligence, Charts and reusable templates provide the structure for this ongoing analysis. For example, teams can customise a template for[competitive landscape & white space analysis](https://www.solveintelligence.com/blog/post/patent-landscape-analysis-rd-teams) around a particular R&D programme. They can define the field from a technical description or uploaded file and inspect the patents behind each finding. Results can be organised by assignee, jurisdiction, or technical field.
...
In Solve Intelligence, Charts support the same progression of[FTO analysis](https://www.solveintelligence.com/blog/post/what-is-a-freedom-to-operate-analysis-and-how-ai-speeds-it-up) . Solve Intelligence can run broad multi-patent analyses and produce detailed, feature-by-feature claim charts, while automatically pulling in relevant prosecution histories and accounting for jurisdiction-specific practices. The analyses can be updated with more detailed product evidence as the design develops.
...
The EPO’s nine-month opposition period is an example of a situation where AI monitoring can support a time-sensitive decision. An[EPO opposition](https://www.epo.org/en/applying/european/oppositions) must be filed within nine months of publication of the mention of grant. AI can manage this deadline and set up a monitoring task that can detect the mention of grant, retrieve the patent family and prosecution history, run an automated prior-art search and generate an initial claim chart identifying possible grounds for challenging the patent.
...
Solve Intelligence connects directly to patent-office registers, allowing scheduled tasks to run automatically when an alert is detected. A grant or claim amendment can trigger retrieval of the patent family and prosecution history, an agentic prior-art search and an initial[invalidity claim chart](https://www.solveintelligence.com/blog/post/ai-invalidity-chart-guide) .
...
AI allows teams to go beyond the administrative view and conduct detailed analysis across thousands of patents. Claims can be[mapped to the company’s products](https://www.solveintelligence.com/blog/post/what-is-patent-mapping-and-claim-analysis-with-ai) and technical roadmap to show which commercial features are protected and where coverage is limited. The same analysis can be applied to competitor products to identify potential infringement and[licensing opportunities](https://www.wipo.int/en/web/business/ip-valuation) , helping the company monetise its portfolio.
...
Solve Intelligence keeps these workflows connected in one place. If your team is rethinking how patent intelligence supports R&D, product or portfolio strategy,[request a demo](https://www.solveintelligence.com/#book-demo) or contact us atpartnerships@solveintelligence.com to compare workflows.
