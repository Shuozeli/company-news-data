...
document_id: "a0b3f2471c7a51eb2dd023694ebc608eac0213febd02d953e5710c8db357ae24"
...
canonical_url: "https://news.medtronic.com/how-collaboration-built-a-replicable-model-for-community-based-healthcare-delivery-newsroom"
...
content_hash: "sha256:b0dbab9ed45641bcca8bc1edd3b593b51aee021f21d7b3e0a174bbebe0931b29"
---
...
- [Leadership perspectives](https://news.medtronic.com/leadership-perspectives)
...
Across the U.S., millions of people face[growing barriers to accessing healthcare](https://pmc.ncbi.nlm.nih.gov/articles/PMC11806735/) , driven by lack of insurance, policy changes, and systemic inequities that leave entire communities underserved. These challenges are not new, nor are they limited to the United States, but they are intensifying and they demand new models of care.
...
**Dennis:**[Virtua Health](https://www.virtua.org/) is South Jersey's largest healthcare provider, serving a region marked by profound health disparities. Over decades, we invested in mobile health programs, from a[grocery store on wheels](https://www.virtua.org/About/Community-Programs/Eat-Well/Mobile-Grocery-Store) stocked with nutritious food to custom-designed vehicles that offer[cancer screenings](https://www.virtua.org/services/Cancer-Care/Mobile-Health-and-Cancer-Screening-Unit) and[pediatric care](https://www.virtua.org/About/Community-Programs/Pediatric-Mobile-Services) .
...
One patient,[Bill Adams*](https://news.medtronic.com/from-home-visits-to-health-victories-global-health-tech-gets-personal-newsroom) , initially questioned whether his CHW would even show up. He had no health insurance and little trust in the healthcare system in general. But Karen showed up at his home, took his blood pressure, and discovered it was dangerously elevated. She connected him to emergency care the same day.
...
**Geoff:**[Medtronic LABS](https://www.medtroniclabs.org/) has a decade of experience delivering community-based, tech-enabled care in countries around the world, including in Kenya, Ghana, Sierra Leone, and Bangladesh.[With 8,000+ community health workers trained and over 1 million patients reached](https://www.medtroniclabs.org/approach/) , we have frameworks, tools, and credibility to help scale a new model, but had never built a program in the United States.
...
From the outset, Healthy Neighbor was designed for scale. A[comprehensive toolkit](https://www.medtroniclabs.org/wp-content/uploads/2025/08/Virtua-Toolkit-Final-Version-August-2025.pdf) , covering workflows, protocols, and lessons learned, helps other organizations adopt the model. With multiple entry points across primary care, emergency departments, and community settings, plus a modular tech platform, the program can be tailored to different populations and geographies.
...
[From home visits to health victories: Global health tech gets personal](https://news.medtronic.com/from-home-visits-to-health-victories-global-health-tech-gets-personal-newsroom)


[Shining light through the fog: How AI makes every pulse count](https://news.medtronic.com/shining-light-through-the-fog-how-ai-makes-every-pulse-count-newsroom)


[Documentary: Better health for everyone, everywhere](https://news.medtronic.com/documentary-better-health-for-everyone-everywhere-newsroom)
