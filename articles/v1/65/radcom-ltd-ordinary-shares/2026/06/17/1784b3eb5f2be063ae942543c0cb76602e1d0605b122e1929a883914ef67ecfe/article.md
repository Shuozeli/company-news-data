...
document_id: "1784b3eb5f2be063ae942543c0cb76602e1d0605b122e1929a883914ef67ecfe"
...
canonical_url: "https://radcom.com/what-to-expect-at-dtw-2026-in-copenhagen/"
published_at: "2026-06-15T12:31:08+00:00"
first_seen_at: "2026-07-25T01:07:32.935415+00:00"
fetched_at: "2026-07-28T21:54:03.866440+00:00"
content_hash: "sha256:128c6029739b44911cf39aa95fbd1c267bb49874f0f4bff767f3316d64bc2b72"
---

# What to Expect at DTW Ignite 2026 in Copenhagen

*Trends, insights, and a vision for scaling AI at the speed of trust*


DTW Ignite 2026 returns to Copenhagen’s Bella Center during the last week of June, bringing together operators, vendors, standards bodies, and technologists under one roof. DTW remains a premier forum for the industry to take stock of where it is, debate where it’s going, and, critically, how to get there.


Here’s what we expect to take center stage.


## The Race to Level 4: Where Do Autonomous Networks Stand Today?
...
[TM Forum’s six-level autonomy framework](https://www.tmforum.org/missions/autonomous-networks) has been the industry’s north star since 2019, and progress toward Level 4, where near-full automation is possible across many scenarios, is becoming a reality for a small but growing number of operators.[Rakuten Mobile](https://network.mobile.rakuten.co.jp/en/) , a RADCOM customer, is one example that has already demonstrated Level 4 at scale in a live RAN network, achieving[20% RAN energy](https://symphony.rakuten.com/blog/telecom-has-reached-level-4-autonomy-in-live-networks-the-operational-implications-are-significant?utm_source=chatgpt.com) savings through AI-driven closed-loop control. And TM Forum has noted a “significant change” in the pace of Level 4 validations among *select* operators heading into 2026.


The broader picture, however, is slower.[TM Forum](https://www.fierce-network.com/broadband/accenture-79-telcos-still-level-01-autonomous-networks-maturity) found only 21% of operators are operating at Level 3 autonomy or above overall, up only slightly from 19% the year before. While industry progress appears modest on average, the reality is more polarized: a small group of leaders is accelerating toward Level 4 autonomy and beyond, while many operators remain stuck in the earlier stages of the journey.


We expect sessions on how cross-domain autonomy can unlock the next level of scale, including how distributed agents coordinate from the RAN to the core as well as the interoperability challenges the multi-agent approach introduces. Or see[RADCOM’s Catalyst “Agent Fabric: A2A-T Runtime – Phase III](https://www.tmforum.org/catalysts/projects/C26.0.910/agent-fabric-a2at-runtime-phase-iii) **,** ” which tackles this problem by moving the industry from isolated agents exchanging loosely structured prompts to agents that negotiate tasks, share outcomes, delegate workflows, and operate with a shared operational context.
...
Trustworthy AI means systems that are explainable, fair, transparent, robust, and secure, and operators say they aren’t there yet. A recent[Heavy Reading-RADCOM](https://radcom.com/further-reading/from-ambition-to-action-the-future-of-aiops-and-agentic-ai-in-telecom/) survey of telecom operators confirms it: after integration complexity, the single biggest obstacle to leveraging AI in the network is accuracy and trust in the models themselves. As AI researcher, Qiang Liu, from the University of Nebraska-Lincoln School of Computing, recently put it: “Everyone’s using AI, and they want to use it, and the performance looks great in the testbed, but they still don’t trust it.”
...
### RADCOM Looks Forward to Welcoming You at DTW Ignite 2026, Copenhagen
...
We look forward to seeing you there. Book a time to meet with us here:[https://radcom.com/events/digital-transformation-world/](https://radcom.com/events/digital-transformation-world/)
