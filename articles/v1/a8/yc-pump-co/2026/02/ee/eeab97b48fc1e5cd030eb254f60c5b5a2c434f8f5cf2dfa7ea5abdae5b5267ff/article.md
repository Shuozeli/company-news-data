...
content_hash: "sha256:741834f0530534350e92c5dce2735853c9adc86efd3c98533f658bc2f414d8a2"
---

# AWS App Runner: What It Is, Pricing & Use Cases
...
App Runner supports two main sources for your application. You can use App Runner with[Amazon Elastic Container Registry](https://www.pump.co/) for a container image or[GitHub](https://docs.aws.amazon.com/apprunner/latest/dg/getting-started.html) with the source code directly.
...
Unlike[AWS Lambda](https://www.pump.co/) , which can go down to zero instances, App Runner is guaranteed to always have one instance. This means they will still respond quickly to requests, and they will adjust their traffic.
...
**Use environment variables securely:** Store sensitive information, such as API keys and database passwords, in a secure location such as[AWS Secrets Manager](https://www.pump.co/) or[Systems Manager Parameter Store](https://aws.amazon.com/systems-manager/) , and only reference these in your App Runner as secure environment variables.


-


**Monitor:** Keep a close watch on your auto-scaling metrics with[AWS CloudWatch](https://www.pump.co/) to track the number of active instances, the amount of memory used, and the number of HTTP 4xx and 5xx errors to stay updated on the health of your service.
...
[AWS ECS Best Practices - Optimize Container Workloads](https://www.pump.co/)


-


[ECS vs EKS vs Fargate: Choosing Your AWS Container Service](https://www.pump.co/)


-


[AWS EKS Pricing - Cost Guide & Savings Tips](https://www.pump.co/)
