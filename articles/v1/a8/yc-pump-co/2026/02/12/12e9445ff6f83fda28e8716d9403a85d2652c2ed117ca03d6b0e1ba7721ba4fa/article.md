...
# Amazon Lex: Pricing, Benefits, and Use Cases
...
Amazon Lex has the advantage of being in the AWS ecosystem, meaning it integrates automatically with[Amazon CloudWatch,](https://www.pump.co/)[Amazon DynamoDB](https://www.pump.co/) , and[Amazon Connect](https://www.pump.co/) , making it a very powerful and easy-to-use contact center solution.
...
**Enterprise-Grade Security** :[AWS IAM](https://www.pump.co/) gives your customers more control over accessing the bot and associated data, and the organization will stay safe and compliant.
...
**Contact Center Automation** : Integrate Amazon Lex with[Amazon Connect](https://www.pump.co/) so that customers can be greeted, their needs identified, and directed to the right department. The bot can resolve the whole call on its own.
...
**AWS Ecosystem Integration:** Lex integrates seamlessly with other AWS services like[AWS Lambda](https://www.pump.co/) ,[Amazon Connect](https://www.pump.co/) , and[AWS CloudWatch](https://www.pump.co/) , which gives you more power in your current setup.
...
**Learning curve:** Requires technical knowledge of AWS services like[AWS IAM](https://www.pump.co/) and Lambda.
...
[AWS DynamoDB Pricing - Cost Breakdown & Savings Guide](https://www.pump.co/)
