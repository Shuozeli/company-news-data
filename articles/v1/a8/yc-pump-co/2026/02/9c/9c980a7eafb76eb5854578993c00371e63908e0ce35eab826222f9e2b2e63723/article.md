...
content_hash: "sha256:fb9366ddd12589121c07a39c42413882e8743ae97daebd0ebb837c143e67f50b"
---

# AWS CodePipeline: Pricing & Features Guide
...
CodePipeline integrates with other AWS services, which can provide you with a lot of value in your workflow. Your source code can come from[GitHub](https://github.com/) ,[Amazon ECR](https://www.pump.co/) ,[AWS S3](https://www.pump.co/) , and[CodeCommit](https://aws.amazon.com/codecommit/) ; your builds run in CodeBuild; your deployments can go to ECS, Fargate, Elastic Beanstalk, or CodeDeploy; and you can run an AWS Lambda function at any of the steps in the workflow. For example, you can use it to validate a deployment or conduct a post-deployment check.


You can also use the[AWS CloudFormation](https://www.pump.co/) service to add actions in your pipeline to provision, update, or delete AWS infrastructure, which is very useful when working with the AWS SAM.
...
All the pipelines are protected by[AWS IAM](https://www.pump.co/) . You can control the pipeline modifications, execution of the pipeline, and viewing of the execution history by using IAM users, roles, and SAML-integrated directories.
...
**CodePipeline integrates with**[Amazon SNS](https://www.pump.co/) so the users can receive alerts based on events in a pipeline. These events include failures in stages, successful deployments, and manual actions. This allows the users to be updated without logging in to the console and monitoring events.
...
If you want to see more details on your CodeBuild and CodePipeline costs, you can see this in[AWS Cost Explorer](https://www.pump.co/) . Create budget alerts so that you can catch cost spikes on the issue and avoid them. It is beneficial to review the costs for teams that have many active pipelines.
...
[Amazon Connect: What It Is, Features & Pricing Guide](https://www.pump.co/)


-


[AWS EMR: What It Is, Features & Pricing Guide](https://www.pump.co/)


-


[AWS Batch: What It Is and Why You Should Use It](https://www.pump.co/)
