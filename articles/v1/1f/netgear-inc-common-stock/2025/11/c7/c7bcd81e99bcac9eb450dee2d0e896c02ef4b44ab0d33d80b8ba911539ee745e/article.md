...
document_id: "c7bcd81e99bcac9eb450dee2d0e896c02ef4b44ab0d33d80b8ba911539ee745e"
...
Customers can choose data plans ranging from 3GB to 20GB and manage their usage in real time with transparent tracking. The NETGEAR eSIM platform makes it simple to find and activate competitive data plans that best match travel needs. For the M7 Product launch, NETGEAR has partnered with[Gigs](https://gigs.com/) to deliver data plans in the eSIM Marketplace.
...
- **5G Powered WiFi 7:** Speeds up to 3.6 Gbps for up to 32 devices for fast downloads, gaming, & streaming.
- **Powered by Qualcomm® Dragonwing® SDX72 Chipset ​:** Qualcomm’s 5th Generation 5G modem-to-antenna solution designed with advanced capabilities such as more Sub6 carrier aggregation that can deliver multi-gig 5G speeds up to 4 Gbps​.
- **Connect More Devices with Confidence** : Liberate your phone and connect up to 32 devices at once, reducing dropped calls and dead batteries.
- **Instant Coverage with eSIM** ​: Coverage 140+ countries using 5G or 4G without contracts. Purchase flexible data plans right from the NETGEAR app for seamless connectivity.
...
- **Unlocked Potential:** Accepts SIM cards and eSIMs from major 5G/4G network operators.​ Certified with AT&T, T-Mobile, and Verizon in the U.S.
...
- **Long-Lasting Battery** ​: High-capacity battery lasts up to 10 hours on a single charge for all-day WiFi performance. M7 can also be used as a power bank to charge other devices while traveling.
...
The M7 Portable WiFi Hotspot with eSIM marketplace will be available in January 2026 for $499.99 MSRP. Visit[www.netgear.com](https://www.netgear.com/) for more information.
...
-
-
- [Copy link](https://www.netgear.com/hub/pressroom/netgear-introduces-the-nighthawk-5g-m7-hotspot-with-esim/)
