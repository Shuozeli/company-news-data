...
document_id: "ccb4540d1bf5aa2a72eec42f4e5a22680b2be4944c7c4851ec66d77b38c2dd97"
company_key: "altisource-portfolio-solutions-s-a-common-stock"
company: "Altisource Portfolio Solutions S.A. Common Stock"
source_id: "altisource-portfolio-solutions-s-a-common-stock-rss-18e4b2369197"
canonical_url: "https://www.altisource.com/resources/blog-the-source/2023/09/using-data-to-optimize-cwcot-outcomes-2/"
published_at: "2023-09-15T10:13:12+00:00"
first_seen_at: "2026-07-24T15:39:12.500062+00:00"
fetched_at: "2026-07-28T22:26:23.018316+00:00"
content_hash: "sha256:21627d6405f79e3266c25e49d87deb0f482c1ec45eb08dbd0b700a2a2fea7708"
---

# Using Data To Optimize CWCOT Outcomes

[Altisource - Home](https://www.altisource.com/)


>[Resources](https://www.altisource.com/category/resources/)


>[Blog The Source](https://www.altisource.com/category/resources/blog-the-source/)
...
In 2016, nearly[one in five](https://pages.altisource.com/CWCOTWhitePaper_LPform.html) newly originated loans were Federal Housing Administration (FHA) loans. Although these loans led to an increase in home sales, they also comprised more than 34 percent of loans that were delinquent over 30 days, or nearly[8 million in outstanding FHA loans](https://www.nawrb.com/tag/cwcot/) .


Fortunately, there’s a way to tackle this problem: the Claims Without Conveyance of Title (CWCOT) program.[In 1987](https://dsnews.com/daily-dose/11-24-2017/closer-look-fhas-cwcot) , the FHA developed CWCOT, which allows third parties to bid on homes at foreclosure sales for less than the total debt owned on the properties, causing sales to close at a faster rate.
...
Sale at foreclosure auction (or shortly thereafter as a so-called "second chance" auction)
2.


Conveyance to the Department of Housing and Urban Development (HUD).
...
Yet collecting too little data also doesn’t allow servicers to navigate through the CWCOT process with integrity. In fact, without enough data, servicers are forced to cobble together suboptimal solutions. Altisource calls these solutions “[waterfall resolution strategies](https://pages.altisource.com/CWCOTWhitePaper_LPform.html) .” This means that rather than stick to a single solution that has been proven to work, servicers try one option on for size at a time. If the option fails, the servicer will then attempt innumerable other strategies—a cascade of them, in fact—to try to find the right fit. Unfortunately, this can add to the timeline of an auction and increase costs.


Outcomes of waterfall resolution strategies nearly always fall into the “good enough” zone. Unfortunately, in the world of CWCOT, the[Jim Collins quote rings true](https://www.jimcollins.com/media_topics/GoodIsTheEnemyOfGreat.html) : “Good is the enemy of great.” Not only do these strategies tack on unnecessary steps for servicers, but they add even more data to sort through.
...
To tap into a vendor pool that allows them to coordinate with other partners in the CWCOT value chain on strategic and technological levels. This helps all systems work together to produce data that is accurate.
2)


A technology platform, whether built internally or created by a third-party, that can handle the aforementioned vendor integration. This ensures that the data can then be put to action through an appropriate framework.
3)


Industry-leading marketing and auction capabilities within real estate marketing. This means that calculated risks taken while optimizing the CWCOT program still produce strong results for servicers and buyers alike.
...
To learn more about how to optimize your CWCOT program for your business, including data-driven, automated decision trees, assessing technology partners and enhancing operational controls for better asset exposure and revenue generation, download Altisource’s white paper:[New Opportunities for Servicers to Optimize CWCOT Disposition Strategies](https://pages.altisource.com/CWCOTWhitePaper_LPform.html) .
