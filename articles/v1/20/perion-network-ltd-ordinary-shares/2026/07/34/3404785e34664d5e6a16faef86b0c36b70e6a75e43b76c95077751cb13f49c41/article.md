...
document_id: "3404785e34664d5e6a16faef86b0c36b70e6a75e43b76c95077751cb13f49c41"
...
canonical_url: "https://perion.com/product/how-to-measure-dooh-digital-out-of-home-campaign-success/"
published_at: "2026-07-08T11:13:19+00:00"
first_seen_at: "2026-07-20T23:22:51.777610+00:00"
fetched_at: "2026-07-21T12:34:37.229008+00:00"
content_hash: "sha256:1281785465f6ae0b5bd40229e6c3072e888d13a033504384d2ddbdb28b2cac1d"
---

# How to Measure DOOH (Digital-Out-of-Home) Campaign Success
...
- **Measuring the performance of OOH campaigns has been a challenge because of the fragmentation of the ecosystem and the traditional nature of the channel.**


- **Programmatic technology empowers marketers with tools that use advanced location and audience data and analytics to measure effectiveness and preferred KPIs.**


- **Customizable KPIs can measure campaign effectiveness across the entire funnel, from Brand Lift at the top of the funnel to Sales Lift at the bottom.**


## Sales Lift


**Sales lift studies measure the increase in sales driven by the DOOH campaign exposure against a control number.** These studies analyze the effectiveness of advertising by linking consumer exposure to the DOOH ads with subsequent offline sales behavior. By examining the uplift in sales in regions or groups exposed to the campaign versus those not exposed, marketers can


**directly attribute sales growth to the advertising efforts.** This provides a clear view of how DOOH measurements link exposure to offline sales.
...
In-app (IAP) conversions are also a type of online conversion in DOOH since it is connected via a QR code. IAP metrics measure the effectiveness of a monetization strategy within a mobile app.


This group of metrics may include conversion rates and average revenue per user (ARPU), which assesses the revenue generated per active unit.


It can be quite challenging to measure offline to online conversions from exposure to a


**DOOH ad** , however not impossible with the right partner.


Request a


[demo today](https://perion.com/contact-us/) to see how Perion can optimize your campaigns.
...
### Example Case Studies from Perion


[Bakers Delight:](https://perion.com/case-study/bakers-delight-the-perfect-dooh-recipe/) **“The Perfect DOOH Recipe”.** This programmatic Digital Out‑of‑Home (DOOH) campaign targeted audiences near bakery locations using proximity-based triggers and real-time dynamic creatives.
...
[Tecate & Perion](https://perion.com/case-study/tecate-perion-case-study/) **Case Study.** Perion partnered with


**Tecate** , a leading light beer brand, to execute a programmatic digital-out-of‑home campaign. The goal was to build brand presence and


**drive foot traffic** using location‑aware messaging and dynamic content tailored to context. It combined


**dynamic creatives** with


**location intelligence** to trigger ads during high‑engagement moments.
...
Brand lift studies are critical in


**measuring a campaign’s impact on consumer awareness, consideration, interest, ad recal,l and intent, making them a valuable top-of-the-funnel metric** . These studies provide insights into how a target audience perceives a brand after exposure to specific campaigns.


Brand studies are especially suitable for specific campaign types. For example, a


**branding or rebranding campaign** can gauge shifts in brand recognition or perception.


**Product launch** studies measure how well a new product enters consumer awareness.


**Competitive awareness** campaigns assess a brand’s standing relative to competitors, and


**loyalty programs** measure how campaigns influence ongoing customer engagement and retention. These studies help marketers optimize future strategies based on data-driven insights.
...
## Examples of Successful DOOH Campaign Measurements
...
Source:[Perion](https://perion.com/case-study/lululemon-case-study/)
...
**promoted Lululemon’s shorts using “Custom Audience” targeting** females aged 18-34 in health-conscious environments such as gyms and transit stations. Another campaign focused on


**performance leggings, targeting marathon routes** in Munich and Berlin to engage participants and spectators.


The results were impressive. For the


**“performance leggings” campaign, there was a 640% increase in brand image and a 208% increase in interest.** The


**“shorts” campaign saw a 314% boost in foot traffic and 4296 modeled incremental walk-ins.** Lululemon continues to optimize its DOOH strategies year-round with Hivestack, driving substantial brand growth and in-store sales.


### Fiji Airways


Source:[Perion](https://perion.com/case-study/fiji-airways/)


Fiji Airways, recognized as the “Best Airline in Australia and the Pacific” sought to


**increase brand awareness and loyalty across multiple global markets** . Using programmatic digital-out-of-home (DOOH) advertising, the airline effectively targeted key audiences, including young families and affluent travelers. The campaign ran in markets such as Australia, New Zealand, Hong Kong, China, Singapore, Japan, Canada, and the U.S. By leveraging demographic and behavioral data and dayparting to display ads during peak times, Fiji Airways ensured maximum relevance and engagement.


The agile campaign


**allowed the airline to adapt creatives across markets in a single day, while also integrating omnichannel retargeting to reinforce its message.** Fiji Airways also leveraged measurement techniques such as a Brand Lift study to evaluate the campaign results.


The results exceeded expectations, delivering 79 million global impressions –


**40% more than anticipated** . The


**Brand Lift Study in China** revealed that 77% of respondents recalled outdoor and elevator ads, with 97% associated with Fiji Airways. Furthermore, 76% reported an improved impression of the airline, and 77% expressed an increased intention to fly with them in the future. Retargeting efforts also reduced the cost per acquisition by 300%.


## Leverage Programmatic DOOH with Perion


Source:[Perion](https://perion.com/targeting-and-measurement/)
...
[Perion today](https://perion.com/contact-us/) to learn how programmatic DOOH can transform your advertising efforts.
...
### What is the best metric to measure DOOH performance?
...
The post[How to Measure DOOH (Digital-Out-of-Home) Campaign Success](https://perion.com/product/how-to-measure-dooh-digital-out-of-home-campaign-success/) appeared first on[Perion](https://perion.com/) .
