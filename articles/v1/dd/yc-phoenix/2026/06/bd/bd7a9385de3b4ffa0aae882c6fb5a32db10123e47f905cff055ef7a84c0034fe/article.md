...
document_id: "bd7a9385de3b4ffa0aae882c6fb5a32db10123e47f905cff055ef7a84c0034fe"
company_key: "yc-phoenix"
company: "Phoenix"
source_id: "yc-phoenix-news-import-be2e24644a46"
canonical_url: "https://www.phoenix.ca/blog/glp1-semaglutide-side-effects-week-week"
published_at: "2026-06-08T20:36:25.826+00:00"
first_seen_at: "2026-07-25T19:08:38.231288+00:00"
fetched_at: "2026-07-28T21:46:31.447870+00:00"
content_hash: "sha256:06fa73758fca5f46cadff505b84f02a07fab6d7588bc935b66738dba04ce7f67"
---

# GLP-1 & Semaglutide Side Effects: Week-by-Week Guide

The most common complaint from people starting GLP-1 treatment is nausea. The second-most common complaint is that no one explained why it happens.
...
This is the most commonly reported early effect. In the STEP 1 trial, nausea was the most frequently reported GI symptom — and importantly, the trial also found these effects were "typically transient and mild-to-moderate in severity and subsided with time" ([Wilding et al., NEJM, 2021](https://cci-cic.org/wp-content/uploads/2021/04/STEP-1-Trial.pdf) ). Most people move through it.


A clinical review in *Nutrients* found that nausea prevalence is highest during the first 4 to 5 weeks, when the effect on gastric emptying is most pronounced, and that individual episodes typically last 8 days or less before resolving ([Martín-Fernández de Basoa et al., Nutrients , 2023](https://pmc.ncbi.nlm.nih.gov/articles/PMC9821052) ).
...
A pooled analysis of the STEP 1–3 data showed that GI side effect prevalence peaked around week 20 (roughly 4 weeks after reaching the full maintenance level) and declined steadily from there ([Wharton et al., Diabetes, Obesity and Metabolism , 2022](https://pmc.ncbi.nlm.nih.gov/articles/PMC9293236) ).
...
For most people, the early gut side effects have largely faded by around week 8 to 10. The pattern reported consistently across trials and clinical reviews is that these effects show up during the start and step-up periods, then ease as the body adapts ([Frontiers in Endocrinology](https://www.frontiersin.org/journals/endocrinology/articles/10.3389/fendo.2026.1788698/full) ).


Energy often improves compared with the early weeks as the body settles into a steadier metabolic rhythm.


One effect that can show up at any stage is a mild skin reaction at the injection site — a little redness or itching that usually fades within hours. In clinical trials, injection site reactions were reported in about 1.4% of participants on the active treatment versus 1.0% on placebo, and the vast majority were mild to moderate ([FDA prescribing information, 2023](https://www.accessdata.fda.gov/drugsatfda_docs/label/2023/215256s007lbl.pdf) ). Rotating where you inject from week to week helps reduce build-up of irritation in one spot.
...
Ongoing follow-up with a[licensed healthcare provider](https://www.phoenix.ca/treatments/weight-loss) is critical. Your provider knows your baseline and can distinguish between an expected adjustment effect and something that needs attention.
...
- Don't skip the starting dose. That low starting level exists specifically to ease you in. Clinical guidance consistently recommends a gradual step-by-step increase to reduce gut side effects ([Frontiers in Endocrinology](https://www.frontiersin.org/journals/endocrinology/articles/10.3389/fendo.2026.1788698/full) ).
...
For most people, nausea is most noticeable in the first couple of weeks and then improves as the body adapts. In the STEP 1 trial, gut side effects were generally described as transient and resolved with time ([Wilding et al., NEJM, 2021](https://cci-cic.org/wp-content/uploads/2021/04/STEP-1-Trial.pdf) ).


### When do side effects get better?


The common pattern is improvement across the first 4 to 8 weeks. Gut effects tend to flare briefly after each step-up in level, then settle again within a week or two. A pooled analysis of the STEP 1–3 trials found that nausea, diarrhoea, and vomiting prevalence peaked around week 20 and declined steadily thereafter ([Wharton et al., Diabetes, Obesity and Metabolism , 2022](https://pmc.ncbi.nlm.nih.gov/articles/PMC9293236) ).
