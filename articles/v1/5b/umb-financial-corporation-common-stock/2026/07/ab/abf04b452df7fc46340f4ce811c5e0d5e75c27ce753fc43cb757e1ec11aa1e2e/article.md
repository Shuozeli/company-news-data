...
document_id: "abf04b452df7fc46340f4ce811c5e0d5e75c27ce753fc43cb757e1ec11aa1e2e"
...
canonical_url: "https://blog.umb.com/institutional-banking-how-p3-address-workforce-housing-needs/"
published_at: "2026-07-10T15:00:30+00:00"
first_seen_at: "2026-07-24T05:08:02.111883+00:00"
fetched_at: "2026-07-28T21:50:17.978782+00:00"
content_hash: "sha256:7c820723018a75e34f80877a8809156c94bc51b6aea0498d78d43760858da3bb"
---

# The P3 sweet spot for housing projects

In a recent discussion with more than one hundred city managers around Colorado, I explored the potential of public-private partnerships (P3s) in addressing workforce housing needs. Many communities are grappling with acute housing shortages, particularly middle-income households (typically those making 60% to 120% of area median income, such as teachers, entry-level professionals, and first responders).
...
[Municipalities](https://blog.umb.com/institutional-banking-economic-development-financing-tools-for-municipalities/) usually start exploring P3 options when projects feature one or more of these characteristics:
...
1. **Design-Build-Finance-Operate-Maintain (DBFOM).** The private party designs, builds, finances, operates, and maintains the project and the municipality repays all of these costs over time either through a revenue share or periodic availability payments based on performance.
2. **Design-Build-Operate-Maintain (DBOM).** The private party designs, builds, operates, and maintains the project and the municipality finances the project, typically using low-cost tax-exempt municipal bonds.
3. **Design-Build Finance (DBF).** The private sector designs, builds, and finances the project, turning it over to the municipality upon completion.
4. **Design-Build (DB).** The private sector designs and builds the project. The local government finances, operates, and maintains the asset.
5. **Design-Bid-Build (DBB).** The most classic public procurement model where the municipality designs the project, solicits bids for construction, and, generally speaking, the lowest bid wins the contract. Notably, this procurement model tends to have the least amount of cost efficiencies.
...
*Learn more about how UMB Bank, n.a. Public Finance, can support your organization’s*[financing and capital needs](https://www.umb.com/institutional-banking/capital-markets-division/public-finance) *, or*[contact us](https://www.umb.com/contact-us-business/capital-markets) *to be connected with a public finance specialist.*
