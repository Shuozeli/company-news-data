...
document_id: "e60c23cc5b5d44470387111d5a80f14bdd12d10cb8ec8a214d9edb19addb246e"
...
canonical_url: "https://www.ameresco.com/what-25-years-in-energy-has-taught-me-about-resilience/"
published_at: "2026-06-11T20:48:54+00:00"
first_seen_at: "2026-07-20T23:17:14.272230+00:00"
fetched_at: "2026-07-28T21:11:25.860154+00:00"
content_hash: "sha256:f8c6181a7524f2e179abf722e1722d69c270f58630940c38507da97f40367441"
---

# What 25 Years in Energy Has Taught Me About Resilience
...
Throughout the course of my career, the most successful projects I’ve been a part of have all shared one common trait: they were built to perform


*and* adapt.


Take Ameresco’s work with the


[Joint Forces Training Base Los Alamitos](https://www.ameresco.com/ai-is-changing-everything-is-your-grid-ready/) , for example. The facility is home to a microgrid that is designed to be resilient, built on a combination of solar power, battery storage, and backup generator capacity. During a particular outage caused by a foil balloon, the microgrid detected the loss of grid power instantly and went into ‘islanded mode’ in seconds. When grid power was restored, it smoothly reconnected without any interruption to operations. This example shows how energy systems can be designed to respond to the environment around them in real time, rather than simply waiting to be fixed.


Generally speaking, that design philosophy is more important now than ever. The rapid expansion of AI and data centers is driving electricity demand at a scale our existing grid infrastructure was not built to handle. According to the


[International Energy Agency,](https://www.iea.org/news/global-electricity-demand-is-set-to-grow-strongly-to-2030-underscoring-need-for-investments-in-grids-and-flexibility) global demand is already outpacing grid upgrades, with investments needing to increase by 50% by 2030 to keep pace.
...
What has Ameresco learned about energy resilience over the past 25 years?


Ameresco has learned that energy resilience has evolved from a reactive focus on reliability into a broader framework that includes planning for both known and unknown disruptions. The company emphasizes integrating technical system design with human decision-making to better navigate uncertainty and sustain long-term performance.


How does Ameresco define energy resilience in today’s evolving energy landscape?


Ameresco defines energy resilience as the ability to anticipate, adapt to, and recover from disruptions. This modern definition reflects challenges such as severe weather, aging infrastructure, global volatility, and rapid technological change, requiring more dynamic and forward-looking planning approaches.


What does Nicole Bulgarino say about how resilience has changed in the energy industry?


Nicole Bulgarino explains that resilience has expanded beyond reliability and redundancy to include adaptability and preparation for unknown disruptions. She emphasizes that modern resilience depends on both strong infrastructure and the leadership needed to manage increasingly complex and unpredictable operating environments.


How does Ameresco design resilient and adaptable energy systems?


Ameresco designs energy systems to perform and adapt in real time by integrating technologies such as solar, battery energy storage, and backup generation. This approach enables systems to respond to outages as they occur and supports uninterrupted operations across critical facilities.


What does Ameresco’s Los Alamitos microgrid demonstrate about energy resilience?


Ameresco’s microgrid at Joint Forces Training Base Los Alamitos demonstrates resilience by instantly detecting a grid outage and transitioning to islanded mode within seconds. The system maintained uninterrupted operations and seamlessly reconnected when grid power returned, showcasing real-time system adaptability.


How is rising AI and data center demand shaping Ameresco’s resilience strategy?


Ameresco recognizes that AI and data center growth are accelerating electricity demand beyond existing grid capacity. The company is addressing this challenge by developing resilient, behind-the-meter energy infrastructure that performs without adding strain to a grid already under stress.


Why does Nicole Bulgarino emphasize the human element in energy resilience?


Nicole Bulgarino emphasizes that resilience is about people as much as technology because energy systems support critical services and communities. She highlights that leadership, coordination, and sound decision-making are essential, especially in environments where even brief power disruptions can have serious consequences.


What role do leadership and collaboration play in Ameresco’s approach to resilience?


Ameresco views leadership and collaboration as essential to resilience because energy decisions span engineering, operations, policy, and finance. By aligning cross-functional teams and maintaining consistency under pressure, Ameresco supports stronger decision-making and more effective, system-wide outcomes.


---


*# Originally published on[Linkedin](https://www.linkedin.com/pulse/what-25-years-energy-has-taught-me-resilience-nicole-bulgarino-fkibf/) #*
