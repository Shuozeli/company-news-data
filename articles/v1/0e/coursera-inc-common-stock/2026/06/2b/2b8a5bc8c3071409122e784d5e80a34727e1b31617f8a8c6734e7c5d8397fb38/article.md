...
document_id: "2b8a5bc8c3071409122e784d5e80a34727e1b31617f8a8c6734e7c5d8397fb38"
...
canonical_url: "https://www.coursera.org/enterprise/articles/cybersecurity-skills-gap-non-security-teams-cm"
published_at: "2026-06-25T19:28:01.828+00:00"
first_seen_at: "2026-07-21T15:10:41.343478+00:00"
fetched_at: "2026-07-28T21:42:09.561502+00:00"
content_hash: "sha256:c46520ca61e060782b84ee08fc9a221fb8fd8222e28510e18295091fafa5c3a1"
---
...
Coursera's[Industry Skills Brief 2026](https://www.coursera.org/enterprise/resources/ebook/industry-skills-brief) shows the workforce starting to catch up. The fastest-growing security skills aren't concentrated inside security teams. They're climbing through general IT, data, and developer tracks in every industry the report analyzed.
...
The[Industry Skills Brief 2026](https://www.coursera.org/enterprise/resources/ebook/industry-skills-brief) draws on enrollment data from six million enterprise learners across nearly 7,000 organizations. Across all six industries analyzed, security skills rank among the fastest-growing in general IT, data, and developer learning paths—not just in specialist security training:
...
The security community is reframing the risk to match. “The biggest change I've seen is that security is moving closer to the engineers building AI-enabled applications,” shares[Caroline Wong](https://www.linkedin.com/in/carolinewmwong/) , Chief Strategy Officer at Axari. “The latest[OWASP Top 10 for LLMs](https://owasp.org/www-project-top-10-for-large-language-model-applications/) reflects a shift from concerns about chatbots and prompt injection to concerns about autonomous agents, tool use, supply chain compromise, data poisoning, and AI systems that can take action in the real world. As AI becomes more capable, engineers are increasingly expected to understand not just how to build these systems, but how to build them safely.”
...
*Recommended starting points:*[Introduction to Cybersecurity Essentials](https://www.coursera.org/learn/introduction-to-cybersecurity-essentials) *from IBM and*[Cybersecurity Awareness for Everyone](https://www.coursera.org/specializations/cybersecurityzarenessforeveryone) *from Kennesaw State.*
...
*Recommended starting points:*[Responsible AI for Developers: Privacy and Safety](https://www.coursera.org/learn/responsible-ai-for-developers-privacy-and-safety) *from Google Cloud,*[Privacy Law and Data Protection](https://www.coursera.org/learn/privacy-law-data-protection) *from University of Pennsylvania, and*[Introduction to Security Principles in Cloud Computing](https://www.coursera.org/learn/introduction-to-security-principles-in-cloud-computing) *from Google Cloud.*
...
*Recommended starting point:*[Securing AI and Advanced Topics](https://www.coursera.org/learn/securing-ai-and-advanced-topics) *from Johns Hopkins.*
...
### Industry Skills Brief 2026


See the fastest-growing skills across industries


[Get report](https://www.coursera.org/enterprise/resources/ebook/industry-skills-brief)
