...
document_id: "c08978b12ae978e23b29f5e1e4e7f2821495d9360f09f1b61fecb4329ed58fab"
...
canonical_url: "https://www.salesforce.com/blog/ai-change-management/"
published_at: "2026-02-25T17:51:08+00:00"
first_seen_at: "2026-07-24T00:39:58.007171+00:00"
fetched_at: "2026-07-28T22:03:18.293552+00:00"
content_hash: "sha256:260ab21ec3147d9c67ecd1ce5a76d273cff6e30a691776ffe06fe43f7719e104"
---
...
- AI is transforming change management, so the field is now more about strategic planning than reactive task work.
- Companies can use AI to analyze data, identify skills gaps, and redesign roles faster than ever.
- Employees can tap into round-the-clock training support and answers through AI agents, chatbots, and learning systems.
- AI can predict productivity dips and track sentiment to help companies stay ahead of change challenges.
...
An Amazon Web Services (AWS)[study](https://pages.awscloud.com/rs/112-TZM-766/images/GC-400-GENAI_acc-inn-genai-EN.pdf?version=1) found that, in 2024, only 14% of companies in 2024 had a change management strategy for adopting AI. But that percentage jumped to 54% in 2025, and it’s expected to reach 76% by the end of this year. If you’re struggling to see the ROI of AI, having the right change management strategy in place can help — and AI itself can be a powerful tool to implement that change.
...
Once a company has figured out what skills employees need, it can use AI to help with the upskilling. Many companies already use AI to[create personalized learning paths](https://www.salesforce.com/blog/half-life-of-ai-skills/) . But it can also act as an interactive tutor. The law firm mentioned above, for example, created an AI chatbot to teach paralegals how to do legal research. Whenever a paralegal had a question about how to proceed, they simply asked the chatbot, anytime, day or night.


Likewise, when Salesforce employees have questions about a new tool or a change that’s taking place, they can use[Slackbot](https://slack.com/intl/en-gb/features/slackbot) — Slack’s internal AI agent — or the company’s employee agent. Salesforce’s change management team has trained these agents on knowledge articles and equipped them to answer just as a member of the change management team would. “Now, I don’t have to manage or make sure there’s a system in place for people to get answers because it’s all autonomous and it’s 24/7,” said Sergi. “That’s a huge unlock for change teams and change management in general.”
...
2. **How can AI help with your change management strategy?** **** AI can quickly look at company data and spot problem areas, such as skills gaps. This saves change managers weeks of manual work.
3. **Can AI replace human trainers?** **** No, but it can help 24/7. Employees can ask AI agents and chatbots questions about new tools anytime they want.
4. **How does AI track employee reactions to change?** **** AI can track conversations in public chat channels. It can tell if people are happy or frustrated about changes.
5. **How can AI help change managers predict how a change might unfold?** **** AI can analyze huge amounts of historical data to predict problems that might occur during a change process. It can identify, for example, when productivity might drop or which employees need extra help.
6. **How does AI measure success?** AI can track who is using new tools and completing training. It can also show if people are working more effectively as a result of the changes.


## Use change management to increase AI deployment


Learn strategies and best practices to support organizational change.


[Visit Trail](https://trailhead.salesforce.com/content/learn/modules/change-management-for-ai-implementation)
...
- [High Tech](https://www.salesforce.com/blog/category/high-tech/)
- [AI](https://www.salesforce.com/blog/category/ai/)
- [Employee Experience](https://www.salesforce.com/blog/category/employee-experience-2/)
...
I’m a senior writer for the 360 Blog, where I write about all things AI. I came to Salesforce from LinkedIn, and before that, I was a freelance journalist. My articles have appeared in The New York Times, Sports Illustrated, Vogue, and O, The Oprah Magazine.


[More by Laura](https://www.salesforce.com/blog/author/laura-hilgers/)
