...
document_id: "928678c447ecb3988e44bb3014345fdb2d8853445d74cb9c0b640c7b1681cd73"
...
canonical_url: "https://www.vertiv.com/en-us/about/news-and-events/corporate-news/2020/proliferation-of-hybrid-computing-models-among-2020-data-center-trends-identified-by-vertiv-experts/"
published_at: null
first_seen_at: "2026-07-20T23:21:38.534751+00:00"
fetched_at: "2026-07-28T21:49:03.166047+00:00"
content_hash: "sha256:352f0fb68eec4368a19fb6e4ded6b2cdd1ef73c252c496c6929202f5766d9c8b"
---

# Proliferation of Hybrid Computing Models Among 2020 Data Center Trends Identified by Vertiv Experts

**Columbus, Ohio** \[Jan. 15, 2020\] – As the world charges into 2020, organizations increasingly will forego the enterprise-or-cloud debate that dominated C-level conversations in recent years in favor of hybrid architectures that incorporate public and private cloud models and edge assets around a reconfigured core. This evolving approach to managing data and computing resources is one of five emerging 2020 data center trends identified by experts from[Vertiv](https://www.vertiv.com/en-us/) , a global provider of[IT infrastructure](https://www.vertiv.com/en-us/about/news-and-events/articles/blog-posts/just-how-reliable-is-the-digital-it-infrastructure-that-supports-your-healthcare-system-operations/) and continuity solutions.
...
**Batteries pay it forward** . In[2016, Vertiv experts](https://www.vertiv.com/en-us/about/news-and-events/corporate-news/2016/vertiv-identifies-data-center-infrastructure-trends-for-2017/) predicted lithium-ion batteries would begin to find a home in the data center, and that has proven to be true as lithium-ion today holds a significant share of the UPS battery market. That share is growing and starting to extend to edge sites, where the smaller footprint and reduced maintenance requirements are a natural fit. The next step is leveraging the flexibility of[lithium-ion](https://www.vertiv.com/en-us/about/news-and-events/articles/blog-posts/the-data-center-spotlight-is-shining-on-lithium-ion-batteries-are-they-ready-for-prime-time/) and other emerging battery alternatives, such as thin plate pure lead (TPPL), to offset their costs. As we move into 2020, more organizations will start to sell the stored energy in these batteries back to the utility to help with grid stabilization and peak shaving. Expect this to be an important part of larger conversations around sustainability in the data center industry.


5.


**Global cross-pollination** : The U.S., particularly Silicon Valley, has been the epicenter of the digital universe and this generation of[data center development](https://www.vertiv.com/en-us/about/news-and-events/articles/blog-posts/data-center-2025-how-to-prepare-for-massive-growth-at-the-edge/) , but innovation happens everywhere. A parallel digital ecosystem with notable differences is emerging in China. Data centers across Europe and in other Asian and South Pacific markets, such as Australia, New Zealand and Singapore, are evolving and diverging from traditional practices based on specific regional issues related to data privacy and controls and sustainability. For example, General Data Protection Regulation (GDPR) compliance is driving hard decisions around data management around the world. Those issues, and more vigorous attention to environmental impacts, are leading to new thinking about hybrid architectures and the value of on-premise computing and data storage. In China, some data centers have been running 240V DC power into manufacturer-modified servers to improve efficiency and reduce costs. DC power has long been a theoretical goal for U.S. data centers, and it’s not hard to envision other parts of the world adopting the model being embraced today in China.


Vertiv last month[announced it will become a publicly traded company](https://www.vertiv.com/en-us/about/news-and-events/corporate-news/2019/vertiv-to-list-on-new-york-stock-exchange/) through a merger with GS Acquisition Holdings Corp (NYSE: GSAH, GSAH.U, GSAH WS). The transaction is expected to close in the first quarter of this year, at which point Vertiv’s stock will trade under the ticker symbol NYSE: VRT. For more information on that transaction, the 2020 data center trends or any data center solutions from Vertiv, visit[Vertiv.com](https://www.vertiv.com/en-us/) .
