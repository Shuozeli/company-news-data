...
document_id: "12d072d82ad042d359e7538f07eada3799a6aabe60c59c62464d895bd39c29a3"
...
canonical_url: "https://www.blog.adtran.com/en/training-ai-for-optical-networks-without-compromising-data-sovereignty"
...
content_hash: "sha256:0d404030963b1f801fabe90db90cb4847d340eb741595be6830ecba3bb6bbbcb"
---
...
Federated optical testbeds enable the training of network AI without exposing sensitive data. At OFC, we’re proud to be part of a demonstration of how European-led, data‑sovereign collaboration can accelerate safer AI innovation in transport networks.


-


[Achim Autenrieth](https://www.blog.adtran.com/en/about/achim-autenrieth) March 11, 2026
...
Federated multi‑domain testbed architecture used in the OTDS collaboration


**A European‑driven initiative with international reach**


One of the strengths of this work is the way it combines European research leadership with global collaboration. Fraunhofer HHI and Trinity College Dublin anchor the project within Europe’s optical‑research ecosystem, while NICT contributes cutting‑edge expertise from Japan and Adtran complements this with real data from high-end optical equipment and their digital-twin models.


The approach aligns naturally with Europe’s broader focus on:


- Data sovereignty
- Secure digital infrastructure
- Sustainable, AI‑enabled network evolution


At the same time, it remains open and inclusive, demonstrating how shared innovation can progress across continents without compromising control over critical data assets.


**What’s next: Expanding AI‑ready optical research**


The federated testbed work continues to evolve through several major research programs, including SUSTAINET‑Advance, a European flagship project in which Adtran leads one of the core sub‑projects. As these initiatives progress, they will shape future approaches to AI‑driven optical networking, from digital‑twin modelling to cross‑domain orchestration.


For now, the OFC demonstration offers an accessible look at what’s possible when partners collaborate across borders. Adtran is proud to contribute its technology and expertise to this effort and to support a European‑driven innovation ecosystem with global impact.


This work is being demonstrated live in the[OFC 2026](https://insights.adtran.com/ofc-26?utm_source=technically-speaking&utm_medium=blog&utm_campaign=ofc-26) Demo Zone and at the SUSTAINET booth in the exhibition area, where attendees can see how federated testbeds enable AI training for optical networks without compromising data sovereignty.


- [AI](https://www.blog.adtran.com/tag/ai)
- [Optical Networking](https://www.blog.adtran.com/tag/optical-networking)
