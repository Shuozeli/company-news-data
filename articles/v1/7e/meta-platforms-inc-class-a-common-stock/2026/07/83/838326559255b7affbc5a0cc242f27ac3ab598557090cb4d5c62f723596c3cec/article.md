...
document_id: "838326559255b7affbc5a0cc242f27ac3ab598557090cb4d5c62f723596c3cec"
...
canonical_url: "https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/"
published_at: "2026-07-15T17:00:52+00:00"
first_seen_at: "2026-07-20T04:35:35.936675+00:00"
fetched_at: "2026-07-28T21:50:17.978782+00:00"
content_hash: "sha256:f45d8139de75f4ef887e82b83182f2efd1716d481aa54ae8c73f7f9da759fe29"
---
...
[Andromeda](https://engineering.fb.com/2024/12/02/production-engineering/meta-andromeda-advantage-automation-next-gen-personalized-ads-retrieval-engine/) , and the


[Adaptive Ranking Model](https://engineering.fb.com/2026/03/31/ml-applications/meta-adaptive-ranking-model-bending-the-inference-scaling-curve-to-serve-llm-scale-models-for-ads/) , to advance deep funnel optimization.
...
Hierarchical Interest Representation enriches heterogeneous entities, in particular advertiser and product types, with multimodal content features such as text, images, and video. These features are pulled from structured page metadata and advertiser catalog attributes and processed through vision or language models. This extra information complements existing engagement data. Instead of just knowing


*how users interact* with something, it captures


*what that thing actually is* . Even for entities it hasn’t seen before it understands the underlying businesses and products.


### Unified Relational Representation


Hierarchical Interest Representation learns


*thorough knowledge representation* for users and entities, together with their latent interest primitives representation in a single metric space. It can infer entities’ mutual


*relationship and affinities* across or within types. Using embedding operations, Hierarchical Interest Representation can determine primitive-to-primitive and cluster-to-cluster relationships. It can also estimate user proximity to interest primitives; how closely an ad/advertiser serves certain interest primitives; and what are the similar users, ads, and products that are closest neighbors.
...
*hierarchical* layers for this flexibility, accommodating ranking modeling architecture, personalization, or retrieval applications.
...
*We would like to thank[Sammy Bald](https://engineering.fb.com/?author_name=sammy-bald) ,[Shaoqing Yuan](https://engineering.fb.com/?author_name=shaoqing-yuan) ,[Chuan Hu](https://engineering.fb.com/?author_name=chuan-hu) ,[Chris Hayduk](https://engineering.fb.com/?author_name=chris-hayduk) ,[Wenfan Xu](https://engineering.fb.com/?author_name=wenfan-xu) ,[Liang Xu](https://engineering.fb.com/?author_name=liang-xu) ,[Piyush Dak](https://engineering.fb.com/?author_name=piyush-dak) ,[Ikuhiro Ihara](https://engineering.fb.com/?author_name=ikuhiro-ihara) ,[Ashish Kalbhor](https://engineering.fb.com/?author_name=ashish-kalbhor) ,[Manjari Jha](https://engineering.fb.com/?author_name=manjari-jha) ,[Priya Krishnamurthy](https://engineering.fb.com/?author_name=priya-krishnamurthy) ,[Xulei Liu](https://engineering.fb.com/?author_name=xulei-liu) ,[JC Lyu](https://engineering.fb.com/?author_name=jc-lyu) ,[Yuqi Bi](https://engineering.fb.com/?author_name=yuqi-bi) ,[Vivek Bitla](https://engineering.fb.com/?author_name=vivek-bitla) ,[Krishna Poola](https://engineering.fb.com/?author_name=krishna-poola) ,[Jiayin Ge](https://engineering.fb.com/?author_name=jiayin-ge) ,[Santanu Kolay](https://engineering.fb.com/?author_name=santanu-kolay) ,[Matt Steiner](https://engineering.fb.com/?author_name=matt-steiner) ,[Sandeep Pandey](https://engineering.fb.com/?author_name=sandeep-pandey) ,[Gunjit Singh](https://engineering.fb.com/?author_name=gunjit-singh) ,[Marvin Kim](https://engineering.fb.com/?author_name=marvin-kim) ,[Karan Jindal](https://engineering.fb.com/?author_name=karan-jindal) ,[Krishi Suresh Kumar](https://engineering.fb.com/?author_name=krishi-suresh-kumar) ,[Mehul Parsana](https://engineering.fb.com/?author_name=mehul-parsana) ,[Manveer Kaur](https://engineering.fb.com/?author_name=manveer-kaur) ,[Hua Liu](https://engineering.fb.com/?author_name=hua-liu) and the entire team behind the development and production of the Hierarchical Interest Representation Project.*


### Share this:


- [Share on Facebook (Opens in new window) Facebook](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=facebook)
- [Share on Threads (Opens in new window) Threads](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=threads)
- [Share on WhatsApp (Opens in new window) WhatsApp](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=jetpack-whatsapp)
- [Share on LinkedIn (Opens in new window) LinkedIn](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=linkedin)
- [Share on Reddit (Opens in new window) Reddit](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=reddit)
- [Share on X (Opens in new window) X](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=x)
- [Share on Bluesky (Opens in new window) Bluesky](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=bluesky)
- [Share on Mastodon (Opens in new window) Mastodon](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=mastodon)
- [Share on Hacker News (Opens in new window) Hacker News](https://engineering.fb.com/2026/07/15/ai-research/exploring-hierarchical-interest-representation-for-meta-ads-deep-funnel-optimization/?share=custom-1699562127)
