...
document_id: "0e15b36a07b70e3fdcf9b78b457cd73362b197f9b67924f71bc1dfa4f68bc997"
company_key: "yc-sphere"
company: "Sphere"
source_id: "yc-sphere-news-import-5ec0a2b1b77f"
canonical_url: "https://www.getsphere.com/blog/vat-gst-id"
published_at: "2026-07-15T00:00:00+00:00"
first_seen_at: "2026-07-24T02:30:09.854048+00:00"
fetched_at: "2026-07-28T21:38:32.326002+00:00"
content_hash: "sha256:5cbc25aacbd900d5ec098df3e78ee3d0ba8677d7b98d8ae7ed271b07544e3817"
---

# What Is a VAT/GST ID? Global Tax Guide for SaaS
...
It’s easy for SaaS companies to sell their digital products cross-border. But the need to[comply with VAT or GST](https://www.getsphere.com/blog/do-i-charge-sales-tax-to-international-customers) can be triggered from the very first sale into a new country, even without physical presence.
...
Country Country Code Character Count Format Notes


**Australia** ABN (no standard 2-letter VAT prefix) 11 digits


**Canada** Depends on tax scheme, generally RT 9 digits 9-digit Business Number (BN); 2-letter program identifier code (generally “RT”); 4-digit reference number starting with 0001 to specify different accounts that may be held by a single business


**France** FR 13 characters FR + 2-character alphanumeric key (can include letters, except O or I) + 9-digit SIREN number


**Germany** DE 9 digits


**Great Britain** GB 9 digits


**Ireland** IE 8 or 9 characters


**India** IN 15 characters Goods and Services Tax ID Number (GSTIN) includes 2-digit state code + 10-character PAN + 1 entity number digit + 1 default “Z”


**Japan** JP 13 digits


**New Zealand** NZ (no standard VAT prefix) 8 or 9 digits


**Norway** NO 12 characters 9-digit Organisasjonsnummer + suffix “MVA”


**Switzerland** CHE 15–16 characters CHE + 9 digits + language-specific VAT suffix: MWST (German), TVA (French), or IVA (Italian). Formatted with punctuation (e.g., CHE-123.456.789 MWST)


**United States** No country code 9 digits Employer Identification Number (EIN)


‍


You must have a tax ID number before collecting taxes in each jurisdiction where you are legally obligated or voluntarily comply. For example, your California sales tax ID won’t suffice as a tax ID when selling into the EU.
...
## Does the US have a VAT/GST ID?


No. Rather than a nationwide sales tax system, the US allows every state to levy its own sales tax. Because of this, there is no national equivalent to a sales tax ID. That said, sometimes foreign partners or governments wil require some type of federal ID from US-based businesses. In that case, they’re often looking for the Employer Identification Number (EIN), which is used by the US’s Internal Revenue Service (IRS) to differentiate businesses. But they may also require other business identification, such as a certificate of incorporation, so be sure to follow each government’s instructions.
...
[SaaS](https://www.getsphere.com/blog/are-subscriptions-taxable) and AI businesses should keep a close eye on both sales location and volume.
...
## Need help determining when you become liable to register for VAT or GST?


Sphere has your back! Schedule a demo with Sphere today.
...
- **United Kingdom** -[HMRC Online Services](https://www.gov.uk/register-for-vat) portal
- **Australia** -[Australian Tax office (ATO)](https://www.ato.gov.au/businesses-and-organisations/preparing-lodging-and-paying)
- **European Union** -[VAT One Stop Shop](https://vat-one-stop-shop.ec.europa.eu/index_en)
- **Canada** -[Canada Revenue Agency](https://www.canada.ca/en/revenue-agency/services/tax/businesses/topics/gst-hst-businesses/account-register.html)
...
When making a purchase from a foreign supplier who is not required to register for VAT/GST in your country, they may apply the “[reverse charge mechanism](https://www.getsphere.com/blog/reverse-charge-vat) .” In this case, they’ll send an invoice stating that reverse charge applies. On your end, rather than paying the tax to your supplier, you’ll keep track of the VAT/GST you should have paid on the transaction and include it with your tax return. This process facilitates doing business cross-border with non-registered companies.
...
Taxing authorities have little patience with companies who “didn’t realize” they had to register and collect VAT or GST. We recommend using[automatic threshold tracking](https://www.getsphere.com/blog/ai-tools-for-tax-professionals) , like Sphere, to let you know when you become liable to register. They’ll even automatically register for you!
...
[Book a Call](https://calendly.com/d/csk5-khg-5jg)
...
How do you validate a VAT number? The EU’s VAT Information Exchange System (VIES) allows you to enter your customer’s VAT number and check its validity. But it’s important to note that the VIES system isn’t perfect, so each member state generally has their own validation service.[Sphere](https://www.getsphere.com/) checks both VIES and the member state’s database in order to obtain accurate validation.
