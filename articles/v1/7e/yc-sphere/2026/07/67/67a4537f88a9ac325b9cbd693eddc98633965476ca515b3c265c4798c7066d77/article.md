...
document_id: "67a4537f88a9ac325b9cbd693eddc98633965476ca515b3c265c4798c7066d77"
company_key: "yc-sphere"
company: "Sphere"
source_id: "yc-sphere-news-import-5ec0a2b1b77f"
canonical_url: "https://www.getsphere.com/blog/missouri-sales-tax"
published_at: "2026-07-16T00:00:00+00:00"
first_seen_at: "2026-07-24T02:30:09.854048+00:00"
fetched_at: "2026-07-28T21:21:05.434568+00:00"
content_hash: "sha256:1e5d20fc523c179ad485d1ec342abbfc7a9a67efb64d53f84efa076e60079550"
---

# Missouri Sales Tax: Rates, Rules & Filing Guide

Missouri Sales Tax Quick Facts
...
**Tax portal**[MyTax Missouri](https://mytax.mo.gov/rptp/portal/home)
...
This means rates change block by block, not just city by city. You may be tempted to calculate sales tax based on zip code, but zip codes often span multiple taxing jurisdictions. Because of this, you’ll need to determine sales tax rates based on your buyer’s exact address. The[Missouri Department of Revenue's Sales and Use Tax Lookup](https://missouri.atr.avalara.com/) tool gives you the precise combined rate for any address in the state, and it's the only reliable way to confirm what you owe.
...
[SaaS](https://www.getsphere.com/blog/are-subscriptions-taxable) is not considered taxable by the state of Missouri. Neither is software delivered electronically or most digital goods and services. This applies whether you're selling to another business or directly to a consumer.


However, if prewritten software is delivered on physical media such as a disc or flash drive, then it’s considered tangible personal property and becomes taxable. Also be cautious if you bundle[SaaS](https://www.getsphere.com/blog/sales-tax-software) with a physical component such as a paper user manual or tangible device. In this case, the taxability can depend on exactly how the sales is structured. We recommend checking with the Missouri Department of Revenue if you are unsure how your bundled sale should be taxed.
...
[Sphere](https://www.getsphere.com/) monitors your sales activity across states automatically and flags you before you cross a nexus threshold, so you're never caught off guard by a surprise registration requirement.


### Physical Nexus


Any physical presence in Missouri creates[sales tax nexus](https://www.getsphere.com/blog/nexus-tax-software) , regardless of how much revenue you generate. This includes having employees, an office, or inventory stored in the state, even temporarily.
...
[Sphere](https://www.getsphere.com/) handles the entire Form 2643 registration process for you, including setting up your account in the Missouri DOR portal, so you don't have to navigate the paperwork yourself.
...
## Remittance: How to Pay Missouri Sales Tax
...
If your business doesn't have a US bank account, that shouldn't stop you from staying compliant.[Sphere's](https://www.getsphere.com/) embedded remittance platform handles payment on your behalf, so you can remit Missouri sales tax without needing to open a local account.
...
- Manages[exemption certificate](https://www.getsphere.com/blog/exemption-certificate-management) collection and storage for Missouri B2B transactions
