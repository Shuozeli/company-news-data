...
document_id: "f6f5e56587398b0700760494f8480bf5ff3a79f7bba61cc51ca0974bb3964f95"
company_key: "yc-sphere"
company: "Sphere"
source_id: "yc-sphere-news-import-5ec0a2b1b77f"
canonical_url: "https://www.getsphere.com/blog/minnesota-sales-tax"
published_at: "2026-07-22T00:00:00+00:00"
first_seen_at: "2026-07-24T02:30:09.854048+00:00"
fetched_at: "2026-07-28T21:20:58.380206+00:00"
content_hash: "sha256:622228ea38a9a1ccb398061331d811c41bcaf24b85a74d02c17d9053be9853e2"
---

# Minnesota Sales Tax: Rates, Rules & Compliance Guide

Minnesota Sales Tax Quick Facts


**Minnesota sales tax rate** 6.875%


**Max combined state and local sales tax rate** 9.875%


**Economic nexus threshold** $100,000 in retail sales or 200 or more retail transactions, including marketplace sales, in the twelve-month period ending on the last day of the most recently completed calendar quarter


**What sales count toward the threshold** Retail sales, marketplace sales


**Tax authority**[Minnesota Department of Revenue](https://www.revenue.state.mn.us/)


**Tax portal**[MN e-Services](https://www.mndor.state.mn.us/tp/eservices/_/)
...
To find the right rate to charge, use the[Minnesota Sales Tax Rate Calculator](https://www.revenue.state.mn.us/sales-tax-rate-calculator) . But note that this calculator only returns the state and local rates. If your transaction is also subject to special taxes such as admissions, entertainment, liquor or lodging, you’ll need to check the state’s[Local Sales Tax Information](https://www.revenue.state.mn.us/local-sales-tax-information) page.


Sales tax in Minnesota is administered through[Minnesota e-Services](http://mndor.state.mn.us/tp/eservices) . There you’ll register for your sales tax permit, file your returns, and pay by the due date.
...
[SaaS](https://www.getsphere.com/blog/are-subscriptions-taxable) is generally not taxable in Minnesota. If your customers subscribe to remotely hosted software and never download or take possession of a copy, the state considers that a nontaxable service. This applies to both B2B and B2C SaaS sales.
...
If you sell both[SaaS](https://www.getsphere.com/blog/sales-tax-software) (hosted by you, your customer never downloads or takes possession of a copy) and digital products (downloadable, your customer takes possession of a copy) be sure you’re applying Minnesota sales tax correctly to each transaction.


[Sphere's](https://www.getsphere.com/) tax engine classifies Minnesota software and digital product transactions automatically and applies the correct rate, so you're not making these calls manually.
...
You’re required to collect Minnesota sales tax once you establish[sales tax nexus](https://www.getsphere.com/blog/nexus-tax-software) in the state. Here’s how that happens.
...
Go to[Minnesota e-Services](https://www.mndor.state.mn.us/tp/eservices/_/) and register for a Minnesota Tax ID Number with a Sales and Use Tax account. You'll provide your legal business name, entity type, address, and expected sales volume.
...
If you’d rather not deal with this administrative hassle,[Sphere](https://www.getsphere.com/) manages the full Minnesota sales tax registration process for you.
...
**Annual** Less than $100/month February 5 of the following year


**Quarterly** $100–$500/month April 20, July 20, October 20, January 20


**Monthly** More than $500/month 20th of the following month
...
Automate your sales tax filing and payments with[Sphere](https://www.getsphere.com/) so you never miss a due date or owe a penalty.


## Ready to automate Minnesota sales tax compliance?
...
No US bank account? The state of Minnesota won’t accept a foreign ACH payment directly. But there’s a solution.[Sphere's](https://www.getsphere.com/) embedded remittance platform handles the payment on your behalf, no local bank account required. Your Minnesota liability gets paid on time, and you skip the headache of opening a US account just to remit sales tax.
...
- [Exemption certificates](https://www.getsphere.com/blog/exemption-certificate-management) **:** Sphere collects, validates, and stores Form ST3 exemption certificates for your Minnesota B2B transactions, so exempt sales hold up under audit.
