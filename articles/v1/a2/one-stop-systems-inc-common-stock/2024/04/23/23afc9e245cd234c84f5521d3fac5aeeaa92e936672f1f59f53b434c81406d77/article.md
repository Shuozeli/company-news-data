...
document_id: "23afc9e245cd234c84f5521d3fac5aeeaa92e936672f1f59f53b434c81406d77"
...
Clients that have Industrial Edge and Embedded Edge applications which need the accelerated computing capabilities found in Provider Edge and Enterprise Edge come to OSS to solve their needs. Examples of this include One Stop System’s proven ability to design and manufacture reliable, rugged HPC systems for anything from[multi-GPU computing](https://onestopsystems.com/products/rigel) in an airplane, to dense[removable storage platforms](https://onestopsystems.com/products/centauri-storage-expansion?_pos=1&_sid=91e03e09b&_ss=r) that are mounted to the side of moving trucks, to disaggregated[GPU and PCIe networked architecture](https://cdn.shopify.com/s/files/1/0286/3140/0483/files/Cernis_Donati_Datasheet.pdf?v=1711058602) on military vehicles, and providing all-in-one, liquid-cooled GPU and storage[hyperconverged servers](https://onestopsystems.com/products/pcie-gen-5-3u-short-depth-server)


inside the cabin of an unmanned watercraft. As such, One Stop Systems has claimed leadership in the Edge Computing industry by defining our own niche brand of Edge Computing (remember “ *AI on the Fly* ”, and “ *AI Transportables* ”).
