...
document_id: "67a6b8bb084c1c9201eb3ea76c90ff35615fbcb9799fb8d1594a14cb1fea8193"
company_key: "yc-combinehealth"
company: "CombineHealth"
source_id: "yc-combinehealth-news-import-bb91426d417b"
canonical_url: "https://www.combinehealth.ai/blog/medical-coding-automation"
published_at: "2026-07-27T18:30:00+00:00"
first_seen_at: "2026-07-28T13:05:30.518447+00:00"
fetched_at: "2026-07-28T21:33:52.463534+00:00"
content_hash: "sha256:52b92fe6b062512b57731cde1e7863eff01adf33816974327b3a809bfe171c10"
---
...
Medical coding gets more complex every year. On January 1, 2026,[418 changes to the CPT code set took effect](https://www.ama-assn.org/press-center/ama-press-releases/ama-releases-cpt-2026-code-set) : 288 new codes, 84 deletions, and 46 revisions.
...
>
>
> CombineHealth's medical coding automation software, Amy, codes charts as they arrive, with reviewable rationale and a full audit trail behind every decision.[Book a Demo](https://www.combinehealth.ai/demo)
...
An automated medical coding software **does the work a human coder would typically do manuall** y: read the chart, decide which codes the documentation supports, check them against payer rules, and pass the claim to billing.
...
> **Recommended reading:**[Autonomous Medical Coding Guide](https://www.combinehealth.ai/blog/autonomous-medical-coding-guide)
...
> **Recommended reading:**[Clinical Documentation Improvement Software](https://www.combinehealth.ai/blog/clinical-documentation-improvement-software)


### Defends Every Code With the Documentation Behind It


A complete audit trail **records the original recommendation, the confidence score (of AI), every reviewer action, the reason for each override, and the chart's version history** . With that, explaining a coding pattern to an auditor is incredibly easier. This completely depends on[whether the medical coding automation software has explainable AI](https://www.combinehealth.ai/blog/explainability-in-ai-for-healthcare-rcm) .
...
It then evaluates the number and complexity of problems addressed, the amount and complexity of data reviewed, and the level of risk associated with patient management. Together, these three elements determine the level of[medical decision-making (MDM)](https://www.combinehealth.ai/blog/medical-decision-making-in-healthcare) , which drives E/M code selection.
...
For[ICD-10](https://www.combinehealth.ai/blog/icd-10-explained-a-comprehensive-guide-to-medical-coding) , medical coding automation software **reads the record and assigns the most specific diagnosis the documentation supports** . The hard part is not finding the code—it is that specificity has a ceiling set by the note.
...
Automation **identifies the procedures performed and reports them in the right order and combination** .[CPT coding](https://www.combinehealth.ai/blog/cpt-codes-what-are-they-types-and-uses) gets difficult on multi-procedure encounters, where bundling rules determine which services report separately and which are already included in another code.
...
Medical coding automation **assigns**[E/M coding](https://www.combinehealth.ai/blog/e-m-coding-guide) **a level based on medical decision-making or total time** . This is the hardest of the five code sets to automate cleanly, because **leveling is a judgment call and two credentialed coders can reach different defensible answers** on the same chart.
...
[Modifiers](https://www.combinehealth.ai/blog/modifiers-in-medical-billing) tell the payer that something about a service differs from the default. Medical coding automation **reads the note for those circumstances and appends the modifier the documentation supports** . It handles the rules-based ones reliably and gets less certain where payers read the same modifier differently.
...
If the modifier is left off, the payer folds the visit into the procedure and pays for the injection alone. Modifier errors like this sit among the more[common claim denial codes](https://www.combinehealth.ai/blog/common-claim-denial-codes) in coding.
...
Tracking these alongside your existing[revenue cycle management metrics](https://www.combinehealth.ai/blog/revenue-cycle-management-metrics) keeps the comparison honest, since coding is only one of several inputs to[A/R days](https://www.combinehealth.ai/blog/accounts-receivable-days-in-medical-billing) .
...
This matters because regulators are paying closer attention to AI-generated coding. In February 2026,[HHS-OIG updated its Medicare Advantage compliance guidance](https://oig.hhs.gov/compliance/ma-icpg/) for the first time in 27 years.
...
>
>
> Read the full[10-point checklist to evaluate any AI medical coding platform](https://www.combinehealth.ai/blog/evaluating-ai-medical-coding-software) properly, or compare options in[Top 10 AI Medical Coding Software](https://www.combinehealth.ai/blog/evaluating-ai-medical-coding-software) .
...
CombineHealth's Amy, an[AI medical coding solution](https://www.combinehealth.ai/ai-medical-coding-software) , **reads the full chart and assigns ICD-10, CPT, HCPCS, E/M, and modifier codes** in one pass. Each code carries its rationale, the guideline behind it, and the passage of documentation supporting it.
...
[Book a Demo](https://www.combinehealth.ai/demo) , and we will show you which encounters Amy codes on her own, which ones come back to your coders, and the reasoning behind every code!
