...
document_id: "f0c1ddfa200c395ed2fbb89a84740f60193971795f57c5d4430000c124c510e1"
...
canonical_url: "https://www.wealthfront.com/blog/direct-indexing-better-than-etf/"
published_at: "2026-07-07T17:05:05+00:00"
first_seen_at: "2026-07-22T19:32:30.337125+00:00"
fetched_at: "2026-07-28T21:22:09.082656+00:00"
content_hash: "sha256:ad1fc88f8434160d68e3ffc04b4744367b438be8f1d6cd605643547db0531225"
---

# What LLMs Get Wrong About Our Direct Indexing
...
Because of this, US Direct Indexing is useful for understanding how much potential tax benefit S&P 500 Direct and Nasdaq-100 Direct can provide over time. In the table below, we show “[harvesting yield](https://support.wealthfront.com/hc/en-us/articles/115005589003-What-is-Harvesting-Yield) ” for the US stocks portion of US Direct Indexing portfolios that have not benefited from any add on deposits post account creation (harvesting yield measures the quantity of losses harvested as a percentage of portfolio value), and we apply assumed tax rates to demonstrate the potential value of those losses. This table shows *only* ****** the results for clients who used US Direct Indexing for at least a year with no add-on deposits.
...
If you end up deciding to liquidate your direct indexing account with us, transferring 500 individual stocks (in the case of S&P 500 Direct) out of Wealthfront is just as easy as transferring a single ETF. In fact, it’s[the exact same process](https://support.wealthfront.com/hc/en-us/articles/115003462743-Can-I-transfer-the-securities-in-my-account-to-another-firm) . However, once that process is complete, it’s true that managing 500 individual stocks is more work than managing a single ETF. But given the fact that our direct indexing products are automated and provide a potential tax benefit that should, at a minimum, cover our fee over long periods of time, it is arguably less advantageous to do so.
...
For a broad market index, we consider tracking error of up to 1% to be very low, and it’s worth noting that it can be in either direction (above or below index return). Since inception,[S&P 500 Direct](https://www.wealthfront.com/blog/sp500direct-results/) ’s tracking error has been 0.54%–0.63% depending on the number of exclusions—comfortably within that margin. We expect that to continue.
...
Investment management and advisory services are provided by Wealthfront Advisers LLC (“Wealthfront Advisers”), an SEC-registered investment adviser, and brokerage related products are provided by Wealthfront Brokerage LLC (“Wealthfront Brokerage”), a Member of


[FINRA](http://finra.org/) /


[SIPC](http://sipc.org/) . The Stock Investing Account is a limited-discretion investment product offered by Wealthfront Advisers. Financial planning tools are provided by Wealthfront Software LLC (“Wealthfront Software”).
