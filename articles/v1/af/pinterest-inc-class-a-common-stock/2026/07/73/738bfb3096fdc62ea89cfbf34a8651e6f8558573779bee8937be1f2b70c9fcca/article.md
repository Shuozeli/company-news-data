...
document_id: "738bfb3096fdc62ea89cfbf34a8651e6f8558573779bee8937be1f2b70c9fcca"
...
### When Engagement Optimization Is Not Enough
...
### User Interest Clusters: A Stateful Interest Representation


### From PinnerSage/OmniSage to UICs
...
Left: Purely sequential information misses the nuances of why the same Pin might mean *very* different things to different users…. | Right: …while clustered representations provide enriched context that differentiates Pins based on how they’re used rather than what they *are* .
...
Note: we fetch from GSS once. UIC features are attached to the User UFR node and can be accessed by any Home feed processing stage.
...
[Pinner Progression: Better Use-Case Representation Driving Weekly Active User Growth at Pinterest](https://medium.com/pinterest-engineering/pinner-progression-better-use-case-representation-driving-weekly-active-user-growth-at-pinterest-bd2131ab238a) was originally published in[Pinterest Engineering Blog](https://medium.com/pinterest-engineering) on Medium, where people are continuing the conversation by highlighting and responding to this story.
