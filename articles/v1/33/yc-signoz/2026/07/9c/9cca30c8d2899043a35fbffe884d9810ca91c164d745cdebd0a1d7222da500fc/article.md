...
document_id: "9cca30c8d2899043a35fbffe884d9810ca91c164d745cdebd0a1d7222da500fc"
company_key: "yc-signoz"
company: "SigNoz"
source_id: "yc-signoz-rss-564a62b873f8"
canonical_url: "https://signoz.io/blog/opentelemetry-nextjs-logging"
published_at: "2026-07-08T00:00:00+00:00"
first_seen_at: "2026-07-20T23:20:42.602972+00:00"
fetched_at: "2026-07-28T21:08:44.176891+00:00"
content_hash: "sha256:709486f0023050752ac4a81325501489b73e289c49bbbf10acfd392ed32baf2d"
---
...
[OpenTelemetry NextJS Tutorial](https://signoz.io/blog/opentelemetry-nextjs/) Part 4 of 5
...
If you haven’t instrumented tracing yet, please follow the first guide in this series, “[Monitor NextJS with OpenTelemetry](https://signoz.io/blog/opentelemetry-nextjs/) ,” and then come back.
...
- **Runtime Guard:** The` if (process.env.NEXT_RUNTIME === 'nodejs')` check is essential. It ensures our Node.js-based log exporter is only initialized for server-side executions (like page renders and server actions) and is *not* bundled for the browser or Edge runtimes.
...
**` createLoggerProvider` function:** This is the main setup.
...
**` initializeLogsExporter` function:** This function is called by` instrumentation.ts` . It creates the provider, sets it as the *global* logger provider, and uses an` isInitialized` flag to prevent running twice.


3.


**` exportLogEntry` function:** This is the function our application logger will call. It:
...
While sending logs to SigNoz is great, you *also* want to see structured, human-readable logs in your console during local development.[Pino](https://github.com/pinojs/pino) is a popular, high-performance logger for Node.js. This optional step creates a Pino-based logger that *also* injects trace context.
...
1. **` serverLogAction` :** This is a Next.js[Server Action](https://www.google.com/search?q=https://nextjs.org/docs/app/building-your-application/routing/server-actions) . When the form is submitted, this function runs *on the server* . We use our` logger` to emit` info` and` error` logs. These logs will be sent *directly* from the server to the OTLP collector, complete with trace context.
...
[Next in "OpenTelemetry NextJS Tutorial" (Part 5 of 5) Deploying and Scaling OpenTelemetry in Production NextJS Apps](https://signoz.io/blog/opentelemetry-nextjs-production/)[Previous](https://signoz.io/blog/opentelemetry-nextjs-web-vitals/)[View Full Series](https://signoz.io/blog/opentelemetry-nextjs/)
