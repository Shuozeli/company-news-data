...
document_id: "073e66bb77d32a34ea96aa139d216b80bb7f4a402e42a76eb6a8d0e362dfbb77"
company_key: "yc-staffbar"
company: "Superwall"
source_id: "yc-staffbar-rss-5f8991137f5c"
canonical_url: "https://superwall.com/blog/growth-sessions-transaction-abandon-recap"
published_at: "2025-09-04T18:28:35.248+00:00"
first_seen_at: "2026-07-20T23:20:38.930038+00:00"
fetched_at: "2026-07-28T21:08:32.413121+00:00"
content_hash: "sha256:ef05598df2d1d1dd315c56eb902add8695c42acf240db0a1c7416ad42ed68018"
---

# Growth Sessions: Transaction Abandon Recap

Our recent Superwall Growth Session on[transaction abandon campaigns](https://superwall.com/docs/dashboard/guides/tips-abandoned-transaction-paywall) was packed full of great tips, questions, and paywall advice. If you weren't able to make it, no worries, I've got it all recapped for you here.


Also, be sure not to miss our next Superwall Growth Session too, you can see all of our events coming up right[here](https://luma.com/superwallHQ?k=c) .


🎥[YouTube Recording](https://youtu.be/w7fzW9UcYc4) 📓[Slides](https://www.figma.com/deck/rwbt8K6pKYmXORC5dDfxu5/Increasing-Revenue-with-Transaction-Abandon-Campaigns?node-id=2-1063&t=mFF7o2GcPazQ6O8D-1&scaling=min-zoom&content-scaling=fixed&page-id=0%3A1)
...
- [Quick Start](https://superwall.com/docs/dashboard/guides/tips-abandoned-transaction-paywall)
- [Case Study](https://superwall.com/blog/17-revenue-boost-with-transaction-abandon-paywalls-a-case-study)
- [Technical Docs](https://superwall.com/docs/android/guides/3rd-party-analytics/tracking-analytics#superwall-events)
...
What is a transaction abandon campaign in Superwall? When a user exits the platform's native payment sheet after it appears to purchase a product, Superwall records a transaction abandoned event. Using the built-in placement for this, you can trigger a different paywall—most commonly one showing a discounted product—to appear when that happens. That's a transaction abandon campaign.


What percent of users typically convert with an abandonment offer on first use? It typically ranges from 5–22% of users who enter that campaign. As always, test different transaction abandon setups to find what works for your app.


When does the transaction abandon paywall show—after dismissing the payment sheet or on next app open? It occurs when the user taps the X on the platform's native payment sheet, not on a later app open.


How do I measure results so I don't give discounts to users who would have paid full price? Create a campaign that shows a discount offer versus a paywall at the same price but with different messaging and design, then compare the two to see if pricing is the sticking point. You can also segment with user seeds and associate those cohorts with revenue.


How should freemium apps think about transaction abandonment? Look at how many conversions come from post-onboarding flows. If most conversions come from regular placements, a transaction abandon campaign may not make sense in onboarding. Since people usually abandon due to price uncertainty or unclear messaging—and freemium already gives a lot away for free—consider testing a hard paywall first to quickly validate demand before moving to freemium.
