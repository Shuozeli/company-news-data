...
> We started to work together in April. They had like a 1.1% install-to-paid rate. From April to September, we got it from 1.1% to close to 4%.
>
>
> — Vahe Baghdasaryan
...
As always, if you're ready to test your paywall, run price tests and more for your app, then you're already in the right spot.[Sign up for a free Superwall account today!](https://superwall.com/sign-up)


## FAQ


What is a multi-step paywall and why does it convert better? A multi-step paywall guides users through the value proposition across several screens instead of one all-encompassing offer. By breaking information into digestible steps and reinforcing the free trial five to seven times, it reduces anxiety and can boost trial start rates by 20-40%. Vahe's Claim app reached a 34% trial start rate, more than double the 15% benchmark.


How does a trial toggle on the paywall increase revenue? A trial toggle lets users choose between a free trial and an immediate discounted purchase. About 10% of users opt to skip the trial and pay upfront at a roughly 30% discount, which captures the same revenue per user (since a good trial-to-paid rate is around 30%) while generating immediate cash that improves payback period for paid acquisition.


Why use a spin wheel for discount offers? A spin wheel gamifies the discount reveal, a tactic borrowed from e-commerce. Instead of showing a static '80% off' message, users spin a wheel that lands on a discount and tap to claim it. Feeling like they earned the reward increases follow-through, and Vahe reports double-digit conversion increases over static displays.


How much can fixing a paywall improve install-to-paid rate? Vahe took an entertainment app from a 1.1% install-to-paid rate in April to close to 4% by September—nearly a 4x increase—without spending any additional money on user acquisition or changing the product. The gains came entirely from optimizing the onboarding and paywall experience.
