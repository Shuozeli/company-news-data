...
document_id: "0a41745bc238ed5048de2f757e655b2ebb0a3f7fb2e03013aac8d71f772ac358"
...
canonical_url: "https://blog.championsoncology.com/blog/clinically-relevant-3d-tumor-models-for-her2-targeted-adc-development"
published_at: null
first_seen_at: "2026-07-21T13:12:49.975749+00:00"
fetched_at: "2026-07-28T21:21:00.620727+00:00"
content_hash: "sha256:6f5e3297ce6cbb08b1923c8db81fc342d362903b4c2eb76445a23f34b84915de"
---
...
FDA approved HER2-targeted ADCs trastuzumab emtansine (T-DM1, Kadcyla®) and trastuzumab deruxtecan (T-DXd, Enhertu®). Figure adapted from Joubert et al1.
...
Workflow overview to evaluate HER2-targeted ADCs using breast cancer PDXO models.
...
HER2 expression assessed by IHC and flow cytometry analysis. A) HER2-positive PDXO and B) HER2-negative PDXO model.
...
Representative dose-response curves (IC₅₀). A) HER2-positive PDXO model comparing exatecan (payload) and trastuzumab deruxtecan (T-DXd) and B) control naked antibody trastuzumab and isotype-payload conjugate IgG-DXd.


Across HER2-positive breast cancer PDXO models and control cell lines, ADCs demonstrated greater efficacy and specificity compared with naked antibody and isotype-payload controls (Figure 4, and data not shown). Full datasets across additional PDXO models are presented in the accompanying[AACR 2025 poster](https://www.championsoncology.com/2025aacr-her2-positive-patient-derived-xenograft-organoids-pdxos-as-a-novel-preclinical-tool-to-evaluate-new-therapies-against-her2-driven-cancers) . These results highlight the utility of PDXO models derived from Champions’ CTG-3D platform for evaluating next-generation ADCs and discriminating between payload-driven cytotoxicity, nonspecific conjugate effects, and HER2-targeted ADC activity.
...
Normalized ∆AUC. The response difference between isotypes and ADCs is calculated as: \[AUC of Isotype\] – \[AUC of ADC\] / \[AUC of Isotype \] x 100%
...
**To explore the full datasets in more detail, download the full poster presented at AACR 2025 here.**


### References


1. Joubert, Nicolas, Alain Beck, Charles Dumontet, and Caroline Denevault-Sabourin. 2020. “Antibody-Drug Conjugates: The Last Decade.” *Pharmaceuticals (Basel, Switzerland)* 13 (9).[https://doi.org/10.3390/ph13090245](https://doi.org/10.3390/ph13090245) .
