...
document_id: "0fa6ca497643d334aeda572878b0fcab1788894744b6b059c6abbb140edddb10"
...
canonical_url: "https://www.guidewire.com/resources/blog/partner-perspective/take-digital-first-approach-enhance-customer-experience"
...
content_hash: "sha256:544afa8908f18e3af8912691d8c8fd7d1b21a4727ff798dfa3ba137c79c600b7"
---
...
When today’s customers interact with their insurance carriers, for example, they expect ease and efficiency. And while the agent relationship will always be an important aspect of the value chain, for the first time in more than 20 years, a[JD Power survey](https://www.propertycasualty360.com/2020/08/31/handling-cat-claims-in-a-covid-19-world/?slreturn=20200802100500) found that digital-first interactions positively impacted customer engagement and retention more than agent interactions.


The only way insurers can achieve this level of change at scale is to invest in digital transformation initiatives. As partners,[Smart Communications](https://www.smartcommunications.com/) and Guidewire have helped more than 85 carriers do just this – building out the necessary strategies and technologies to respond to customers’ ever-changing needs. In fact, Smart Communications is the only Customer Communications Management provider that Guidewire resells directly. This shared history provides unique insight into how brands can reimagine customer engagement and achieve success.
...
An integrated technology stack allows insurers to glean the most insight about their customers, which is necessary to create meaningful and tailored experiences. Recently,[Forrester](https://www.forrester.com/report/The+State+Of+Digital+Experience+Delivery+2017/-/E-RES137495#:~:text=In%20Q1%202017%2C%20Forrester%20surveyed,struggling%20to%20optimize%20past%20investments.) identified “ease of integration” and interoperability as the most important purchase criteria for today’s digital buyers. Siloed solutions not only create a disjointed customer experience, but also limit the ability of internal resources to have a 360-degree view of the customer. Using plug-and-play accelerators (such as those available on the[Guidewire Marketplace](https://marketplace.guidewire.com/) or the[Smart Communications Conversation Cloud Marketplace](https://www.smartcommunications.com/products/conversation-cloud-framework/) ), systems can ‘talk’ to each other and trigger faster responses – providing insight into both inbound and outbound communications to enable insurers to set themselves apart from the competition.
...
Find out more about how Smart Communications can complement an existing investment in Guidewire InsuranceSuite:[www.smartcommunications.com/guidewire](http://www.smartcommunications.com/guidewire) . Check out Smart Communications’ solution available on the[Guidewire Marketplace](https://marketplace.guidewire.com/ccrz__Products?cartID=&operation=quickSearch&searchText=Smart%20Communications&portalUser=&store=&cclcl=en_US) and download the Guidewire eBook[Building an Ecosystem to Improve the Customer Experience](https://explore.guidewire.com/marketplace/ecosystem-ebook?utm_campaign=2020-08-blog&utm_source=website&utm_medium=web-site&utm_content=marketplace-ecosystem-ebook) *.*
