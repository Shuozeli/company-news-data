...
document_id: "b5439d0f9e428b215bfbb36d7cd075e71ea05798d258e7b74f2b855b1326e9d7"
...
canonical_url: "https://www.guidewire.com/resources/blog/technology/claims-automation-made-cool-you-can-help"
...
content_hash: "sha256:e148d12b7c5cf91c712e0cc2f2c396fcfa0495c751820979b95393f93568c354"
---

# Claims Automation Made Cool – You Can Help
...
You also need decision-making expertise. Every step in the process is a transition that requires some logic or rules to decide the next action. These can be simple rules looking for the presence of data, rules driven by analytics, or even passing to a claims handler when something novel needs a decision. You can learn more about this by watching Reshma Mani’s[Guidewire Claims Autopilot Deep-Dive](https://explore.guidewire.com/c/autopilot-deep-dive?x=U_gOJN) session (Guidewire Connections, November 2021) and/or reading our[5 Essentials for Delivering a Modern Claims Experience](https://assets.ctfassets.net/vdinc3339dpx/1kM0YFmfLUEXSFFO1fZM5P/43f120658279682dcdc45fbeb22883fd/5_Essentials_for_Delivering_a_Modern_Claims_Experience_-_eBook.pdf) e-book.


"But wait!" I hear you say. "That process engine needs to interact with the core system!" Fortunately, the Guidewire Application Events Service, described in architect Mark Bolger's[blog post](https://medium.com/guidewire-engineering-blog/guidewire-application-events-service-d1b0bee685b3) , makes it easy for Claims Autopilot to respond to events occurring in[ClaimCenter](https://www.guidewire.com/products/core-products/insurancesuite/claimcenter-claims-management-software) and just as easily take action in ClaimCenter through its[Cloud APIs](https://docs.guidewire.com/cloud/cc/202111/apiref/) , which are described (along with Guidewire's comprehensive approach to integration) in Chris Vavra's blog post “[Cloud Integration Framework: The Right Tools for the Job](https://www.guidewire.com/blog/technology/cloud-integration-framework-the-right-tools-for-the-job/) .”


**How You Can Help**


However, we all know that there are nuances to every claims process. In Australia, there are not only the typical issues of automating lodgement, assessment decisions, settling, or paying and closing a claim. You also need to overlay the requirements of the General Insurance Code of Practice, which is where the feedback we receive from the industry can help us localise claims automation with the requirements of the code of practice in Australia. Again, we’d appreciate your help with this by completing our[screening survey](https://www.surveymonkey.co.uk/r/V97Q6DL) . We look forward to hearing from you!
