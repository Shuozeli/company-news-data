...
document_id: "1c10b0814484e89bdb8dac542e863913b794d310e2d469f1963b06f362425f9c"
...
canonical_url: "https://www.guidewire.com/resources/blog/industry-trends/the-insurance-pricing-struggle-bridging-the-gap-between-risk-data-and-action"
...
content_hash: "sha256:3db450994f8d43947c53a264fd72bd419e4da1228c4126f7de446642a211fa07"
---

# The Insurance Pricing Struggle: Bridging the Gap Between Risk, Data, and Action
...
In this three-part blog series, we’ll unpack the core challenges that make insurance pricing one of the most persistent headaches in the industry — and discuss strategies to overcome them. This[first installment](https://explore.guidewire.com/c/why-insurance-pricing-is-hard?x=Rx-Ukw) focuses on the foundational issue: the misalignment between the key stakeholders who own, build, and inform pricing decisions — and how these disconnects undermine speed, accuracy, and adaptability.
...
1. **Business owners** – These include Chief Underwriting Officers, product owners, and heads of operations — the profit-and-loss leaders. They define the strategy, manage overall performance, and ultimately decide what prices to charge.
2. **IT professionals** – These are the teams that maintain the systems that power daily operations, including the rating engines that calculate premiums.
3. **Analytics teams** – These include the actuaries and data scientists who extract insights from data to recommend appropriate, risk-based rates.
