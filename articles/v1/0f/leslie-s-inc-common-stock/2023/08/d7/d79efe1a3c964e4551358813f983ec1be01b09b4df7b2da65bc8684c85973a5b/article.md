...
document_id: "d79efe1a3c964e4551358813f983ec1be01b09b4df7b2da65bc8684c85973a5b"
...
The size of the pool directly impacts the time it takes for the shock treatment to disperse and the chlorine levels to stabilize. Larger pools with a greater **[water volume](https://lesliespool.com/blog/calculating-pool-volume.html)** require more time for the shock treatment to fully integrate with the water and disperse throughout the pool. Keep the pool pump running on high speed when adding any type of pool shock or water balancing chemicals to ensure optimized distribution throughout the pool and avoid “hot spots,” which are areas of concentrated chemicals that can harm swimmers and damage pool surfaces.
...
**BONUS TIP:** There are many reasons why a pool might turn cloudy, and a low sanitizer level is just one of them. Learn more about the most common causes of cloudy pool water — and how to clear the water up quickly — in our **[Resource Center guide](https://lesliespool.com/blog/how-to-fix-cloudy-pool-water.html)** .
...
If the chlorine levels are too high, you’ll need to wait a little longer before jumping in the pool. On the other hand, if chlorine levels are too low, you’ll need to treat the water again. There are a few causes for low chlorine levels after shocking the pool. The most common reason is that you may not be adding enough daily sanitizer, or you may not have added enough shock to the water. If neither of these are the issue, you may have a problem with **[heightened chlorine demand](https://lesliespool.com/blog/how-to-manage-chlorine-demand.html)** in your pool. In either case, an extra shock treatment is strongly recommended to ensure well-sanitized pool water that’s safe for swimming.


At-home test kits and test strips allow you to quickly measure FAC levels, pH balance, and other important chemistry parameters. But for a more comprehensive look at the chemistry levels in your pool, Leslie's can help with a FREE in-store **[water test](https://lesliespool.com/accublue.html)** . In just 60 seconds, you'll get precise results for 10 different aspects of water chemistry, plus a customized step-by-step water care plan based on your test results. AccuBlue water testing can be helpful for troubleshooting recurring water quality issues, but it's also a great tool for keeping a close eye on the health of your water.
...
For more expert advice about water treatments in your pool, check out the other chemistry tips in our **[blog](https://lesliespool.com/blog/water-treatment/)** or stop by **[your local Leslie's](https://lesliespool.com/stores)** .


## Shop Leslie's Shock


[Cal-Hypo](https://lesliespool.com/power-powder/)


[Sodium Dichlor](https://lesliespool.com/chlor-brite/)


[Chlorine-Free](https://lesliespool.com/fresh-n-clear/)
