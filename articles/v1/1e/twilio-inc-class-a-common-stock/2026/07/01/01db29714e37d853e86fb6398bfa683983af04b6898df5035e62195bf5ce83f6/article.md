...
document_id: "01db29714e37d853e86fb6398bfa683983af04b6898df5035e62195bf5ce83f6"
...
canonical_url: "https://www.twilio.com/en-us/blog/developers/tutorials/product/handle-background-noise-when-using-conversation-relay-in-php"
published_at: "2026-07-24T00:00:00+00:00"
first_seen_at: "2026-07-22T17:37:59.927743+00:00"
fetched_at: "2026-07-28T21:37:39.039431+00:00"
content_hash: "sha256:bc7e61fd75d0fa16fb09937f1bfdd771a1bd1e29ecf65c687ffcfa6f6ccd6e79"
---
...
- The[Owl Air phone agent](https://www.twilio.com/en-us/blog/build-ai-phone-agent-conversation-relay) from the previous tutorial, or any Conversation Relay agent built with Python and FastAPI
- A voice-capable Twilio phone number
- [ngrok](https://ngrok.com/) running and your DOMAIN environment variable set


## Why noise breaks voice AI differently than it breaks human calls
...
The changes from the previous tutorial are` ignoreBackchannel` set to` true` and` interruptSensitivity` changed from` medium` to` low` . No other code in *src/App/src/Handler/TwimlHandler.php* changes.
...
Audio preprocessing libraries like[the adrc filter in FFmpeg](https://ayosec.github.io/ffmpeg-filters-docs/7.1/Filters/Audio/adrc) and the ElevenLabs Audio Isolation API are designed for offline processing and are not compatible with a Conversation Relay pipeline.
