...
document_id: "2a884aaeb521645290ce7dd9729979d1a2a64233e0fd942815c60d3b8ddba749"
...
canonical_url: "https://www.bat.com/media/press-releases/_2025/february/preliminary-results-for-the-year-ended-31-december-2024"
published_at: null
first_seen_at: "2026-07-21T11:41:41.928523+00:00"
fetched_at: "2026-07-28T21:38:29.998390+00:00"
content_hash: "sha256:ed0ff2a14c49b32f71159013adc3cee363a0dca8b74fc24cf0fdeaa25c6f8073"
---
...
Reported Adjusted2 Adjusted2 Organic3
...
The use of non-GAAP measures, including adjusting items and constant currencies, are further discussed from page 49 of the full announcement, with reconciliation from the most comparable IFRS measure provided.


**Notes**


1. Internal estimate, see page 43 of the full announcement, for a discussion on the revision to prior estimates.
2. See page 29 of the full announcement, for discussion on adjusting items.
...
* Due to the uncertainty around the timing of any settlement in Canada, the Group will present certain measures excluding the profit earned from ITCAN (except for New Categories) for 2025, with 2024 comparatives rebased accordingly. Please refer to page 18 of the full announcement.
** measure presented at constant rates only. n/m refers to movements that are not meaningful as prior year was a loss.
...
* Due to the uncertainty around the timing of any settlement in Canada, the Group will present certain measures excluding the profit earned from ITCAN (except for New Categories) for 2025, with 2024 comparatives rebased accordingly. Please refer to page 18 of the full annoucement.


[Preliminary results for the year ended 31 December 2024 (1.0 mb)](https://www.bat.com/content/dam/batcom/global/main-nav/investors-and-reporting/results-centre/pdf/FY_2024_Announcement.pdf)
...
In particular, these forward-looking statements include, among other statements, statements regarding the Group's future financial performance, planned product launches and future regulatory developments and business objectives (including with respect to sustainability and other environmental, social and governance matters), as well as: (i) certain statements in the Chief Executive Statement and Summary (both on page 1 of the full annoucement); (ii) certain statements in the Chief Financial Officer Statement and the 2025 Outlook (both on page 2 of the full annoucement); (iii) certain statements in the Group Operating Review (pages 3 to 6 of the full annoucement) including Cash/capital allocation and Sustainability update; (iv) certain statements in the Category Performance Review (pages 7 to 9 of the full annoucement), including the Vapour, Modern Oral and Beyond Nicotine sections; (v) certain statements in the Regional Review section (pages 10 to 12 of the full annoucement), including the Asia-Pacific, Middle East and Africa (APMEA) section; (vi) certain statements in the Other Financial Information section (pages 13 to 19 of the full annoucement), including Taxation, Borrowings and net debt and Dividends summary; (vii) certain statements in the Other Information section (pages 20 to 21 of the full annoucement), including Update on Quebec class action and CCAA, Risks and uncertainties, Update on investigations, Changes in the Group, Going concern and Additional information; (viii) certain statements in the Notes to the Financial Statements section (pages 29 to 40 of the full annoucement), including Accounting policies and basis of preparation, Amortisation and impairment of trademarks and similar intangibles, Ongoing impairment review of assets, Liquidity, Cash Flow, Earnings per share and Contingent liabilities and financial commitments sections; and (ix) certain statements in the Other Information section (pages 41 to 44 of the full annoucement), including Dividends.
