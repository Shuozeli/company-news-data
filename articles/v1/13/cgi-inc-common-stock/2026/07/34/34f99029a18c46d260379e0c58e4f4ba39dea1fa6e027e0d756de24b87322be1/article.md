...
document_id: "34f99029a18c46d260379e0c58e4f4ba39dea1fa6e027e0d756de24b87322be1"
company_key: "cgi-inc-common-stock"
company: "CGI Inc. Common Stock"
source_id: "cgi-inc-common-stock-rss-66ef697d2497"
canonical_url: "https://www.cgi.com/en/artificial-intelligence/from-hype-to-horizon-a-ctos-roadmap-for-AI-powered-software-delivery"
published_at: null
first_seen_at: "2026-07-20T23:21:24.029549+00:00"
fetched_at: "2026-07-28T21:08:32.413121+00:00"
content_hash: "sha256:da72ceea91d63f86afa9908420a80c71e208b18515ed525edb7ab7e05ab00718"
---

# From hype to horizon: A CTO's roadmap for AI-powered software delivery

There's no shortage of voices and headlines telling you what AI can do for software development. At CGI, we also have a perspective on this, built from our own adoption and client experiences, which you can explore through our[From AI to ROI podcast series](https://www.cgi.com/en/podcast/artificial-intelligence/ai-roi-applying-ai-across-software-development-lifecycle) and our[enterprise software delivery hub](https://www.cgi.com/en/artificial-intelligence/enterprise-software-delivery) .
...
[Julie Godin](https://www.cgi.com/en/about-us/leadership/julie-godin) , Executive Chair of the Board of Directors, and[François Boulanger](https://www.cgi.com/en/about-us/leadership/francois-boulanger) , President and CEO, go more deeply into this topic in their point of view,[Why the digital puzzle can’t solve itself](https://www.cgi.com/en/article/artificial-intelligence/why-the-digital-puzzle-cant-solve-itself) . You’ll also find throughout this blog quotes from experts across CGI that expound on the topic.


> *"Even in legacy environments, teams can code better, faster, and more sustainably if they rely on strong engineering practices. Without them, we've seen AI have the opposite effect, amplifying existing challenges and creating new risks."* —[Kevin Beaugrand](https://www.cgi.com/en/experts/kevin-beaugrand) , Director, Consulting Expert, AI Technologies Lead, CGI Western & Southern Europe
...
Most organizations are at this stage. The immediate priority shouldn’t be AI tooling only; it should be on building strong foundations, including an honest inventory of your digital estate, AI governance with executive ownership, and AI literacy beyond just for developers.
...
> *"AI doesn't fail because the technology isn't ready, it fails because organizations aren't. True differentiation comes from the maturity to govern, educate, and continuously evolve around AI."* —[Luuk Filart](https://www.cgi.com/en/experts/luuk-filart) , Director, Consulting Expert, CGI SmartLab Founder, CGI’s Scandinavia, Northwest and Central-East Europe Operations


Legacy applications are also often a focus here. According to our[2025 CGI Voice of Our Clients research](https://www.cgi.com/en/voice-of-our-clients) , 41% of executives say legacy systems pose a significant challenge to implementing their digital strategy.
...
> *"We needed to upgrade components on an outdated framework with no documentation— like trying to put a 2025 engine into a 1990 car. Leveraging AI with our own expertise, we made the upgrade where it had been nearly impossible before."* —[Lukas Krappmann](https://www.cgi.com/en/experts/lukas-krappmann) , Senior Consultant, CGI’s Germany Operations


**Horizon 2: From assistance to orchestration (12 – 36 months)**


In this stage, AI moves from helping individuals work faster to orchestrating delivery processes across previously siloed phases, and the ambition expands.


> *"Leading organizations are using AI to build the right thing—not just to build the thing right."* —[John Davis](https://www.cgi.com/en/experts/john-davis) , Vice President, Consulting Expert, AI Software Engineering, CGI’s UK & Australia Operations
...
> *"AI is no longer just assisting development, it is becoming an intelligent orchestration engine. When you connect business architecture, IT architecture, and implementation through AI, you fundamentally change what's possible."* —[Guillaume Brincin](https://www.cgi.com/en/experts/guillaume-brincin) , Director, Consulting Expert, CGI’s Canada Operations


Measurement must evolve, too. Developer productivity and sprint velocity become insufficient. Executive teams need frameworks connecting delivery performance to business outcomes. ([Read more here: The AI value paradox: Measuring what matters (not just what’s easy)](https://www.cgi.com/en/blog/artificial-intelligence/ai-value-paradox-measuring-what-matters-not-just-whats-easy) .)


> *"The future isn't one AI assistant per engineer. It's orchestrating federations of agents that plan, build, and test together. Success won't come to teams that automate the most, but to those that measure which agents improve velocity, quality, and reliability."* —[Steve Zemanick](https://www.cgi.com/us/en-us/experts/steve-zemanick) , Director, Consulting Expert in AI, CGI’s U.S. Commercial & State Government Operations
...
> *"Delivering for a leading Japanese bank proved what disciplined AI-assisted delivery can achieve. We reimagined the life cycle to deliver over three months faster—not by cutting corners, but by engineering reliability into speed."* —[Raghav Kumar P](https://www.cgi.com/en/experts/raghava-kumar) , Vice President, CGI Asia Pacific Global Deliver Centers of Excellence
...
1. **Are we measuring what matters?** Quality, stability, and business outcomes, or just activity and velocity?
2. **Are our foundations ready for speed?** Governance and engineering disciplines ensure AI-accelerated delivery doesn't become AI-accelerated risk?
3. **Do we have accountability for AI outputs?** Transparency, auditability, and values alignment?
4. **Are we enabling people, not just equipping them?** AI literacy, change management, and new organizational structures?
5. **Do we have a build-or-buy strategy?** Strategic differentiation versus where to partner? ([Read more here: Choosing the right AI solution: Five build or buy mistakes to avoid (and what to do instead)](https://www.cgi.com/en/blog/artificial-intelligence/choosing-right-ai-solution-five-build-or-buy-mistakes-to-avoid) .)
6. **Is user value at the center?** Accelerating outcomes customers need, or just accelerating output?
...
> *"This is the least capable these systems will ever be."* —[Jade Hind](https://www.cgi.com/en/experts/jade-hind) , Lead Data Scientist, CGI’s UK & Australia Operations
...
[Explore our enterprise software delivery hub](https://www.cgi.com/en/artificial-intelligence/enterprise-software-delivery)


[Listen to the From AI to ROI podcast](https://www.cgi.com/en/podcast/artificial-intelligence/ai-roi-applying-ai-across-software-development-lifecycle)


[Connect with our experts](https://www.cgi.com/en/experts)


---


\[1\][AI Coding Assistants: Statistical Twins of Rogue Developers](https://paiml.com/blog/2025-02-27-ai-coders-rogue-developers/) (February 2025)
