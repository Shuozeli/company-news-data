...
document_id: "a6df2b21befd143272906faa20738ddc38ca147c8dc1c454fedb1818d428951f"
company_key: "cgi-inc-common-stock"
company: "CGI Inc. Common Stock"
source_id: "cgi-inc-common-stock-rss-66ef697d2497"
canonical_url: "https://www.cgi.com/en/blog/utilities/european-cooperation-flexibility-accelerate-energy-transition"
published_at: null
first_seen_at: "2026-07-20T23:21:24.029549+00:00"
fetched_at: "2026-07-28T20:37:08.491459+00:00"
content_hash: "sha256:62f6ba594eef4d464f80c0dd6c10ed221680d146dcbfa5c6b98d7c2b431fb1bd"
---
...
- [GOPACS](https://en.gopacs.eu/) in The Netherlands is an initiative to mitigate congestion in the grid through collaboration with the open flex market. It brings together supply and demand, including the constraints of the network operators’ local situation.
- [IO.ENERGY](https://www.ioenergy.eu/) in Belgium is a platform led by Elia, Belgium’s TSO, which allows the market to develop innovative services using real-time metering data. These innovations range from data platforms validating different measurement methods to consumer applications assessing how to engage in flexibility.
- [INTERRFACE](http://www.interrface.eu/) is a cross-border collaborative EU H2020 program to develop a pan-European Grid Services Architecture (IEGSA) to act as the interface between the power system (TSO and DSO) and customers, and allow the seamless and coordinated operation of all stakeholders to use and procure common services.
...
- **Collaboration** : Collaboration across all market parties, including new entrants, is vital to ensure that a fair and effective value chain emerges. For example, TSO-DSO cooperation is vital around congestion management, regulatory guidance and market interaction. The report on


[An Integrated Approach to Active System Management](https://www.entsoe.eu/news/2019/04/16/a-toolbox-for-tsos-and-dsos-to-make-use-of-new-system-and-grid-services/) by several European associations is a clear example of how this cooperation can support the market.
...
[Mattijs van de Hoed](https://www.cgi.com/en/experts/mattijs-van-den-hoed) , Vice-President Consulting Services and central markets expert in the utilities industry, has published a series of blogs about energy flexibility and data exchange:


-


[Are central markets the answer to commoditizing energy flexibility?](https://www.cgi.com/en/blog/are-central-markets-the-answer-to-commoditizing-energy-flexibility)


-


[Next-gen, real-time data exchanges will power the energy industry](https://www.cgi.com/en/utilities/next-generation-data-exchanges)


-


[Delivering on the benefits of data: How utilities can get the first-mover advantage](https://www.cgi.com/en/blog/delivering-on-the-benefits-of-data-how-utilities-can-get-the-first-mover-advantage)


Also see the interview with Mattijs by[Smart Energy International](http://www.smart-energy.com/) about[“Digitalization: supporting central energy markets in transition.”](https://www.smart-energy.com/industry-sectors/data_analytics/digitalisation-supporting-central-energy-markets-in-transition/)


**Read more about the regional drivers**


1. [Danish Energy Agency report: Danish Experiences from Offshore Wind Development](https://ens.dk/sites/ens.dk/files/Globalcooperation/offshore_wind_development_0.pdf)
2. [ScienceDirect.com: Congestion Management, from Renewable Energy Integration, 2014](https://www.sciencedirect.com/topics/engineering/congestion-management)
3. [GlobalSecurityReview.com: Poland and Baltic States Reduce Reliance on Russian Energy](https://globalsecurityreview.com/poland-baltic-states-reduce-reliance-russian-energy/)
4. [PVTech.org: Netherlands to restrict grid linking requests to alleviate congestion](https://www.pv-tech.org/news/netherlands-to-restrict-grid-linking-requests-to-alleviate-congestion)
5. [Gov.uk: Offshore wind energy revolution to provide a third of all UK electricity by 2030](https://www.gov.uk/government/news/offshore-wind-energy-revolution-to-provide-a-third-of-all-uk-electricity-by-2030)
