...
document_id: "6847acbccbbafbcd1b659a65234b109e2d11bcd2a8c1287cb7f97004ee40392c"
...
canonical_url: "https://www.muellerwaterproducts.com/news/utah-city-deploys-collaboration-innovation-ami-upgrade-0"
published_at: null
first_seen_at: "2026-07-22T05:04:06.822451+00:00"
fetched_at: "2026-07-28T21:38:27.854613+00:00"
content_hash: "sha256:aabed653747e5f072a1dc9678aec2035a87a20ca543982afc4b9a415cd01ef1f"
---
...
[Water Finance & Management](https://waterfm.com/utah-city-deploys-collaboration-innovation-on-ami-upgrade/)
...
In 2022, the state legislature passed[HB 242](https://le.utah.gov/~2022/bills/static/HB0242.html) , followed by[SB 251](https://le.utah.gov/~2023/bills/static/SB0251.html) in 2023. These bills led to Utah Code[73-10-34](https://le.utah.gov/xcode/Title73/Chapter10/73-10-S34.html) , which requires that all secondary pressurized irrigation connections be metered by Jan. 1, 2030. By measuring indoor and outdoor usage separately, state and local leaders are working with water suppliers to shift the public mindset from viewing water as unlimited to one that practices responsible conservation.


A significant advancement was achieved through the state's[Transparent Water Billing Grant Program](https://conservewater.utah.gov/transparent-water-billing/) . The program's goals are straightforward yet impactful: provide customers with clear information about their water use, promote conservation and enhance public access to data.


[Cedar Hills](https://www.cedarhills.org/) , a city with approximately 10,000 residents, was among the first to utilize the grant program. The city owns and operates a water utility system that serves roughly 2,600 residential connections, each with two meters per address: one for drinking water and one for Pressurized Irrigation (PI). Snowmelt accounts for a major source of its water supply. Since snowfall can vary greatly from year to year, it's crucial that water conservation remains top of mind.
...
To meet new[Utah water conservation goals](https://conservewater.utah.gov/regional-water-conservation-goals/) , Cedar Hills installed additional residential Solid-State Meters (SSMs) from Mueller Systems in 2024. At the same time, Cedar Hills also moved from charging a flat rate for PI water to billing based on actual water use.
...
Cedar Hills' solution was to implement Mueller Systems'[SentryxTM water intelligence platform](https://muellersystems.com/ami-solutions/sentryx-water-intelligence-platform/) and[AquaTrax's](https://aquatraxsolutions.com/) consumer portal, integrating advanced metering with near real-time, customer-friendly insights. Using an Application Programming Interface (API), the AMI system transmits near-real-time water usage data to support the customer portal, turning metering data into valuable usage insights. The consumer portal allows Cedar Hills to deploy PI billing without increasing customer service calls.
...
[Click here](https://waterfm.com/utah-city-deploys-collaboration-innovation-on-ami-upgrade/) to read the article on Water Finance & Management.
