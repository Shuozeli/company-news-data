...
document_id: "88bd3fcd5ed9b8c9aad761d8709760068743bcf3fb4527b0a0ffeb6a9ce27840"
...
The following piece was published in[Signal Integrity Journal](https://www.signalintegrityjournal.com/articles/2920-six-principles-of-fft-analysis-with-real-time-oscilloscopes) and is excerpted here by permission of Signal Integrity Journal.


***************************


We live in the time domain. This is where we measure all digital performance. But sometimes, we can get to an answer faster by taking a detour through the frequency domain. With these six principles, we can understand how an oscilloscope transforms time domain measurements into a frequency domain view. All six principles are applied “under the hood” by[oscilloscopes with a built-in FFT function](https://teledynelecroy.com/oscilloscope/) . (Our note: Also by software packages designed for spectral analysis, such as the[SPECTRUM-1](https://teledynelecroy.com/options/productseries.aspx?mseries=631&groupid=144) and[SPECTRUM-PRO-2R](https://teledynelecroy.com/options/productseries.aspx?mseries=625&groupid=144) options.)
...
To learn more about this topic, view this free webinar by Prof. Eric Bogatin,[Understanding Real-time Spectral Analysis](https://go.teledynelecroy.com/l/48392/2021-06-04/87xtss?utm_source=Webinar&utm_medium=bethesignal-com-homepage&utm_content=+21-07-21+Bogatin+Spectral+Analysis+Webinar&utm_campaign=+21-07-21+Bogatin+Spectral+Analysis) .


#### Also see:


[Using Spectrograms to Visualize Spectral Changes](https://blog.teledynelecroy.com/2021/02/using-spectrograms-to-visualize.html)


[Situational Awareness: RF Noise in the Lab](https://blog.teledynelecroy.com/2021/02/situational-awareness-rf-noise-in-lab.html)


[A Real World FFT Example](https://blog.teledynelecroy.com/2019/05/a-real-world-fft-example.html)


[Fast Fourier Transforms: Automatic Edition](https://blog.teledynelecroy.com/2019/04/fast-fourier-transforms-automatic.html)


[Fast Fourier Transforms: Stickshift Edition](https://blog.teledynelecroy.com/2019/04/fast-fourier-transforms-stickshift.html)


[Getting From the Time Domain to the Frequency Domain](https://blog.teledynelecroy.com/2019/01/getting-from-time-domain-to-frequency.html)
[About Data Truncation in Fast Fourier Transforms](https://blog.teledynelecroy.com/2019/02/about-data-truncation-in-fast-fourier.html)
[About Windowing in Fast Fourier Transforms](https://blog.teledynelecroy.com/2019/02/about-windowing-in-fast-fourier.html)
[Which Windowing Function to Use in FFTs?](https://blog.teledynelecroy.com/2019/03/which-windowing-function-to-use-in-ffts.html)
