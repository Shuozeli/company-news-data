...
document_id: "d0750c19a418b8ceee9e104c26bcf86bd7d519cef3ae2c1bd3cb728b04b52ca3"
...
canonical_url: "http://engineering.block.xyz/blog/3-principles-for-designing-agent-skills"
...
content_hash: "sha256:7ad4729f801c3ef6968ecdb1ae8d799a59838eec6539d90f43c71378af1435d4"
---
...
[Skills](https://agentskills.io/) are an open standard supported by most major AI coding tools: Claude Code, Goose, Cursor, Amp, GitHub Copilot, Gemini CLI, VS Code, and many more.
...
```text
bash    1  A3_PASS  =  false
2   A3_POINTS  =  0
3   if     [     ${  #  A3_FOUND  [  @  ]  }   -gt   0     ]  ;     then
4      A3_PASS  =  true
5      A3_POINTS  =  20
6   fi
```
...
1. **Know what the agent should NOT decide** : If it needs to be reproducible, put it in a script
2. **Know what the agent SHOULD decide** : Explanation, creation, and conversation are the agent's strengths
3. **Write a constitution** : Be explicit about constraints; the agent will thank you by being consistent
4. **Bonus: Design for the arc** : The best skills turn output into input, making the agent more useful for whatever comes next
