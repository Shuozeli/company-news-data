...
document_id: "7c129cb0ad746e08b035fb966111e3fef7817030472537a1f3ea0ec7f083c24f"
...
canonical_url: "https://newsroom.cardinalhealth.com/2026-04-21-Leveraging-medical-device-reprocessing-to-reduce-healthcares-carbon-footprint"
...
content_hash: "sha256:7ac77e89edd4e2519090ddc948ff28e2d3e23e9b02d34a0fc2f2039032327e7b"
---

# Leveraging medical device reprocessing to reduce healthcare’s carbon footprint

*In celebration of Earth Day, we highlight the impact of our Sustainable Technologies business*


Many hospitals and health systems have committed to reducing greenhouse gas (GHG) emissions by 50% by 2030, and achieving net-zero emissions by 2050, in line with the[Paris Agreement](https://unfccc.int/process-and-meetings/the-paris-agreement) , which aims to slow climate change by cutting emissions and limiting global warming. They have a convincing reason to do so, as the[National Academy of Medicine](https://pmc.ncbi.nlm.nih.gov/articles/PMC12393226/) (NAM) reports that the healthcare sector is a significant contributor to climate change, accounting for 8.5% of U.S. emissions and 4.4% globally; single-use medical devices (SUDs) are a notable driver of those emissions.


A growing body of peer-reviewed research, as cited by[NAM](https://nam.edu/perspectives/the-case-for-hospitals-to-boost-single-use-device-reprocessing-programs/#:~:text=Single-use%20medical%20and%20surgical,challenge%20due%20to%20limited%20data.) , supports single-use device reprocessing as a strategy for hospitals to help reduce costs, GHG emissions and solid waste and improve supply chain resiliency.[Reprocessing](https://newsroom.cardinalhealth.com/2023-04-20-Sustainable-Technologies-TM-Reprocessing-medical-devices-to-reduce-healthcares-carbon-footprint-and-drive-cost-savings) — the process of cleaning, testing and disinfecting and/or sterilizing single-use medical devices, allowing them to be safely resold for patient use — creates unique opportunities for the healthcare supply chain.


Our Cardinal Health[Sustainable Technologies](https://www.sustainabletechnologies.com/en_us.html) business is a leading provider of SUD collections and reprocessing services in the U.S. In fiscal year 2025,[we](https://www.cardinalhealth.com/content/dam/corp/web/documents/Report/cardinal-health-fy25-sustainable-business-report.pdf) collected 21.6 million single-use devices and diverted 6.6 million pounds of waste from landfills, avoiding 1,900 metric tons of CO2e emissions.


In its most recent[report](https://amdr.org/newsroom/reprocessing-by-the-numbers/) , the Association of Medical Device Reprocessors (AMDR) shared that U.S. hospitals and surgical centers saved nearly half a *billion* dollars through reprocessing in 2024, including more than $443 million in savings from lower-cost, reprocessed, single-use medical devices.


Cited in the same[report](https://amdr.org/newsroom/reprocessing-by-the-numbers/) , hospitals saved nearly $8 million from waste reduction in 2024; this includes more than 12 million pounds of medical waste diverted from landfills by using reprocessed single-use medical devices. By using reprocessed SUDs, hospitals and surgical centers helped to eliminate more than 115 million pounds of carbon dioxide emissions —[equivalent](https://amdr.org/earth-day-news-hospitals-and-surgical-centers-in-17-countries-partnered-with-amdr-members-to-save-over-451m-e433m-eliminate-the-equivalent-of-over-115m-pounds-52m-kg-of-co2-emissions-by-using/#:~:text=%5BWashington,%20DC%20/%20Berlin%20Germany,keeping%20more%20products%20available%20domestically.) to eliminating close to 6 million gallons of gasoline, which is enough to fill 693 tanker trucks.


Overall, nearly[10,000 hospitals](https://amdr.org/newsroom/reprocessing-by-the-numbers/) , surgical centers and U.S. military surgical hospitals (including all U.S. News & World Report “Top Hospitals”) benefitted by using reprocessed SUDs in 2024.
...
For perspective, hospitals and surgical centers in 17 countries across North America, Australia and New Zealand, Asia and Europe saved more than $451M and reduced CO2 emissions by more than 115M lbs. by using regulated, reprocessed SUDs in 2024, according to[AMDR](https://amdr.org/wp-content/uploads/2025/04/AMDR-Members-Helped-Hospitals-Eliminate-the-Equivalant-of-52M-Kilograms-of-CO2-in-2024_FINAL.pdf) .
...
- Collection of their single-use medical devices to divert them from landfill
