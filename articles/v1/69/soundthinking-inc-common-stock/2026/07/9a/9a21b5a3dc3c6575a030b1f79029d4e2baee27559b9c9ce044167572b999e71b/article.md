...
document_id: "9a21b5a3dc3c6575a030b1f79029d4e2baee27559b9c9ce044167572b999e71b"
company_key: "soundthinking-inc-common-stock"
company: "SoundThinking Inc. Common Stock"
source_id: "soundthinking-inc-common-stock-news-import-af287c5827c8"
canonical_url: "http://www.soundthinking.com/press-releases/soundthinking-unveils-crimetracer-gen3-expanding-from-investigations-to-agency-wide-crime-data-solution"
published_at: null
first_seen_at: "2026-07-22T14:19:42.386058+00:00"
fetched_at: "2026-07-28T21:38:24.318832+00:00"
content_hash: "sha256:a06a60131734bf21a721d625f2f6873275e1fe2ab9bb1d4a7392d70cb6a786cc"
---

# SoundThinking Unveils CrimeTracer Gen3: Expanding from Investigations to Agency-Wide Crime Data Solution

***Summary:*** *SoundThinking today announced CrimeTracer Gen3, the third generation and most significant upgrade in the product’s history. This release introduces more than a dozen new capabilities and delivers greater value to more units across agencies.*


**IACP, Denver, CO, October 17, 2025** –[SoundThinking, Inc.](https://www.soundthinking.com/) (Nasdaq: SSTI), a leading public safety technology provider, today announced **CrimeTracer Gen3,** the most significant upgrade in the product’s history. The new release expands CrimeTracer from an investigative tool into a comprehensive, agency-wide crime-fighting solution, delivering automated patrol briefings, natural language search and AI-driven analysis, among more than a dozen new capabilities to support patrol officers, analysts, investigators and command staff.
...
CrimeTracer Gen3 introduces features to give officers easy access to actionable insights before and during every shift along with a new, intuitive UX:
...
- **Enhanced Natural Language Search** – Voice-enabled and tuned to police terminology, allowing officers to ask questions in plain language, rather than complex search syntax, to get the answers they need.
- **AI Summarization** – Instantly surfaces key facts from lengthy reports and records, reducing time spent on manual review.
- **Case Folders –** Centralizes all related incidents and leads into one organized view to better reveal connections and accelerate investigations from initial lead to closure.
- **Entity Summary Pages** – Provides a comprehensive view of people, addresses and vehicles, including involvements and associations of such persons across jurisdictional boundaries, all at a glance.
...
CrimeTracer’s usage by over 2000 agencies nationwide creates a powerful network effect that grows stronger with every new agency that joins. Each record added to the system makes CrimeTracer more valuable for all users, expanding the ability to connect people, addresses, vehicles and other entities within and across jurisdictions. This collaborative model transforms CrimeTracer into a force multiplier at the agency level and beyond – helping to ensure officers have the broadest, most actionable view when making critical decisions.
...
- **Available By End of 2025:** Configurable dashboards for Patrol Officers, Analysts and Command Staff, and advanced entity extraction that utilizes data from unstructured narratives to be used when attempting to make connections across entities such as people, address and vehicles.


[Learn more about CrimeTracer Gen3](http://soundthinking.com/blog/turn-data-into-crime-fighting-decisions-with-crimetracer-gen3/) .
