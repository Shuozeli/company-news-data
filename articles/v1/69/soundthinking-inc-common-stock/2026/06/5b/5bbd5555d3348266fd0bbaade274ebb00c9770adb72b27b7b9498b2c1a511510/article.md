...
document_id: "5bbd5555d3348266fd0bbaade274ebb00c9770adb72b27b7b9498b2c1a511510"
...
canonical_url: "http://www.soundthinking.com/blog/gang-investigations-cross-jurisdictional-boundaries"
published_at: "2026-06-30T21:38:38+00:00"
first_seen_at: "2026-07-22T14:19:40.145434+00:00"
fetched_at: "2026-07-28T21:43:26.997349+00:00"
content_hash: "sha256:0f6d31e632e3f979d70debae4a5bd18c64dc648636d86662466337754e64b06c"
---

# Gang Investigations Cross Jurisdictional Boundaries – Your Investigation Should Too

Gang investigations are not a numbers game — they’re a network game. Research out of San Diego found that about[35% of the gang-affiliated arrestees](https://www.sandag.org/-/media/SANDAG/Documents/PDF/data-and-research/criminal-justice-and-public-safety/evaluation-services/drugs/cj-in-brief-gang-association-among-san-diego-arrestees-2019-12-01.pdf) surveyed reported working with other gangs for profit. Not only is one gang network large and unwieldy to track, but the connections and links between one or more gangs can be even harder to pin down. But finding, mapping, and dismantling the relational network around a criminal enterprise can have an outsized impact on violence in a community.
...
Sometimes the network doesn’t reveal itself right away. In[2019, Cobb County, Georgia,](https://youtu.be/0DN7YIY3tZk?si=Ednzau5d_rkkof7a) investigators caught one suspect in a homicide shortly after the crime, but the driver disappeared. A year passed. During trial prep, investigators turned up a phone number that might have belonged to the missing suspect.


A[CrimeTracer™](https://www.soundthinking.com/blog/law-enforcement/crime-data-solution-crimetracer/) search on that number surfaced something Cobb County had no way of knowing on its own: the suspect had filed a vehicle report in Los Angeles, more than 2,000 miles away, just five days after the murder. That single cross-jurisdictional record gave investigators what they needed to locate and extradite him. Both suspects were convicted.
...
[CrimeTracer](https://www.soundthinking.com/law-enforcement/crime-data-solution-crimetracer/) is a law enforcement intelligence platform that searches more than 1 billion records from agencies nationwide, searching over 40 document types, including RMS, CAD, LPR data, ShotSpotter incidents, jail bookings, court records, pawn tickets, field interview cards, warrants, and more.
...
**Link analysis that maps the whole network:** CrimeTracer’s[link analysis](https://www.soundthinking.com/blog/blog/link-analysis-an-overview/) and Visualizer tool transform data into a relational map. Each person, vehicle, location, or organization becomes a node. Their connections become links.
...
Because[motor vehicles are involved in more than 75% of all crimes](https://www.theiacp.org/sites/default/files/2019-12/Educational%20Toolkit%20PowerPoint.pdf) , vehicle intelligence is central to gang investigations, not supplemental. When PlateRanger ALPR data is integrated with CrimeTracer, investigators can instantly surface:
...
Gang cases are long-running and complex. CrimeTracer’s[case folder functionality](https://www.soundthinking.com/blog/how-crimetracer-gen3s-case-folders-transform-investigations/) keeps all related incidents, leads, records, and associate profiles organized in one place — so as the investigation grows, investigators aren’t starting from scratch every time they come back to it.
