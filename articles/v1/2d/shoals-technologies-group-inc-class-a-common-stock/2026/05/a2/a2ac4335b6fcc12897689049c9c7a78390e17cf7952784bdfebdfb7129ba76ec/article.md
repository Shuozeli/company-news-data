...
document_id: "a2ac4335b6fcc12897689049c9c7a78390e17cf7952784bdfebdfb7129ba76ec"
...
canonical_url: "https://shoals.com/en/insights/bess-bridge-between-data-centers-and-the-grid/"
published_at: "2026-05-27T17:10:59+00:00"
first_seen_at: "2026-07-20T23:18:26.282483+00:00"
fetched_at: "2026-07-28T21:11:58.236396+00:00"
content_hash: "sha256:cce3c6f5032e0ec022ab519c1eeb549c26faf48e3ebd69879326eb6734a64c8b"
---

# BESS is Becoming the Bridge Between Data Centers and the Grid
...
The Shoals and ON.energy[collaboration](https://www.datacenterdynamics.com/en/news/you-said-i-am-writing-a-peice-on-the-growing-trend-of-us-state-leglislatures-bringing-in-legislation-to-protect-rate-payers-being-saddled-with-the-costs-of-new-generation-and-transmssion-infrastructure-needed-to-support-data-center-load-with-many-seeki/) is a good example of where the market is headed. By pairing ON.energy’s medium-voltage AI UPS™ platform with Shoals[Power Hub](https://shoals.com/en/products/data-center-solutions/power-hub/) , the companies are targeting a simpler, more scalable path to resilient backup power for AI data centers. The joint approach is built around critical-power systems that are predictable under stress, fast to deploy, and designed to interact with the grid.
...
Shoals Power Hub complements BESS by simplifying power distribution, while delivering standardization, scalability, and flexibility across modern data center infrastructure.


## Bring Your Own Power Becomes the Default


This is also why “bring your own power” is moving from workaround to default design principle. Developers are increasingly building power alongside compute. Instead of waiting for the grid to deliver all required capacity on day one, they are combining on-site generation, storage, backup systems, and grid supply into phased, flexible architectures. Grid power still matters. In most cases, large data centers are not going fully off-grid. But the old model of building the data center and waiting for utility capacity no longer works.


As Unison Energy CEO Alan Meier recently told[Data Center Knowledge](https://www.datacenterknowledge.com/build-design/unison-energy-ceo-on-data-centers-turning-to-on-site-power) , five years from now large data centers will likely require some amount of on-site power. He described the future architecture as a combination of on-site generation, grid power, energy storage, and flexibility, with on-site power becoming part of the default approach.
...
This is where companies with deep utility-scale DC experience matter. In solar and storage, Shoals has spent decades simplifying the electrical backbone of large energy projects. That same discipline is becoming relevant to data centers as they adopt BESS, DC-coupled architectures, and higher-current power systems. The challenge is not just adding batteries. It is building the electrical architecture around them in a way that supports speed, safety, reliability, and scale.


## Storage Is No Longer Optional


The U.S. energy storage market installed a record 18.9 GW of battery energy storage systems in 2025,[up 52%](https://cleanpower.org/resources/u-s-energy-storage-monitor/) from 2024, according to ACP and Wood Mackenzie. Data centers are one of the demand drivers pushing storage into a more central role, especially as developers look for ways to manage power availability, power quality, and interconnection risk.


Today, much of the conversation is about speed-to-power and grid bottlenecks. Over time, DC power may move deeper into the data center itself, especially as AI racks become denser and power architectures evolve beyond 800 V DC. But storage is already solving the immediate problem: how to bridge the gap between what data centers need and what the grid can deliver right now.
...
### Want to explore the other trends transforming solar, storage, and data center infrastructure?


Download our eBook,[From Solar and Storage to Data Centers: 7 Trends in Power Infrastructure for 2026](https://shoals.com/en/insights/solar-storage-data-centers-trends-in-power-infrastructure-for-2026/) , for insights on AI-driven energy demand, BESS, DC architectures, speed-to-power, and more.


To learn how Shoals supports modern power infrastructure deployments, explore our[solutions](https://shoals.com/en/products/) or[reach out](https://shoals.com/en/get-in-touch/) to our team.
