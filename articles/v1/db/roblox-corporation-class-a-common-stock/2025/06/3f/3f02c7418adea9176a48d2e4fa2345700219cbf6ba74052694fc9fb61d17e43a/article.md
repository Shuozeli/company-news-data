...
document_id: "3f02c7418adea9176a48d2e4fa2345700219cbf6ba74052694fc9fb61d17e43a"
...
canonical_url: "https://about.roblox.com/zh-hant/newsroom/2025/06/accelerating-ai-inference-roblox-3d-creation"
published_at: "2025-06-02T18:20:00+00:00"
first_seen_at: "2026-07-23T23:14:36.468733+00:00"
fetched_at: "2026-07-28T21:30:14.907341+00:00"
content_hash: "sha256:bac6cb596fb9c43dbb25e6c0599a62bc6e9bab15f5e0ce0eb04e3ce8bbc44d5e"
---
...
今年稍早，Roblox 分享了我們[Cube 3D 基礎模型](https://research.roblox.com/publications/cube-a-roblox-view-of-3d-intelligence)[的首項功能](https://about.roblox.com/newsroom/2025/03/introducing-roblox-cube) 。透過 Cube 3D，創作者可直接根據文字提示生成 3D 模型與環境。 我們從一開始就將延遲優化列為優先事項，因為我們意識到，緩慢的生成時間會打斷這個本質上屬於迭代的過程。在 Cube 3D 於三月推出之前，我們已經將推論步驟的速度提升了 7.8 倍，並為開發者和使用者帶來更流暢的體驗。


自推出以來，已有超過 578,000 個物件在多個知名體驗中被生成。開發者也表達了希望讓使用者能在體驗中透過「貓」、「漢堡」等文字提示生成 3D 物件的意願。最值得注意的是[《Mic Up](https://www.roblox.com/share?code=c43093a34c17fd4695f80fc7e6fa67c4&type=ExperienceDetails&stamp=1747772570292) 》——這款使用語音聊天的熱門聚會遊戲，便運用 Cube 3D 為玩家提供了一種有趣且互動的物件生成方式。 在該遊戲的實作中，玩家可開啟左側選單以存取額外功能，其中包括一個 AI 圖示。點擊該圖示後，玩家即可輸入文字提示來生成 3D 物件。對使用者而言，過長的生成時間會造成使用阻礙，使他們無法體驗到創意即時轉化為 3D 模型的魔力。
...
「我們希望打造能實現四維互動的系統，」[工程副總裁 Anupam Singh](https://www.youtube.com/watch?v=S5Vgxj_7Gtg) 解釋 Roblox 選擇自迴歸方法的原因時表示。「我們不僅想造出一輛車，還希望能夠打開車門並坐進車內。」
...
當我們擴展至完整的場景生成與理解時，這項工作將變得更加複雜，因為許多 3D 元素需要在佈局中相互配合、在上下文中協同運作。我們也希望所創建的 3D 物件與世界能具備完整功能，例如門能開闔、輪子能轉動等。為此，我們需要快速的生成與迭代能力，以擴展至整個場景、具備完整功能的物件以及虛擬角色。 隨著我們持續擴展[Cube 3D 基礎模型](https://about.roblox.com/newsroom/2025/03/introducing-roblox-cube) ，我們期待能分享進一步的改進與新功能，並見證創作者社群運用這些工具所建構的沉浸式世界。
