...
document_id: "5d7b0cd28a07a66be1ab1ca7cc1a79740e92095de146f847349a04d0521f61f2"
...
canonical_url: "https://jfrog.com/press-room/jfrog-and-anthropic-bring-enterprise-grade-software-supply-chain-governance-and-security-to-claude-code/"
published_at: "2026-06-10T13:20:31+00:00"
first_seen_at: "2026-07-25T10:14:51.945017+00:00"
fetched_at: "2026-07-28T21:42:42.932365+00:00"
content_hash: "sha256:b8f1eeb166d0e77ccac2c36dfc61f9a0ade896eb9945f88559570898698beb10"
---
...
**SUNNYVALE, Calif. – June 10, 2026 –**[JFrog Ltd](https://jfrog.com/?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) (Nasdaq:[FROG](https://finance.yahoo.com/quote/FROG/) ), the creators of the[JFrog Software Supply Chain Platform](https://jfrog.com/platform/?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) , the system of record for trusted software artifacts, binaries, and AI assets, unveiled its[JFrog Platform plugin](https://claude.com/plugins/jfrog) for Claude Code, in collaboration with Anthropic. Available immediately to all Claude Code users, the new plugin represents a significant milestone in bringing enterprise-grade software supply chain governance to one of the fastest-growing AI coding agent platforms in the world, reinforcing JFrog’s position as a critical trust layer and system of record for the rapidly expanding AI agent environment.


The need for agent-specific security has been[highlighted by Anthropic, stating](https://www.anthropic.com/engineering/how-we-contain-claude) , “As agents grow more capable, attack surfaces are constantly shifting. The types of failures we’ve seen are likely to be repeated across industries and labs. We need collective investment in agent-specific security posture, from shared benchmarks and disclosure norms to common identity standards and cross-vendor red-teaming.
...
AI coding agents are driving a surge of binaries, with the JFrog Platform currently managing over 18 billion artifacts, a 136% increase from the previous year\[1\] . The new JFrog Platform plugin for Claude Code is designed to help organizations tame unorthodox AI agent behavior by providing developers with governed access to scan, curate, and secure every artifact and dependency their agents consume. It also extends Claude Code with deep, domain-specific[JFrog Platform Skills](https://docs.jfrog.com/integrations/docs/jfrog-skills?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) , designed to give developers and their agents the ability to execute platform operations using natural language. Combined with the recently announced[JFrog MCP Registry](https://jfrog.com/press-room/jfrog-unveils-universal-mcp-registry-for-ai-software-supply-chain/?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) and[JFrog Agent Skills Registry](https://jfrog.com/press-room/jfrog-delivers-trust-layer-for-ai-driven-software-with-nvidia/?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) , the new plugin is expected to deliver:
...
- [MCP and Agent Skills Governance](https://jfrog.com/blog/ai-agents-jfrog-skills-mcp-tools/?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) **:** Ensures agents, developers, and AI users only pull verified, secure, and governed MCP servers and agent skills – blocking rogue access to sensitive internal data and preventing unauthorized actions.
...
The JFrog Platform plugin for Claude Code is available immediately at[https://claude.com/plugins/jfrog](https://claude.com/plugins/jfrog) . For more information on the new JFrog Platform plugin for Claude Code and more details on JFrog’s agentic interfaces, read[this blog](https://jfrog.com/blog/introducing-the-jfrog-plugin-for-claude-code/?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) or check out[this video](https://youtu.be/XKVzVSXdtM0?utm_source=businesswire&utm_medium=wirepress&utm_campaign=claudeplugin&utm_content=pr) .


*###*


***Like this Story? Share this on X:*** Accelerate your #AI development without sacrificing #governance or security with the new @JFrog Platform plugin for @Anthropic’s #ClaudeCode. Give your AI agents the full software supply chain context needed to automatically enforce governance, security, and compliance right from your IDE workflow. Learn how to harness the power of agentic #DevSecOps with new JFrog Platform Skills and MCP tools. *Learn more:*[https://bit.ly/41O6RBZ](https://bit.ly/41O6RBZ) *#security #DevGovOps*
...
**Media Contact:** Siobhan Lyons, Director, Global Communications, siobhanL@jfrog.com


**Investor Contact:** Jeff Schreiner, VP of Investor Relations, jeffS@[jfrog.co](http://jfrog.com/)[m](http://jfrog.com/)


\[1\] JFrog 2026 Software Supply Chain Security State of the Union:[https://jfrog.com/software-supply-chain-state-of-union/](https://jfrog.com/software-supply-chain-state-of-union/)
