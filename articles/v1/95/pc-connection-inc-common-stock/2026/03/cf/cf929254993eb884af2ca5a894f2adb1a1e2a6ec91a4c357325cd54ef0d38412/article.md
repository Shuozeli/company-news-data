...
document_id: "cf929254993eb884af2ca5a894f2adb1a1e2a6ec91a4c357325cd54ef0d38412"
...
canonical_url: "https://community.connection.com/trust-falls-and-agentic-calls/"
published_at: "2026-03-23T12:47:51+00:00"
first_seen_at: "2026-07-20T23:22:23.189033+00:00"
fetched_at: "2026-07-28T22:00:18.082649+00:00"
content_hash: "sha256:b4fd93a061114eea31920404ac112308fda28d9382b90d7b6596072af3882080"
---

# Trust Falls and Agentic Calls
...
And the proof they want is operational, not theoretical. They are not waiting for another white paper. They want to see a prior auth agent actually reduce denials at a health system that looks like theirs. They want to see a call center triage bot handle 10,000 calls a week without a compliance incident. Consider the math behind that urgency:[an AMA survey from 2025 found that clinicians complete roughly 39 prior authorizations per week and spend about 13 hours on the process](https://www.ama-assn.org/practice-management/prior-authorization/fixing-prior-auth-nearly-40-prior-authorizations-week-way) , with most reporting that it contributes directly to burnout.[McKinsey estimates that AI-enabled revenue cycle management could deliver a 30 to 60 percent reduction in cost to collect](https://www.mckinsey.com/industries/healthcare/our-insights/agentic-ai-and-the-race-to-a-touchless-revenue-cycle) .[Health systems collectively spend more than $140 billion annually on revenue cycle operations](https://www.mckinsey.com/industries/healthcare/our-insights/agentic-ai-and-the-race-to-a-touchless-revenue-cycle) , and the[CAQH Index pegs the savings opportunity from automating routine transactions like eligibility, claims, and prior auth at $20 billion](https://www.caqh.org/blog/new-caqh-index-reveals-20b-savings-opportunity-to-cut-waste-reduce-costs-and-improve-patient-access) . The ROI case is not theoretical. It is staring at the ceiling of every CFO’s office.
...
I expected privacy to rank higher, honestly. HIPAA has been the dominant conversation in healthcare IT for two decades. But this group told us something different: they are less worried about data leaking out and more worried about bad reasoning going in. A hallucinated care pathway, a confidently wrong claim code, an agent that auto-approves something it should have flagged. That kind of failure is hard to catch because it looks like competence. And it is not just a theoretical risk. Payers are now deploying AI systems that can review and deny claims in seconds, processing denials at a scale and speed that manual provider workflows cannot match.[The percentage of providers reporting denial rates above 10 percent surged from 30 percent in 2022 to 41 percent in 2025](https://www.experianplc.com/newsroom/press-releases/2025/experian-health-s-3rd-annual-state-of-claims-survey-finds-denial) . When both sides are running agents, the accuracy question becomes an arms race.
...
Talk to CNXN Helix: **[cnxnhelix.com](http://cnxnhelix.com/)**


### [Rai Basharat](https://community.connection.com/author/raibasharat/)


Rai Basharat is a seasoned Senior Director of Data Orchestration, responsible for advising and guiding businesses in transforming data strategies from concept to execution and delivery. He possesses extensive expertise in modern data stacks, ELT data pipelines, and leveraging data as features for predictive AI and various deep learning techniques, especially natural language processing (NLP). Rai has deep knowledge in the breadth and depth of generative AI and large language models (LLMs), introducing advanced techniques such as prompt engineering, retrieval-augmented generation (RAG), and fine-tuning. He is proficient in agentic workflows, tools, and extensions, enabling businesses to harness the full potential of AI technologies. Throughout his career, Rai has led significant eCommerce efforts and managed teams in app development, business intelligence, and machine learning for industry giants like Rocket Internet and Ali Baba. Rai's comprehensive understanding of data orchestration and AI, coupled with his strategic leadership, makes him an invaluable asset to any organization looking to navigate the complexities of the modern data landscape.
