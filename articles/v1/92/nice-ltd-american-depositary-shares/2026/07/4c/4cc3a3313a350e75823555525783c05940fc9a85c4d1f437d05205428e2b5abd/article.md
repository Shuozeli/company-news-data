...
document_id: "4cc3a3313a350e75823555525783c05940fc9a85c4d1f437d05205428e2b5abd"
company_key: "nice-ltd-american-depositary-shares"
company: "NICE Ltd American Depositary Shares"
source_id: "nice-ltd-american-depositary-shares-news-import-f3768d40b7a7"
canonical_url: "https://www.nice.com/blog/why-agentic-ai-will-grow-customer-service-demand-not-shrink-it"
published_at: "2026-07-22T01:00:00+00:00"
first_seen_at: "2026-07-22T18:07:13.969628+00:00"
fetched_at: "2026-07-28T21:20:58.380206+00:00"
content_hash: "sha256:ceaa8d6624c09d0719c1b65b43459c75d58518d1fba4e86ffe7b8c6e095534bf"
---
...
[Andy Traba](https://www.nice.com/blog/author/andy-traba)
...
The logic is sound. The assumption deserves another look — and the timing could not be more relevant.[A Gartner survey of customer service and support leaders](https://www.gartner.com/en/newsroom/press-releases/2024-12-09-gartner-survey-reveals-85-percent-of-customer-service-leaders-will-explore-or-pilot-customer-facing-conversational-genai-in-2025) found 85% planned to explore or pilot customer-facing conversational generative AI. That unprecedented scale of experimentation means most enterprises are about to test, in real time, their demand assumptions.
...
It’s common for customers to do a quick cost-benefit analysis before reaching out to a company. They ask themselves whether the issue is worth enduring hold purgatory? Or searching through a website, navigating a menu, verifying an account, explaining the situation – only to have to repeat every detail a second, third or fourth time? Something our friend Kristen Bell knew all too well before experiencing[the NiCE effect](https://www.nice.com/lps/the-nice-effect) .
...
As the marginal cost of a customer interaction decreases so does the threshold for starting one. We’re at the point now where the same customer issue that made a 15-minute call seem daunting may easily justify a 15-second exchange with an[AI agent](https://www.nice.com/products/agentic-experience-automation) today.
...
Stack several such tools, each governed by different rules, and the result is AI that's individually competent but collectively incoherent.[Gartner's 2025 research on customer service AI investment](https://www.gartner.com/en/newsroom/press-releases/2025-10-08-gartner-says-the-most-valuable-ai-use-cases-for-customer-service-and-support-fall-into-four-areas) captures this shift directly: the most valuable AI use cases are no longer standalone chatbots but AI embedded across the full service operating model.
...
[McKinsey's 2025 Global Survey on AI](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) shows why most enterprises aren't there yet: 88% report regular AI use in at least one function and 62% are experimenting with AI agents, yet only 23% are actually scaling an agentic system anywhere.
...
This is the role of a[CX AI platform](https://www.nice.com/products/cxone) , a connective layer of intelligence, orchestration and governance that lets every AI agent, employee and system operate from the same context, policy and source of truth.


NiCE’s CX AI centers on exactly this — linking intelligence,[orchestration](https://www.nice.com/products/engagement-orchestration) and human expertise so AI moves beyond isolated automation toward complete, coordinated outcomes, growing more valuable as volume grows.
...
As[McKinsey's survey](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) shows, most organizations still have work to do to scale AI enterprise-wide. Leaders should prepare for growing demand rather than assume volume stays fixed.
...
Enterprises that start answering those questions now can start building the[CX AI coordination layer](https://www.nice.com/platform/ai-for-cx) that customer service abundance requires instead of spending time managing the disconnected conversations.


### Frequently Asked Questions


In 1865, economist William Stanley Jevons noticed that as steam engines became more fuel-efficient, coal consumption rose rather than fell because cheaper power created more uses for it. That became known as Jevons Paradox: when technology sharply reduces the cost of a resource, demand often expands enough that total consumption increases. Customer service today faces the same dynamic. Today's interaction volume is less about demand and more about the amount of friction customers have been willing to tolerate. When AI makes help immediate, conversational, and capable of completing an action, customers find more reasons to engage.


Nearly every AI business case begins with the same assumption: customer demand is finite. Automate a share of it, and the rest becomes savings. That assumption deserves another look. Agentic AI creates value four ways — substitution, stimulated demand, proactive engagement, and expanded purpose. Toyota's E-Care agents now reach out before a customer even calls, generating interactions that never existed before. The economic theory doesn't guarantee AI increases demand everywhere. Quality and governance decide the outcome. Leaders should prepare for growing demand rather than assume volume stays fixed.


The first wave of customer service AI focused on substitution with chatbots answering questions, copilots summarizing calls, classifiers routing intent. Point AI is built to answer a question rather than coordinate an enterprise. A standalone chatbot can resolve one request in isolation but can't see what a customer discussed with an agent last week or where a related workflow stands. Stack several such tools, each governed by different rules, and the result is collectively incoherent AI. In an abundance economy, the scarce resource is context, and no point solution comes close.


A chatbot resolves one request in isolation — competent, but blind to what came before or comes next. An AI agent goes further: it verifies identity, pulls information from multiple systems in parallel, and completes an action end to end, handing off full context the moment a human is needed, as Tripadvisor's voice agent Vesper does. Agentic AI is the operating model built on that with AI agents, employees, workflows, and systems running as one coordinated whole, including AI agents negotiating directly with other AI agents. A chatbot answers. An agent resolves. Agentic AI coordinates the system both depend on.


Efficiency and cost-per-resolution metrics still matter, but they capture just part of the picture. A complete business case also asks how much additional demand becomes viable when service is immediate and scalable. That means tracking whether service is trustworthy. Outcomes like adoption, retention, and recovery, prevention of what would otherwise be lost, intelligence gleaned from conversations, and, increasingly, coordination. So, whether agents, employees, and systems share one governed view of the truth becomes the measure. Interaction volume was long treated as a measure of demand. It's better understood as a measure of how much friction customers were willing to tolerate before reaching out.


Interaction growth accelerates as customers delegate work to personal AI agents that negotiate directly with an enterprise's AI agent. The question stops being whether the answer was correct and becomes who authorized the exchange, whose identity is represented, and what was the agent permitted to agree to. Authorization must work in both directions. Consent must be scoped and revocable. Policy must be enforced inside the exchange itself, since no human reviews every handshake, and auditability must be built in so decisions can be reconstructed later. Human oversight must be engineered on one unified CX AI foundation.


For as long as customer service has existed, demand has been rationed by two constraints: human capacity and cost. AI makes an entire tier of conversations that are too small or inconvenient to justify a human interaction economically viable for the first time. That turns scarcity into abundance. As the marginal cost of an interaction falls, so does the threshold for starting one. An issue that once failed to justify a 15-minute call may be more appealing to a customer if it’s just a 15-second exchange with an AI agent. Traditional metrics miss this hidden demand because they only measure what customers already tolerated.
...
Andy Traba is Vice President of Product Marketing at NiCE, where he establishes the narrative for AI platform innovation and its real customer and business impact. With over 20 years of experience spanning product, data, and operations, he has led high-impact go-to-market and innovation strategies for startups and global enterprises.


[See All Blogs](https://www.nice.com/blog/author/andy-traba)
