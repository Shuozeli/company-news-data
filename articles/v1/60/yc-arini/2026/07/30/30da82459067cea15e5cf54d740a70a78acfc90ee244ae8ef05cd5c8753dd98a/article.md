...
AR Aging Recovery Strategy Aging Bucket Recovery Rate Priority Action


**0–30 days** 95%+ Clean claim submissions + prompt patient statements


**31–60 days** 70–85% File denial appeals + SMS reminders + payment plan offer


**61–90 days** 50–70% Direct patient calls + escalated insurance appeals


**90+ days** 15–25% Triage each account: collection referral, settlement, or write-off
...
- Dental practices typically recover only **15–25% of AR that reaches 90+ days** , according to[dental AR benchmark data](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) consistent action at 31–60 days is the most effective strategy for protecting revenue.
- Best-performing practices keep[dental AR over 90 days](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) below **3% of total AR** practices with AR consistently above this threshold face significant revenue leakage.
...
- Your[dental net collection rate](https://dentx.ca/blog/dental-collection-rate-benchmarks/) should be **98%+** if it's consistently below that, aged AR is likely the primary drag on your practice financials.
...
- **PMS access and AR aging report capability** You need to run an aging report filtered separately by payer and by patient. Know how to generate this in your[practice management software](https://www.arini.ai/blog/how-to-integrate-ai-receptionist-practice-management-software) (OpenDental, EagleSoft, Denticon, CareStack, or Curve Dental). A combined report doesn't give you enough resolution to apply different strategies.
...
Most practices allow significant balances to sit unworked in the 90+ bucket without a structured protocol. Best-performing dental practices hold[AR over 90 days](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) under 3% of total AR, according to[dental AR benchmark data](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) .


For DSOs, the stakes extend beyond cash flow. A $100,000 bad debt write-off reduces EBITDA dollar-for-dollar and at a 5x valuation multiple, that single write-off reduces enterprise value by $500,000. For[multi-location groups](https://www.arini.ai/blog/multi-location-dental-practice) preparing for acquisition or investment, aged AR on the balance sheet is a material liability.
...
1. **Split insurance AR from patient AR** - Many PMS systems combine these in the default aging view. Create two working lists before doing anything else.
2. **Sort each bucket by balance, descending** - Work the highest balances first.
3. **Flag expired insurance appeal windows** - For claims in the 61–90 or 90+ bucket, verify whether the payer's appeal deadline is still open. Expired windows cannot be reopened.
4. **Check for duplicate or in-transit payments** - A 90+ day balance may already have payment in the clearinghouse pipeline. Check payer portals first.
5. **Identify zero-activity accounts** - Balances with no payment, no denial response, and no patient contact at 60+ days need immediate escalation, not routine follow-up.
6. **Note patient communication history** - A patient with multiple non-responses is categorically different from one who hasn't received a statement. Check your PMS contact log first.
...
AR Aging Recovery Priorities Aging Bucket Typical Recovery Rate Primary Strategy Urgency Level


**0–30 Days** 95%+ Clean claim submission + patient statement Low — routine process


**31–60 Days** 70–85% Denial appeals + billing reminders + payment plan offer Medium — act this week


**61–90 Days** 50–70% Direct patient calls + escalated insurance appeals High — last best chance


**90+ Days** 15–25% Triage: collection referral, write-off, or settlement Critical — triage first


*Recovery rate estimates based on industry benchmark data from*[IC System](https://www.icsystem.com/dental-accounts-receivable/) *and*[Pearly.co](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) *.*
...
At 6 months, per IC System research on dental AR recovery, indiscriminate pursuit costs more in staff time than it recovers across the portfolio see their[dental AR benchmarks](https://www.icsystem.com/dental-accounts-receivable/) for full data.
...
1. **Check balance size against your minimum threshold.** Balances under $50 with three or more prior contact attempts have an expected recovery of roughly $10 after staff time is factored in. Write them off and move on.
2. **Verify the collection agency sweet spot.** Accounts between $50 and $500, aged 90–180 days, where internal recovery has been exhausted, are the ideal profile for collection agency referral. Collection agencies typically charge 25–40% of collected amounts netting $150–$300 on a $500 balance is still a positive outcome.
3. **Confirm patient and insurance status.** If the patient has filed for bankruptcy, collection is legally restricted. If the patient is deceased, transition to estate billing protocols. These accounts should not enter your standard collection queue.
4. **Check the insurance appeal deadline.** If the claim aged past the payer's appeal window without a filed appeal, internal recovery is no longer possible. Write it off and note the missed deadline in your billing workflow review.
5. **Review patient contact history.** A patient who made a partial payment two months ago or has actively communicated about their balance is materially different from a patient with zero contact history. Recent activity even partial payment may extend the collection window under your state's statute of limitations rules.
...
Accounts Receivable Action Guide Scenario Recommended Action Reason


**Balance under $50, 3+ contact attempts, no response** Write off Cost to collect exceeds expected recovery at this balance level


**Balance $50–$500, 90–180 days, internal recovery exhausted, patient unresponsive** Collection agency referral Sweet spot for external recovery; net amount after agency fee is positive


**Patient deceased or bankruptcy filed** Write off immediately Collection legally restricted; staff time better allocated elsewhere


**Balance over $500, patient has been responsive or made partial payments** Payment plan or settlement offer before collection referral Recovery rate improves meaningfully with structured arrangement


**Insurance denied, appeal window expired, all internal options exhausted** Write off No remaining internal recovery path; carrying balance inflates AR metrics


**Any balance, 12+ months, zero payment activity or contact** Write off Collection probability near zero; carrying forward distorts practice financials


**The benchmark to monitor:** Bad debt write-offs should not exceed 2% of gross production. If your write-offs are consistently above that threshold, the problem is upstream review your[dental write-off percentage benchmarks](https://dentalbillingassist.com/blog/posts/dental-billing-kpis-benchmarks) and audit your patient collections process for the systemic gap.
...
[Arini's AI receptionist](https://www.arini.ai/blog/ai-for-dentists) handles this automatically during inbound scheduling calls collecting the patient's insurance provider, member ID, and group number and verifying eligibility in real time for supported payers. That information pushes directly into your PMS so your billing team submits accurate claims from day one.
...
Arini handles routine billing inquiries automatically in full HIPAA compliance learn how[automating billing inquiries](https://www.arini.ai/blog/how-to-automate-billing-inquiries-in-dental-practices) reduces the volume of balances that age past the first bucket. With 300ms response latency, conversations feel immediate and natural patients who call after hours to ask about a balance or make a payment receive the same quality of interaction as a live call. Most patients report they cannot tell they're speaking with AI rather than a staff member, which removes the hesitation that causes billing calls to go unreturned.
...
Best-performing dental practices keep AR over 90 days below 3% of total AR, according to[dental AR benchmark data](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable) . If your 90+ bucket consistently exceeds that threshold, a structured bucket-by-bucket recovery protocol should be your immediate priority.
...
Working dental AR by aging bucket with a specific protocol for each stage and a clear write-off decision framework is what separates practices that maintain a consistent[98%+ net collection rate](https://dentx.ca/blog/dental-collection-rate-benchmarks/) from those writing off more than they should.


The sustainable path to reducing aged AR is upstream: accurate insurance verification at intake, prompt patient statements, and consistent outreach before balances cross the 60-day line. For dental practices, DSOs, and multi-location groups where the front desk team doesn't have the bandwidth to run that outreach consistently because they're managing inbound calls, scheduling, and patient check-in at the same time[Book a Demo](https://arini.ai/) to see how an AI receptionist handles billing inquiries, runs outbound follow-up campaigns, and frees your team to focus on the insurance and high-value collection work that requires professional judgment.


*Related resources:*


- [Dental AR Over 90 Days Benchmarks](https://www.pearly.co/dentistry-huddle/dental-practice-benchmarking-for-accounts-receivable)
- [Dental Collection Rate Benchmarks](https://dentx.ca/blog/dental-collection-rate-benchmarks/)
- [Dental Write-Off Percentage Benchmarks](https://dentalbillingassist.com/blog/posts/dental-billing-kpis-benchmarks)
