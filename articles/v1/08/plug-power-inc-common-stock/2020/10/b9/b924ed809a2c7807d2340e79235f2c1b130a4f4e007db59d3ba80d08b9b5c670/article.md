...
document_id: "b924ed809a2c7807d2340e79235f2c1b130a4f4e007db59d3ba80d08b9b5c670"
...
Fifty-one of Plug Power’s[GenSure fuel cells](https://www.plugpower.com/fuel-cell-power/gensure-backup-power/gensure-low-power/) were on the front lines during the storm and after it passed, providing backup power that enabled the people in the path of the storm to keep in touch with each other, check on family members and do the work to get power back to the more than 540,000 customers who had outages.


**Plug Power’s Telecom Fuel Cell Performance**


In all, Plug Power’s 51[GenSure fuel cells](https://www.plugpower.com/fuel-cell-power/gensure-backup-power/gensure-low-power/) provided more than 1,573 run-hours of backup power for communications equipment – with the longest run duration being 7 days. The length of time served by each fuel cell was primarily determined by how quickly the primary utility power was restored, with average time being 30 hours. Hydrogen refueling was provided as needed by our[GenFuel hydrogen team](https://www.plugpower.com/hydrogen/genfuel/stationary-power/) to twelve of the sites while they continued to provide critical power.
