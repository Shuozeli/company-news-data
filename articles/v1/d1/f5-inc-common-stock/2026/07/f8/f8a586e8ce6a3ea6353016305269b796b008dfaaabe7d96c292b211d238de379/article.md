...
document_id: "f8a586e8ce6a3ea6353016305269b796b008dfaaabe7d96c292b211d238de379"
company_key: "f5-inc-common-stock"
company: "F5 Inc. Common Stock"
source_id: "f5-inc-common-stock-news-import-991598d866eb"
canonical_url: "https://www.f5.com/company/news/press-releases/frontier-ai-cyber-resilience-new-fleet-management"
published_at: null
first_seen_at: "2026-07-27T06:18:11.693235+00:00"
fetched_at: "2026-07-28T21:33:52.463534+00:00"
content_hash: "sha256:a02b1384bb43c568d1af5366140b28891027c7fedc98b4f9b3e5401e9871b821"
---
...
SEATTLE – F5 (NASDAQ: FFIV), the global leader in delivering and securing every app and API, today announced new fleet management capabilities for[F5 Insight for ADSP](https://www.f5.com/products/f5-insight) that help enterprises reduce risk exposure across F5 BIG-IP environments as[frontier AI](https://www.f5.com/frontier-ai-defense) compresses vulnerability response timelines. The new F5 Insight workflows give security and operations teams fleet-wide visibility, guided update management, enterprise authentication, role-based access controls, and a tamper-evident AI audit trail. This enables customers to move from identifying risk to taking accountable action across large, distributed application delivery and security fleets.


The new capabilities build on F5’s move to monthly[hardened software releases](https://www.f5.com/company/blog/release-cadence-security-notifications-frontier-ai) and reflect a broader shift in how F5 helps customers respond to AI-accelerated threats. As vulnerability response timelines shrink, enterprises need more than faster fixes. They need the operational control to understand what is exposed, prioritize updates, execute changes safely, and maintain a clear record of action across complex environments.
...
F5 Insight for ADSP v1.2 introduces fleet management workflows for[BIG-IP](https://www.f5.com/products/big-ip) devices, streamlining and simplifying the software update and patching process. Operations teams can see the software version, update readiness, and security posture of every device in their estate, then stage and execute updates across standalone deployments, HA pairs, and fleet segments with guided workflows designed to minimize downtime risk. Key capabilities include:
...
- **Blog:**[Announcing new fleet management capabilities within F5 Insight for ADSP](https://www.f5.com/company/blog/announcing-new-fleet-management-capabilities-within-f5-insight-for-adsp)
- **Blog:**[A faster release cadence: What’s changing at F5, and what you need to do](https://www.f5.com/company/blog/release-cadence-security-notifications-frontier-ai)
- **Blog:**[The operational reality of AI-era security and how we’re helping you meet it](https://www.f5.com/company/blog/the-operational-reality-of-ai-era-security-and-how-we-re-helping-you-meet-it)
- **Webinar:**[How F5 Insight for ADSP updates transform BIG-IP operations](https://www.f5.com/company/events/webinars/how-f5-insight-for-adsp-updates-improve-visibility-security-and-scalability)
- **Product trial:**[F5 Insight for ADSP](https://www.f5.com/trials/insight-for-adsp)
...
For more information visit[f5.com](https://www.f5.com/)
Explore F5 Labs threat research at[f5.com/labs](https://www.f5.com/labs)
Follow to learn more about F5, our partners, and technologies:[Blog](https://www.f5.com/company/blog) |[LinkedIn](https://www.linkedin.com/company/f5/) |[X](https://x.com/f5) |[YouTube](https://www.youtube.com/@F5_inc) |[Instagram](https://www.instagram.com/f5.global/) |[Facebook](https://www.facebook.com/f5incorporated)
