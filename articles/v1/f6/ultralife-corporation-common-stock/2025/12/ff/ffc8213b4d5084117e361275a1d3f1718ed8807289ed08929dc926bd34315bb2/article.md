...
document_id: "ffc8213b4d5084117e361275a1d3f1718ed8807289ed08929dc926bd34315bb2"
...
canonical_url: "https://blog.ultralifecorporation.com/blog/batteries-help-detect-water-leaks-to-stop-commercial-property-damage"
published_at: "2025-12-10T09:35:55+00:00"
first_seen_at: "2026-07-20T23:19:14.081824+00:00"
fetched_at: "2026-07-28T20:55:05.658267+00:00"
content_hash: "sha256:ec96494209c703deccd31d6c6b2fade5fd59a6815e7f2588f0b4a7a023036804"
---

# Batteries help detect water leaks to stop commercial property damage

A recent article in[Environmental Protection magazine](https://eponline.com/home.aspx) reports that ‘Internal water leaks are the number one cause of property damage in commercial buildings, surpassing fire, theft, and weather-related events combined’ and that ‘Water-damage deductibles of $100,000 to $200,000 are now common’. It is therefore essential to have reliably powered smart meters and water leak detectors that continuously look for signs of a leak.


Power failure is not an option when it comes to devices that can save properties and lives, such as pipe-fitted leak detectors, portable leak detectors and smart meters. These are applications in which the battery manufacturer[Ultralife Corporation](https://info.ultralifecorporation.com/contact-ultralife-battery-and-energy) specializes. The company started out as a detector battery manufacturer – over 30 years ago – and has sold over 100 million batteries containing its small and light[Thin Cells®](https://info.ultralifecorporation.com/thin-cell) . Additionally, Ultralife’s engineers worked closely with metering manufacturers to develop the[ER Generation X range](https://info.ultralifecorporation.com/er-cells) of Lithium Thionyl Chloride cells. These robust batteries are made from 100% stainless steel, so do not rust, and the[D-size bobbin cell](https://www.ultralifecorporation.com/ECommerce/product/er-generation-x/er-generation-x/uhe-er34615-x/d-ltc-bobbin-cell-gen-x) variant has a leading capacity of 19Ah, reducing the need for replacement.
...
[Lithium Thionyl Chloride batteries](https://info.ultralifecorporation.com/er-cells) are well-suited for use in remote applications, as they have a high energy density (exceeding 400Whr/Kg) that results in a long service life. Additionally, the high and stable operating voltage of Lithium Thionyl Chloride batteries provides consistent performance, maintaining the accuracy and reliability of data transmission over time.
...
If water around them reaches a certain level, an alarm will sound or a notification will be sent to a smartphone. Due to the small size of the device, many use Lithium Coin Cells but[Ultralife Thin Cells®](https://info.ultralifecorporation.com/thin-cell) (containing Lithium Manganese Dioxide chemistry) offer significant advantages.
...
For example, Ultralife’s[D size bobbin cell](https://www.ultralifecorporation.com/ECommerce/product/er-generation-x/er-generation-x/uhe-er34615-x/d-ltc-bobbin-cell-gen-x) offers an industry leading capacity of 19Ah that helps it to be embedded for the lifetime of the device.
