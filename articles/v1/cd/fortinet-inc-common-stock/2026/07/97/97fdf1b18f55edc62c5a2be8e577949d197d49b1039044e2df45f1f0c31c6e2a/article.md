...
document_id: "97fdf1b18f55edc62c5a2be8e577949d197d49b1039044e2df45f1f0c31c6e2a"
...
canonical_url: "https://www.fortinet.com/corporate/about-us/newsroom/press-releases/2026/fortinet-launches-fortisoc-unified-soc-platform-powered-by-agentic-ai"
published_at: null
first_seen_at: "2026-07-22T22:16:43.729571+00:00"
fetched_at: "2026-07-28T21:40:00.658555+00:00"
content_hash: "sha256:046df04204850dfe3ecb00afe963f8801763f7ec33a3c6dbfee26d1d244d1a16"
---
...
Fortinet announced the availability of FortiSOC, a unified, cloud-delivered security operations center (SOC) platform powered by agentic AI.


**Mentions In This Article**


- [Read more about FortiSOC](http://www.fortinet.com/products/fortisoc)
...
Fortinet® (NASDAQ: FTNT), the global cybersecurity leader driving the convergence of networking and security, today announced the availability of[FortiSOC](http://www.fortinet.com/products/fortisoc) , a unified, cloud-delivered security operations center (SOC) platform. FortiSOC brings together six security operations functions into a single Software-as-a-Service (SaaS) experience and embeds agentic AI to autonomously investigate and correlate alerts across assets and identities, then recommend or execute response actions under analyst oversight. Built on Fortinet’s proven security operations (SecOps) technologies, FortiSOC helps organizations simplify and scale modern operations through one console, one subscription, and one unified operating model.
...
FortiSOC is designed to simplify how organizations operationalize security operations by unifying security information and event management (SIEM); security orchestration, automation, and response (SOAR); threat intelligence; and behavioral and identity threat detection (ITDR) into a single platform. With agentic AI and FortiGuard Labs threat intelligence, FortiSOC extends the SecOps innovations introduced at[Fortinet Accelerate 2026](http://www.fortinet.com/corporate/about-us/newsroom/press-releases/2026/fortinet-advances-its-security-operations-platform-with-unified-soc-agentic-ai-and-expanded-endpoint-security) by integrating analytics, investigation, automation, and response workflows into a single cloud-delivered experience for modern environments. FortiSOC enables security teams to move from alert to investigation to response with reduced friction, fewer operational silos, and stronger cross-environment visibility.
...
Read the[blog](http://www.fortinet.com/blog/security-operations/introducing-fortisoc-one-platform-total-control) and listen to the[webinar](https://global.fortinet.com/lp-en-wc-socreimagined?utm_source=Blog&utm_medium=Fortinet-led&utm_campaign=AI-DrivenSecOps-GLOBAL-Global&utm_content=WC-AgenticAI-G&utm_term=SOC-Reimagined&lsci=701Pr00000mO7MUIA0) for more detail on how FortiSOC helps streamline SecOps and accelerate detection and response.


**Additional Resources**


- Learn about[FortiSOC](http://www.fortinet.com/products/fortisoc) .
...
- Visit[fortinet.com/trust](http://www.fortinet.com/trust) to learn more about Fortinet innovation, collaboration partners, product security processes, and enterprise-grade products.
