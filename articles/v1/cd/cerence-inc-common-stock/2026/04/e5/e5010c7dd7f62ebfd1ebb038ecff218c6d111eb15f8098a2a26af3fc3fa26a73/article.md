...
document_id: "e5010c7dd7f62ebfd1ebb038ecff218c6d111eb15f8098a2a26af3fc3fa26a73"
...
canonical_url: "https://www.cerence.com/newsroom/blog/text-to-speech-eu-ai-act"
...
content_hash: "sha256:4ce927ec8e6253a5e2f0a95b0c3c81885793f0cf160b303691649268bf3bfb08"
---

# EU AI Act Compliance and Why Trusted Text-to-Speech Matters Now More than Ever

High‑quality, realistic, and expressive synthetic voices are now core interface layers across assistants, applications, services, and devices. Text‑to‑Speech (TTS) underpins conversational AI, accessibility solutions, customer interaction channels, and generative AI experiences.


At the same time, trust in AI‑generated content has become a regulatory and societal priority. The[EU Artificial Intelligence Act](https://artificialintelligenceact.eu/) (EU AI Act) is one of the first legal frameworks to explicitly address this need.
...
For[Cerence AI](https://www.cerence.com/) , the EU AI Act is not just another compliance topic, but rather an opportunity to strengthen our product with transparency and verification at the center of our offering, setting clear trust guardrails for the AI-generated voice interfaces changing how we interact with technology.
...
For organizations that deploy TTS across cloud services, embedded environments, or hybrid architectures, this represents an important shift:[TTS voice output](https://www.cerence.com/products/speech-input-output#tts) is no longer just an output modality; it is a traceable and accountable AI artifact.
...
Trust is our North Star, and rather than waiting for final enforcement milestones, we have already designed and delivered a compliant Cerence AI TTS product. At the same time, we’re proactively supporting our customers to help them align with the evolving[Code of Practice](https://digital-strategy.ec.europa.eu/en/policies/code-practice-ai-generated-content) .
