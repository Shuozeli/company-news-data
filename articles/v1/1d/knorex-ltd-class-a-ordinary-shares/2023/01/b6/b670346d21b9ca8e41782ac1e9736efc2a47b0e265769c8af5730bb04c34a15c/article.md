...
document_id: "b670346d21b9ca8e41782ac1e9736efc2a47b0e265769c8af5730bb04c34a15c"
company_key: "knorex-ltd-class-a-ordinary-shares"
company: "KNOREX LTD. Class A Ordinary Shares"
source_id: "knorex-ltd-class-a-ordinary-shares-rss-21729167ea84"
canonical_url: "https://investor.knorex.com/location-based-advertising-2/"
published_at: "2023-01-25T00:34:13+00:00"
first_seen_at: "2026-07-25T10:57:52.857484+00:00"
fetched_at: "2026-07-28T21:02:31.747135+00:00"
content_hash: "sha256:b06f1102d8e3024814da3345fb132387df7e0702541b02d4f154daca3c3959b2"
---

# Complete Guide to Location-Based Advertising (LBA) in 2023 – Geo-Targeting, Geo-Fencing, Geo-Conquesting, Proximity Targeting

It is imperative that retailers must make themselves as discoverable as possible online in this digital age. With Covid-19 pandemic easing, marketers of brick-and-mortar stores may want to double down or start looking at embracing location based advertising (LBA) to target their prospects who are within the vicinity of their store to check out their products and services.
...
***A report shared by***[Factual](https://www.factual.com/blog/factuals-2019-location-based-marketing-report/) ***says that 9 out of 10 marketers believe that LBA creates higher sales, growth in the customer base (by 86%) and an increase in customer engagement (by 84%).***
...
As per prediction by[GrandViewResearch](https://www.grandviewresearch.com/industry-analysis/location-based-advertising-market) , the global location-targeted ad spend in 2019 was valued at USD 62.35 billion and forecasted a compounding annual growth rate (CAGR) of 17.4% from 2020 to 2027.


[The Global Location Trends Report (2020)](https://thelbma.com/wp-content/uploads/2020/12/Global-Location-Trends-Report-2020-THE-LBMA.pdf) , found that 95% of global companies are employing this medium to reach their consumers. A global average of a whopping 52% was allocated to location based marketing budgets and investments in 2020. Despite stagnant growth in this area for 2020 in light of the pandemic, markets still recognize the value of location based marketing and have invested large portions of marketing budgets in location based advertising. Despite the slowdown, the increasing reliance on digital adoption consequently shift advertisers’ methodologies to reach their audience and inevitably propelled the use of LBA across industries. LBA can be a viable channel mix, especially for some businesses when used strategically.


## **How Covid-19 has changed the prospects of brick-and-mortar stores: Understanding the consumer behavior of store visits**


It’s been almost three years since the start of Covid-19 pandemic. Throughout this period, it has disrupted many businesses, especially brick-and-mortar retailers where many were decimated due to the sudden plunge in footfall traffic. However, things are looking up,[footfall has been gradually rising](https://www.statista.com/statistics/1133634/coronavirus-yoy-foot-traffic-growth-by-week-us/) in recent times where people are learning to live and cope with the pandemic.


Covid-19 has drastically changed consumers’ behavior — purchase shifted online. Online purchase became almost the primarily, if not the only, mode for many as the pandemic reached its height. Today, a large number of consumers across many sectors whether it is when purchasing for[automobile](https://investor.knorex.com/blog/articles/automotive-marketing-strategies) , fashion, footwear, furniture, home appliances and more, would first research online, then visit a brick and mortar store to view or try out the goods in person before finally making a purchase at that moment in-stores or perhaps even back online.


Even though some industries such as F&B do not have a similar buyer journey as the above, LBA is still applicable and can be highly effective. LBA allows for targeting of high intent audiences when consumers are out of their homes and especially when they are at certain locations. Although visiting a store may not always lead to a sale purchase at that moment, it plays a vital part of the customer journey that leads to eventual sales conversion.


## **What is location-based advertising (LBA)?**


*What exactly is LBA and why is it effective in reaching prospects?*


LBA lets marketers send marketing messages to prospects when they are within a certain distance from either certain place of interests or their business premises. Businesses can tailor their messages based on the retail location, routes, weather, and of course, behavioral patterns of their local customers.
...
[“The State of Location-Tracking Mobile Apps in 2019”](https://themanifest.com/app-development/location-tracking-mobile-apps) report shows that 96% of the surveyed adults (727) have seen an ad that references their location.
...
LBA is affected by various parameters. As a marketer, you may need to collect and leverage on different sets of information to efficiently reach out to your target group of customers.
...
When it comes to “[contextual targeting](https://investor.knorex.com/blog/articles/what-is-contextual-advertising) ”, we often associate that with targeting based on texts that users are viewing or browsing. Yet, context has far broader application. Location is yet another contextual signal which in turn could render a few interesting signals. LBA could provide hyper contextual data that’s meaningful to select a group of audience or the “micro-audience”.
...
[Geofencing](https://www.mobileads.com/blog/geofencing) is similar to place-based advertising since it allows you to target customers within a fixed and predefined area. Areas are defined based on the longitude and latitude information that is derived from a user’s mobile device.
...
The technique uses global positioning systems (GPS) along with[radio frequency identification (RFID)](https://www.abr.com/what-is-rfid-how-does-rfid-work/) to create a “fence”.
...
1. **Personalization:** Personalizing an ad based on the consumer’s location increases the likeliness to show them something relevant.
2. **Timeliness:** Since location-based content is served to consumers in real-time, it increases the chances of brands targeting consumers dynamically at precise moments.
3. **Targeted** : Speaking directly to a defined audience helps you to attract high-quality leads and drive conversions.


***And the results?***


**Prudent Ad Spent:** Spend your marketing budget efficiently by reaching a specific target audience at the right time.[Mobile advertising is highly effective](https://investor.knorex.com/blog/articles/why-is-mobile-advertising-effective#3_Cost-effectiveness) but LBA is a low-cost highly-targeted tool to further sharpens your campaign to help you meet your ROI.


As per the[Location Based Marketing Report by Factual](https://s3.amazonaws.com/factual-content/marketing/downloads/Factual-2019-Location-Based-Market-Report.pdf) , LBA helped in increase the effectiveness of campaigns evident through an 89% increase in sales, 86% growth in customer base and 84% increase in audience engagement.
...
- Optimize the features of[mobile advertising](https://investor.knorex.com/blog/articles/mobile-advertising) . These include contextual, in time, personalized, etc.
...
In order to show your ads to the target consumers every time they are surfing the Internet (or even at a specified relevant time), you need to buy ad space. Solutions like using[Demand Side Platforms (DSP)](https://digiday.com/media/wtf-demand-side-platform/) are used for media buying and location targeting. DSPs can be in the “do it yourself” models or can be handled by managed services. Most service providers will typically ask for a minimum ad spending per campaign.
...
Various creative ad services are offered by rich media vendors available in the market. Most organizations have ready to push[templates](https://investor.knorex.com/blog/ad-templates/new-creative-ad-templates) that can be modified based on your needs. A rich media ad can be included in a pre-packaged plan in addition to other services like media buying, optimization, etc.
...
Based on empirical research on[Behaviorally targeted location-based mobile marketing (Bernritter et. al, 2021)](https://link.springer.com/article/10.1007/s11747-021-00784-0#citeas) , in order to reduce resistance to your ad message, run out-store LBA displaying **non-price promotions** (i.e. informing consumers about products and services without discounts) to consumers with **high** personal relevance and offer **price promotions** to consumers with **low** personal relevance.
2. **Compelling Creatives and Call-to-Actions (CTA)**
...
1. **Accuracy –** The distance between the estimated location and the actual location.
2. **Precision –** Level of pinpointing for a particular device location. Lat longs that measure up to two decimal points are precise within one km of the user location whereas those measuring up to 4 decimal points can be precisely pinpoint within 10 meters.
3. **Recency –** The time lapse between when the location data was collected and when it is passed on to the ad servers.
...
**Starbucks** uses LBA mobile ads to successfully target their prospects. The metric for the measurement of success was the footfall or the number of people that walked into the food outlet after seeing the advertisement.
...
The result? An overall increase in the likeliness of people clicking the ad, visiting the store and inquiring or booking appointments for the car. In another[article](https://investor.knorex.com/blog/articles/automotive-marketing-strategies) , we explore[8 key advertising strategies](https://investor.knorex.com/blog/articles/automotive-marketing-strategies) to drive conversion in the automotive industry across each stage of the customer journey.
...
As the pandemic eases, footfall to retail stores is recovering. Marketers should restart if yet to do so, to tap on LBA ads to reach out to their desired audience. LBA helps to lift yet another source of traffic albeit primarily to the retail stores.


Contact us to[request a demo](https://investor.knorex.com/contact-us) to start driving footfall traffic and conversions!


Tags:


[LBA](https://investor.knorex.com/tag/lba/)[location app](https://investor.knorex.com/tag/location-app/)[location based advertising](https://investor.knorex.com/tag/location-based-advertising/)
