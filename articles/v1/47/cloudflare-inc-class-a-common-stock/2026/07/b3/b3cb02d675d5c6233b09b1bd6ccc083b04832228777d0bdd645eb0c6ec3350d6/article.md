...
document_id: "b3cb02d675d5c6233b09b1bd6ccc083b04832228777d0bdd645eb0c6ec3350d6"
...
canonical_url: "https://blog.cloudflare.com/making-ai-search-smarter/"
...
So we're starting to shape Pay Per Crawl into Pay Per Use. We're running experiments with top AI companies, like[Ceramic.ai](http://ceramic.ai/) and[You.com](http://you.com/) , and the arrangement is straightforward: organizations can bring their payment models and easily scale them to content owners across the Cloudflare network.
...
*Building on the open, agent-ready web? If you are interested in learning more about the Ceramic and You programs, please fill out[this form](https://forms.gle/ZWxi1pnHoFFZZBDC8) . If you're building an answer engine and want to crawl smarter, we’d love to hear from you too: aeo@cloudflare.com.*
