...
document_id: "da6f0fcab6ed2a67418ac9f50b34c0b33bd88b65cae31579fe9176c07d6eb45f"
...
canonical_url: "https://www.atlassian.com/blog/ai-at-work/mercedes-benz-ai-agents-enterprise"
published_at: "2026-07-08T18:20:19+00:00"
first_seen_at: "2026-07-24T17:38:21.036095+00:00"
fetched_at: "2026-07-28T21:22:09.082656+00:00"
content_hash: "sha256:e4925cce8f73ca3d51f5cb56480a8afcbaef743a66c1f1ae90ba8e152287dce6"
---

# Why AI alone isn’t enough for enterprises (and what Mercedes-Benz did about it)

*The learnings in this blog post are based on the session, “How Mercedes turns Teamwork Graph into an AI advantage”, presented at Atlassian’s Team ’26 conference.*[You can](https://events.atlassian.com/team/)[check out this session and others on demand.](https://events.atlassian.com/teameurope-digital/session-preview?sId=3410555)
...
When you ask individual users whether AI tools have helped them, more than 50% say “yes”, that they’ve actually saved time and effort. But when you zoom out and[ask companies whether they’ve seen dramatic improvements to their business, 96% report that they have not](https://www.atlassian.com/blog/AI-Collaboration-Report-2025) . The technology is there, but unlocking the enterprise-level value has been stubbornly difficult.
...
Mercedes-Benz recognized that if they could connect their various data sources through the Teamwork Graph, Atlassian’s living map of how the organization actually works, they could re-imagine the entire defect lifecycle. They brought together requirements data from IBM Doors, code repositories, release management information, physical part and asset data, and telemetry from test vehicles streaming log data to a central data hub.


With these sources connected through the Teamwork Graph the entire set of relationships between a defect, the requirement it traces to, the code that implements it, and the vehicle configuration where it was observed becomes traversable.
...
**Defect Norris** handles quality assurance at intake. **Analyze the Snores** reaches out to central data hubs to pull log data and telemetry related to the specific vehicle and event. And the third agent, **Main Norris** , handles the regulatory and safety context.
...
Mercedes-Benz’s results aren’t a one-off, but rather a preview of what’s possible when AI has the right foundation to work from. The Teamwork Graph is a connected, living map of your organization’s work that gives AI agents the context they need to act with precision, not just speed.


While Teamwork Graph captures the most important use cases across industries, almost every organization has its own unique tools and workflows. A home loan company might need to bring data from a specialized testing platform. An aerospace company might want to connect its project management tool. A social media company might need to surface data from a custom sales system.
...
Experience the power of the[Teamwork Graph](https://teamworkgraph.com/) for yourself and see your graph preview.
