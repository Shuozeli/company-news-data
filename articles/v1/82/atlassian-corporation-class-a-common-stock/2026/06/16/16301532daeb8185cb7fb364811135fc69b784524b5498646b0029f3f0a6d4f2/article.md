...
document_id: "16301532daeb8185cb7fb364811135fc69b784524b5498646b0029f3f0a6d4f2"
...
canonical_url: "https://www.atlassian.com/blog/ai-at-work/three-ways-atlassians-learning-team-uses-ai-and-one-way-they-wont"
published_at: "2026-06-22T18:11:26+00:00"
first_seen_at: "2026-07-28T23:52:22.306761+00:00"
fetched_at: "2026-07-28T23:52:24.153841+00:00"
content_hash: "sha256:e61c04b63e75d7b383a4a168406b2e88b1b9483396bfe2a6fcbe1d007c8f5d15"
---

# Three ways Atlassian’s Learning Team uses AI, and one way they won’t

*The best way to get value out of AI is to scale at the team level, but while*[85% of workers use AI, only 29%](https://www.atlassian.com/blog/state-of-teams-2026) *have embedded it into team workflows.*[The Atlassian Learning Team](https://community.atlassian.com/forums/Training-Certification-articles/Behind-the-scenes-with-Atlassian-Learning/ba-p/2985912) *is in that 29%, and the lessons they’ve learned are a model for teams of all types. They shared three ways teams can start becoming AI native today.*


[The Atlassian Learning Team](https://community.atlassian.com/learning) helps Atlassian app users build skills and confidence with[free on-demand courses](https://community.atlassian.com/learning/hub/all-learning-paths) , dynamic[live team training](https://community.atlassian.com/learning/catalog?type=Team+training) , and[app adoption guides](https://community.atlassian.com/learning/adoption) for teams. The Learning Team loves new technology, but their top priority is creating excellent customer experiences.


So when[Atlassian’s in-app AI, Rovo](https://www.atlassian.com/software/rovo) , launched last year, the team began exploring ways it could help them build content for the[Learning catalog](https://community.atlassian.com/learning) without handing over control or compromising on quality.
...
The Learning Team thought[Rovo Deep Research](https://community.atlassian.com/learning/path/get-the-most-out-of-rovo/course/get-help-from-rovo-search-and-chat/lesson/get-help-from-rovo-chat#get-the-most-out-of-rovo-chat) , a feature in Rovo Chat, could help, and they created a simple, short prompt any team can adapt to their needs:
...
So, each team member added the[Loom notetaker](https://community.atlassian.com/learning/collection/topic/loom-ai-notetaker) to their calendars, and now every meeting is recorded. Afterward, everyone gets the AI summary Loom automatically creates in Confluence, and it includes action items. Team members can then send the video and summary to anyone who attended (or missed) the meeting.
...
The team takes their Confluence notes and ideas and uses[Create with Rovo](https://community.atlassian.com/learning/collection/topic/create-with-rovo-in-confluence) to get a draft. They always edit or rewrite what Rovo gives them, but Rovo helps them over the hurdle of putting something on the page. Because Atlassian has so much internal documentation, and because everyone throughout the company shares their work in Confluence, Rovo has a lot of context to work with.


One Learning Team member shared how she used Rovo to help her describe why someone without any previous experience with[Jira Plans](https://community.atlassian.com/learning/course/jira-plans-tutorial) would want to use it. She asked Rovo to:
...
Find out how to[generate all types of content with Rovo](https://community.atlassian.com/learning/lesson/generate-new-content-using-rovo) .
...
*If you haven’t tried Rovo or Loom yet, check out the Learning Team’s free, self-paced, on-demand courses:*[Get the most out of Rovo](https://community.atlassian.com/learning/hub/all-learning-paths/path/get-the-most-out-of-rovo) *and*[Get the most out of Loom](https://community.atlassian.com/learning/hub/all-learning-paths/path/get-the-most-out-of-loom) *. If you already have a Rovo foundation, the*[Work more effectively with Rovo](https://community.atlassian.com/learning/collection/topic/work-more-effectively-with-rovo-ai) *collection of resources offers more advanced support.*
