...
document_id: "9116c56771d1d9f03ae408254762a24484296b00d780bbf0fd78e1a2a092c323"
company_key: "yc-usergems"
company: "UserGems"
source_id: "yc-usergems-news-import-b2a9aa8bde01"
canonical_url: "https://www.usergems.com/blog/how-to-build-account-based-marketing-sales"
published_at: "2026-07-29T00:33:22.933+00:00"
first_seen_at: "2026-07-29T00:10:06.522299+00:00"
fetched_at: "2026-07-29T00:10:07.497042+00:00"
content_hash: "sha256:f3f256e844f1336eeb7bd99b9d02523416768704638b66dec8eeb9707183e628"
---

# The 'No-BS' guide to building an Account-Based Everything program from scratch

Account-based Marketing and account-based everything programs have become standard practice for B2B revenue teams over the last few years.
...
But there's almost nothing out there for them.


We built our account-based everything program from scratch and 5xed revenue in one year—targeting just 200-300 accounts per month. No special tools. No agency. No massive budget.


I’m[Trinity Nguyen](https://www.linkedin.com/in/trinitynguyen/) , VP of Marketing, UserGems, and I’m going to walk you through the foundations of account-based everything programs, share key success factors, and provide a step-by-step blueprint for implementing account-based everything.
...
Rather than chasing individual leads or spray-and-pray outreach, you identify which target accounts show buying signals—job changes, intent data, relationship connections—and coordinate sales and marketing around those accounts.
...
Account-based everything requires your entire revenue team to align around the same target accounts and coordinate their efforts.For account-based everything to work for your business, you have to:
...
“A key difference \[between account-based marketing and account-based everything\] is the focus on account-based customization at every stage for marketing AND sales in account-based everything,” explains[Isaac Ware](https://www.linkedin.com/in/isaac-ware) , Director of demand generation at UserGems.


**Benny Bridger** , Director of Demand Generation,[CloudAcademy,](https://cloudacademy.com/) adds, “Account-based marketing doesn’t work by itself, or at least, it shouldn’t work independently so that we can collectively prioritize time, effort, and budget on high priority prospects. I also call it ABSM — account-based sales and marketing.”
...
[Check out 65 account-based marketing statistics](https://www.usergems.com/blog/abm-statistics)
...
UserGems has successfully implemented account-based everything for both mid-market and enterprise segments.. We’ve made account-based everything work for our mid-market segment as well as our enterprise targets.


Having said that, if you target small and midsized businesses (SMBs), and the average contract size is less than $10k-15k per year, account-based everything may suit businesses with higher contract values better.
...
If your average contract size is more **than $15k per year, account-based everything** works—you just need to adapt your approach to fit your audience and budget. Keep in mind there’s no one-size-fits-all account-based everything program — adapt your approach to fit your audience and budget, start small, iterate quickly, and scale.


### 2. Account-based marketing frameworks fail without alignment


Account-based everything strategies fail due to misalignment between sales and marketing teams.


Failure happens due to misalignment between sales and marketing teams. Specificallywhen they don't go after the same accounts together.


As I explained in this article on[why ABM campaigns fail](https://www.usergems.com/blog/b2b-account-based-marketing) , “In one of my previous companies, we had all the[best ABM tools](https://www.usergems.com/blog/how-to-build-account-based-marketing-sales) . We also had alignment on our target account list and process. We believed we had alignment.


A quarter after launching the program, we realized that the sales team only worked on half of the target accounts. So essentially, the marketing team wasted 50% of their ABM spending. The results fell short of the team's expectations. This led to mistrust between the two teams, and there went the ABM program.”
...
It sounds simple, but according to a[2021 ABM Benchmark Study](https://abmleadershipalliance.com/ebook/embedding-abm-2021-benchmark-study/) , stronger alignment between sales and marketing teams correlates with having productive ABM programs.
...
When we started our program, the conventional wisdom was we should run ads for 2-4 weeks to “warm up” the accounts before we moved forward with sales prospecting efforts. But, we noticed our booking rate went up significantly when our ad campaigns and sales prospecting started on the same day.
...
But it’s generally challenging to “herd cats.” So to[build habits](https://www.usergems.com/blog/sales-rep-development) and make sure the team knows what they should be doing at every stage, we’ve been very intentional about turning our account-based everything program into a recurring cadence.
...
[34 ABM tools that help with orchestration of your ABE program!](https://www.usergems.com/blog/account-based-marketing-tools)


At UserGems, we use AI to surface the right prospects automatically and rank them based on buying signals—job changes, previous customer status, recent promotions. Our AI agents then draft personalized outreach based on this context, so reps spend time on conversations, not research.
...
Most revenue teams focus on[segmentation](https://www.usergems.com/blog/account-based-marketing-segmentation) and personalization when building out an account-based everything program. At UserGems, the past two years have taught us it should come after[sales and marketing alignment](https://www.usergems.com/blog/how-to-build-account-based-marketing-sales) . If you don’t have that locked down, a lot of your personalization efforts will be wasted. But when you get alignment right, you see real results.
...
This step takes time, but it's what makes the difference between a campaign that converts and one that wastes budget.


If you’re not sure where to start, an internal product marketer is usually your go-to person to help define your ICP. A report by Gartner on companies using an account-based everything framework revealed that[81%](https://www.metadata.io/webinar-reg-2020-abm-trends) of top-performing companies are confident in their ICP.
...
The sales and marketing teams work closely during this process and set parameters to prevent our account-based everything strategy from getting out of hand. For example, if a sales rep wants to add an account just because they saw it on a billboard, but it doesn’t fit the criteria, it’s a no from us. This happens more often than you'd think.
...
For most companies, this task falls to sales reps. Each sales rep typically has 20 to a few hundred accounts to research. These insights end up in individual Google Docs or post-it notes, never shared with marketing.
...
To illustrate UserGems’ value proposition, our creative shows an example of the target account’s own customer who changed jobs to a new company. ( *FWIW - This is our main product - playbooks for*[automating pipeline generation](https://www.usergems.com/blog/how-to-build-account-based-marketing-sales) *through turning*[buyer job changes](https://www.usergems.com/blog/tracking-buyer-job-changes) *and relationship insights into qualified pipeline* ). This way, we show (instead of telling) them the benefits of targeting previous customers in a way *specifically relevant to them* .
...
We’ve seen great success with a quarterly cadence for[sales enablement](https://www.usergems.com/blog/sales-enablement) . But to be honest, this is an area we are still working on as we scale.
...
- Number of prospects per account to encourage[multi-threading](https://www.usergems.com/blog/sales-multithreading) from the start
...
To do this quickly at scale, our ADRs use our own[ABM playbook](https://www.usergems.com/blog/pipeline-generation) which:
...
It allows us significantly scale the account-based everything program targeting 200-300 accounts per month with only 2-3 ADRs. Our product solved this exact problem for our own team.


But[it’s 100% true.](https://www.linkedin.com/feed/update/urn:li:activity:6912421631659245568?commentUrn=urn%3Ali%3Acomment%3A%28activity%3A6912421631659245568%2C6912497440965222400%29)


[‍](https://www.linkedin.com/feed/update/urn:li:activity:6912421631659245568?commentUrn=urn%3Ali%3Acomment%3A%28activity%3A6912421631659245568%2C6912497440965222400%29) If your team has other[sales intelligence software](https://www.usergems.com/pages/sales-intelligence-software) like ZoomInfo or LinkedIn Sales Navigator, you could try doing this too. But it might be a lot more manual work, which means reps might not evaluate all the accounts thoroughly.
...
Need inspiration for what that one-to-one treatment actually looks like? These[account-based marketing examples](https://www.uglygtm.com/blog/account-based-marketing-examples) break down eight campaigns that worked, from a custom comic book that won a Fortune 500 account to $5,280 of Masters swag that returned roughly 40x in pipeline.
...
Which factors actually make an account-based everything program successful? Here are tips from our in-house sales and marketing experts, and Miguel Palma, Head of Marketing at[Appsembler](https://www.appsembler.com/) , a developer marketing startup that has run similar account-based everything frameworks.
...
Make sure you’re setting your team up with the warmest paths into an account by finding the most likely buyers with relationship data (like previous customers, previous prospects, and new executives) and[intent data](https://www.usergems.com/blog/how-to-build-account-based-marketing-sales) (such as newsletter subscribers, followers, and website visitors).


Your past customers are 3x likely to buy from you again. With UserGems, you can take advantage of the buyer job-change trigger to automate[lead generation](https://www.usergems.com/blog/how-to-build-account-based-marketing-sales) and relationship insights to build a qualified pipeline.


### Expert tip #2: Nurture throughout the buying journey


Similar to other marketing campaigns, don’t forget to retarget and continue nurturing the prospects throughout the sales funnel, i.e., open opps.


Your success rate improves when retargeting campaign messaging matches your top-of-funnel account-based everything campaigns.


“For lower tiered contacts, have proper fit-for-purpose messaging with routing/sequences doing all of the heavy lifting,”[Blaise Bevilacqua](https://www.linkedin.com/in/blaise-bevilacqua) , Enterprise Account Executive at UserGems, recommends.
...
Marketing requires strong product-market fit to succeed. "Account-based everything requires solid product-market fit as a foundation," says Miguel Palma.


Establish product-market fit before implementing account-based everything. Instead, it’s something you use to scale an existing product-market fit and a large enough market.
...
“Focus on automating as much as possible, but embrace pushing boundaries by doing things that require manual effort,” advises Isaac Ware, Director of demand generation at UserGems.


Otherwise, you’ll end up spending time justifying the ROI of the tool instead of driving revenue from target accounts.


Start small, get results, iterate, templatize, then scale.
...
Looking for an ABM checklist?


[Get your ABM checklist](https://www.usergems.com/content/abm-checklist)
...
Grab your FREE checklist with all these ABM tips
