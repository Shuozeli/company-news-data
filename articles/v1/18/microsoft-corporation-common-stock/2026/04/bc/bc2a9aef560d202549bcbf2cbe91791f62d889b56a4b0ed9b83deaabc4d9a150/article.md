...
document_id: "bc2a9aef560d202549bcbf2cbe91791f62d889b56a4b0ed9b83deaabc4d9a150"
...
canonical_url: "https://www.microsoft.com/en-us/power-platform/blog/2026/04/15/making-business-apps-smarter-with-ai-copilot-and-agents-in-power-apps/"
published_at: "2026-04-15T15:00:00+00:00"
first_seen_at: "2026-07-24T05:43:33.356370+00:00"
fetched_at: "2026-07-28T21:56:44.009033+00:00"
content_hash: "sha256:b722af4dc38bbc9c7b65f2d404d8c24cc2cffd755e903caf29d051f664a5d9d4"
---

# Making business apps smarter with AI, Copilot, and agents in Power Apps

Every enterprise runs on its applications. Applications hold the business rules, the permissions, and the process knowledge that keeps work moving. We’re making the apps that you use daily dramatically more intelligent and productive. With these new updates,[Microsoft Power Apps](https://www.microsoft.com/en-us/power-platform/products/power-apps) brings AI, Copilot, and agents directly into the apps and extends those apps’ intelligence out to the AI surfaces where work happens.


[Build AI-first applications with Power Apps](https://www.microsoft.com/en-us/power-platform/products/power-apps)
...
- **[Agent feed](https://learn.microsoft.com/en-us/power-apps/user/supervise-agents-with-agent-feed) with[Power Apps MCP Server](https://learn.microsoft.com/en-us/power-apps/maker/model-driven-apps/power-apps-mcp-server#invoke_data_entry)** will be generally available on May 4, 2026, giving users a dedicated experience to supervise agent activity directly inside their business apps.
...
[Watch the Business Applications Update event: Power Platform and Copilot Studio edition](https://aka.ms/PPCSBAUReg)
...
As[agents execute more tasks](https://www.microsoft.com/en-us/microsoft-365-copilot/agents) , the question is how to keep humans in the loop at the right moments. The agent feed in model-driven apps, generally available in May 2026, answers that directly.
...
From embedding intelligence directly in apps, to extending app capabilities across AI surfaces like Copilot and custom agents, to empowering seamless human-AI collaboration through the agent feed, every component is connected. Together, this answers the question business and IT leaders are asking: how to[bring AI into core business processes](https://www.microsoft.com/en-us/power-platform/products/power-apps#use-cases) with real impact, without starting from scratch. This is what makes the shift from experimentation to execution real for the enterprise.


Watch the[Business Applications Update event](https://aka.ms/PPCSBAUReg) for product demos that show how apps, agents, and Microsoft 365 Copilot drive business transformation.
