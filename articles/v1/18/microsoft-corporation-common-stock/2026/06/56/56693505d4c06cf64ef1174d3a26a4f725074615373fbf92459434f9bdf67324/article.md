...
document_id: "56693505d4c06cf64ef1174d3a26a4f725074615373fbf92459434f9bdf67324"
...
canonical_url: "https://azure.microsoft.com/en-us/blog/announcing-microsoft-discovery-general-availability-and-microsoft-discovery-app-preview/"
...
content_hash: "sha256:bee28c35db09253e2902940b9ffd3d6feee9f8b6ac8b63ce27b757409653f23f"
---
...
[Microsoft Discovery enables organizations to define agentic workflows](https://azure.microsoft.com/en-us/solutions/discovery/) around their own R&D programs. Teams can create and coordinate specialized agents, connect those agents to institutional knowledge and external scientific information, and orchestrate work across modeling, simulation, analysis, and validation tools.


At the center of the platform is[the Microsoft Discovery Engine](https://learn.microsoft.com/en-us/azure/microsoft-discovery/concept-discovery-engine) , which supports the core loop of scientific work by helping teams move from evidence to hypotheses, through execution and analysis, and into the next iteration. This loop allows teams to move beyond isolated analysis toward repeatable, evidence-driven exploration, where they can compare tradeoffs, question assumptions, and narrow a search space in a way that can be reviewed and repeated.


*Figure 2: The Microsoft Discovery Engine task creation and status overview* .


As we continued product development, we focused on what it takes to[bring agentic AI into production R&D environments](https://azure.microsoft.com/en-us/blog/microsoft-discovery-advancing-agentic-rd-at-scale/) :
...
The Microsoft Discovery app is a localized experience that gives researchers, students, academic labs, and scientific teams a simpler way to begin using Microsoft Discovery capabilities without starting with a full enterprise deployment. It is available for download on the[Microsoft Discovery GitHub](https://github.com/microsoft/discovery) and users can get started with a[GitHub Copilot account](https://github.com/features/copilot) .


This preview extends Microsoft Discovery to earlier stages of exploration, where research ideas begin as small-team projects, academic work, or individual investigation.[The Microsoft Discovery app](https://github.com/microsoft/discovery) is designed to lower the barrier to hands-on exploration, with a practical entry point for literature exploration, hypothesis generation, scientific reasoning, and iterative experimentation.
...
[Read more about the Yale and Microsoft collaboration](http://engineering.yale.edu/news/kwabi-microsoft)
...
Powered by[Microsoft Discovery](https://azure.microsoft.com/en-us/solutions/discovery/) , cutting-edge robotics and AI agents work like a virtual research team: imagining experiments, reasoning across mountains of scientific data, designing brand-new molecules, and learning on the fly from live laboratory results at PNNL.
...
[Causaly](https://www.causaly.com/blog/drug-discovery-has-been-missing-decision-quality-evidence-causaly-and-microsoft-are-closing-the-gap?utm_source=Microsoft&utm_medium=Partner&utm_campaign=Microsoft_Discovery_Announcement&utm_content=Marketplace_Announcement) provides agentic solutions that compound the world’s biomedical evidence with an organization’s proprietary knowledge to deliver confident, traceable, cited decisions at every stage, from discovery through launch.
...
With Microsoft Discovery,[Cambridge Consultants](https://cmcn.uk/msft) is helping demonstrate how AI agents, simulation, and physical lab systems can work together in a closed-loop discovery process.
...
Syensqo is a global science company developing groundbreaking solutions that enhance the way we live, work, travel, and play. The company is currently leveraging[Microsoft Discovery](https://azure.microsoft.com/en-us/solutions/discovery/) to scale agentic AI that accelerates discovery, improves decision-making, and unlocks measurable business impact, particularly in the development of next-generation heat transfer fluids for semiconductor manufacturing.
...
[Review documentation](https://aka.ms/MicrosoftDiscoveryDocs)


*[Microsoft Discovery](https://azure.microsoft.com/en-us/solutions/discovery/) is generally available.[The Microsoft Discovery app](https://github.com/microsoft/discovery) is available in preview. Preview features and capabilities are subject to change* .
