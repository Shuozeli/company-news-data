...
document_id: "d5aa8f0377a6602013850822a871cff4721820b1d5bd65d49d21156364c3ef2f"
...
canonical_url: "https://azure.microsoft.com/en-us/blog/from-insight-to-action-the-next-phase-of-agentic-cloud-operations/"
published_at: "2026-06-23T15:45:00+00:00"
first_seen_at: "2026-07-25T02:59:23.665583+00:00"
fetched_at: "2026-07-28T21:43:28.836467+00:00"
content_hash: "sha256:a0735637ae2e0c701d6cec9d81b28bc8d23515a71a2b62055fa9e23a0f12077f"
---
...
According to[recent research conducted with Material](https://aka.ms/AgenticOps-MaterialWhitepaper) , 79% of organizations are already deploying agentic AI in production, reflecting how quickly this model is becoming part of how cloud environments are operated.


[Explore the research findings](https://aka.ms/AgenticOps-MaterialWhitepaper)
...
Building on this foundation, the[Azure Copilot observability agent](http://aka.ms/ObservabilityAgentGA) , now generally available, brings this intelligence into day-to-day operations. The observability agent can continuously analyze telemetry across your environment, including application topology, dependencies, and baseline behavior. When an issue begins to emerge, it can identify patterns, begin investigation, and provide context before teams start their analysis.
...
In this model, progress comes from acting with better context and greater consistency. Microsoft is helping organizations adopt this approach by connecting people, data, and tools through[Azure Copilot](https://azure.microsoft.com/en-us/products/copilot) and related capabilities. Teams gain the ability to resolve issues more efficiently, apply optimization continuously, and operate with governance built in.
...
- [Azure Copilot observability agent (generally available)](http://aka.ms/ObservabilityAgentGA)


- Identify root causes and accelerate resolution through continuous analysis and assisted investigation.


- [Azure FinOps MCP Server (public preview)](https://github.com/Azure/Azure-Resource-Manager-MCP/blob/main/docs/CostManagementAndPricingTools.md)
...
[Get started](https://azure.microsoft.com/en-us/products/copilot)
