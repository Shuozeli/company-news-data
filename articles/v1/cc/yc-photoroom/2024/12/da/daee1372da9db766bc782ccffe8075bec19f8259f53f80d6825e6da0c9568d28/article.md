...
document_id: "daee1372da9db766bc782ccffe8075bec19f8259f53f80d6825e6da0c9568d28"
company_key: "yc-photoroom"
company: "Photoroom"
source_id: "yc-photoroom-rss-d1044ff9c1aa"
canonical_url: "https://www.photoroom.com/blog/sell-fast-on-depop"
published_at: "2024-12-17T00:00:00+00:00"
first_seen_at: "2026-07-23T22:00:08.835718+00:00"
fetched_at: "2026-07-28T21:47:36.059629+00:00"
content_hash: "sha256:2a796404f2869dc8b5509dd1358897cf3786b1c8175b193ab2b63e6943723ce1"
---

# How to sell on Depop (2025 guide)

Making your first sale is a major milestone for anyone who sells online.


But it takes time to achieve, especially in a platform like Depop, where there are up to[140,000 daily listings](https://news.depop.com/who-we-are/facts-and-figures/) and nearly[2 million sellers](https://www.businessofapps.com/data/depop-statistics/) — a mix of individuals doing some spring cleaning and small business owners who deal in vintage fashion.
...
If you’ve been wanting to sell your clothes on Depop or you already started but want to improve sales, you’ve found the guide you need. I’ll walk you through absolutely everything you need to know about selling on Depop, including how you can explore[AI product photography](https://www.photoroom.com/blog/ai-product-photography-tips) to retouch product photos and elevate your aesthetic.
...
After doing your research, you need to decide what you’ll sell. You can select items by thrifting, cleaning your closet, collecting hand-me-downs from family and friends, or browsing Depop to identify trendy items and what others are selling.[Vintage](https://www.photoroom.com/blog/sell-vintage-clothing) , streetwear fashion, and Y2K are currently the most popular styles on Depop.
...
*Best guess: you’re going for B, right?*
...
Examples of great, clutter-free product images from Depop sellers. Left to right:[Ailuros](https://www.depop.com/ailuros/) ,[Limia Vintage](https://www.depop.com/limiavintage/) ,[Spely](https://www.depop.com/spely/) , and[Hazel Layne Vintage](https://www.depop.com/hazellaynevintage/) .


> Want to make your listings pop and sell faster? Use **P[hotoroom’s background remover for Depop](https://www.photoroom.com/lp/background-remover/depop)** to create clean, eye-catching product photos that stand out in the feed.
...
Here's a great example of an engaging item description from[Loveless Vintage](https://www.depop.com/lovelessvtg/) , one of the top sellers on Depop:
...
As you grow, you can use Depop’s[bulk listing tool](https://blog.depop.com/articles/bulk-listing-on-depop) to create up to 100 listings at once. This feature is available to sellers with a blue tick and those who have made 500+ sales.
...
PayPal is also a popular payment method on Depop, although the company recently[announced removing PayPal](https://depophelp.zendesk.com/hc/en-gb/articles/17659492828305-Switching-to-Depop-Payments-in-the-US-UK#:~:text=As%20part%20of%20our%20continuous,PayPal%20as%20a%20payment%20method.) from its platform.
...
Remember that Depop charges a[10% flat fee](https://depophelp.zendesk.com/hc/en-gb/articles/4410084801169-Learn-more-about-Depop-Payments-fees) for every item sold. They also bill a separate transaction fee from the payment provider.
...
Depop has 3.1 million[active buyers](https://www.businessofapps.com/data/depop-statistics/) , over 90% aged below 26. **It caters primarily to a Gen Z demographic who are big on visuals** . The more striking your pictures, the more you can attract buyers to your shop.
...
Photoroom's 2026 State of GenAI in Marketplaces report found that 87% of shoppers overall say product visuals are the most important factor in their purchase decisions.
...
**Product editing features:** Look for an AI photo editor made for businesses. They’re known to offer features like[background removal](https://www.photoroom.com/tools/background-remover) , color correction, and image retouching, which result in high-resolution images that help you stand out.
...
As soon as customers land on your shop, you want to delight them with pictures that are laser-focused on the product — which means using images that don’t have a lot happening in them. AI technology is perfect for this. The best AI image editors have a retouching tool for[removing unwanted objects](https://www.photoroom.com/blog/how-to-remove-a-person-from-a-photo-on-an-iphone) and drawing attention to your products. They also make it easy for you to[get rid of backgrounds](https://www.photoroom.com/tools/background-remover) entirely, allowing you to layer your product over different backdrops.


*Removal of unwanted objects from product photo of vintage bag using Photoroom*


### Build an image for your brand


With AI photo editing tools, you can easily[change the color of your picture's background](https://www.photoroom.com/tools/change-background-color) . Once you erase the original backdrop, you can select a new color from the catalog provided and apply it to all your product photos, ensuring a consistent brand image. This consistency is vital for brand recognition, especially in a crowded marketplace like Depop.


The colors you use can influence buyers’ perception of your shop. So, c **onsider your brand’s identity, the product’s color** , and the mood you’re trying to convey when choosing background colors for your product pictures. Go for subtle colors like brown, beige, or white if you want customers to perceive you as minimalist. If you’re leaning toward a more playful aesthetic, use colors like orange and yellow. It also helps to experiment with different colors to see how they impact the overall look of your images.


### Take creative control


You’ve probably heard about generative AI by now and how good it is at creating everything from art to software code. But one of its best, but least discussed, use case is[creating custom backgrounds](https://www.photoroom.com/tools/instant-backgrounds) for product images. You can **generate unique backgrounds tailored to each product category** or the vibe of your pose (if you’re editing a try-on image), which ensures brand consistency and allows you to adapt to changing design trends.
...
*Same red vintage earring layered over different AI-generated backgrounds \[With[Instant Backgrounds](https://www.photoroom.com/tools/instant-backgrounds) \]*


Try Photoroom - You can download the app for free on your[iOS](https://app.adjust.com/13mku062?campaign=depop) or[Android](https://app.adjust.com/13mku062?campaign=depop) device, or sign up now on[Photoroom Web](https://app.photoroom.com/signup) .
...
**Apply enhancements:** Open your chosen image editing tool and start applying edits like resizing,[adding shadows](https://www.photoroom.com/tools/instant-shadows) , color correction, adding your logo, making transparent backgrounds, and retouching to improve lighting and[remove unwanted objects](https://www.photoroom.com/tools/remove-object-from-photo) .
...
When you have many pictures to edit, consider using automation features like[batch processing](https://www.photoroom.com/tools/batch-mode) and preset settings available in most image editing applications, to make editing faster and easier.
...
**Optimize for speed:** Optimize images for fast loading times, especially on mobile devices, since[87% of young adults](https://www.pewresearch.org/short-reads/2022/11/21/for-shopping-phones-are-common-and-influencers-have-become-a-factor-especially-for-young-adults/) (the core demographic of Depop buyers) use their phones for shopping. You can do this by compressing images to reduce file size, resizing images to fit the required dimension on Depop, and using the right image format.
...
*A/B testing for product image by Susamusa shop on Depop: Vintage brand Susamusa listed the same item at different times, using different cover images. The brand tweaked the product’s description to fit the current state of the piece. Images: Left,[the Gina top sold](https://www.depop.com/products/susamusa-sample-sale-32-the-gina/) . Right,[the Gina top in-stock](https://www.depop.com/products/susamusa-sample-sale-46-the-gina/) .*
...
Vintage fashion has a special place in Gen Z's hearts, and Fiona Short has been delivering on that since launching[Fifi’s Closet](https://www.depop.com/fionashort/) in 2015. The U.K.-based seller currently provides sustainable jewelry to her 125,000 followers and has sold nearly 7,000 items, including to fashion model[Bella Hadid](https://www.lofficielsingapore.com/fashion/bella-hadid-39-s-three-favorite-vintage-stores) .
...
*Product listing from Campervan Vintage:[Equator vintage 90s bag](https://www.depop.com/products/campervanvintage-90s-vintage-travel-bag-equator/)*


#### Christie’s Cupboard


[Christie's Cupboard](https://www.depop.com/christiescupboard/) is a treasure trove of Y2K and designer clothing. U.K. and Australia-based, Christie Eccles launched her Depop shop to supplement her part-time job. She has since turned it into her full-time business, selling more than 10,000 items and amassing over 100,000 followers on the platform.


**What she does well with images:** If anyone knows the power of good images on Depop, it’s Eccles.


> “Using a good camera and natural light or studio lights to capture your stock with clear photos makes a huge difference,” the top seller told[Business Insider](https://www.businessinsider.com/depop-sellers-turn-side-hustles-into-full-time-businesses-2020-2?r=US&IR=T) in an interview.
...
*Product listing from Christie’s Cupboard:[Vintage burgundy leather jacket](https://www.depop.com/products/christiescupboard-vintage-burgundy-leather-jacket-y2k-b1d8/)*
...
**Follow others and like their products** to get more eyes on your page. Search for items within and outside your niche to find other business owners to engage with. You can also join the[r/Depop community](https://www.reddit.com/r/Depop/) on Reddit to interact with other sellers.
...
[Jewelry product photography: Tips, tools, and techniques](https://www.photoroom.com/blog/jewelry-product-photography)
...
[What are the Shopify sizes for images?](https://www.photoroom.com/blog/guide-to-shopify-image-sizes)


-


[How to create Jewlery product photos](https://www.photoroom.com/blog/jewelry-product-photography)
