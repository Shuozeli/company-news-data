...
document_id: "f131e84abf2d9ba993e04e3d707ac0e598e29cc4ca86964a9b1afe5e7862077c"
company_key: "yc-photoroom"
company: "Photoroom"
source_id: "yc-photoroom-rss-d1044ff9c1aa"
canonical_url: "https://www.photoroom.com/blog/viral-campaigns-creative-agencies"
published_at: "2024-02-20T00:00:00+00:00"
first_seen_at: "2026-07-23T22:00:08.835718+00:00"
fetched_at: "2026-07-28T21:47:36.059629+00:00"
content_hash: "sha256:cadc5da07dbec0dd44da0239f23b7717a75107986489c06e2ec9e16ce549aa3c"
---

# Top 4 tips to create viral campaigns with AI

Gen AI is shaking up the world of consumer marketing as we know it. Think about it: marketing campaigns that used to take months of planning, content creation, and customer targeting can now come to life in a matter of weeks—or even days,[with the right API](https://www.photoroom.com/api) —thanks to at-scale personalization.
...
Nostalgia is a powerful marketing tactic with a huge potential for virality.[The reason it works](https://www.forbes.com/sites/laurenfriedman/2016/08/02/why-nostalgia-marketing-works-so-well-with-millennials-and-how-your-brand-can-benefit/?sh=3c454bb36364) so well is that it taps into very powerful emotions, like longing and childhood memories. Take what the marketing team of the Barbie movie did to promote the film, for example.


The Barbie team,[in collaboration with Photoroom](https://a.storyblok.com/f/191576/x/50e8379f97/warner-bros-case-study.pdf) , created a virtual photo booth that allowed fans to transform their selfies into posters from the movie, tagline and all. This not only allowed audiences to become characters in the Barbie universe, it also created new fans by giving them shareable, personalized content they could use to create memes for their social media.


The results were immeasurable. The Barbie movie's marketing campaign—through its[collaboration with Photoroom](https://a.storyblok.com/f/191576/x/50e8379f97/warner-bros-case-study.pdf) —ingeniously amplified brand visibility (and affinity) across social media platforms by literally turning fans into dolls from the Barbie universe. By allowing audiences to transform their selfies into personalized movie posters using a digital selfie booth, the campaign not only engaged the franchise's target fanbase, but it also attracted new audiences, effectively turning spectators into brand ambassadors.
...
That’s exactly what the Hennessy marketing team set out to do. In celebration of 50 years of hip hop, Hennessy collaborated with the creative technology agency[Solarflare Studio](https://a.storyblok.com/f/191576/x/af20a5040e/solarflare-x-hennessy.pdf) to create a digital and live event timed with the release of Hennessy’s limited edition VS bottle. The aim was to design a campaign that honored hip hop’s rich history and deepened Hennessy’s relationship with fans.


Using Photoroom’s API, the team created an AI-generated social experience that allowed fans to take selfies and transform them into personalized album covers based on iconic hip-hop eras. The purpose of the campaign was to give hip hop fans a way to show what the genre means to them through “[immersive digital expression](https://www.prnewswire.com/news-releases/hennessy-and-hip-hop-icon-nas-join-forces-to-celebrate-hip-hops-50th-anniversary-301864307.html) .”
...
This unique approach engaged audiences in a whole new way, sparking conversations and generating buzz around the show. The campaign not only showcased the power of AI in storytelling but also highlighted Netflix's ability to create immersive and thought-provoking content experiences—much like their show, Black Mirror.


## 4. Connect a global creative audience with a contest


Contests that ask for submissions from the general public aren’t a new marketing tactic by any means. Doritos, for example, created the fun and fresh campaign[“Crash the Super Bowl](https://en.wikipedia.org/wiki/Crash_the_Super_Bowl) ” that ran for ten years. They asked fans to submit a Doritos commercial that could potentially be featured in the Super Bowl (here’s a[personal favorite](https://youtu.be/3usaGfn7r0w?feature=shared) ). Ice cream brand Ben & Jerry’s created the[“Do the World a Flavor”](https://vermontbiz.com/news/2009/november/11/wisconsin-fan-wins-ben-jerrys-do-world-flavor-contest) contest where they asked fans to submit ice cream flavor ideas that could potentially become a new product in their line of ice creams. Contests like these empower consumers to play a direct role in a brand’s creative process, turning everyday fans into influential contributors to the brand's legacy and product lineup.


And when you add the interactive, personalized element of AI to a traditional contest? You get magic. That’s what Coca-Cola discovered with its AI-leveraged campaign,[Create Real Magic](https://www.coca-colacompany.com/media-center/coca-cola-invites-digital-artists-to-create-real-magic-using-new-ai-platform) , which invited digital artists from around the world to submit artwork featuring elements from Coca-Cola's advertising history.


The “first-of-its-kind AI platform” combined the advanced text generation of GPT-4 with the image creation abilities of DALL-E to generate the imagery. Participants in the "Create Real Magic" contest had the chance to have their artwork displayed on digital billboards in prominent locations like Times Square and Piccadilly Circus.
...
Whether you're a marketing agency looking to create a buzz for a product launch, a company looking to foster employee engagement, or a brand looking to create a unique, immersive experience for your customers,[Photoroom can help](https://www.photoroom.com/api) . You can leverage our[Remove Background API](https://www.photoroom.com/api/remove-background) to power your next innovative marketing campaign.


-


**Unlocked creative power:** Photoroom's[Remove Background API](https://www.photoroom.com/api/remove-background) empowers marketers to harness the potential of AI-driven creativity, motivating audiences to participate and share their personalized content
...
For more information, check out our the full suite of our API solutions and try the Selfie Generator using[the demo](https://photoroom-api-web-demo.vercel.app/) .
...
[How to create a social media campaign using the Photoroom API](https://www.photoroom.com/blog/how-to-create-a-viral-social-media-campaign-with-the-photoroom-api)


-


[How to process hundreds of product images using the Photoroom API](https://www.photoroom.com/blog/how-to-process-hundreds-of-product-images-using-the-photoroom-api)
...
[How AI photo editing boosts ad performance by up to 29%](https://www.photoroom.com/blog/how-photoroom-boosts-ad-performance)
