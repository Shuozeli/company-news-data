...
document_id: "2401652f2febbc8cf8e13c3240c6f8c85e2643de802f7f91aea2521748ce68fc"
...
Using AI to transform text into images wasn't so popular at first.[AI art generator tools](https://www.photoroom.com/comparisons/photoroom-vs-black-forest-labs) like[Midjourney AI](https://discord.com/invite/midjourney) made it easier and more viral. Find here a list of the[best 50 AI tools for ecommerce](https://www.photoroom.com/blog/ecommerce-ai-tools) .


Anyone, from professional designers to hobbyists, can create complex, beautiful images by simply typing what they envision. Now, OpenAI's popular[ChatGPT](https://chat.openai.com/) includes an AI image generator from text in its premium plan.
...
Here are 10 detailed prompts specifically tailored for creating background images for your[jewelry product photos](https://www.photoroom.com/blog/jewelry-product-photography) . Each of these prompts is crafted to create a unique and fitting atmosphere for various types of jewelry, enhancing their features and catering to different styles and themes which add additional details.
...
📚 **Further reading:** Learn how to create AI backgrounds using an image for reference with our article about[image prompting for beginners](https://www.photoroom.com/blog/image-prompting) .
...
**Image prompts:** This feature allows the AI image generator to create a background based on an image. It is available in the[Photoroom web](https://app.photoroom.com/) and iOS apps. You can upload the picture you want to guide the AI with or search for one in Unsplash directly from the app, and the AI will generate an image inspired by your image prompt.


For more detailed information on how to use each of these custom prompt features, here's[a detailed guide](https://help.photoroom.com/en/articles/7835526-create-your-own-instant-backgrounds-with-custom-prompts#h_644d8318f7) to help you.
