...
document_id: "3d6a31787ad555db61a882480afacfb264fa66e09bcd2c2b8edafc1ffebb9d43"
company_key: "sap-se-ads"
company: "SAP SE ADS"
source_id: "sap-se-ads-rss-5a5b87a458d9"
canonical_url: "https://news.sap.com/2026/07/new-in-sap-cx-q2-2026-when-insight-is-not-enough/"
published_at: "2026-07-16T12:15:00+00:00"
first_seen_at: "2026-07-25T22:15:27.001075+00:00"
fetched_at: "2026-07-28T20:41:19.924237+00:00"
content_hash: "sha256:c7266dfae72c87eb14aeb531577d9bfb929767147722b151b58e0a4d750dd5a6"
---

# When Insight Is Not Enough: What’s New in SAP Customer Experience Q2 2026
...
[Learn how](https://www.sap.com/products/crm.html)
...
This latest release of the[SAP Customer Experience](https://www.sap.com/products/crm.html) solution portfolio helps organizations strengthen that foundation by connecting workflows across marketing, commerce, sales, and service—enabling more consistent, scalable execution across every customer interaction.


Explore the highlights of the Q2 2026 release. For full sub-solution details, see our recaps for the[SAP Commerce Cloud](https://community.sap.com/t5/crm-and-cx-blog-posts-by-sap/sap-commerce-cloud-q2-26-release-highlights/ba-p/14441615) ,[SAP Sales Cloud](https://community.sap.com/t5/crm-and-cx-blog-posts-by-sap/sap-sales-cloud-q2-2026-innovation-highlights/ba-p/14437076) ,[SAP Service Cloud](https://community.sap.com/t5/crm-and-cx-blog-posts-by-sap/sap-service-cloud-q2-26-release-highlights/ba-p/14442331) ,[SAP Enterprise Service Management](https://community.sap.com/t5/crm-and-cx-blog-posts-by-sap/q2-2026-innovations-sap-enterprise-service-management/ba-p/14442632) , and[SAP Engagement Cloud](https://community.sap.com/t5/crm-and-cx-blog-posts-by-sap/sap-engagement-cloud-q2-2026-release/ba-p/14409616) solutions.
...
- **Conversational AI shopping through a model context protocol (MCP) server** : Enable secure integration between[SAP Commerce Cloud](https://www.sap.com/products/crm/commerce-cloud.html) and AI agents that can guide or act on behalf of customers. AI assistants can query real-time product information, provide inventory updates, manage shopping carts, and complete transactions directly within chat or voice interfaces—creating more intelligent, conversational buying experiences beyond the traditional storefront.
...
- **AI-assisted content composer** (pilot): Generate high-quality, on-brand campaign content in[SAP Engagement Cloud](https://www.sap.com/products/crm/engagement-cloud.html) . Using Gemini models informed by audience, product, and campaign context, teams can quickly create and refine content variations so they can launch personalized campaigns faster and spend less time on manual content creation.


AI-assisted content composer


- **Embedded audience builder** : Enable marketers to access and activate rich data from[SAP Customer Data Platform](https://www.sap.com/products/data-cloud/customer-data-platform.html) directly within SAP Engagement Cloud. With this capability, they can build advanced segments themselves without switching systems or waiting on data analysts. The precision and relevancy of omnichannel campaigns can be improved by combining behavioral, transactional, account, and profile data with operational data across the business.
...
- **Agentic opportunity summary overview** : Give sales teams the tools they need to quickly assess deal health. This capability in[SAP Sales Cloud](https://www.sap.com/products/crm/sales.html) aggregates engagement signals, activity levels, and progress indicators into a real-time view, allowing teams to identify risks early, prioritize effectively, and maintain deal momentum.
- [SAP Sales Cloud, field sales add-on](https://www.sap.com/products/crm/sales-cloud-field-sales-addon.html) : Optimize sales velocity and help ensure the right product placement with retail execution enabled by intelligent, AI-enhanced processes that maximize revenue. Teams can improve visit planning and execution, harness insights to improve sales performance, and optimize interactions. For consumer products companies, this helps drive shelf availability, promotion compliance, and merchandising effectiveness across retail locations. Field teams gain greater visibility into store-level execution, enabling more consistent brand presence and stronger sell-through performance.


SAP Sales Cloud, field sales add-on


- **SAP Incentive Management** : Improve sales team effectiveness by using the[SAP Incentive Management](https://www.sap.com/products/crm/incentive-compensation-management.html) solution, which is part of[sales performance management](https://www.sap.com/products/crm/sales.html#sales-performance-management) solutions. It helps drive profitable behaviors that increase revenue and support business growth while providing real-time performance insights, dispute management, and motivating rewards. Teams can use flexible tools to streamline incentive compensation and quickly design, test, and launch sales plans. AI-supported recommendations are also available to guide organizations in optimizing plans, maximizing outcomes, and uncovering actionable insights.
...
- **Self-service catalog:** Allow employees to quickly find what they need without understanding backend processes. Through this guided, intuitive catalog for[SAP Enterprise Service Management,](https://www.sap.com/products/crm/enterprise-service-management.html) requests are automatically routed with the right context, reducing delays and improving resolution times.
...
- **Flow connector:** Enables smooth data flow between the[SAP Order Management Services](https://www.sap.com/products/crm/order-management-software.html) solution, other SAP solutions, and third-party products. This predefined capability allows business users to configure custom business flows and integrations with minimal IT involvement, creating connected order management processes across the enterprise.
...
Our recently announced strategic partnerships with[Parloa](https://www.sap.com/products/crm/partners/parloa-gmbh-parloa-ai-agent-management-platform.html) and[Google Cloud](https://news.sap.com/2026/04/ai-customer-experience-sap-google-cloud-building-what-comes-next/) help extend this execution-first approach by connecting AI-powered service, commerce, and engagement experiences directly to operational systems and business data. As a result, organizations can move from isolated interactions and insights to coordinated actions that drive faster resolutions, better customer experiences, and greater business impact.
...
- [SAP Commerce Cloud: What’s New](https://help.sap.com/whats-new/3d7190d2aab14c7d92f918cc3fa9a024?locale=en-US)
- [SAP Sales Cloud: What’s New](https://help.sap.com/whats-new/58f0cc34e3c141a793ba8dfb7fc47f21)
- [SAP Service Cloud: What’s New](https://help.sap.com/whats-new/19050980c758425da3080e88f2d0505f)
- [SAP Enterprise Service Management: What’s New](https://help.sap.com/whats-new/0e2676cbd30e4c9091c2a7a1d723927a)
- [SAP Engagement Cloud: What’s New](https://help.sap.com/docs/SAP_EMARSYS/8bf21e3e3ad3475bb9e25de1e0ac3d86/fdf6ade874c11014bcd8e4654db72520.html)
