...
document_id: "180843d523dffa054f353dfd241739c8d1759d8af50832a42b40e8e64a9840f8"
...
canonical_url: "https://www.diginex.com/news/united-nations-appoints-diginex-to-help-migrant-workers"
...
content_hash: "sha256:25dd4577c2b97993276c63482eb0a1be0c9919311ae31410489b445ce645bd4c"
---

# United Nations Appoints Diginex to Help Migrant Workers
...
IRIS-SAFER works like the[TCFD reporting](https://www.diginex.com/insights/the-complete-tcfd-reporting-guide-for-companies) system, which was created in 2015. TCFD, shortening for Task Force on Climate-Related Financial Disclosures, is used to solicit decision-useful and progressive-looking information into the standard financial filings.
...
The use of[blockchain technology](https://www.diginex.com/) – essentially a set of immutable, secure, data records – will strengthen data management and enforce data integrity, which allows for a **higher level of transparency and visibility** .


There are almost **390,000 migrant domestic workers in Hong Kong** 1, nearly 1 in 10 of all workers in the city. Almost all (98%) of these domestic workers are women.
...
To be fully sustainable, we cannot just focus on one pillar of the environment. Instead, we need to commit to all areas of sustainability, and we can achieve this via **TCFD guidelines** all the time. Do not be left behind in making the world a better place!
