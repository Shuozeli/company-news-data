...
document_id: "7beb88b7658697c1f146d7041b6fa7b0dae65bbe26893c7033cfe72f9d8ec30d"
...
canonical_url: "https://blog.bentley.com/insights/the-hunt-for-infrastructures-lost-data-comes-to-philadelphia-with-ai-joining-the-search/"
published_at: "2026-06-22T15:06:03+00:00"
first_seen_at: "2026-07-24T19:29:36.034394+00:00"
fetched_at: "2026-07-28T21:23:18.688239+00:00"
content_hash: "sha256:6e1428e4fa9d3da5a57625a5862d896bdfa8c38faf0cfcf64f32a5987df7944b"
---
...
The adoption so far among seasoned users “has been quite organic, and we’re aiming to help accelerate that,” Cozzi said. Among the steps Cesium has taken is an MCP server for Cesium ion, its platform for managing 3D geospatial data. “The combination of these agentic skills and the[MCP servers](https://blog.bentley.com/insights/would-you-cross-that-bridge-ai-and-the-trust-problem-in-infrastructure/) do allow these chat-based agentic AIs to use Cesium quite well without having to know how to code, but just to know the end result that you want,” he said.
...
The stakes are long term. Bentley’s chief technology officer,[Julien Moutte](https://blog.bentley.com/insights/would-you-cross-that-bridge-ai-and-the-trust-problem-in-infrastructure/) , framed it in an earlier conversation: Infrastructure assets like bridges and roads last for decades, and the data behind them needs to last just as long, which only works if that data stays open.
...
Why did Bentley Systems acquire the 3D geospatial company Cesium?


The goal of bringing Bentley and Cesium together is to build a unified, open platform where developers can assemble comprehensive digital twins of the entire physical world. By blending 3D visualization with engineering data, users can seamlessly manage everything from natural terrain to completed bridges, buildings, and highways in a single platform.
...
How does Model Context Protocol (MCP) make AI easier for engineers to use?


MCP serves as an open-standard translator that enables AI assistants, such as Claude, to communicate directly with complex engineering software. Instead of writing code, architects and engineers can simply describe what they want in plain English, and the AI agent performs the action within the application to enable smoother handovers between project phases.
...
What is Gaussian splatting, and how does it improve 3D geospatial modeling?


[Gaussian splatting](https://blog.bentley.com/insights/why-gaussian-splats-could-change-infrastructure/) is a powerful technique featured in the upcoming 3D Tiles 2.0 standard that transforms ordinary photographs into strikingly realistic 3D scenes. It captures tricky, fine details that older rendering methods miss—such as thin wires and fences—making it the perfect tool to pair with AI for tracking physical changes across sprawling sites like oil refineries.
