...
document_id: "6d1aebb439f1b12c319ed3c03ddc64dc1337d02dafdcbf4585dc09641718290d"
...
canonical_url: "https://ohmyhome.com/en-sg/blog/12-step-guide-landlords-renting-out-whole-hdb-flat-without-agent/"
published_at: "2024-04-04T09:50:57+00:00"
first_seen_at: "2026-07-24T07:11:16.108825+00:00"
fetched_at: "2026-07-28T22:26:02.237076+00:00"
content_hash: "sha256:245abb1e568a6851817547b1ce12737dea4416ffc3df3b9c1b51d55b423c729e"
---

# For Landlords: How to Rent Out HDB Without Property Agent

Last Updated on April 4, 2024 byMaelyn Lagman
...
You can also view all these steps on the[Ohmyhome app](https://ohmyhome.com/download-app/?utm_source=blog&utm_medium=article&utm_campaign=landlord_how_to_rent_out_hdb_guide) , available on App Store and Google Play at no cost.
...
- 1: Check your eligibility to rent out HDB
- 2: Take beautiful pictures of your flat
- 3: Post your flat for rent on Ohmyhome
- 4: Conduct viewings and negotiations
- 5: Ask tenant to 'Make an Offer'


- Found a tenant


- 6: Collect LOI and good faith deposit
- 7: HDB online application for renting out the flat
- 8: Issue Tenancy Agreement (TA)
- 9: e-stamping
- 10: Prepare for the handover
...
Here is the[HDB non-Malaysian non-citizen quota](https://www.hdb.gov.sg/NC-quota) per neighbourhood and block:
...
To prevent overcrowding, the number of tenants allowed in each HDB flat is limited by flat type. The[occupancy cap](https://www.hdb.gov.sg/cs/infoweb/press-releases/revised-occupancy-cap-for-renting-out-hdb-flats) for 3-room, 4-room and larger HDB flats being rented out is 6 pax, while the cap for 3-room is six persons and for 1-2-room flats is 4 pax.
...
>
>
> [A post shared by Ohmyhome (@ohmyhomesg)](https://www.instagram.com/p/CKf1KTjMVQZ/?utm_source=ig_embed&utm_campaign=loading)
...
Downlaod the Ohmyhome app[here](https://ohmyhome.com/download-app/?utm_source=blog&utm_medium=article&utm_campaign=landlord_how_to_rent_out_hdb_guide) . It’s available on App Store and Google Play.
...
- [NRIC, Student Pass or Long Term Social Visit Pass](https://eservices.ica.gov.sg/ipienquiry/web/verifi/landing)
- [Work permit](https://wponline.mom.gov.sg/WPOLLoginController?action=WPOLLoginAction&actionType=WPOLNonLogin)
- [S Pass or Employment Pass](https://eponline.mom.gov.sg/epol/PEPOLUAMT012DisplayAction.do)


You can use ICA’s[iEnquiry System](https://www.ica.gov.sg/eservicesandforms) to ensure the eligibility of the tenant’s work permit or NRIC.


- **Tenancy duration**


According to[HDB](https://www.hdb.gov.sg/residential/renting-a-flat/renting-from-the-open-market/regulations-for-renting-out-your-flat#:~:text=You%20must%20rent%20an%20HDB,per%20approval%20is%202%20years.) , tenants must rent the HDB flat for at least 6 months. Hence, you (as the landlord) must ensure that passes of your non-citizen tenants must have a validity period of at least 6 months at the date of your application. HDB will reject the application if it’s shorter.
...
4. Rental terms the tenant wants to include in the tenancy agreement
5. Specific requests like aircon usage and repairs
...
- [My HDBPage](https://www.hdb.gov.sg/rentingout)
- [Mobile@HDB](https://www.hdb.gov.sg/cs/infoweb/mobile-hdb)
...
For the inclusion of new proposed tenants, you must obtain HDB’s approval before they may move into the flat. You can confirm your eligibility for renting out your flat[here](https://www.hdb.gov.sg/rentingout) . You may print the confirmation letter from My HDBPage > My Flat > Purchased Flat > Renting Out > Renting Out of Whole Flat.


After you have registered your tenants to HDB,[enquire on the authorised tenants](https://www.hdb.gov.sg/cs/infoweb/business/estate-agents-and-salespersons/renting-out-a-flat-or-room/apply-for-approval) of your flat. This allows you to print HDB’s confirmation letter showing the names of tenants registered. This assures your tenants that they have been registered and they can legally stay in your property.
...
1. Particulars of the landlord and tenant (including NRIC/Working Pass)
2. If the tenant is a foreigner, ensure that the company’s address is stated
3. Lease terms, such as the rental price, duration, start and end date
4. Security deposit
5. Minor repair costs (Approx. $100-$150)
6. Air-con maintenance (optional)


If you need help with the TA, let us help you. With our[documentation services](https://ohmyhome.com/en-sg/property-agent-services/documentation-services/?utm_source=blog&utm_medium=article&utm_campaign=how_to_rent_hdb_without_agent) , we can help you with the paperwork, such as the eligibility checks and tenancy agreement.


### Step 9: e-stamping


You need to do the e-stamping via IRAS’[e-stamping portal](https://mytax.iras.gov.sg/ESVWeb/default.aspx?scope=openid+7EphIB3kyl8OCP2PhdmCkw&response_type=code&redirect_uri=https%3A%2F%2Fmytax.iras.gov.sg%2Festamping%2F&state=24735f460ed82b954c60dc47fe0f73797cLFIej7w&code_challenge_method=S256&nonce=ba81a0f17f08481b003e5e092948985c10P6d9W0v&client_id=7EphIB3kyl8OCP2PhdmCkw&code_challenge=wxqi05vmCcZ5j7DGCUcWRdaEOxyVhiTpbukx3U-USP8) on your computer or laptop once the TA has been signed by you and the tenant. Don’t worry, the e-stamping costs are usually borne by the tenant.
...
You have come a long way! Before the most awaited day of concluding your rental transaction, inspect your property and prepare an inventory list. Ensure that everything is working well because you will need to do[handyman work](https://ohmyhome.com/en-sg/home-services/handyman-services/?utm_source=blog&utm_medium=article&utm_campaign=landlord_how_to_rent_out_hdb_guide) to any defects identified during the problem-free period.
...
*Let Ohmyhome’s smart data-matching technology MATCH you with the right home, according to your specific needs.*[Submit your preferences to us](https://ohmyhome.com/en-sg/tenant-form/?utm_source=blog&utm_medium=article&utm_campaign=landlord_how_to_rent_out_hdb_guide) *and our algorithm will filter all our available listings based on those, and we’ll WhatsApp them to you once we find a match. We’ll also send you relevant content that you can use for your research and inform your home buying decision, so you no longer have to spend hours searching online for the information that you need.*


*You can secure an appointment with any of our Super Agents by dropping us message on[WhatsApp](https://api.whatsapp.com/send?phone=6597559283&text=Hi%20Ohmyhome,%20I%20would%20like%20to%20enquire%20about%20your%20services.) or via our Live Chat at the bottom, right-hand corner of the screen.*


Sources:[HDB](https://www.hdb.gov.sg/cs/infoweb/residential/living-in-an-hdb-flat/for-our-seniors/rent-out-your-flat-bedroom) ,[CEA](https://www.cea.gov.sg/professionals/agreements_and_checklists) , CEA Checklist
