...
document_id: "c95a84013030b1a0a1b4ddd77894d2c155425b9c987647c627948b3ea77331e2"
...
## Get your current condo rental value instantly


With Homer AI, you can stay updated on all the[recent rental transactions](http://ohmyhome.com/en-sg/homer/?utm_source=blog&utm_medium=backlink&utm_campaign=ForeignerGuideRentCondo) in your development, block, and cluster, plus key market trends that will help you price your rental property right.


## Condo rental price trends from 2023 to 2024


Overall, the data suggests a fairly robust rental market in terms of prices, with notable fluctuations in rental transactions that do not severely impact rental prices.
...
### 1. Legal requirements and contracts when renting a condo
...
If you have children, you might want to look at Bukit Timah, which is home to[several international schools](https://ohmyhome.com/en-sg/blog/check-out-which-primary-schools-are-near-you/?utm_source=blog&utm_medium=backlink&utm_campaign=ForeignerGuideRentCondo) , such as Singapore American School, Hollandse School, Swiss School in Singapore.


> [What Are the Primary Schools Near Me? | 1km and 2km Interactive Map](https://ohmyhome.com/en-sg/blog/check-out-which-primary-schools-are-near-you/)
...
There are many property portals that let you search for condos for rent manually, but if you don’t want to spend so much time on this, then you can[get matched to a rental property](https://ohmyhome.com/en-sg/tenant-form/?utm_source=blog&utm_medium=clickthru&utm_campaign=ForeignerGuideRentCondo) that fits all your requirements here.


### 2. Check the legitimacy of the property agent and schedule viewings


Estate Agents are granted licences by[Council for Estate Agencies](https://www.cea.gov.sg/public-register) (CEA) and the salespersons of the estate agents are registered. They can perform estate agency work only if they have a valid licence or registration.


**[Check the CEA’s Public Register](https://ohmyhome.com/en-sg/blog/how-to-check-property-agent-transaction-record-in-cea-public-register/?query=CEA&lang=en-sg&utm_source=blog&utm_medium=backlink&utm_campaign=ForeignerGuideRentCondo) of Estate Agents and Salespersons so you may:**
...
LOI is addressed to the landlord. It is where you’ll state your intentions to enter a tenancy agreement. Sending this letter will serve as a lead up to signing up the official and legal binding[Tenancy Agreement](https://www.hdb.gov.sg/residential/renting-a-flat/renting-from-the-open-market/matters-relating-to-renting-out-flats) (TA).
...
A friendly reminder is that never pay anything in advance because, in legitimate property agent transactions, you issue a check or create a fund transfer to the landlord’s bank account. Property agents are not allowed to accept cash payments. Learn more about[CEA reminders](https://youtu.be/V7DJu9ZzNT8) for tenants.
...
**[Drop us a message on WhatsApp](https://api.whatsapp.com/send?phone=6597559283&text=Hi%20Ohmyhome,%20I%20would%20like%20to%20enquire%20about%20your%20services.&&utm_source=blog&utm_medium=backlink&utm_campaign=ForeignerGuideRentCondo)** or start a conversation on our Live Chat below to speak to a Relationship Manager and schedule a non-obligatory, free meeting with one of our Super Agents.
