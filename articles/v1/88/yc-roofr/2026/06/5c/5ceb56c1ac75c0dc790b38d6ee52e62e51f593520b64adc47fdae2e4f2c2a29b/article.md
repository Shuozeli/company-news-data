...
document_id: "5ceb56c1ac75c0dc790b38d6ee52e62e51f593520b64adc47fdae2e4f2c2a29b"
company_key: "yc-roofr"
company: "Roofr"
source_id: "yc-roofr-news-import-01583925d837"
canonical_url: "https://roofr.com/blog/roofing-glossary"
published_at: "2026-06-25T19:57:53.234+00:00"
first_seen_at: "2026-07-22T12:11:38.031242+00:00"
fetched_at: "2026-07-28T21:42:09.561502+00:00"
content_hash: "sha256:b6776611876f8fdbc5d95a8135555e11ddb1e55585b1bc9738deded41adb2858"
---

# Roofing Terms & Definitions: The Roofer's Glossary | Roofr

TL;DR


AI gets things wrong, and explains things in dry terms like... well, like a robot. Instead of asking AI, use our A to Z glossary to learn the major roofing terms from real human experts.


Roofing has its own language, and roofing lingo changes FAST. New roofing terms pop up all the time. Some roofing definitions (and acronyms) are very technical. And the stuff roofers say can sound crazy if you’re not in the know.


That’s where this roofing glossary comes in. We’ve listed the most common roofing terms and definitions used on job sites, so you never have to feel like you’re out of the loop. Our list breaks down everything from basic roofing concepts to standard materials, commercial work, install techniques, roof designs, insurance terms, roof coating types, and more.


Save this page now so you don’t need to hunt for roof terms later. Let’s talk shop.
...
**Acrylic Coating** : A water-based reflective coating commonly used on low-slope roofs. Dries flexible and UV-resistant.


**ACV (Actual Cash Value)** : An insurance settlement method. The insurance payout reflects the depreciated value of the damaged roof.


**Algae Stain** : Roof discoloration caused by algae. Often misidentified as fungal growth.


**Aluminized Coating** : A roof coating containing aluminum particles that reflect solar energy and reduce heat transfer through the roof surface.


**Application Rate** : The amount of coating material applied per square foot. Expressed in gallons per square foot or mils of wet film thickness.
...
[Architectural Shingles](https://roofr.com/blog/architectural-shingles) : Also known as laminated shingles. These shingles have many layers to create added thickness and visual depth.
...
[Bitumen](https://roofr.com/blog/why-is-modified-bitumen-so-popular-for-flat-roofs) : A sticky black material, used for road paving, waterproofing, and roofing. See Modified Bitumen Roofing. See also: Asphalt.


**Bituminous Coating** : A coating made from bitumen applied as a waterproofing layer. Often used as a base coat in built-up roofing systems.
...
**Built-Up Roofing (BUR)** : A traditional flat or low-slope roofing system consisting of multiple layers of ply sheets embedded in hot asphalt. Includes alternating layers of bitumen and reinforcing felts, topped with gravel or a cap sheet.


**Bundle** : A package of shingles. Most of the time, 3 bundles cover one square (100 sq. ft.) of roof. Though it can take 4 or 5 bundles, depending on the shingle type.


**Butt** **Edge** : The lower edge of the shingle tabs. Not 🍑.
...
**Caulk** : To seal a joint with mastic or asphalt cement to prevent leaks. Not 🍆.
...
**Cool Roof Coating** : A coating that reflects sunlight and emits absorbed heat, keeping the roof surface cooler. Classified by high solar reflectance and high thermal emittance.
...
[CRM (Customer Relationship Management)](https://roofr.com/blog/crm-for-roofers-everything-you-need-to-know) : A software that allows roofers to manage their jobs, leads, customers, communications, timelines, and pipelines in one place. Helps with strategy, organization, time management, efficiency, professionalism, and business growth.


Built by roofers, for roofers.


Roofr’s own CRM is the best around. If you’re looking for awesome customer service and an all-in-one tech solution to grow with your business, try Roofr for free.
...
**Cure Time** : The period required for a roof coating to reach its full physical properties (and be fully effective) after it's been applied.
...
**Depreciation** : The reduction in a roof's value due to age and wear. Insurance companies calculate depreciation when settling ACV claims.
...
**Downspout:** A pipe for draining water from roof gutters. Also called a leader. Famously used as a highway by the itsy-bitsy spider.


**Drip Edge Flashing:** A metal strip installed along the edges of a roof to direct water away from the fascia. Corrosion-resistant, non-staining. Used along the eaves and rakes to allow water runoff and avoid water damage. Often required by building code.


**Dry Film Thickness (DFT)** : The thickness of a coating layer after all solvents have evaporated. Quality indicator for coating systems.


### ‍E


**Eave:** The horizontal, lower edge of a sloped roof. Overhangs the walls of the building.


**Eaves Flashing** : An additional layer of roofing material applied at the eaves to help prevent damage from water backup.


**Elastomeric coating** : A rubber-like coating that stretches. Made to bridge minor cracks and for thermal movement. Comes in silicone, acrylic, and polyurethane.


[EPDM](https://roofr.com/blog/what-is-epdm-roofing-and-why-should-you-care) : Ethylene Propylene Diene Monomer — a durable synthetic rubber roofing membrane often used on low-slope commercial roofs. Known for flexibility and weather resistance.


**Estimate** : A general estimate of the cost to perform a roofing job from start to finish. This generally includes materials, labor, and a profit margin. It’s a rough estimate of what the job will cost, but should be accurate. *Roofr helps you offer free, accurate estimates for homeowners in minutes with our*[Instant Estimator](https://roofr.com/estimator) *.*
...
**Facets** : The individual flat planes that make up a roof. Important when measuring. More facets means more complexity.
...
**Fully Adhered System** : A commercial installation where the membrane is bonded directly to the substrate with adhesive across its full surface area.
...
**Gutter** : The trough that channels water from the eaves to the downspouts. Or something the younger guys have to get their minds out of.
...
**Hip Roof** : A type of roof containing sloping planes on all four sides. Doesn’t have gables. Also just a really cool, with-it roof.
...
**Infrared Scan** : A diagnostic method (using thermal imaging) to detect moisture trapped under roofing membranes or coatings without destroying anything.
...
**Layer:** A single level or sheet of roofing material (e.g., one layer, two layers). A roof, like Shrek, has many of these.
...
[Measurement Report](https://roofr.com/measurements) : See Roof Report. Or just[make a free Roofr account](https://app.roofr.com/register) and order your first measurement for free.


**Mechanically Fastened System** : A commercial membrane installation secured with fasteners and plates, typically in laps.


**Membrane** : A flexible, continuous layer of waterproofing material (like TPO, EPDM, or PVC), used on low-slope commercial roofs.
...
[Modified Bitumen Roofing](https://roofr.com/blog/why-is-modified-bitumen-so-popular-for-flat-roofs) : Asphalt-based, best for shallow roofs, popular in North America. Also known as mod bit.


**Moisture Drive** : Moisture vapor moving through a roofing assembly. Important when choosing a coating system for an existing roof.


### N


**No-Cutout Shingles:** Shingles with a solid tab and no cutouts. Says what it does on the tin, I guess.
...
**OSB (Oriented Strand Board)** : A roof decking material made from compressed wood strands.
...
**Parapet** : A low wall around the perimeter of a flat roof. Needs special flashing at the base and along the top edge.


**Peak** : The highest point of a roof. Keeps roofers feeling on top of the world.


**Pitch** : The steepness of a roof expressed as a ratio (rise over run). A 6/12 pitch rises 6 inches for every 12 inches of horizontal run.


**Polyurethane Foam (SPF)** : Spray foam applied directly to a roof deck. Expands to fill gaps and create a seamless insulating surface.
...
**PVC (Polyvinyl Chloride)** : A thermoplastic single-ply membrane known for chemical resistance and heat-weldable seams.
...
**RCV (Replacement Cost Value)** : An insurance settlement method. The payout covers the full cost to replace the damaged roof with new materials.
...
**Reflectance** : Also known as Solar Reflectance Index or SRI. A measure of how much solar radiation a surface reflects. Higher reflectance = cooler roof.
...
Roof reports save you tons of time vs. hand measuring every roof. Roofr offers a free measurement report for new users, so take advantage!


[Roofr Report](https://roofr.com/podcasts) : Our awesome podcast, one of the few worth listening to, featuring roofer interviews and industry topics. Not to be confused with Roof Reports.
...
**R-Value** : A measure of thermal resistance in insulation. Higher R-value = more insulating.
...
**Silicone Coating** : A moisture-cure coating with good UV and ponding water resistance. Popular for low-slope commercial roof restoration.
...
[Square](https://roofr.com/blog/what-is-a-roofing-square-in-measurements) **:** A unit of roof measurement covering an area of 100 square feet.
...
**Substrate** : The surface to which a coating or membrane is applied. Knowing the substrate type will tell you which primer and coating system is appropriate.
...
**Takeoff:** Roof takeoff is another name for accurately measuring and estimating a roof before starting work. *These days, it’s easiest to use fast tech tools, like Roofr’s*[measurement reports](https://roofr.com/measurements) *or*[Instant Estimator](https://roofr.com/estimator) *.*
...
**Thermal Emittance** : How well a surface releases absorbed heat. High thermal emittance keeps a roof cooler by radiating heat away.
...
**Urethane Coating** : A high-performance coating known for impact resistance and durability. Good for high-traffic roof areas.


### ‍V


[Valley](https://roofr.com/blog/a-valley-on-my-roof-roofing-language-explained-valleys) : The internal angle formed by the intersection of two sloping roof planes.
...
**Waste Factor** : An extra percentage added to material quantities to account for cuts and trim during install. Typically 10–20%, but can vary a lot based on roof complexity and other factors.
...
If you want to grow your business and make your life easier, Roofr’s the answer. From instant estimates to proposals to material orders to invoices, Roofr tech lets you work faster, win more work, and keep customers happy.


[Try Roofr Now](https://roofr.com/blog/app.roofr.com/register)
