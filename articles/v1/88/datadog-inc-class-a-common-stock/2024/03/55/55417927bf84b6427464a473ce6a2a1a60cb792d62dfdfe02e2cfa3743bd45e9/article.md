...
document_id: "55417927bf84b6427464a473ce6a2a1a60cb792d62dfdfe02e2cfa3743bd45e9"
company_key: "datadog-inc-class-a-common-stock"
company: "Datadog Inc. Class A Common Stock"
source_id: "datadog-inc-class-a-common-stock-rss-a5f59b9b4ce5"
canonical_url: "https://www.datadoghq.com/blog/engineering/engineering-spotlight-marie-laure-bardonnet-part-2/"
...
content_hash: "sha256:d08b592e2f59843dbb6a4ccfcceb828b93364046c1d9f7f784c9800e2afa8f10"
---
...
*In this edition of the Datadog Engineering Spotlight, Austin from the Community team sat down (virtually) with Marie-Laure Bardonnet. She’s a Senior Engineering Manager leading engineering for Datadog’s Log Management team, and*[was once an intern in the New York office](https://www.datadoghq.com/blog/engineering/engineering-spotlight-marie-laure-bardonnet/) *. We talk about her growth as an individual contributor and as a people manager, her passion for mentorship and development, and her engineering-driven approach to problem solving and decision making.*
...
When I joined, I started on the Dashboards team for the web platform in Paris for two years. We launched the[Notebooks product](https://www.datadoghq.com/blog/engineering/engineering-spotlight-marie-laure-bardonnet/) , a project I worked on as an intern and continued developing as a college graduate. I also worked on the backend for the launch of our[new Dashboard layout](https://www.datadoghq.com/blog/datadog-dashboards/#responsive-grid-based-layout) , a fully responsive grid that scales for any screen size.
...
I joined the Logs backend team one year after the[Logmatic acquisition](https://www.datadoghq.com/blog/datadog-acquires-logmatic-io/) , and found this team to be the right kind of environment I was looking for! Really, I felt as if I had stepped into an environment a thousand times larger for me, with new things for me to learn and challenges for me to solve.
...
Three Horizons Model for Business Growth. Three Horizons Model for Business Growth.
...
The postmortem mindset: I’ve always admired[Datadog’s approach to blameless postmortems](https://www.datadoghq.com/blog/how-datadog-manages-incidents/) . If something happens on our end, we are able to acknowledge it, discuss what happened and how and what we can do better next time.
...
I dedicated the rest of my studies to software engineering, applied to internships in the US, and eventually[interned at Datadog in New York](https://www.datadoghq.com/blog/engineering/engineering-spotlight-marie-laure-bardonnet/) . The rest is history!
...
Marie-Laure and her husband biking up the Col de l’Iseran in the Route des Grandes Alpes. Marie-Laure and her husband biking up the Col de l’Iseran in the Route des Grandes Alpes.
...
There’s a pattern that our CTO,[Alexis Lê-Quôc](https://www.linkedin.com/in/alexislequoc/) , has observed in the career growth of the engineers at Datadog that he’s mentioned at an All Hands meeting before.
...
*Many thanks to Marie-Laure for sitting down to share her experience and insights with us! If working with people like Marie-Laure who are passionate about solving Datadog’s technical challenges, building products, and growing people interests you,*[check out our Careers page](https://careers.datadoghq.com/engineering/) *and join the pack!*
