...
document_id: "c04e7ee7df15fc2a7d2d5dfbbce059823a4b3d4870adc464a8e7dbac1bf952d1"
...
canonical_url: "https://www.emersonautomationexperts.com/2026/measurement-instrumentation/flow/smarter-flow-measurement-life-sciences-batch-cleaning-meter-health/"
published_at: "2026-07-20T14:00:17+00:00"
first_seen_at: "2026-07-25T01:09:56.979097+00:00"
fetched_at: "2026-07-28T21:08:32.413121+00:00"
content_hash: "sha256:0299d72feafcdb1dc8d395146a29d7c17a678307661b5af76fc86d456a6f3819"
---

# Smarter Flow Measurement for Life Sciences: A Window into Batch, Cleaning, and Meter Health
...
That was the through line of the Pharmaceutical Manufacturing webinar,[Deliver Confidence: Smarter Flow Measurement Insights for Life Sciences](https://www.pharmamanufacturing.com/webinars/webinar/55374289/deliver-confidence-smarter-flow-measurement-insights-for-life-sciences) , featuring Emerson’s[Tom Belling](https://www.linkedin.com/in/tom-belling-48a28365/) ,[Rob O’Flaherty](https://www.linkedin.com/in/rob-o-flaherty-4a88398/) , and[Joel Duvall](https://www.linkedin.com/in/joel-duvall-610bb917/) . Tom, Rob, and Joel showed how modern Coriolis flow measurement, paired with advanced diagnostics, gives engineers continuous visibility into both meter performance and process behavior across pharmaceutical and biotech operations.
...
- [Micro Motion™ Coriolis flow meters](https://www.emerson.com/en/measurement-instrumentation/catalog/flow-measurement/coriolis-flow-meters#perPage=15&sortCriteria=relevance) measure mass and density. From those values, engineers can derive volume and concentration without flow conditioning, provided the tube is full.
- [Smart Meter Verification](https://www.emerson.com/en/measurement-instrumentation/smart-meter-verification) (SMV) tests approximately 96 percent of meter components in roughly one to one and a half minutes, in line, without breaking into the pipe.
...
- All Emerson[Micro Motion™ Coriolis transmitters](https://www.emerson.com/en/measurement-instrumentation/micro-motion) discussed include SMV as standard, with optional embedded data historians that are time-stamped and compliant with Code of Federal Regulations Title 21, Part 11 (21 CFR Part 11).
- [AMS Device Manager](https://www.emerson.com/en/automation-systems/asset-performance-management/field-device-management/ams-device-manager) and the Coriolis[Plantweb Insight](https://www.emerson.com/en/measurement-instrumentation/catalog/industrial-wireless-technology/plantweb-insight-applications#perPage=15&sortCriteria=relevance) app extend these capabilities across an installed base, supporting fleet-wide monitoring and audit-ready reporting.
...
Rob walked through Emerson’s hygienic Coriolis sensor portfolio: the new[G-series](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-g-series-compact-coriolis-flow-and-density-meter-family) designed for tight spaces, skids, and Original Equipment Manufacturer (OEM) integration; the[T-series](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-t-series-straight-tube-coriolis-flow-and-density-meters) straight-through design; the[H-series](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-h-series-hygienic-coriolis-flow-and-density-meters) ; and the[ELITE™ series](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-elite-peak-performance-coriolis-flow-and-density-meter-family) for maximum accuracy across the full range. Various models are ASME Bioprocessing Equipment (ASME BPE) compliant, 3-A certified, European Hygienic Engineering and Design Group (EHEDG) certified, and Bovine Spongiform Encephalopathy (BSE) qualified, with polish finishes down to 0.3 micron.


The Coriolis transmitter range spans the compact Micro Motion[1600](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-1600-compact-flow-transmitter-family) , the loop-powered[4200](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-4200-2-wire-transmitter-family) , the[4700](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-4700-flow-transmitter-family) , and the top-of-range[5700](https://www.emerson.com/en/measurement-instrumentation/products/micro-motion-5700-field-mount-transmitter-family) . All ship with SMV basic, while advanced diagnostics, the embedded data historian, Bluetooth, and Wi-Fi are available as options, with security controls so information technology teams can disable wireless when needed. Diagnostics analyze drive gain to detect entrained gas, tube coating, and process instability, in accordance with the NAMUR NE 107 standard for alert handling.
...
[Watch the webinar](https://www.pharmamanufacturing.com/webinars/webinar/55374289/deliver-confidence-smarter-flow-measurement-insights-for-life-sciences) and explore Emerson’s[measurement instrumentation for life sciences](https://www.emerson.com/en/measurement-instrumentation/industries/life-sciences-manufacturing) manufacturing, including Coriolis flow, level, pressure, and liquid analysis solutions.
