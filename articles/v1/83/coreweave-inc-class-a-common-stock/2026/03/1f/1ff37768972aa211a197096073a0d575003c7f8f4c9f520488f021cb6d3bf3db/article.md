...
document_id: "1ff37768972aa211a197096073a0d575003c7f8f4c9f520488f021cb6d3bf3db"
...
canonical_url: "https://www.coreweave.com/news/coreweave-advances-ai-native-cloud-platform-for-the-next-phase-of-production-scale-ai"
...
content_hash: "sha256:0edf373e6ba8ea1479c866bb69edd2cec809cb16908f39e8d57c8a77bf3a0ff4"
---

# CoreWeave Advances AI-Native Cloud Platform with NVIDIA HGX B300 | CoreWeave Press Release

SAN JOSE, Calif. — March 16, 2026 –[CoreWeave, Inc.](https://coreweave.com/) (Nasdaq: CRWV), The Essential Cloud for AI™, today announced an expansion of its purpose-built AI cloud platform at[NVIDIA’s GTC conference](https://www.coreweave.com/nvidia-gtc-2026) . The expansion brings[NVIDIA HGX B300](https://www.nvidia.com/en-us/data-center/hgx/) to the[CoreWeave Cloud](https://www.coreweave.com/platform) , unlocking a new generation of performance for AI workloads, alongside new[Weights & Biases](https://wandb.ai/site/) capabilities that streamline reinforcement learning (RL) and agent development workflows.
...
- **Unprecedented Bandwidth** : Next-generation[NVIDIA Quantum-X800XDR InfiniBand](https://docs.nvidia.com/networking/nvidia-quantum-x800-xdr-clusters/index.html) support doubles node-to-node bandwidth, eliminating interconnect bottlenecks.
...
CoreWeave also expects to be among the first cloud providers to deploy the[NVIDIA Vera Rubin](https://www.nvidia.com/en-us/data-center/vera-rubin-nvl72/) NVL72 platform and NVIDIA Vera CPU rack in production in the second half of 2026. This expansion will further support large-scale inference, reasoning, and the most demanding agentic AI applications.


### **Direct "On-the-Job" Training for Agents with Environment-Free RL**


RL is the most effective method for post-training LLMs on agentic tasks, but it traditionally requires costly, time-consuming, and difficult-to-model simulated environments. Weights & Biases now addresses this with environment-free training in its[Serverless RL](https://wandb.ai/site/serverless-rl/) offering, eliminating the need to build simulated environments, and allowing agents to learn through continual "on-the-job" training.
...
Production agent evaluations in[W&B Weave](https://wandb.ai/site/weave/) close that gap, connecting research and production, enabling teams to learn from real user interactions. It automatically detects production failure modes, alerts researchers, and feeds insights back to improve evaluation datasets and accelerate iteration. By closing this loop, W&B Weave helps teams ship more reliable agents faster.
...
CoreWeave’s AI cloud delivers industry-leading performance and efficiency through an end-to-end technology stack optimized for AI workloads. It has achieved top[MLPerf benchmark](https://coreweave.com/news/coreweave-achieves-new-record-breaking-ai-inferencing-benchmark-with-nvidia-gb200-grace-blackwell-superchips?utm_source=linkedin&utm_medium=social&utm_content=362353553&_gl=1*ahpf75*_gcl_aw*R0NMLjE3NjUzOTkxMDUuQ2p3S0NBaUEwZVRKQmhCYUVpd0EtUGEtaGRJWGZlbV81RjZzT3NzZnJNdWExUFk0Nm8wZDRiLVgwTllrTkUwX1UxS0JJbjc2VmFHMC14b0NHYTRRQXZEX0J3RQ..*_ga*MTI4OTAzMDUwNS4xNzU0NDIxOTgw*_ga_XKNHS53VYL*czE3Njk0NTYyODUkbzE2MCRnMCR0MTc2OTQ1NjI4NSRqNjAkbDAkaDU0Mjg5MzMxOA..) for AI workloads,[Platinum rankings](https://newsletter.semianalysis.com/p/clustermax-20-the-industry-standard?utm_source=linkedin&utm_medium=social&utm_content=362353553) in both SemiAnalysis ClusterMAX™ 1.0 and 2.0, and NVIDIA Exemplar Cloud validation for[training](https://www.coreweave.com/blog/coreweave-sets-new-standard-as-first-nvidia-gb200-exemplar-cloud-improving-upon-nvidias-own-training-performance-targets) and[inference](https://www.coreweave.com/blog/coreweave-becomes-one-of-the-first-cloud-providers-to-achieve-nvidia-exemplar-cloud-validation-for-inference-on-nvidia-gb200-nvl72) on GB200 NVL72.


Visit us at booth #913 at NVIDIA GTC to learn more about today’s announcements.
