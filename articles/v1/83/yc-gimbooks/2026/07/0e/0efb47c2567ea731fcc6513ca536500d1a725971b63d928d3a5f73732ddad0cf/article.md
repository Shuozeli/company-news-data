...
document_id: "0efb47c2567ea731fcc6513ca536500d1a725971b63d928d3a5f73732ddad0cf"
company_key: "yc-gimbooks"
company: "GimBooks"
source_id: "yc-gimbooks-rss-a270650329c9"
canonical_url: "https://www.gimbooks.com/blog/place-of-supply-audit-checklist-goods-invoices/"
published_at: "2026-07-15T08:48:35+00:00"
first_seen_at: "2026-07-20T23:23:58.428442+00:00"
fetched_at: "2026-07-28T05:58:54.793688+00:00"
content_hash: "sha256:fbd4be585d90b88a48cc6fb71290240d2d1a1c3c4e06d152c40789ed57a3b687"
---
...
Read the detailed guide:[E-Invoice for Bill To–Ship To Transactions](https://www.gimbooks.com/blog/e-invoice-bill-to-ship-to-data-entry-checklist/)
...
Based on supplier location vs Gujarat
...
Based on supplier location vs Tamil Nadu
...
For dispatch validation, read:[E-Way Bill Distance and PIN Code Validation Checklist](https://www.gimbooks.com/blog/e-way-bill-pin-code-distance-validation-checklist/)
...
Supplier delivers goods to buyer in another state


Location where delivery ends


IGST


Charging CGST/SGST because buyer has office in supplier state


Supplier and buyer are in same state


Same state delivery location


CGST + SGST


Charging IGST due to interstate billing address confusion


Bill-to/Ship-to transaction


Principal place of Bill-to buyer in applicable cases


Based on buyer location
...
Based on installation state


Using supplier or buyer billing state


Goods already located at buyer premises


Location of goods at delivery


Based on goods location


Using invoice issuing state


Branch transfer between GSTINs


Receiving GSTIN / place as per transfer structure


IGST or CGST/SGST


Treating separate GSTINs as same branch movement


Delivery from warehouse


Place based on delivery and transaction structure


Based on supplier location vs POS


Using registered office as dispatch location
...
Read:[E-Way Bill for Branch Transfers Between GSTINs](https://www.gimbooks.com/blog/e-way-bill-branch-transfer-between-gstins/)
...
GSTIN or branch issuing the invoice


Dispatch From


Actual location from where goods move


Bill To


Buyer receiving the invoice


Ship To


Location or consignee receiving the goods


Place of Supply


GST location used to determine tax type
...
## **Create Accurate GST Invoices With GimBooks**
...
Explore[GimBooks GST billing software](https://www.gimbooks.com/) to manage GST invoices, billing and reports more efficiently.


For transport-linked invoicing, also explore[GimBooks e-way bill software](https://www.gimbooks.com/e-waybills/) .


## Place of Supply For Goods Invoice
...
1. supplier GSTIN and location;
2. buyer GSTIN and billing address;
3. actual delivery or Ship-to location;
4. transaction type;
5. place-of-supply rule;
6. correct GST tax type;
7. e-way bill and invoice consistency;
8. GSTR-1 reporting before filing.
...
Using[GimBooks GST billing software](https://www.gimbooks.com/) can help businesses create structured GST invoices, maintain customer and item records, generate e-way bills and manage invoice reports in one place.
