...
document_id: "00b5e18fb75ad03eba895a3ba5bcd49a83eb684165c3c1c98d96142555a1d65d"
company_key: "yc-gimbooks"
company: "GimBooks"
source_id: "yc-gimbooks-rss-a270650329c9"
canonical_url: "https://www.gimbooks.com/blog/place-of-supply-service-invoice-checklist/"
published_at: "2026-07-16T13:08:37+00:00"
first_seen_at: "2026-07-20T23:23:58.428442+00:00"
fetched_at: "2026-07-28T05:58:54.793688+00:00"
content_hash: "sha256:eb424dfef57cb112defb16a5c044f7394d536eb9122007face20fd9ddb648410"
---
...
Treated separately as interstate


Review IGST / zero-rated treatment
...
Unregistered recipient with address on record


Location of recipient as per address on record


Unregistered recipient without address on record
...
For dispatch and e-way bill workflows, read:[GimBooks e-way bill software](https://www.gimbooks.com/e-waybills/)
...
Place where passenger embarks for the continuous journey
...
Location of recipient on supplier’s records
...
For invoice field-level compliance, read:[GST Invoice Mandatory Fields Audit Checklist](https://www.gimbooks.com/blog/gst-invoice-mandatory-fields-rule-46-checklist/)
...
Consulting to registered client


Client’s registered location


Using service provider’s state


IGST or CGST/SGST based on recipient location


Consulting to unregistered client with address


Recipient address on record


Not collecting address


Based on address on record


Consulting to unregistered client without address


Supplier location


Assuming client city verbally


Usually supplier state


Architect for property


Property location


Using client billing address
...
Using client head office state


Based on venue state


Training to registered company


Registered recipient location


Using training venue


Based on recipient state


Training to unregistered person


Performance location


Using supplier office state
...
Using buyer location


Based on event state


Event organisation for registered client


Registered recipient location


Using event venue always


Based on recipient state


Goods transport to registered recipient
...
Goods transport to unregistered recipient


Goods handover location


Using destination always
...
Insurance service to registered person


Registered recipient location


Using insured asset location blindly
...
OIDAR / digital-service rules


Applying normal rule blindly
...
For goods-specific review, read:[Place of Supply Audit Checklist for Goods Invoices](https://www.gimbooks.com/blog/place-of-supply-audit-checklist-goods-invoices/)
...
GST registration/location of service provider


Billing address


Address used for customer billing


Registered recipient location


GST location of registered customer
...
GST location used to decide tax type
...
Performance / Property / Event State
...
Explore[GimBooks GST billing software](https://www.gimbooks.com/) to manage service invoices, tax details and billing workflows more efficiently.


For businesses using editable formats, you can also review the[GST invoice format](https://www.gimbooks.com/invoice-format) page before moving to a more structured billing system.
...
2. confirm customer registration status;
3. verify customer GSTIN and address;
4. check whether a special place-of-supply rule applies;
5. compare supplier location with place of supply;
6. select the correct tax type;
7. review invoice data before filing GSTR-1.


Using[GimBooks GST billing software](https://www.gimbooks.com/) can help service businesses create GST-compliant invoices, maintain customer records and manage billing reports in a more organised workflow.
