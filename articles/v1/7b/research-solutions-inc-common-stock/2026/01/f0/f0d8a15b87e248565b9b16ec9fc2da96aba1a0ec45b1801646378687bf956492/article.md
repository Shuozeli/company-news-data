...
document_id: "f0d8a15b87e248565b9b16ec9fc2da96aba1a0ec45b1801646378687bf956492"
...
canonical_url: "https://www.researchsolutions.com/blog/the-89-problem-when-published-research-cant-be-trusted"
published_at: "2026-01-29T19:11:59+00:00"
first_seen_at: "2026-07-20T23:19:56.052731+00:00"
fetched_at: "2026-07-28T22:22:55.791060+00:00"
content_hash: "sha256:1f0b1540f201b1cbdd26f571160db4cfbd08873a12fe2e304bb56bb3181306bd"
---

# The 89% Problem: When Published Research Can't Be Trusted

89% percent. That's how many landmark cancer studies Amgen researchers couldn't replicate[when they tried](https://pubmed.ncbi.nlm.nih.gov/22460880/) .
...
[Bayer ran similar experiments](https://pubmed.ncbi.nlm.nih.gov/21892149/) and got 36% reproducibility. The math is stark. If your manufacturing process had a 36% success rate, you'd be shut down by Friday. Yet we're routinely making go/no-go decisions at stage gates based on literature that fails to replicate more often than it succeeds.
...
[Retractions have jumped](https://doi.org/10.1038/d41586-023-03974-8) from about 1,000 in 2013 to over 10,000 in 2023. Those are just the papers that get formally retracted. All the problematic research still out there, quietly misleading teams, never shows up in these numbers.
...
[AI arrived](https://www.researchsolutions.com/blog/the-evolution-of-large-language-models-in-research) to complicate things further. What can be done with this technology is extraordinary, but it creates a new problem: AI-generated citations that look real but correspond to papers that don't exist.
...
Some genuinely good news: smart people have figured out that[not all citations are created equal](https://www.researchsolutions.com/test-blog-nb-24/blog/smarter-citations) , and we finally have the technology to distinguish between them at scale.
...
Eugene Garfield proposed this in the 1960s when he created the[first citation index](https://garfield.library.upenn.edu/essays/V1p084y1962-73.pdf) . He recognized that citations needed "markers" to indicate relationships between papers. The technology to implement his vision didn't exist yet.[Now it does](https://doi.org/10.1162/qss_a_00146) .
...
Organizations with[better tools for literature evaluation](https://www.researchsolutions.com/blog/the-billion-dollar-blind-spot-in-pharmaceutical-research) can move differently. Literature reviews that automatically flag questionable research mean fewer false starts. Due diligence that catches problems others miss means better licensing deals. Portfolio reviews grounded in independently validated research mean smarter resource allocation.
