...
document_id: "560e5abd0bb827178a26ac725cd509d9d4a4e6a50b2a6dcf4b59569540fa540d"
...
canonical_url: "https://www.researchsolutions.com/blog/what-the-get-it-now-sunset-means-for-your-document-delivery-workflows"
published_at: "2026-04-14T14:47:55+00:00"
first_seen_at: "2026-07-20T23:19:56.052731+00:00"
fetched_at: "2026-07-28T21:56:44.009033+00:00"
content_hash: "sha256:20028414917278cd56fb7e7ff9774cb66939998d55728304308ec90e2b3bd40e"
---

# Evaluating Your Get It Now Replacement: A Guide For Academic Libraries

If you work in electronic access or resource sharing, you've likely been following the retirement of *Get It Now* . While many libraries completed their transition before the June 30 sunset, others are still evaluating alternatives, updating workflows, or refining their new document delivery processes. If your library is in that position, you're not alone.


Document delivery sits at the center of research support. When a researcher needs an article outside your licensed holdings, speed, reliability, and copyright compliance still matter just as much as they did before. The good news is that replacing *Get It Now* is often less about reinventing your workflows than making thoughtful updates to systems your team already knows well.
...
Even if you had anticipated this change, that doesn't make the transition painless. If your library had journal titles set up in your link resolver and staff routines built around *Get It Now* ’s ordering interface or related processes that were in place for years, there's still important work involved in updating workflows and ensuring requests continue flowing smoothly.


### Start With Your Current Workflow


Most libraries had *Get It Now* embedded in one of three ways: unmediated patron-facing access, staff-mediated ordering, or integration with ILL management systems like ILLiad, Rapid, IDS, or Rapido. In practice, these workflows are tightly woven into daily operations. Even small changes can create confusion if requests don't flow the way staff and patrons expect.
...
One of the biggest considerations is updating how article request links


are routed. If your journal titles pointed to *Get It Now* in Alma, OCLC, or another system, those links will need to be updated. It’s familiar work for most teams, but worth doing carefully.


The next thing to think about is system integration


. For most libraries already using established ILL systems, the change is more about replacing the fulfillment source in your existing setup than building something new. This typically means the adjustment is more incremental than it might seem at first.
...
### What To Do If Your Library Is Still Making The Switch


Whether you're still evaluating replacement options or refining a workflow you've already put in place, it's worth reviewing how requests are routed, how your systems are integrated, and whether your current approach is meeting researchers' expectations.


If you'd like to compare approaches or talk through your library's workflow, we're always happy to share what we're seeing across academic libraries navigating the transition from *Get It Now* .
