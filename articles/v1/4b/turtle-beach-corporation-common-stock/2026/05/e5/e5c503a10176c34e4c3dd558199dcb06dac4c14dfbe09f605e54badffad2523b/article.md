...
document_id: "e5c503a10176c34e4c3dd558199dcb06dac4c14dfbe09f605e54badffad2523b"
...
canonical_url: "https://www.turtlebeach.com/blog/headset-mic-not-working-fix-pc-ps5"
published_at: "2026-05-06T06:02:00+00:00"
first_seen_at: "2026-07-20T23:23:09.249565+00:00"
fetched_at: "2026-07-28T22:12:46.079122+00:00"
content_hash: "sha256:a3fe5b749fa7d5f0a5958ab0c83de9c3192cfb88c1f1670b5774fd7a1178c5ef"
---
...
Start with the basics. Make sure your[gaming headset](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=Xbox&Color=Black) is fully plugged in. For 3.5mm connections, push the plug all the way in until it clicks. For USB headsets, try a different USB port. A loose connection is the most common cause of mic failure.


If you are using a headset with a separate mic and audio jack, make sure the mic plug is in the pink port (not the green audio-out port). On headsets with a flip-to-mute boom mic, like the[Recon 70](https://www.turtlebeach.com/products/recon-70-headset?Platform=Xbox&Color=Black) , the mic needs to be flipped all the way down to position 1 to be active. If the boom is sitting halfway or flipped up, your voice will not transmit.
...
For[wireless headsets on PC](https://www.turtlebeach.com/products/stealth-500-headset?Platform=Xbox&Color=Arctic+Camo) , make sure the USB dongle is recognized and paired before adjusting in-app audio. Some headsets also offer companion software for fine-tuning. The Stealth 500 and Stealth 700 Gen 3, for example, let you adjust mic sensitivity and the Mic Monitor level in the Swarm II desktop app under the MICROPHONE section. If you are still deciding between connection types, our guide on[wired vs wireless gaming headphones](https://www.turtlebeach.com/blog/wired-vs-wireless-gaming-headphones-sound-quality-latency) breaks down the differences in sound quality and latency.
...
The[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=Xbox&Color=Black) gives you a clear tactile confirmation: flip the boom mic up, and it mutes; flip it down, and you are live. If your headset supports companion software, you can also adjust mic sensitivity and the Mic Monitor level there. The Swarm II app handles this for the Stealth 500,[Stealth 600](https://www.turtlebeach.com/products/stealth-600-headset?Platform=Xbox&Color=Purple) , and Stealth 700 Gen 3 through a MONITORING slider in the MICROPHONE section, available on both desktop and mobile. For a closer look at how wireless mic quality compares across setups, check out our post on[wireless vs wired headset microphone quality](https://www.turtlebeach.com/blog/wireless-vs-wired-headset-microphone-quality) .
...
Keep in mind that some wireless headsets may take about half a second to resume audio after the console comes out of rest mode or a period of silence. This is normal behavior for models like the Stealth 500, Stealth 600, and Stealth 700 Gen 3, and not a sign of a connection problem. If you are weighing whether to go wireless for good, our breakdown of[wired or wireless gaming headsets](https://www.turtlebeach.com/blog/should-i-stick-with-wired-or-try-wireless-gaming-headsets) can help you decide.


## Why Does My Headset Mic Work on Phone but Not PC?


Your phone likely auto-detects the mic from the headset jack. PC is pickier because it has multiple potential audio inputs. The fix is almost always selecting the correct input device in Windows Sound Settings. Headsets built for[multi-platform compatibility](https://www.turtlebeach.com/blog/wireless-headset-pc-console-compatibility) tend to handle this more gracefully since they are designed to pair across PC, PlayStation, and Switch without extra configuration.
...
Most headset mic problems come down to incorrect settings, loose connections, or mute buttons you forgot about. Running through these steps fixes the issue in most cases. For a reliable mic experience with less troubleshooting, Turtle Beach headsets like the[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=Xbox&Color=Black) and[Stealth Pro](https://www.turtlebeach.com/products/stealth-pro-headset?Platform=Xbox) feature clear microphones with flip-to-mute, adjustable mic monitoring via the Swarm II app, and easy setup across PC and console. Browse the full lineup of[Xbox-compatible headsets](https://www.turtlebeach.com/collections/xbox-headsets) to find the right fit.
