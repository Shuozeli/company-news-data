...
document_id: "f518454cd3c2fccca04440e15cccae1834ff5cc3bb12034a74da019713dddc98"
...
canonical_url: "https://www.turtlebeach.com/blog/connect-wireless-headset-ps5"
published_at: "2026-05-21T04:48:00+00:00"
first_seen_at: "2026-07-20T23:23:09.249565+00:00"
fetched_at: "2026-07-28T22:12:59.555603+00:00"
content_hash: "sha256:2ad9c6a89054087e57de08158ae2c7210dd4b7d1dddc812734a8012de348d514"
---

# How to Connect a Wireless Headset to PS5 (With & Without Dongle)

Your PS5 is fired up, your squad's online, and you need to connect your wireless headset. The short version: plug the included USB dongle into a USB port, power on the headset, and select it in Settings > Sound > Audio Output. That's it for most wireless gaming headsets.
...
This is the go-to method and the one you want for gaming. Dedicated 2.4GHz USB transmitters used by[wireless gaming headset](https://www.turtlebeach.com/collections/wireless-gaming-headsets) deliver low-latency audio that Bluetooth can't match: near-zero delay, full mic support, and a rock-solid connection.
...
If it doesn't connect right away, check your headset's manual. Some models need you to hold a pairing button on both the dongle and headset simultaneously. On Turtle Beach headsets like the[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=PlayStation&Color=Black) , press the Power button for 2 seconds to turn it on, then wait for the transmitter LED to turn solid green (unmuted) or red (muted), confirming a successful pair. The[Stealth 600 Gen 3](https://www.turtlebeach.com/products/stealth-600-headset?Platform=PlayStation&Color=Purple) shows a solid blue LED on the transmitter when paired.


## Can You Connect a Bluetooth Headset to PS5?


Here's where people get tripped up. The PS5 has Bluetooth built in, but Sony does not support standard Bluetooth audio headphones natively. The console's Bluetooth is reserved for controllers and select accessories, so your regular Bluetooth headset either won't appear in the menu or won't connect as an audio device.


The workaround: A third-party USB Bluetooth adapter plugged into the PS5 lets you pair Bluetooth headphones through the adapter instead. It works, but expect higher latency than a 2.4GHz transmitter, and mic support is often limited. For a deeper look at[wired vs. wireless sound quality and latency](https://www.turtlebeach.com/blog/wired-vs-wireless-gaming-headphones-sound-quality-latency) , we've got you covered.


## How to Adjust Headset Audio Settings on PS5


Go to Settings > Sound > Audio Output and confirm your headset is the output device. Press the PS button and select the Sound icon to adjust volume and game/chat balance on the fly. Try toggling 3D Audio on in the audio output menu too. Footsteps in shooters suddenly have real directionality with it enabled, though some games sound off if they weren't built for it.
...
If you own a Stealth 500,[Stealth 600 Gen 3](https://www.turtlebeach.com/products/stealth-600-headset?Platform=PlayStation&Color=Purple) ,[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=PlayStation&Color=Black) , or[Atlas Air](https://www.turtlebeach.com/products/atlas-air-headset?Title=Default+Title) , there's a specific re-pairing process. Insert the USB transmitter until the LED lights up, then remove it within 2-3 seconds. Repeat once more, then on the third insert, leave it connected. The LED will indicate pairing mode. With the headset powered off, long-press the power button for 5-8 seconds until the LED pulses slowly. A solid green or blue transmitter LED confirms you're paired.
...
Still stuck? Double-check[console compatibility](https://www.turtlebeach.com/blog/wireless-headset-pc-console-compatibility) . Not every[gaming headset](https://www.turtlebeach.com/collections/gaming-headsets) supports every platform.
...
For more on how connection types affect[microphone quality](https://www.turtlebeach.com/blog/wireless-vs-wired-headset-microphone-quality) , or if you're deciding[between wired and wireless](https://www.turtlebeach.com/blog/should-i-stick-with-wired-or-try-wireless-gaming-headsets) , those breakdowns are worth a read.
...
The[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=PlayStation&Color=Black) ships with dual USB transmitters and Bluetooth 5.2 for cross-platform flexibility. The[Stealth 500](https://www.turtlebeach.com/products/stealth-500-headset?Platform=PlayStation&Color=Black) offers the same plug-and-play wireless experience at a lower price point.
