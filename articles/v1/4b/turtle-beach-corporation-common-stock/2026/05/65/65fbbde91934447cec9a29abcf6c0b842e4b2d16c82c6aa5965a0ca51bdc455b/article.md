...
document_id: "65fbbde91934447cec9a29abcf6c0b842e4b2d16c82c6aa5965a0ca51bdc455b"
...
canonical_url: "https://www.turtlebeach.com/blog/how-to-charge-xbox-controller"
published_at: "2026-05-28T09:28:00+00:00"
first_seen_at: "2026-07-20T23:23:09.249565+00:00"
fetched_at: "2026-07-28T21:11:58.236396+00:00"
content_hash: "sha256:72d7a62d1bde44bec00865afe59c1b3cf68b61ba7cf7d090195bbaa3cc6a2071"
---

# How to Charge an Xbox Controller: Batteries, USB-C & Play and Charge Kit
...
[Xbox controllers](https://www.turtlebeach.com/collections/xbox-controllers) use AA batteries by default. Add a rechargeable battery pack + USB-C cable for the best setup. Charge time: 2 to 4 hours. You can play while charging. The


[Stealth Ultra](https://www.turtlebeach.com/products/stealth-ultra-controller?Title=Default+Title) skips the hassle with built-in batteries and a 2-hour Rapid Charge Dock.
...
Standard AA batteries typically deliver


[up to 30 hours of gameplay](https://www.xbox.com/en-US/accessories/batteries-chargers/play-and-charge-kit) , though that number drops fast if you're running


[headset audio through the controller jack](https://www.turtlebeach.com/blog/wired-vs-wireless-gaming-headphones-sound-quality-latency) or cranking the vibration up.
...
Rechargeable battery packs replace the AAs and charge through USB-C. The


[PDP Play & Charge Kit](https://www.turtlebeach.com/products/pdp-play-and-charge-kit-xbox?&Title=Default%20Title) includes a rechargeable battery and cable.
...
Every current Xbox[wireless controller](https://www.turtlebeach.com/products/pacific-skyline-controller) has a USB-C port on top. Plug in a cable, connect the other end to your Xbox, PC, or wall adapter, and you're on wired power.
...
Charge time depends on the battery pack and power source. The


[Xbox Rechargeable Battery](https://www.xbox.com/en-US/accessories/batteries-chargers/play-and-charge-kit) charges in under 4 hours and delivers up to 30 hours per charge. Wall adapters are faster than console USB ports.


Turtle Beach controllers are faster. The Stealth Ultra fully recharges in 2 hours via its Rapid Charge Dock, delivering up to 30 hours of play. The


[Stealth Pivot](https://www.turtlebeach.com/products/stealth-pivot-controller?Title=Default+Title) charges via its included USB cable for up to 20 hours per charge. Both charge whether powered on or off.
...
Turn off the controller when you walk away:


Hold the Xbox button for six seconds until the light goes off. Set auto-off in Settings, then General, then Power options, then Turn off after.


Reduce vibration:


Vibrating motors eat through the battery. Lower or disable vibration in game settings if haptic feedback isn't adding much.


Use Power Modes on Turtle Beach controllers:


The Stealth Ultra and Stealth Pivot offer Power Modes (Eco, Balanced, Full) that trade features for battery life. Create a custom Power Mode through Control Center 2 on the Stealth Pivot, or on the Stealth Ultra's Connected Command Display. Dialing down LED brightness, screen brightness, and vibration pushes battery life well beyond standard numbers.


## Conclusion


[Xbox controllers](https://www.turtlebeach.com/collections/xbox-controllers) run on AA batteries out of the box, but a rechargeable battery pack and USB-C cable is a much better setup. Charge time is under 4 hours, and you can play while charging.


Want to skip the battery pack entirely? Turtle Beach
...
[Victrix Pro BFG Reloaded](https://www.turtlebeach.com/products/victrix-pro-bfg-reloaded-wireless-controller) have built-in rechargeable batteries and USB-C charging. Color-coded charging LEDs, on-controller battery readouts, and customizable Power Modes. No AAs. Just charge and play.
