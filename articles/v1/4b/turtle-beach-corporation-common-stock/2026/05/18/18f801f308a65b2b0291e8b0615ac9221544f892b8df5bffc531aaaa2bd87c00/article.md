...
document_id: "18f801f308a65b2b0291e8b0615ac9221544f892b8df5bffc531aaaa2bd87c00"
...
canonical_url: "https://www.turtlebeach.com/blog/headset-not-working-on-xbox"
published_at: "2026-05-21T04:47:00+00:00"
first_seen_at: "2026-07-20T23:23:09.249565+00:00"
fetched_at: "2026-07-28T22:12:59.555603+00:00"
content_hash: "sha256:d01d25ef1ebb1f1017d1286e41bd9622669bf07a123999c288daf6aedd12b9f8"
---
...
If you're using a Turtle Beach wireless headset, restart the headset too. Power it off and back on, and make sure the USB transmitter is firmly seated in the console. For the[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=Xbox&Color=Black) , you can perform a hard reset by holding the CROSSPLAY and MODE buttons simultaneously for 10 seconds. The headset will power off and reconnect to its transmitter automatically. This fixes power-on loops, unresponsive buttons, and headsets stuck with a dark Bluetooth LED.
...
A loose 3.5mm plug causes more "broken" headset reports than you'd think. If you're running a[wired gaming headset](https://www.turtlebeach.com/products/recon-70-headset?Platform=Xbox&Color=Black) , unplug it and push it back in firmly. You should feel it click. Clean the jack with compressed air and try a different controller to rule out a faulty port. A headset with a reinforced cable, like the[Recon 200 Gen 2](https://www.turtlebeach.com/products/recon-200-gen-2-headset?Color=Black) , helps prevent these issues long-term.


Turtle Beach wireless headsets (Stealth 600/700 Gen 3, Stealth 500)


These connect via a USB transmitter, not the controller jack. Check that the transmitter is plugged directly into the console's USB port, not through a USB hub. Then check the LED indicators. On the[Stealth 600](https://www.turtlebeach.com/products/stealth-600-headset?Platform=Xbox&Color=Purple) , the transmitter LED should be solid green (paired, mic unmuted) or pulsing red (paired, mic muted). If the headset LEDs are blue instead of green, it's in Bluetooth mode, not Wireless mode. Press the QuickSwitch button on the headset to toggle back to Wireless. The LEDs should switch from blue to green.
...
Turtle Beach mic tip:[The Stealth 600 Gen 3](https://www.turtlebeach.com/products/stealth-600-gen-3-headset?Platform=Xbox&Color=Black) and Stealth 700 Gen 3 both use a flip-to-mute mic. You'll hear a low-to-high tone when the mic is unmuted and a high-to-low tone when muted. If teammates can't hear you, flip the mic all the way forward and confirm you hear that unmute tone. For more on[how controller audio routing affects sound quality](https://www.turtlebeach.com/blog/wired-vs-wireless-gaming-headphones-sound-quality-latency) , we've covered that separately.
...
If you're debating[whether to go wired or wireless](https://www.turtlebeach.com/blog/should-i-stick-with-wired-or-try-wireless-gaming-headsets) , keep in mind that wireless headsets connecting directly to the console sidestep controller firmware issues entirely.
...
If the controller port is damaged, a[wireless headset](https://www.turtlebeach.com/collections/xbox-headsets) that connects directly to the console bypasses it entirely. For the full rundown on[wireless headset compatibility across PC and console](https://www.turtlebeach.com/blog/wireless-headset-pc-console-compatibility) , check out our compatibility guide.
...
If you're tired of dealing with controller jack problems altogether,[Turtle Beach wireless Xbox headsets](https://www.turtlebeach.com/collections/xbox-headsets) like the[Stealth 600](https://www.turtlebeach.com/products/stealth-600-headset?Platform=Xbox&Color=Purple) and[Stealth 500](https://www.turtlebeach.com/products/stealth-500-headset?Platform=Xbox&Color=Black) connect directly to your console. No controller passthrough, no jack issues, just clean audio from the jump. And if you want the full premium experience, the[Stealth 700 Gen 3](https://www.turtlebeach.com/products/stealth-700-gen-3-headset?Platform=Xbox&Color=Black) with Superhuman Hearing™ gives you a serious edge in competitive play.
