...
document_id: "ba23597fd450c25fd221a033cad372a45212bfb9b9318114fc64c8d592c23402"
company_key: "yc-caribou"
company: "Caribou"
source_id: "yc-caribou-news-import-d3dc86bbd52a"
canonical_url: "https://www.usecaribou.com/blog/y-combinator-everything-you-need-to-know-about-receiving-us-investment"
published_at: null
first_seen_at: "2026-07-24T23:29:48.758963+00:00"
fetched_at: "2026-07-28T21:36:14.883471+00:00"
content_hash: "sha256:2b114b700540a212c61dfd5f52dae4f8ea9fff768ee835a8150445324ff9861e"
---

# Y Combinator - Everything about receiving US investment.
...
Delaware tax regulations encourage a high number of outstanding shares. The critical figure for UK tax purposes is the proportion of issued shares (For my co-founder and me being a 50/50 split).The lawyers authorise[10,000,000 shares](https://www.airplane.dev/blog/why-does-every-startup-incorporate-with-10-000-000-shares) of Common Stock, reserving 1,000,000 shares in case we would like to create an employee stock option plan after formation. → I laugh as we previously had only 2 shares for the whole company.


7.


They ask for IP assignments. → I find ours on saved in[SeedLegals](https://seedlegals.com/) . Plenty of templates there.
...
Hearing that[Brex](https://www.brex.com/) and[Mercury](https://mercury.com/) only require an SS4 (an application for an EIN) to get a US bank account. We trust that we'll get the application in as soon as we're incorporated, and that's all we need.
...
We don't want to get blocked from issuing[SAFEs](https://fundersclub.com/learn/safe-primer/safe-primer/safe/) , and we weren't sure at this stage if the YC deal stops you (It doesn’t). What does block you are not having your topco incorporated and having a bank account in your topco’s jurisdiction, either of which we still didn’t have.


Our lawyers let us know they’ve sent off the[s138 letter](https://www.gov.uk/guidance/seeking-clearance-or-approval-for-a-transaction) . This is a form sent to HMRC for their clearance on certain tax elements of the flip transaction. It can and often does take up to 30 days to come back.
...
We don’t waste time submitting an[SS4 application](https://www.irs.gov/forms-pubs/about-form-ss-4) for an EIN to get a US bank account, meaning we can finally receive the YC investment. We use the[Doola](https://www.doola.com/) for $99 and submit the form. It’s worth it for the peace of mind that it gets submitted correctly.
...
We learn that we need to submit an[83b form](https://www.cooleygo.com/what-is-a-section-83b-election/) within 30 days of our Delaware incorporation. You can choose not to submit your 83b. The complication is that if you end up being a tax resident in the US, you'll wish you had submitted it. Without the 83b, you may end up paying tax on the value of your shares at the time of an IPO/exit vs based on their value now.
...
We want to issue a SAFE using[Clerky](https://www.clerky.com/) , but they say we can't have access until the YC paperwork is finalised. The YC legal team haven't finished reviewing our docs, so we tell the investor we'll hopefully be ready to issue a SAFE within a week.‍
...
Things are getting pressured, so we poke the YC legal team. They give us access to[Clerky](https://www.clerky.com/) while they finish their review. Clerky's onboarding asks for an EIN (which we don’t have yet) and just put down “pending”.
...
Our lawyers ask for an e-filing code ***"In order to make electronic filings with Companies House".*** We forward it after checking[ewf.companieshouse.gov.uk](http://ewf.companieshouse.gov.uk/)
...
*"We recommend your company work with its attorney to file a paper notice under the DFPI's hardship exception to its rules that require electronic filing. To file a paper notice, use the form and follow the instructions in the*[DFPI's Limited Offering Exemption Notice Packet](https://dfpi.ca.gov/wp-content/uploads/sites/337/forms/Securities/DFPI-260.102.14c.pdf) *. To be timely under the DFPI's rules, a notice must be filed or mailed no later than 15 calendar days after the date of an offering's first sale in California."*
...
Finally, in December, we get a US accountant ([Socotax](https://www.socotax.com/) . Thanks,[Kate Hiscox](https://www.linkedin.com/in/katehiscox/) , for recommending them to us!). They put our mind at ease about many things.
