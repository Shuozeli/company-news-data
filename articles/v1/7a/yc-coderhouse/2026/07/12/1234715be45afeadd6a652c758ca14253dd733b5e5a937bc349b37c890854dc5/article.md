...
document_id: "1234715be45afeadd6a652c758ca14253dd733b5e5a937bc349b37c890854dc5"
...
# Kimi K3: modelo open source frontier de Moonshot AI | Coderhouse
...
Kimi K3 se publicó bajo una licencia permisiva (una variante de MIT), lo que habilita usos amplios, incluidos comerciales. Los pesos de este tipo de modelos suelen distribuirse en plataformas como[Hugging Face](https://huggingface.co/) , el repositorio de referencia de la comunidad de IA abierta.
...
La contracara es que necesitás hardware capaz de correr un modelo grande y conocimiento para desplegarlo y mantenerlo. Ahí es donde el rol del ingeniero de IA se vuelve decisivo. Si querés entender la base de todo esto, empezá por[qué es el machine learning y para qué sirve](https://www.coderhouse.com/coderlibrary/que-es-el-machine-learning-y-para-que-sirve) .


## El contexto: open source ganando terreno


Kimi K3 se suma a una ola de modelos abiertos cada vez más potentes. Medios especializados como[TechCrunch](https://techcrunch.com/category/artificial-intelligence/) vienen documentando cómo la brecha entre modelos abiertos y cerrados se achica trimestre a trimestre. Para las empresas, esto abre una alternativa real a depender exclusivamente de proveedores comerciales.


## Cursos recomendados de Coderhouse


Para trabajar con modelos como este, el[Curso de AI Engineering](https://www.coderhouse.com/cursos/ai-engineering) te enseña a integrarlos en aplicaciones reales. Si te interesa construir agentes sobre modelos abiertos, el[Curso de AI Agents](https://www.coderhouse.com/cursos/ai-agents) es el camino. Y si estás empezando, el[Curso de Introducción a la Inteligencia Artificial](https://www.coderhouse.com/cursos/introduccion-inteligencia-artificial) te da el marco para entender por qué estos anuncios importan.
