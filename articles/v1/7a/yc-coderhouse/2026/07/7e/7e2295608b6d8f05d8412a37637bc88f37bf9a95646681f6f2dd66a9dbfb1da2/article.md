...
document_id: "7e2295608b6d8f05d8412a37637bc88f37bf9a95646681f6f2dd66a9dbfb1da2"
...
# Computer Vision para empresas: casos de uso reales | Coderhouse
...
Es la rama de la inteligencia artificial que permite a las máquinas **interpretar imágenes y video** : reconocer objetos, personas, textos o anomalías. Si querés el fundamento técnico detrás, ayuda entender antes[qué es el machine learning y para qué sirve](https://www.coderhouse.com/coderlibrary/que-es-el-machine-learning-y-para-que-sirve) , ya que el computer vision es una de sus aplicaciones más potentes.
...
Según el[State of AI de McKinsey](https://www.mckinsey.com/capabilities/quantumblack/our-insights/the-state-of-ai) , las operaciones y la manufactura están entre las áreas donde la IA aplicada, incluido el computer vision, genera retornos más medibles.
...
Etiquetar y entrenar modelos con interfaz visual
...
Detección lista para usar vía API
...
Integración en entornos Microsoft


Intermedio


Con[Roboflow](https://roboflow.com/) podés subir imágenes, etiquetarlas y entrenar un modelo sin código. Para tareas comunes ya resueltas,[Google Cloud Vision](https://cloud.google.com/vision/docs) ofrece detección de objetos y texto lista para usar.
...
Para entender la IA que hay detrás y poder liderar estos proyectos, el[Curso de Introducción a la Inteligencia Artificial](https://www.coderhouse.com/cursos/introduccion-inteligencia-artificial) es el primer paso. Si querés construir aplicaciones que usen visión y modelos, el[Curso de AI Engineering](https://www.coderhouse.com/cursos/ai-engineering) te da las herramientas técnicas. Y para automatizar procesos que combinen visión con flujos de negocio, la[Carrera de AI Automation](https://www.coderhouse.com/carreras/carrera-ai-automation) es una gran opción.
