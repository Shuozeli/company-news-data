...
document_id: "7f2920f307054c688bf2bc5b6be0611f814f52a14b1b7ecc7de91cd5b7a2a2c6"
...
# Neochromosome and GlobalBio Launch Pre-Transformed Antibody Libraries in Switchable Yeast Platform

*GlobalBio’s validated, highly diverse human antibody libraries are now available pre-integrated into Neochromosome’s novel neoSwitch yeast strain, enabling rapid in-house antibody discovery via yeast display and streamlined lead characterization in secretion mode.*


**LONG ISLAND CITY, N.Y. AND CAMBRIDGE, MA – November 12, 2025** – Neochromosome, Inc., the genome-scale cell engineering subsidiary of lab automation leader, Opentrons Labworks, today announced a turnkey solution for in-house biologics discovery. The platform integrates GlobalBio, Inc.’s clinically validated antibody libraries into the Neochromosome *®* neoSwitch yeast strain—a novel system that can both surface-display and secrete VHHs, scFvs, and other proteins relevant to therapeutics discovery. This approach enables rapid hit identification and lead optimization, saving weeks per iteration and cutting months from traditional discovery timelines.
...
- 90% of library scFvs confirmed functional, including 70% highly stable (Tm > 700C) members
- Highly diverse HCDR3 regions with a Gaussian length distribution between 4-22 amino acids resembling the human natural diversity
...
- **In-House Platform** : Pre-transformed libraries shipped for internal screening programs
- **Annual Licensing** : Unlimited campaigns under a flat-fee model for predictable budgeting and maximum flexibility
...
contact@globalbioinc.com


The post[Neochromosome and GlobalBio Launch Pre-Transformed Antibody Libraries in Switchable Yeast Platform](https://opentrons.com/archives/news/neochromosome-and-globalbio-launch-pre-transformed-antibody-libraries-in-switchable-yeast-platform) appeared first on[Opentrons](https://opentrons.com/) .
