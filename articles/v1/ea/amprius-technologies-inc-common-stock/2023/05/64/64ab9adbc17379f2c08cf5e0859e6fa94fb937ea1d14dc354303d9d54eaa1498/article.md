...
document_id: "64ab9adbc17379f2c08cf5e0859e6fa94fb937ea1d14dc354303d9d54eaa1498"
...
canonical_url: "https://amprius.com/hybrid-electric-aircraft/"
published_at: "2023-05-23T16:58:10+00:00"
first_seen_at: "2026-07-20T03:32:00.771834+00:00"
fetched_at: "2026-07-28T21:01:55.089772+00:00"
content_hash: "sha256:13e5441e5a0b0b4839ee9d6c416bd0775d6416ce0cd35f3cd58ab7be70d3337b"
---
...
HEA technology is in the early stages of development. Still, there is growing interest in its potential to reduce the environmental impact of air travel, especially as businesses and consumers see the successes of electric vehicles.
...
In September 2022, Air Canada[placed a purchase order](https://electricautonomy.ca/2022/09/15/air-canada-hybrid-electric-passenger-airplanes/) for 30 hybrid-electric aircraft from Swedish manufacturer Heart Aerospace. Those planes are expected to take 30 to 50 minutes to charge. United and Mesa are also[among the airlines](https://www.washingtonpost.com/technology/2022/09/21/electric-plane-heart-aerospace-es-30/) that placed orders for the Heart ES-30.


In an earlier 2015 test, engineers from the[University of Cambridge](https://www.businessinsider.com/hybrid-electric-aircraft-can-recharge-mid-flight-2015-1) tested a plane with a “parallel hybrid-electric propulsion system,” suggesting that their design could also recharge its batteries during flight.
...
The Heart ES-30’s 30 to 50 minute charge time is estimated to give a 200 kilometer all-electric range, or an 800 kilometer hybrid range, with an onboard turbine generator running on[sustainable aviation fuel](https://amprius.com/aviation-safs-batteries/) . This estimate is based on a full charge while moving 30 passengers and their bags weighing up to 25 kilograms per person.


Lilium, City Airbus, Boeing Aurora eVTOL, and Bye Aerospace Sun Flyer 2 are[examples of other projects](https://www.icao.int/environmental-protection/Pages/electric-aircraft.aspx) with varying ranges. The aircraft under the business and regional aircraft category claim a longer flight range of close to 1000 km (621 miles) with a seating capacity of around ten.


## How do hybrid electric aircraft work?


HEAs use both traditional fossil fuel-powered engines and electric motors to provide propulsion, which require batteries or other energy storage systems.


### What is the primary fuel source?


The primary fuel source for HEA varies based on design, but most use aviation fuel, including[sustainable aviation fuel](https://amprius.com/aviation-safs-batteries/) .


Electric motors, however, are commonly powered by batteries. Other energy storage systems, such as fuel cells, can be used, but batteries can be charged from various sources including renewable energy sources, such as solar or wind power, and conventional electricity from the grid.
...
Batteries are one of the key technologies enabling electric flight. The development of lighter and more energy-dense batteries will help drive the adoption of HEAs. Advances in[battery technology](https://youtu.be/30MV9Yu2MQw) can increase HEAs’ range and allow longer flights without refueling.
...
When using a battery as an energy source, the energy density of the battery pack determines how far the aircraft can travel on a single charge. Most HEAs rely on batteries to power their electric motors, so the energy density of these batteries directly affects the range and performance of the aircraft.
...
The previously mentioned[Heart ES-30](https://electrek.co/2022/09/16/air-canada-invests-heart-aerospace-orders-updated-versions-electric-airplane/) is a 30-passenger electric aircraft, replacing the company’s earlier 19-seat design, the ES-19. However, it has yet to be thoroughly tested.


[Heart’s engineering team conducted testing](https://www.futureflight.aero/aircraft-program/heart-electric-airliner) with a ground-based prototype of the ES-19’s complete electric propulsion system in 2021. As for the ES-30, a[full-scale integrated test facility](https://airinsight.com/heart-upsizes-full-electric-aircraft-to-make-it-a-30-seater/) with a full-flight simulator of the ES-30 has been built. A proof-of-concept aircraft is expected to be rolled out in 2024, with flight testing planned to start in 2026.


[In 2020](https://www.bbc.com/future/article/20200617-the-largest-electric-plane-ever-to-fly) , a modified Cessna Caravan 208B with just a seat installed for the pilot flew for 30 minutes solely powered by electricity. VoltAero’s Cassio, with options for four-, six- and nine-seat configurations, also[completed a test flight](https://norfolkaviation.com/hybrid-electric-aircraft-has-first-test-flight/) . For now, companies are starting small and light.
...
- Airbus created the[E-Fan X](https://www.airbus.com/en/innovation/zero-emission/electric-flight/e-fan-x) , a hybrid electric aircraft demonstration[developed in partnership](https://www.airbus.com/en/newsroom/press-releases/2017-11-airbus-rolls-royce-and-siemens-team-up-for-electric-future) with Rolls-Royce and Siemens. The project was canceled during the pandemic.
- Boeing is working on the development of a[hybrid electric propulsion system](https://www.aerospacetestinginternational.com/news/electric-hybrid/boeing-joins-major-us-program-to-demonstrate-hybrid-electric-aircraft.html) for aircraft, modifying a test aircraft and supporting the flight testing of a megawatt-class hybrid-electric aircraft propulsion system being developed by aero-engine maker GE Aviation.
- Sikorsky Aircraft is developing a[hybrid-electric vertical take-off and landing](https://westfaironline.com/aviation/sikorsky-developing-hybrid-electric-aircraft-for-advanced-air-mobility-sector/) (VTOL) aircraft demonstrator vehicle. The Sikorsky Autonomy Research Aircraft (SARA) is a reconfigured S-76B.
- Earlier this year, ZeroAvia flew its[Dornier 228 testbed aircraft](https://skiesmag.com/news/zeroavia-successfully-flies-worlds-largest-aircraft-powered-hydrogen-electric-engine/) with one turboprop replaced by a prototype hydrogen-electric powertrain in the cabin, consisting of two fuel cells and a lithium-ion battery.
...
Airline leaders[are first planning](https://www.smithsonianmag.com/smart-news/electric-planes-are-taking-flight-180980821/) to use early hybrid or electric-only planes for short, urban commuter routes as an important first step toward scalable technologies.


Aerospace engineer and assistant professor Gökçin Çınar spoke to[The Conversation](https://theconversation.com/electric-planes-are-coming-short-hop-regional-flights-could-be-running-on-batteries-in-a-few-years-190098) about the future of electric planes, noting there are fuel burn benefits from batteries in larger jets by using hybrid propulsion systems. She mentions a 2030-2035 target for smaller regional aircraft.
...
With short-range, affordable travel and the addition of VTOL technology, HEAs could open new routes and destinations not currently accessible by conventional aircraft. This could help to connect more communities and promote economic development in underserved areas.
...
For example, Wright Electric[is developing a 186-seat commercial jet](https://www.electrive.com/2021/11/05/wright-electric-announces-plans-for-100-seater-electric-aircraft/) with an 800-mile range with a proposed launch of 2030 and an electric 100-seat plane that could take off in 2026 named the Wright Spirit, an electric-powered version of the BAe 146 regional jet originally manufactured by BAE Systems.


*Last updated May 3, 2026. Photo credit: Heart Aerospace*
