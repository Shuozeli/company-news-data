...
document_id: "939c803d677959b630465ee0fe6ada4f0f0a1db87697caf562d0fc846af63ce3"
...
canonical_url: "https://www.okta.com/newsroom/articles/the-okta-enterprise-ai-index/"
published_at: "2026-07-16T00:00:00+00:00"
first_seen_at: "2026-07-24T07:13:23.896327+00:00"
fetched_at: "2026-07-28T21:38:32.326002+00:00"
content_hash: "sha256:c87ddfc1f4f320987091af2c7c95b662d08c0a6cb174711dda01df7016ab4120"
---
...
Principal Emerging Tech Researcher


Fei Liu is a Principal Emerging Technology Researcher at Okta, leading applied research and enterprise data initiatives. She previously advised Okta’s CEO on market trends and emerging technology. Prior to Okta, she held various research and strategy roles at Huawei and IBM. She received a PhD in electrical engineering from UCLA and an MBA from NYU.
...
Generative AI once sat on IT’s restricted list. In just a few years,[enterprises have moved from blocking the technology](https://www.cio.com/article/4184660/samsung-which-previously-blocked-chatgpt-is-now-fully-adopting-three-generative-ai-models-and-accelerating-its-ax-initiative.html) on corporate networks to enabling it across their workforces. Today, leaders aren’t debating if this technology belongs in their business. They’re deciding which AI platforms, and how many, they need to stay competitive.
...
To identify which AI platforms businesses are using, we analyzed anonymized[Okta Single Sign-On (SSO)](https://www.okta.com/products/single-sign-on-workforce-identity/) data, tracking more than 100 distinct AI products, and consolidating them into 74 product suites.


We then needed an equitable way to compare a startup launching from scratch with a tech giant that already has millions of existing users. Our solution: a framework based on baseline growth velocity. First, we ranked the top 30 performers by measuring their growth in enterprise accounts from June 2022 through June 2026, as shown in Figure 1. Then, under this framework, we categorized companies into two distinct groups (seeMethodology for more detail):


### AI native


Pure-play disruptors that multiplied their corporate customer base by **more than 4x** over this period. These are companies such as Anthropic, OpenAI, and Cursor, where generative AI is the foundational core of their products.


### AI enhanced


Established incumbents growing **below the 4x threshold.** These are companies such as GitHub/Microsoft 365, Google Workspace, Figma, Slack, Adobe, and Notion, which achieved enterprise success before the generative AI era but have since adapted their platforms to lead the market forward.
...
The enterprise AI landscape hasn't just grown. It has fundamentally evolved. As illustrated in Figure 2, we have experiencedthree generative AI paradigms over the past four years , each redefining how businesses operate and how platforms capture market share.
...
But this reality comes with fresh considerations. As AI evolves from software that takes orders to agents that can act autonomously across these systems, organizations face a widening security gap. To close it, they must[treat these new digital workers as first-class identities](https://www.okta.com/solutions/secure-ai/agentic-enterprise-blueprint/) , answering three fundamental questions: Where are my agents? What can they connect to? And what can they do?
...
- Autocomplete paradigm:[GitHub Copilot GA](https://github.blog/news-insights/product-news/github-copilot-is-generally-available-to-all-developers/) (June 2022)
- Chat paradigm:[ChatGPT launch](https://openai.com/index/chatgpt/) (November 2022);[Google Bard launch](https://blog.google/innovation-and-ai/products/try-bard/) (March 2023);[Claude.ai launch](https://www.anthropic.com/news/claude-2) (July 2023);[ChatGPT Enterprise launch](https://openai.com/index/introducing-chatgpt-enterprise/) (August 2023):[GitHub Copilot Chat GA](https://github.blog/news-insights/product-news/github-copilot-chat-now-generally-available-for-organizations-and-individuals/) (December 2023);[GitHub Copilot Enterprise GA](https://github.blog/news-insights/product-news/github-copilot-enterprise-is-now-generally-available/) (February 2024);[Claude Enterprise](https://claude.com/blog/claude-for-enterprise) (September 2024);[Gemini Enterprise GA](https://cloud.google.com/blog/products/ai-machine-learning/introducing-gemini-enterprise) (October 2025)
- Agentic paradigm:[Claude Code GA](https://www.anthropic.com/news/claude-4) (May 2025);[Cursor 1.0](https://cursor.com/changelog/1-0) (June 2025);[OpenAI Codex app GA](https://openai.com/index/introducing-the-codex-app/) (February 2026);[Claude Cowork GA](https://claude.com/blog/cowork-for-enterprise) (April 2026);[Google Antigravity 2.0](https://antigravity.google/blog/introducing-google-antigravity-2) (May 2026);[Microsoft Scout preview](https://www.microsoft.com/en-us/microsoft-365/blog/2026/06/02/introducing-microsoft-scout-your-always-on-personal-agent/) (June 2026)
...
[Industry Insights • 27 May 2026 Shadow AI and securing the agentic enterprise with Okta Regional CSO Matt Immler 27 May 2026 Learn more](https://www.okta.com/newsroom/articles/shadow-ai-and-securing-the-agentic-enterprise-with-okta-regional-cso-matt-immler/)
