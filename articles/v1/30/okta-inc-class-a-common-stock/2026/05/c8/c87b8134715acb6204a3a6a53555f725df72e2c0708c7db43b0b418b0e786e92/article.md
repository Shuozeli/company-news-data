...
document_id: "c87b8134715acb6204a3a6a53555f725df72e2c0708c7db43b0b418b0e786e92"
...
canonical_url: "https://www.okta.com/newsroom/articles/ai-agents-at-work-2026-agentic-enterprise-security/"
published_at: "2026-05-27T00:00:00+00:00"
first_seen_at: "2026-07-24T07:13:23.896327+00:00"
fetched_at: "2026-07-28T22:07:11.290939+00:00"
content_hash: "sha256:6642970f526cab18f41f016217e814cd4be300d6d9612ed15d12e5b80a463666"
---
...
## A global survey reveals a critical disconnect between executive confidence in AI agents and how employees actually use them, creating a concerning security gap. Read the results, plus actionable strategies to secure your agentic enterprise.
...
Building a secure agentic enterprise requires a clear strategy—[a blueprint for managing this new reality](https://www.okta.com/solutions/secure-ai/agentic-enterprise-blueprint/) . It starts with establishing clear accountability and visibility before agents scale out of control. Organizations must be able to answer three questions:
...
### 492 Knowledge workers


### 7 Countries


## 292 C-level executives and vice presidents with authority over IT, security, data, and engineering, alongside knowledge workers in a variety of data-oriented roles.
...
#### Executives are overconfident, but shadow AI is widespread:
90% of executives are confident in their organization’s visibility into AI tools, and 95% are confident employees are using AI responsibly. However, 52% of employees admit to using AI tools without approval, often via personal accounts.


-


#### Governance gaps are resulting in real-world consequences:
More than half of executives (58%) reported that their organization experienced an AI-related security incident or a close call in the past year.


-


#### Employees share sensitive information and access with AI tools:
Of those using unapproved AI tools, over half (54%) share internal messages and emails, 45% share HR-related information, and 39% share confidential company documents.
...
While 65% of executives believe their organization’s AI usage policies are “very clear,” more than half of knowledge workers (57%) disagree, finding policies unclear, hard to find, or non-existent.
...
Only 34% of organizations apply the same security controls to their agentic labor force as their human labor force.


## For more than half of organizations, AI risk has already escalated into a real-world security issue
...
#### For many organizations, this scenario is all too real: In fact, 58% of executives reported that their company experienced an AI-related security issue or close call within the last 12 months.
...
## AI is everywhere, and it’s got the keys to the kingdom
...
## For practically every organization, AI is an everyday reality
...
**Survey question:** ****** To what extent is your organization currently using AI agents, autonomous systems that can make decisions and take action without human intervention (e.g., Microsoft Copilot, Salesforce Einstein, Github Copilot, etc.)?
...
**Survey question:** How often do you use AI tools for work-related tasks?


## Handing over the keys to the kingdom: Users regularly share sensitive data with AI tools
...
**Survey question:** ****** Which of the following types of information have you entered, uploaded, or shared with an AI tool (e.g., ChatGPT, Gemini, Claude) or AI agent (e.g., Microsoft Copilot, Zendesk AI, Salesforce Einstein) in the past 6 months?
...
**Survey question:** Have you ever granted an AI tool or AI agent permission to access any of the following?


##


## Barely half of organizations have a strategy for managing AI, and usage policies aren’t as clear as leaders believe


A major finding from[last year’s survey](https://www.okta.com/newsroom/articles/ai-at-work-2025--securing-the-ai-powered-workforce/) was the alarming gap between AI adoption and AI governance: While 91% of organizations were already using AI agents, only 10% had a well-developed strategy or roadmap for managing non-human identities (NHIs).
...
## The AI policy clarity gap


---


**Survey question:** How clear and accessible are your organization's AI usage policies?


## Widespread shadow AI is undermining AI governance
...
## Executive blindspot: Leaders vastly underestimate the prevalence of shadow AI
...
## A worldwide disconnect on shadow AI
...
## The global shadow AI gap: Perception vs. reality


Your browser does not support the video tag. Please upgrade to a modern browser.


## Convenience and social permission drive shadow AI
...
## Identity remains essential for securing AI agents, but organizations need to get consistent about applying controls


[Last year’s survey](https://www.okta.com/newsroom/articles/ai-at-work-2025--securing-the-ai-powered-workforce/) revealed that 85% of leaders consider identity and access management (IAM) vital to the successful adoption and integration of AI within their organization.
...
**Survey question:** Does your organization treat your digital labor force (e.g., AI agents, bots, or automated systems) with the same level of rigor and vigilance as the human workforce in terms of security, governance, and access management?


## Actionable insights: Closing the AI governance gap
...
1. **Assume shadow AI exists and make discovery a priority.** The data shows that 52% of employees are using unapproved AI tools. Your first step is to assume shadow AI is already in your environment. Use tools like[Shadow AI Agent Discovery](https://www.okta.com/newsroom/press-releases/showcase-2026/) to gain full visibility into all AI agents, not just the ones your IT team has sanctioned.


2. **Make the secure path the easiest path.** Workers are choosing unsanctioned tools because they are faster and easier. A stricter policy won't solve this; it will only be ignored if it hinders productivity. Instead, focus on removing friction from your approved AI tools and workflows by deploying standard protocols such as[Cross App Access](https://www.okta.com/newsroom/press-releases/okta-introduces-cross-app-access-to-help-secure-ai-agents-in-the/) . When the official, secure way to use AI is also the most efficient way, employees will follow it.


3. **Define your AI governance strategy now.** With the majority of surveyed executives reporting AI-related incidents or close calls, don’t wait for a crisis to define your governance strategy. Use the[blueprint for a secure agentic enterprise](https://www.okta.com/solutions/secure-ai/agentic-enterprise-blueprint/) to establish the critical visibility, access controls, and accountability needed to scale AI securely.[Okta's AI Blueprint Tool](https://www.okta.com/assessments/ai-blueprint) can help you assess your agent security architecture and expose security gaps.


4. **Treat AI agents like privileged insiders.** Nearly two-thirds of organizations apply weaker security controls to AI agents than to human employees, creating a dangerous double standard. Every AI agent should be treated as a first-class identity with its own lifecycle and granular permissions. Consider identity solutions tailored to managing AI agents, such as[Okta for AI Agents](https://www.okta.com/products/govern-ai-agent-identity/) .
...
[Industry Insights • 16 Jul 2026 The Okta Enterprise AI Index 16 Jul 2026 Learn more](https://www.okta.com/newsroom/articles/the-okta-enterprise-ai-index/)


[Industry Insights • 14 Jul 2026 Meet your new digital co-worker: Why AI agents belong on the org chart 14 Jul 2026 Learn more](https://www.okta.com/newsroom/articles/meet-your-digital-co-worker-why-ai-agents-belong-on-the-org-chart/)


[Industry Insights • 04 Jun 2026 ADT CISO Tim Rains on why AI agent access is crucial — and risky 04 Jun 2026 Learn more](https://www.okta.com/newsroom/articles/adt-ciso-tim-rains-on-why-ai-agent-access-is-crucial-and-risky/)
...
[Subscribe for free](https://www.linkedin.com/newsletters/access-granted-newsletter-7155652997908193280/)
