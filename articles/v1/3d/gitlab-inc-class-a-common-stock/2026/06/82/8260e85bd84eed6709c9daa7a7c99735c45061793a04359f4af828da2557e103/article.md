...
document_id: "8260e85bd84eed6709c9daa7a7c99735c45061793a04359f4af828da2557e103"
...
canonical_url: "https://about.gitlab.com/blog/gitlab-leader-2026-gartner-mq-devsecops-platforms/"
...
content_hash: "sha256:095ecd027471fc1f0fada6c51e17ac489e7b1d2c9c36905399e7c132b3689c11"
---
...
> [Download the 2026 Gartner® Magic Quadrant™ for DevSecOps Platforms](https://about.gitlab.com/resources/gartner-magic-quadrant/) .
...
Agentic AI is only as good as the platform underneath it, and this is the foundation our customers already build on.[Ericsson](https://about.gitlab.com/customers/ericsson/) cut its deployment time in half while serving the operators that keep billions of subscribers connected.[Southwest](http://youtube.com/watch?v=dMj0XjhEId0&themeRefresh=1) runs mission-critical software for round-the-clock airline operations, where reliability is not negotiable.[Barclays PLC](https://about.gitlab.com/customers/barclays-plc/) and other highly regulated enterprises deliver under security and compliance demands where speed and oversight cannot be traded against each other.
...
At[GitLab Transcend](https://about.gitlab.com/events/transcend/virtual/) last week, we built further on the control layer with five new innovations:
...
2. **[GitLab Orbit](https://about.gitlab.com/blog/introducing-gitlab-orbit/) , a context graph** across your code, work items, pipelines, deployments, and production signals. Point Claude Code at Orbit and the same tasks with the same model run up to 11x faster, with up to 4.5x fewer tokens, and up to 45x fewer hallucinations.
...
5. **[GitLab Flex agreements](https://about.gitlab.com/blog/introducing-gitlab-flex/)** so you can shape your GitLab spend on the products and capabilities without changing your contracts.
