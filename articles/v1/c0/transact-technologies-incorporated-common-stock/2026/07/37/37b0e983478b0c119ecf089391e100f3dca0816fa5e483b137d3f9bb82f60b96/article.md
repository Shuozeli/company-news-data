...
document_id: "37b0e983478b0c119ecf089391e100f3dca0816fa5e483b137d3f9bb82f60b96"
...
canonical_url: "https://www.transact-tech.com/resources/blog/what-are-tcs-foods"
published_at: "2026-07-15T20:51:19+00:00"
first_seen_at: "2026-07-22T17:07:19.981139+00:00"
fetched_at: "2026-07-28T21:38:32.326002+00:00"
content_hash: "sha256:93f1d56ff20a216ad94bf8b73b6b0c2dd256d5a7e0e67d507cb6dfb8eef8a058"
---

# What Are TCS Foods? The Complete FDA List

## What are TCS foods?


**TCS foods are Time/Temperature Control for Safety foods: items that require time and temperature control to stay safe, because they support the rapid growth of bacteria or the production of toxins.** If a food is moist, protein-rich, and low in acid, bacteria thrive in it, and it almost certainly lands on the TCS list.


You may also hear these called “potentially hazardous foods.” That is the older term. The[FDA Food Code](https://www.fda.gov/food/fda-food-code/food-code-2022) replaced it with TCS to make the meaning precise: the food is not inherently dangerous. It simply needs time and temperature control in order to stay safe.


## The science: what actually makes a food TCS


This is not an arbitrary list. Three measurable properties decide it, and they map directly to what bacteria need to grow.


**Water activity (a** **w** **) –** Not total moisture, but *available* water. Bacteria can only use water that is not chemically bound to sugar, salt, or other solids. Foods with a water activity above roughly **0.85** support bacterial growth. This is why beef jerky is safe at room temperature and a fresh steak is not, despite both being meat.
...
### The one-question shortcut: “Is it moist, low in acid, and nutritious?”
...
The[FDA Food Code](https://www.fda.gov/food/fda-food-code/food-code-2022) identifies the foods that commonly require time and temperature control:
...
### **Cooked starches and vegetables**


- Cooked rice, beans, pasta, and other cooked grains


- Heat-treated vegetables (baked potatoes, cooked beans, sauteed onions)
...
- Cut tomatoes and mixtures containing them
...
## The four TCS foods that can surprise people
...
### What your team needs to know: Cutting or cooking changes the rules
...
- Dry goods: flour, sugar, uncooked pasta, uncooked rice


- Unopened commercially canned goods


- Most breads and baked goods without moist, protein-rich fillings


- High-acid foods: most pickles, jams, and citrus


- Whole, uncut raw produce


- Dried and cured products with low water activity, such as jerky
...
## **Why TCS foods matter: the danger zone and the 4-hour rule**


TCS foods are the reason the temperature danger zone exists as a concept. The[danger zone](https://www.fsis.usda.gov/food-safety/safe-food-handling-and-preparation/food-safety-basics/danger-zone-40f-140f) is **41°F to 135°F** , the range where bacteria multiply fastest, and three rules govern how TCS foods move through it.
...
Our[full guide to the temperature danger zone](https://www.transact-tech.com/resources/blog/temperature-danger-zone) covers two-stage cooling, reheating, and the six-hour cold option.


## The rule people forget: date marking
...
## Managing TCS foods across multiple locations
...
## The short version: the TCS essentials
...
1. Water activity above **0.85**
2. pH above **4.6**
3. Enough nutrients to support bacterial growth


### Three controls to remember


1. **Control temperature:** Keep TCS foods at **41°F or below** or **135°F or above** .
2. **Track time:** When time is used instead of temperature control, follow the **4-hour cumulative limit** and discard the food when time expires.
3. **Date mark correctly:** Ready-to-eat TCS food held for more than 24 hours may be kept for a maximum of **7 days at 41°F or below** , with the preparation day counted as **Day 1** .


### The daily operating habit
...
## **Frequently asked questions** TCS foods
...
### **Are cut tomatoes and cut melons really TCS foods?**
...
### **What is the difference between TCS foods and potentially hazardous foods?**
...
### **How long can ready-to-eat food TCS food be kept?**
